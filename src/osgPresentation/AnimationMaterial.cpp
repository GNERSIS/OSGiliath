...
void
AnimationMaterial::insert( double         time,
...
bool
AnimationMaterial::getMaterial( double         time,
...
void
AnimationMaterial::interpolate( osg::Material&       material,
                                float                r,
                                ...
                                const osg::Material& rhs ) const
{
    ...
    material.setAmbient( osg::Material::FRONT_AND_BACK,
                         interp( r,
                                 lhs.getAmbient( osg::Material::FRONT ),
                                 rhs.getAmbient( osg::Material::FRONT ) ) );
    if( !material.getAmbientFrontAndBack() )
    {
        material.setAmbient( osg::Material::BACK,
                             interp( r,
                                     lhs.getAmbient( osg::Material::BACK ),
                                     rhs.getAmbient( osg::Material::BACK ) ) );
    }

    material.setDiffuse( osg::Material::FRONT_AND_BACK,
                         interp( r,
                                 lhs.getDiffuse( osg::Material::FRONT ),
                                 rhs.getDiffuse( osg::Material::FRONT ) ) );
    if( !material.getDiffuseFrontAndBack() )
    {
        material.setDiffuse( osg::Material::BACK,
                             interp( r,
                                     lhs.getDiffuse( osg::Material::BACK ),
                                     rhs.getDiffuse( osg::Material::BACK ) ) );
    }

    material.setSpecular( osg::Material::FRONT_AND_BACK,
                          interp( r,
                                  lhs.getSpecular( osg::Material::FRONT ),
                                  rhs.getSpecular( osg::Material::FRONT ) ) );
    if( !material.getSpecularFrontAndBack() )
    {
        material.setSpecular( osg::Material::BACK,
                              interp( r,
                                      lhs.getSpecular( osg::Material::BACK ),
                                      rhs.getSpecular( osg::Material::BACK ) ) );
    }

    material.setEmission( osg::Material::FRONT_AND_BACK,
                          interp( r,
                                  lhs.getEmission( osg::Material::FRONT ),
                                  rhs.getEmission( osg::Material::FRONT ) ) );
    if( !material.getEmissionFrontAndBack() )
    {
        material.setEmission( osg::Material::BACK,
                              interp( r,
                                      lhs.getEmission( osg::Material::BACK ),
                                      rhs.getEmission( osg::Material::BACK ) ) );
    }

    material.setShininess( osg::Material::FRONT_AND_BACK,
                           interp( r,
                                   lhs.getShininess( osg::Material::FRONT ),
                                   rhs.getShininess( osg::Material::FRONT ) ) );
    if( !material.getShininessFrontAndBack() )
    {
        material.setShininess( osg::Material::BACK,
                               interp( r,
                                       lhs.getShininess( osg::Material::BACK ),
                                       rhs.getShininess( osg::Material::BACK ) ) );
    }
}

void
AnimationMaterial::read( std::istream& in )
{
    while( !in.eof() )
    {
        double    time;
...
void
AnimationMaterial::write( std::ostream& fout ) const
{
    ...
    {
        fout << tcpmitr->first << " "
             << tcpmitr->second->getDiffuse( osg::Material::FRONT ) << std::endl;
    }
}

bool
AnimationMaterial::requiresBlending() const
{
    const TimeControlPointMap& tcpm = getTimeControlPointMap();
    for( TimeControlPointMap::const_iterator tcpmitr = tcpm.begin();
         tcpmitr != tcpm.end();
...
void
AnimationMaterialCallback::operator()( osg::Node*        node,
                                       osg::NodeVisitor* nv )
{
        ...
        nv->getFrameStamp() )
    {
        ...
        if( !_pause )
        {
            ...
            {
                OSG_INFO
                    << "AnimationMaterialCallback::operator() resetting _firstTime to "
                    << time << std::endl;
                _firstTime = time;
            }
            update( *node );
...
double
AnimationMaterialCallback::getAnimationTime() const
{
    if( _firstTime == DBL_MAX )
    {
        return 0.0F;
...
void
AnimationMaterialCallback::update( osg::Node& node )
{
...
void
AnimationMaterialCallback::reset()
{
#if 1
    _firstTime = DBL_MAX;
    _pauseTime = DBL_MAX;
...
void
AnimationMaterialCallback::setPause( bool pause )
{
    if( _pause == pause )
    {
        return;
