...
KeyEventHandler::KeyEventHandler( int                        key,
...
bool
KeyEventHandler::handle( const osgGA::GUIEventAdapter& ea,
...
void
KeyEventHandler::getUsage( osg::ApplicationUsage& /*usage*/ ) const
{
}

void
KeyEventHandler::doOperation()
{
    switch( _operation )
    {
