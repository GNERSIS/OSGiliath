                         ...
                         "osg::Object osg::Node osgParticle::PrecipitationEffect" )
{
    ...
    ADD_FLOAT_SERIALIZER( FogDensity, 0.0f );  // _fogDensity
    ADD_VEC4_SERIALIZER( FogColor, osg::Vec4() );  // _fogColor
    ADD_FLOAT_SERIALIZER( FogStart, 0.0f );  // _fogStart
    ADD_FLOAT_SERIALIZER( FogEnd, 1.0f );  // _fogEnd
}
