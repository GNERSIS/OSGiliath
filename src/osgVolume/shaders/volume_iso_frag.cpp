char volume_iso_frag[] =
    ...
    "    // Recent NVidia drivers have a bug in length() where it throws nan for some "
    "values of input into length() so catch these\n"
    ...
    "\n"
    "    vec4 previousColor = texture( baseTexture, texcoord);\n"
    "\n"
