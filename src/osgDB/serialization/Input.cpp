...
osg::Object*
Input::getObjectForUniqueID( const std::string& uniqueID )
{
...
void
Input::registerUniqueIDForObject( const std::string& uniqueID,
                                  osg::Object*       obj )
{
...
osg::Object*
Input::readObjectOfType( const osg::Object& compObj )
{
    return Registry::instance()
        ->getDeprecatedDotOsgObjectWrapperManager()
        ->readObjectOfType( compObj, *this );
}

osg::Object*
Input::readObjectOfType( const basic_type_wrapper& btw )
{
    return Registry::instance()
        ->getDeprecatedDotOsgObjectWrapperManager()
        ->readObjectOfType( btw, *this );
}

osg::Object*
Input::readObject()
{
    return Registry::instance()->getDeprecatedDotOsgObjectWrapperManager()->readObject(
        *this
    );
}
...
Input::readImage()
{
    return Registry::instance()->getDeprecatedDotOsgObjectWrapperManager()->readImage(
        *this
    );
}
...
Input::readDrawable()
{
    return Registry::instance()->getDeprecatedDotOsgObjectWrapperManager()->readDrawable(
        *this
    );
}
...
Input::readStateAttribute()
{
    return Registry::instance()
        ->getDeprecatedDotOsgObjectWrapperManager()
        ->readStateAttribute( *this );
}

osg::Uniform*
Input::readUniform()
{
    return Registry::instance()->getDeprecatedDotOsgObjectWrapperManager()->readUniform(
        *this
    );
}
...
Input::readNode()
{
    return Registry::instance()->getDeprecatedDotOsgObjectWrapperManager()->readNode(
        *this
    );
}
...
Input::readShader()
{
    return Registry::instance()->getDeprecatedDotOsgObjectWrapperManager()->readShader(
        *this
    );
}

osg::ref_ptr<osg::Object>
Input::readObject( const std::string& fileName )
{
    return readRefObjectFile( fileName, _options.get() );
}

osg::ref_ptr<osg::Image>
Input::readImage( const std::string& fileName )
{
    return readRefImageFile( fileName, _options.get() );
}

osg::ref_ptr<osg::Node>
Input::readNode( const std::string& fileName )
{
    return readRefNodeFile( fileName, _options.get() );
}

osg::ref_ptr<osg::Shader>
Input::readShader( const std::string& fileName )
{
    return readRefShaderFile( fileName, _options.get() );
}

bool
Input::read( Parameter value1 )
{
...
Input::read( Parameter value1,
             Parameter value2 )
{
    if( value1.valid( ( *this )[0].getStr() ) && value2.valid( ( *this )[1].getStr() ) )
    {
        value1.assign( ( *this )[0].getStr() );
