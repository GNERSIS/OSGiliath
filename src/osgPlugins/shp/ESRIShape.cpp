...
printType( ShapeType type )
{
    printf( "%s",
            ...
            : type == ShapeTypeMultiPatch  ? "MultiPatch"
                                           : "Unknown" );
}
...
MultiPoint::MultiPoint( const struct MultiPoint& mpoint ) :
    ShapeObject( ShapeTypeMultiPoint ),
    bbox( mpoint.bbox ),
