 ...
 * ReaderWriterLua, derived from ReaderWriter.
 * Provides: supportsExtension, className, createScriptEngine, readObjectFromScript,
 * readObject, readObjectFromScript.
 */
...
class ReaderWriterLua : public osgDB::ReaderWriter
{
    public:
        ...
        lua::LuaScriptEngine*
        createScriptEngine( const osgDB::ReaderWriter::Options* options ) const
        {
        ...
        virtual ReadResult
        readObjectFromScript( std::istream&                       fin,
                              const osgDB::ReaderWriter::Options* options = NULL ) const
        {
            ...
            osg::ref_ptr<osg::Script> script =
                dynamic_cast<osg::Script*>( result.getObject() );
            if( !script )
            {
            ...
            for( Objects::iterator itr = objects.begin(); itr != objects.end(); ++itr )
            {
