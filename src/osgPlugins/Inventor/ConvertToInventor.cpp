...
// SoNormal:                   supported
// SoNormalBinding:            supported (all modes supported, including non-indexed
// modes) SoMaterial:                 supported SoMaterialBinding:          supported
// (all modes supported, including non-indexed modes) SoBaseColor:                no ->
// using SoMaterial instead SoPointSet:                 supported SoLineSet: no -> using
// SoIndexedListSet instead SoIndexedLineSet:           supported
...
// shape nodes: AsciiText, Cone, Cube, Cylinder, IndexedFaceSet, IndexedLineSet,
// PointSet, Sphere properties nodes: Coordinate3, FontStyle, Info, Material,
// MaterialBinding, Normal, NormalBinding,
...
SoNode*
ConvertToInventor::getIvSceneGraph() const
{
    return ivRoot;
}

void
ConvertToInventor::apply( osg::Node& node )
{
...
template<typename fieldClass,
         ...
         typename osgType>
void
osgArray2ivMField_template( const osg::Array* array,
                            fieldClass&       field,
                            int               startIndex            = 0,
                            int               stopIndex             = 0,
                            int               numItemsUntilMinusOne = 0 )
{
...
template<typename ivType,
         ...
         int shift>
void
osgArray2ivMField_composite_template_worker( ivType*  dest,
                                             osgType* src,
                                             int      num,
                                             int /*numItemsUntilMinusOne*/ = 0 )
{
...
template<>
void
osgArray2ivMField_composite_template_worker<SbColor,
                                            GLubyte,
                                            4>( SbColor* dest,
                                                GLubyte* src,
                                                int      num,
                                                int /*numItemsUntilMinusOne*/ )
{
...
template<>
void
osgArray2ivMField_composite_template_worker<SbVec3f,
                                            float,
                                            2>( SbVec3f* dest,
                                                float*   src,
                                                int      num,
...
template<typename fieldClass,
         ...
         int shift>
void
osgArray2ivMField_composite_template( const osg::Array* array,
                                      fieldClass&       field,
                                      int               startIndex  = 0,
                                      int               stopIndex   = 0,
                                      int /*numItemsUntilMinusOne*/ = 0 )
{
    ...
    // assert(numItemsUntilMinusOne <= 0 && "Composite template must have
    // numItemsUntilMinusOne set to 0.");
    field.setNum( num );
    ivType*  a   = field.startEditing();

    osgType* ptr = ( osgType* )array->getDataPointer() + startIndex;
    osgArray2ivMField_composite_template_worker<ivType, osgType, shift>( a,
                                                                         ptr,
                                                                         num,
                                                                         0 );
...
template<typename fieldClass,
         ...
         int numComponents>
void
osgArray2ivMField_pack_template( const osg::Array* array,
                                 fieldClass&       field,
                                 osgType           mul,
                                 osgType           max,
                                 osgType           min,
                                 ...
                                 int /*numItemsUntilMinusOne*/ = 0 )
{
    ...
    // assert(numItemsUntilMinusOne <= 0 && "Pack template must have
    // numItemsUntilMinusOne set to 0.");
    field.setNum( num );
    ivType*  a   = field.startEditing();
...
template<typename fieldClass,
         typename fieldItemType>
bool
ivApplicateIntType( const osg::Array* array,
                    fieldClass&       field,
                    int               startIndex,
                    int               stopIndex,
                    int               numItemsUntilMinusOne )
    ...
    if( field.isOfType( fieldClass::getClassTypeId() ) )
    {
        switch( array->getType() )
        {
            case osg::Array::ByteArrayType :
                osgArray2ivMField_template<fieldClass, fieldItemType, int8_t>(
                    array,
                    field,
                    startIndex,
                    stopIndex,
                    numItemsUntilMinusOne
                );
                return true;
            case osg::Array::UByteArrayType :
                osgArray2ivMField_template<fieldClass, fieldItemType, uint8_t>(
                    array,
                    field,
                    startIndex,
                    stopIndex,
            ...
            case osg::Array::ShortArrayType :
                osgArray2ivMField_template<fieldClass, fieldItemType, int16_t>(
                    array,
                    field,
                    startIndex,
                    stopIndex,
            ...
            case osg::Array::UShortArrayType :
                osgArray2ivMField_template<fieldClass, fieldItemType, uint16_t>(
                    array,
                    field,
                    startIndex,
                    stopIndex,
            ...
            case osg::Array::IntArrayType :
                osgArray2ivMField_template<fieldClass, fieldItemType, int32_t>(
                    array,
                    field,
                    startIndex,
                    stopIndex,
            ...
            case osg::Array::UIntArrayType :
                osgArray2ivMField_template<fieldClass, fieldItemType, uint32_t>(
                    array,
                    field,
                    startIndex,
                    stopIndex,
            ...
            case osg::Array::FloatArrayType :
                osgArray2ivMField_template<fieldClass, fieldItemType, float>(
                    array,
                    field,
                    startIndex,
                    stopIndex,
                ...
                return true;
            case osg::Array::Vec4bArrayType :    // FIXME: should signed values be
                                                 // handled differently? Like -128..127?
            case osg::Array::Vec4ubArrayType :
                osgArray2ivMField_pack_template<fieldClass, fieldItemType, GLubyte, 4>(
                    array,
                    field,
                    1,
                    255,
            ...
            case osg::Array::Vec4ArrayType :
                osgArray2ivMField_pack_template<fieldClass, fieldItemType, float, 4>(
                    array,
                    field,
                    255.F,
                    255.F,
...
static void
osgArray2ivMField( const osg::Array* array,
                   SoMField&         field,
                   int               startIndex            = 0,
                   int               stopIndex             = 0,
                   int               numItemsUntilMinusOne = 0 )
{
    if( field.isOfType( SoMFFloat::getClassTypeId() ) )
    {
        ...
        {
            case osg::Array::FloatArrayType :
                osgArray2ivMField_template<SoMFFloat, float, float>(
                    array,
                    ( SoMFFloat& )field,
                    startIndex,
                    stopIndex,
    ...
    else if( ivApplicateIntType<SoMFInt32, int32_t>( array,
                                                     ( SoMFInt32& )field,
                                                     startIndex,
                                                     stopIndex,
                                                     numItemsUntilMinusOne ) )
    ...
    else if( ivApplicateIntType<SoMFUInt32, uint32_t>( array,
                                                       ( SoMFUInt32& )field,
                                                       startIndex,
                                                       stopIndex,
                                                       numItemsUntilMinusOne ) )
    ...
    else if( ivApplicateIntType<SoMFShort, int16_t>( array,
                                                     ( SoMFShort& )field,
                                                     startIndex,
                                                     stopIndex,
                                                     numItemsUntilMinusOne ) )
    ...
    else if( ivApplicateIntType<SoMFUShort, uint16_t>( array,
                                                       ( SoMFUShort& )field,
                                                       startIndex,
                                                       stopIndex,
                                                       numItemsUntilMinusOne ) )
    ...
    else if( field.isOfType( SoMFVec2f::getClassTypeId() ) )
    {
        switch( array->getType() )
        {
            case osg::Array::Vec2ArrayType :
                osgArray2ivMField_composite_template<SoMFVec2f, SbVec2f, float, 2>(
                    array,
                    ( SoMFVec2f& )field,
                    startIndex,
                    stopIndex,
    ...
    else if( field.isOfType( SoMFVec3f::getClassTypeId() ) )
    {
        switch( array->getType() )
        {
            case osg::Array::Vec3ArrayType :
                osgArray2ivMField_composite_template<SoMFVec3f, SbVec3f, float, 3>(
                    array,
                    ( SoMFVec3f& )field,
                    startIndex,
                    stopIndex,
                ...
                return;
            case osg::Array::Vec2ArrayType :
                osgArray2ivMField_composite_template<SoMFVec3f, SbVec3f, float, 2>(
                    array,
                    ( SoMFVec3f& )field,
                    startIndex,
                    stopIndex,
    ...
    else if( field.isOfType( SoMFVec4f::getClassTypeId() ) )
    {
        ...
        {
            case osg::Array::Vec4ArrayType :
                osgArray2ivMField_composite_template<SoMFVec4f, SbVec4f, float, 4>(
                    array,
                    ( SoMFVec4f& )field,
                    startIndex,
                    stopIndex,
    ...
    else if( field.isOfType( SoMFColor::getClassTypeId() ) )
    {
        ...
        {
            case osg::Array::Vec3ArrayType :
                osgArray2ivMField_composite_template<SoMFColor, SbColor, float, 3>(
                    array,
                    ( SoMFColor& )field,
                    startIndex,
                    stopIndex,
                ...
                return;
            case osg::Array::Vec4ArrayType :
                osgArray2ivMField_composite_template<SoMFColor, SbColor, float, 4>(
                    array,
                    ( SoMFColor& )field,
                    startIndex,
                    stopIndex,
                ...
                return;
            case osg::Array::Vec4ubArrayType :
                osgArray2ivMField_composite_template<SoMFColor, SbColor, GLubyte, 4>(
                    array,
                    ( SoMFColor& )field,
                    startIndex,
                    stopIndex,
...
template<typename variableType,
         typename indexType>
bool
ivDeindex( variableType*       dest,
           const variableType* src,
           const int           srcNum,
           const indexType*    indices,
           const int           numToProcess )
{
           ...
           const int           numToProcess )
{
    ...
    switch( indices->getType() )
    {
        case osg::Array::ByteArrayType :
        case osg::Array::UByteArrayType :
            return ivDeindex<variableType, GLbyte>( dest,
                                                    src,
                                                    srcNum,
                                                    ( GLbyte* )indices->getDataPointer(),
                                                    numToProcess );
            break;
        case osg::Array::ShortArrayType :
        case osg::Array::UShortArrayType :
            return ivDeindex<variableType, GLshort>(
                dest,
                src,
                srcNum,
                ( GLshort* )indices->getDataPointer(),
                numToProcess
            );
            break;
        case osg::Array::IntArrayType :
        case osg::Array::UIntArrayType :
            return ivDeindex<variableType, GLint>( dest,
                                                   src,
                                                   srcNum,
                                                   ( GLint* )indices->getDataPointer(),
                                                   numToProcess );
            break;
        default :
...
template<typename variableType,
         typename fieldType>
bool
ivProcessArray( const osg::Array* drawElemIndices,
                fieldType*        destField,
                const fieldType*  srcField,
                int               startIndex,
                int               numToProcess )
{
    bool ok = true;
    ...
    if( drawElemIndices )
    {
        ...
        if( !ok )
        {
            OSG_WARN << "IvWriter: Can not deindex - bug in model: index out of range."
                     << std::endl;
        }
    }
    else
    {
        ...
        assert(
            startIndex + numToProcess <= srcField->getNum() && "Index out of bounds."
        );
...
static void
processIndices( const osg::Array* drawElemIndices,
                SoMFInt32&        ivIndices,
                int               startIndex,
                int               stopIndex,
                int               numItemsUntilMinusOne )
{
    if( drawElemIndices )
    {
        ...
        osgArray2ivMField( drawElemIndices,
                           ivIndices,
                           startIndex,
                           stopIndex,
                           numItemsUntilMinusOne );
...
static void
postProcessDrawArrayLengths( const osg::DrawArrayLengths* drawArrayLengths,
                             SoMFInt32*                   field )
{
    ...
    for( osg::DrawArrayLengths::const_reverse_iterator primItr =
             drawArrayLengths->rbegin();
...
static void
postProcessField( const SbIntList&                           runLengths,
                  osg::PrimitiveSet::Mode                    primType,
                  SoMFInt32*                                 field,
                  deprecated_osg::Geometry::AttributeBinding binding )
{
    if( binding ==
        deprecated_osg::Geometry::BIND_OFF ||
        binding ==
                ...
                for( int j = 3; j < c; j++ )
                {
                    *( dst++ ) = -1;
                    ...
                    else if( primType == osg::PrimitiveSet::TRIANGLE_FAN )
                    {
                        *( dst++ ) = first;
                        *( dst++ ) = *( src - 1 );
                    }    // FIXME: are QUADS, QUAD_STRIP, and POLYGON requiring some
                         // handling here as well? PCJohn-2007-08-25
                    else
                    {
                        *( dst++ ) = *( src - 2 );
                        *( dst++ ) = *( src - 1 );
...
static void
postProcessTriangleSeparation( SoIndexedShape*                            shape,
                               osg::PrimitiveSet::Mode                    primType,
                               ...
                               deprecated_osg::Geometry::AttributeBinding colorBinding )
{
    ...
    bool notUseTexCoords =
        shape->textureCoordIndex.getNum() ==
        0 ||
    ...
    if( !notUseTexCoords )
    {
        postProcessField( runLengths,
                          primType,
                          &shape->textureCoordIndex,
                          deprecated_osg::Geometry::BIND_PER_VERTEX );
    }
}

static SoMaterialBinding*
createMaterialBinding( const deprecated_osg::Geometry* g,
                       bool                            isMaterialIndexed )
{
    SoMaterialBinding* materialBinding = new SoMaterialBinding;
    switch( g->getColorBinding() )
    {
        case deprecated_osg::Geometry::BIND_OFF :    // OFF means use material from state
                                                     // set (if any) for whole geometry
        ...
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE_SET :
            ...
            break;
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE :
            materialBinding->value = ( isMaterialIndexed )
...
static SoNormalBinding*
createNormalBinding( const deprecated_osg::Geometry* g,
                     bool                            areNormalsIndexed )
{
    ...
    {
        case deprecated_osg::Geometry::BIND_OFF :    // FIXME: what to do with BIND_OFF
                                                     // value?
        case deprecated_osg::Geometry::BIND_OVERALL :
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE_SET :
            ...
            break;
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE :
            normalBinding->value = ( areNormalsIndexed )
...
static SoTextureCoordinateBinding*
createTexCoordBinding( SbBool useIndexing )
{
...
static SoTexture2::Wrap
convertTextureWrap( osg::Texture::WrapMode osgWrap )
{
    ...
    // note: Coin (since 2.0) uses CLAMP_TO_EDGE for rendering if SoTexture2::CLAMP is
    // specified.
...
setSoTransform( SoTransform*     tr,
                ...
                const osg::vec3& scale = osg::vec3( 1.,
                                                    ...
                                                    1. ) )
{
    tr->translation.setValue( translation.data() );
    tr->rotation.setValue( rotation.x, rotation.y, rotation.z, rotation.w );
    tr->scaleFactor.setValue( scale.data() );
    // tr->scaleCenter.setValue(osg::vec3(node.getPivotPoint())); <- testing required on
    // this line
}

static bool
updateMode( bool&                                  flag,
...
ConvertToInventor::InventorState*
ConvertToInventor::createInventorState( const osg::StateSet* ss )
{
    // Push on stack
    ...
    if( ss )
    {
        ...
        {
            SoLightModel* lm = new SoLightModel;
            lm->model        = ( ivState->osgLighting ) ? SoLightModel::PHONG
                                                        : SoLightModel::BASE_COLOR;
            ivState->ivHead->addChild( lm );
        }

        // front face
        const osg::FrontFace* osgFF = dynamic_cast<const osg::FrontFace*>(
            ss->getAttribute( osg::StateAttribute::Type::FRONTFACE )
        );
        if( osgFF )
        {
        ...
        const osg::CullFace* osgCF = dynamic_cast<const osg::CullFace*>(
            ss->getAttribute( osg::StateAttribute::Type::CULLFACE )
        );
        if( osgCF )
        {
        ...
        if( ivState->osgTwoSided !=
            ivPrevState->osgTwoSided ||
            ivState->osgFrontFace !=
            ivPrevState->osgFrontFace ||
            ivState->osgCullFaceEnabled !=
            ivPrevState->osgCullFaceEnabled ||
            ivState->osgCullFace != ivPrevState->osgCullFace )
        {
            ...
            if( ivState->osgTwoSided )
            {
                ...
                {
                    OSG_WARN << "IvWriter: Using face culling and two-sided lighting "
                                "together! "
                                "Ignoring face culling."
                             << std::endl;
                }

                // set two-sided lighting and backface culling off
                sh->vertexOrdering =
                    ivState->osgFrontFace == osg::FrontFace::Mode::COUNTER_CLOCKWISE
            ...
            else
            {
                ...
                if( ivState->osgCullFaceEnabled )
                {
                    ...
                    bool ccw =
                        ivState->osgFrontFace == osg::FrontFace::Mode::COUNTER_CLOCKWISE;
                    if( ivState->osgCullFace != osg::CullFace::Mode::BACK )
                    {
                        ccw = !ccw;
                    }
                    ...
                    if( ccw )
                    {
                        ...
                        // Inventor does not support this setup and it lits the unculled
                        // faces only.
                        OSG_WARN << "IvWriter: Culling was set in a way that one-sided "
                                    "lighting will lit the culled sides of faces. "
                                    "Using lighting on correct faces."
                                 << std::endl;
                    }

                    // face culling on
                    sh->vertexOrdering =
                        ccw ? SoShapeHints::COUNTERCLOCKWISE : SoShapeHints::CLOCKWISE;
        ...
        // get OSG state
        ivState->osgTexture = dynamic_cast<const osg::Texture*>(
            ss->getTextureAttribute( 0, osg::StateAttribute::Type::TEXTURE )
        );
        updateMode( ivState->osgTexture2Enabled,
                    ss->getTextureMode( 0, GL_TEXTURE_2D ) );

        // detect state changes
        if( ivState->osgTexture2Enabled !=
            ivPrevState->osgTexture2Enabled ||
            ivState->osgTexture != ivPrevState->osgTexture )
        {
            ...
            if( !ivState->osgTexture2Enabled ||
                ivState->osgTexture ==
                NULL ||
                ivState->osgTexture->getImage( 0 ) == NULL )
            {
            ...
            else
            {
                ...
                ivState->ivTexture = ivTexturesMap[ivState->osgTexture];
                ...
                if( !ivState->ivTexture )
                {
                    ...
                    // create texture
                    ivState->ivTexture                 = new SoTexture2;
                    ivTexturesMap[ivState->osgTexture] = ivState->ivTexture;

                    // texture file name
                    const std::string& textureName =
                        ivState->osgTexture->getImage( 0 )->getFileName();
                    ivState->ivTexture->filename.setValue(
                        textureName.c_str()
                    );    // FIXME: handle inlined texture data in the files
                    ...
                    // TGS Inventor: introduced in version 5.0 (as
        ...
        // Material parameters
        const osg::Material* osgMaterial = dynamic_cast<const osg::Material*>(
            ss->getAttribute( osg::StateAttribute::Type::MATERIAL )
        );
        if( osgMaterial )
        {
        ...
        if( ivState->osgMaterial != ivPrevState->osgMaterial )
        {
            ...
            // FIXME: The geometry can be probably doubled, or some estimation can be
            // made whether only front or back faces are used.
            if( ivState->osgMaterial->getAmbientFrontAndBack() ==
                false ||
                ivState->osgMaterial->getDiffuseFrontAndBack() ==
                false ||
                ivState->osgMaterial->getSpecularFrontAndBack() ==
                false ||
                ivState->osgMaterial->getEmissionFrontAndBack() ==
                false ||
                ivState->osgMaterial->getShininessFrontAndBack() == false )
            {
                OSG_WARN << "IvWriter: Model contains different materials for front and "
                            "back faces. This is not handled properly. Using front "
                            "material only."
                         << std::endl;
            }

            // Convert colors
            // OSG represents colors by: vec3, vec4,ubvec4
            // Inventor by: uint32 (RGBA, by SoPackedColor), SbColor (vec3, by SoMaterial
            // and SoBaseColor) note: Inventor can use DIFFUSE component inside a shape
            // only. Material is set for whole shape. Although SoMaterial is used only,
            // SoPackedColor may bring some possibilities on per-vertex alpha and
            // SoBaseColor may be useful on pre-lit scene.
            if( ivState->osgMaterial->getColorMode() !=
                osg::Material::DIFFUSE &&
                ivState->osgMaterial->getColorMode() != osg::Material::OFF )
            {
                ...
                {
                    OSG_WARN
                        << "IvWriter: The model is using AMBIENT_AND_DIFFUSE material "
                           "mode while Inventor supports DIFFUSE mode only. "
                           "The model colors may not much exactly."
                        << std::endl;
                }
                else
                {
                    OSG_WARN
                        << "IvWriter: The model is not using DIFFUSE material mode and "
                           "Inventor supports DIFFUSE mode only. "
                           "The model colors may not be correct."
                        << std::endl;
                }
            }
            ...
            ( ( SoMaterial* )ivState->ivMaterial )
                ->ambientColor.setValue(
                    osgMaterial
                        ->getAmbient( osgMaterial->getAmbientFrontAndBack()
                                          ? osg::Material::FRONT_AND_BACK
                                          : osg::Material::FRONT )
                        .data()
                );
            ( ( SoMaterial* )ivState->ivMaterial )
                ->diffuseColor.setValue(
                    osgMaterial
                        ->getDiffuse( osgMaterial->getDiffuseFrontAndBack()
                                          ? osg::Material::FRONT_AND_BACK
                                          : osg::Material::FRONT )
                        .data()
                );
            ( ( SoMaterial* )ivState->ivMaterial )
                ->specularColor.setValue(
                    osgMaterial
                        ->getSpecular( osgMaterial->getSpecularFrontAndBack()
                                           ? osg::Material::FRONT_AND_BACK
                                           : osg::Material::FRONT )
                        .data()
                );
            ( ( SoMaterial* )ivState->ivMaterial )
                ->emissiveColor.setValue(
                    osgMaterial
                        ->getEmission( osgMaterial->getEmissionFrontAndBack()
                                           ? osg::Material::FRONT_AND_BACK
                                           : osg::Material::FRONT )
                        .data()
                );
            ( ( SoMaterial* )ivState->ivMaterial )
                ->shininess.setValue(
                    osgMaterial->getShininess( osgMaterial->getShininessFrontAndBack()
                                                   ? osg::Material::FRONT_AND_BACK
                                                   : osg::Material::FRONT )
                );
            ( ( SoMaterial* )ivState->ivMaterial )
        ...
        //
        // Inventor is more difficult and not so robust. According to Inventor 2.1
        // standard, just SoMaterial::transparency, SoTexture2 with alpha channel carry
        // transparency information that is controlled by SoGLRenderAction::transparency
        // type that is set to SCREEN_DOOR by default (dither pattern). So, if the user
        // does not select better transparency type, there is no possibility to control
        // transparency type from file format.
        //
        // However, SoTransparencyType node was introduced to overcome this historical
        // limitation because transparency was performance expensive long time ago.
        ...
        //
        // Alpha test was introduced in TGS 4.0, but as SoGLRenderArea::setAlphaTest. So,
        // no direct control in the file format.
        //
        // Conclusion:
        ...
        ivState->osgBlendFunc = dynamic_cast<const osg::BlendFunc*>(
            ss->getAttribute( osg::StateAttribute::Type::BLENDFUNC )
        );

        if( useIvExtensions )
        {
            if( ivState->osgBlendEnabled !=
                ivPrevState->osgBlendEnabled ||
                ivState->osgBlendFunc !=
                ivPrevState->osgBlendFunc ||
                ( ivState->osgBlendFunc &&
                  ivPrevState->osgBlendFunc &&
                  ivState->osgBlendFunc->getDestinationRGB() !=
                  ivPrevState->osgBlendFunc->getDestinationRGB() ) )
            {

                const SoTransparencyType::Type transparencyTable[8] = {
                    SoTransparencyType::BLEND,
                    SoTransparencyType::ADD,
                    SoTransparencyType::DELAYED_BLEND,
                    SoTransparencyType::DELAYED_ADD,
                ...
                {
                    index = ( ivState->osgBlendFunc->getDestinationRGB() ==
                              osg::BlendFunc::ONE )
                              ? 1
                              : 0;
                }
                index |=
                    ( ss->getRenderingHint() == osg::StateSet::TRANSPARENT_BIN ) ? 2 : 0;
...
void
ConvertToInventor::popInventorState()
{
    InventorState* ivState = &ivStack.top();
...
static bool
processPrimitiveSet( const deprecated_osg::Geometry* g,
                     const osg::PrimitiveSet*        pset,
                     osg::UIntArray*                 drawElemIndices,
                     bool                            needSeparateTriangles,
                     int                             elementsCount,
                     int                             primSize,
                     ...
                     SoNode*                         ivTexture,
                     SoShape*                        shape,
                     SoSeparator*&                   indexedRoot,
                     SoSeparator*&                   nonIndexedRoot )
{
    bool                         ok = true;
    const osg::DrawArrayLengths* drawArrayLengths =
        ( elementsCount == -1 ) ? dynamic_cast<const osg::DrawArrayLengths*>( pset )
                                : NULL;
    ...
    // Normal indexing
    int       normalStart =
        ( g->getNormalBinding() == deprecated_osg::Geometry::BIND_PER_VERTEX )
            ? startIndex
            : normalIndex;
    int numNormalsUsed = 0;
    switch( g->getNormalBinding() )
    {
        case deprecated_osg::Geometry::BIND_OFF :    // FIXME: what is meaning of OFF
                                                     // value?
        case deprecated_osg::Geometry::BIND_OVERALL :
            numNormalsUsed = 0;
            break;
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE_SET :
            ...
            break;
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE :
            numNormalsUsed = primSize != 0
                               ? ( stopIndex - startIndex ) / primSize
                               : ( drawArrayLengths ? drawArrayLengths->size() : 1 );
            break;
        case deprecated_osg::Geometry::BIND_PER_VERTEX :
            numNormalsUsed = stopIndex - startIndex;
            break;
    }
    normalIndex += numNormalsUsed;

    // Color indexing
    int colorStart    = g->getColorBinding() == deprecated_osg::Geometry::BIND_PER_VERTEX
                          ? startIndex
                          : colorIndex;
    int numColorsUsed = 0;
    switch( g->getColorBinding() )
    {
        ...
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE_SET :
            ...
            break;
        case deprecated_osg::Geometry::BIND_PER_PRIMITIVE :
            numColorsUsed = primSize != 0
                              ? ( stopIndex - startIndex ) / primSize
                              : ( drawArrayLengths ? drawArrayLengths->size() : 1 );
            break;
        case deprecated_osg::Geometry::BIND_PER_VERTEX :
            numColorsUsed = stopIndex - startIndex;
            break;
    }
    ...
    if( shape->isOfType( SoIndexedShape::getClassTypeId() ) )
    {
        ...
        processIndices( drawElemIndices,
                        ( ( SoIndexedShape* )shape )->coordIndex,
                        startIndex,
                        stopIndex,
                        primSize );
        ...
        {
            processIndices( drawElemIndices,
                            ( ( SoIndexedShape* )shape )->normalIndex,
                            normalStart,
        ...
        if( ivTexCoords &&
            !ivTexCoords->isOfType( SoTextureCoordinateFunction::getClassTypeId() ) )
        {
            processIndices( drawElemIndices,
                            ( ( SoIndexedShape* )shape )->textureCoordIndex,
                            startIndex,
                            stopIndex,
                            primSize );
        }
        ...
        if( drawArrayLengths && primSize == 0 && drawArrayLengths->size() >= 2 )
        {
            ...
            postProcessDrawArrayLengths( drawArrayLengths,
                                         &( ( SoIndexedShape* )shape )->coordIndex );

            if( ivNormals &&
                g->getNormalBinding() == deprecated_osg::Geometry::BIND_PER_VERTEX )
            {
                postProcessDrawArrayLengths(
                    drawArrayLengths,
                    &( ( SoIndexedShape* )shape )->normalIndex
                );
            }
            ...
            if( ivMaterial &&
                g->getColorBinding() == deprecated_osg::Geometry::BIND_PER_VERTEX )
            {
                postProcessDrawArrayLengths(
                    drawArrayLengths,
                    &( ( SoIndexedShape* )shape )->materialIndex
        ...
        {
            postProcessTriangleSeparation( ( SoIndexedShape* )shape,
                                           ( osg::PrimitiveSet::Mode )pset->getMode(),
                                           g->getNormalBinding(),
                                           g->getColorBinding() );
        }
    }
    else
    {
        ...
        assert( shape->isOfType( SoNonIndexedShape::getClassTypeId() ) &&
                "Shape must be non-indexed." );
        ...
        if( ivCoords->isOfType( SoCoordinate4::getClassTypeId() ) )
        {
            ...
            if( ok )
            {
                ...
                ok = ivProcessArray<SbVec4f, SoMFVec4f>(
                    drawElemIndices,
        ...
        else
        {
            ...
            if( ok )
            {
                ...
                ok = ivProcessArray<SbVec3f, SoMFVec3f>(
                    drawElemIndices,
        ...
        if( ivTexCoords )
        {
            if( ivTexCoords->isOfType( SoTextureCoordinate2::getClassTypeId() ) )
            {
                ...
                if( ok )
                {
                    ...
                    ok = ivProcessArray<SbVec2f, SoMFVec2f>(
                        drawElemIndices,
        ...
        if( ivNormals )
        {
            ...
            if( ok )
            {
                nonIndexedNormals->vector.setNum( numNormalsUsed == 0 ? 1
                                                                      : numNormalsUsed );
                ok = ivProcessArray<SbVec3f, SoMFVec3f>(
                    g->getNormalBinding() == deprecated_osg::Geometry::BIND_PER_VERTEX
                        ? drawElemIndices
                        : NULL,
                    &nonIndexedNormals->vector,
                    &ivNormals->vector,
                    normalStart,
                    numNormalsUsed == 0 ? 1 : numNormalsUsed
                );
            }
        }
        ...
        if( ivMaterial )
        {
            ...
            if( ok )
            {
                ...
                ok = ivProcessArray<SbColor, SoMFColor>(
                    ...
                    srcColorField,
                    colorStart,
                    numColorsUsed == 0 ? 1 : numColorsUsed
                );
            }
        }
        ...
        else if( shape->isOfType( SoLineSet::getClassTypeId() ) )
        {
            switch( pset->getMode() )
            {
                case GL_LINES :
                    assert(
                        elementsCount % 2 == 0 && "elementsCount is not multiple of 2."
                    );
                    n = elementsCount / 2;
                ...
                case GL_LINE_STRIP :
                    ...
                    {
                        ( ( SoLineSet* )shape )
                            ->numVertices.setNum( drawArrayLengthsElems );
                        int li = 0;
                        for( osg::DrawArrayLengths::const_iterator primItr =
                                 drawArrayLengths->begin();
                             primItr != drawArrayLengths->end();
                             ++primItr, li++ )
                        {
                            ( ( SoLineSet* )shape )
                                ->numVertices.set1Value( li, *primItr );
                        }
                    }
                    else
                    {
                        ...
                        ( ( SoLineSet* )shape )
                            ->numVertices.set1Value( 0, elementsCount );
                    }
                    break;
                default :
        ...
        else if( shape->isOfType( SoTriangleStripSet::getClassTypeId() ) )
        {
            switch( pset->getMode() )
            {
                case GL_TRIANGLES :
                    n = elementsCount / 3;
                    assert(
                        n * 3 == elementsCount && "elementsCount is not multiple of 3."
                    );
        ...
        else if( shape->isOfType( SoFaceSet::getClassTypeId() ) )
        {
            switch( pset->getMode() )
            {
                case GL_QUADS :
                    n = elementsCount / 4;
                    assert(
                        n * 4 == elementsCount && "elementsCount is not multiple of 4."
                    );
    ...
    if( nonIndexedCoords )
    {
        ...
        if( !ok )
        {
            ...
            {
                nonIndexedTexCoords->ref();
                nonIndexedTexCoords->unref();
            }
            if( nonIndexedNormals )
            {
                nonIndexedNormals->ref();
                nonIndexedNormals->unref();
            }
    ...
    {
        assert( shape->isOfType( SoIndexedShape::getClassTypeId() ) &&
                "Not indexed shape." );
        assert( nonIndexedCoords ==
                NULL &&
                nonIndexedNormals ==
                NULL &&
                nonIndexedMaterial == NULL );
        if( indexedRoot == NULL )
        {
...
void
ConvertToInventor::processGeometry( const deprecated_osg::Geometry* g,
                                    InventorState*                  ivState )
{
    ...
    if( ivState->osgLighting || vrml1Conversion )
    {
        ...
        if( g->getColorArray() )
        {
            ...
            {
                ivMaterial = new SoMaterial;    // FIXME: check default values of
                                                // SoMaterial and OSG lighting
            }
        }
        ...
        if( g->getColorArray() )
        {
            if( ivStateMaterial )
            {
                ...
                ( ( SoBaseColor* )ivMaterial )
                    ->rgb.setValue(
                        ivStateMaterial->diffuseColor[0]
                    );    // copy first value
            }
            else
            {
                ivMaterial = new SoBaseColor;    // FIXME: check default values of
                                                 // SoBaseColor and OSG pre-lit scene
            }
        }
        else if( ivStateMaterial )
        {
    ...
    if( g->getColorArray() )
    {
        ...
        if( ivState->osgMaterial ==
            NULL ||
            ivState->osgMaterial->getColorMode() ==
            osg::Material::DIFFUSE ||
        ...
        {    // FIXME: implement some workaround for non-diffuse cases?
             ...
             // note2: There is no effect to convert
             // SoMaterial::[ambient|specular|emissive]color here because Inventor does
             // not set them per-vertex (performance reasons). See Inventor documentation
             // for more details.
        }
    }
    ...
    if( ivState->ivTexture )
    {
        if( g->getTexCoordArray( 0 ) )
        {
            if( g->getTexCoordArray( 0 )->getDataSize() <= 2 )
            {
                ...
                osgArray2ivMField( g->getTexCoordArray( 0 ),
                                   ( ( SoTextureCoordinate2* )texCoords )->point );
            }
#ifdef __COIN__
            else
            {
                ...
                osgArray2ivMField( g->getTexCoordArray( 0 ),
                                   ( ( SoTextureCoordinate3* )texCoords )->point );
            }
#endif    // __COIN__
        }
        if( texCoords )
    ...
    // Convert normals
    // OSG represents normals by: vec3,svec3,bvec3
    // and can handle: svec4,bvec4 by truncating them to three components
    // Inventor by: SbVec3f
            ...
            case osg::PrimitiveSet::DrawArraysPrimitiveType :
                {
                    const osg::DrawArrays* drawArrays =
                        dynamic_cast<const osg::DrawArrays*>( pset );
                    ...
                    if( !ok )
                    {
                        OSG_WARN << "Inventor plugin, ConvertToInventor "
                                    "processPrimitiveSet() failed."
                                 << std::endl;
                    }
                    break;
                }
            ...
            case osg::PrimitiveSet::DrawElementsUIntPrimitiveType :
                {
                        ...
                        case osg::PrimitiveSet::DrawElementsUBytePrimitiveType :
                            {
                                ...
                                for( osg::DrawElementsUByte::const_iterator primItr =
                                         drawElements->begin();
                        ...
                        case osg::PrimitiveSet::DrawElementsUShortPrimitiveType :
                            {
                                ...
                                for( osg::DrawElementsUShort::const_iterator primItr =
                                         drawElements->begin();
                                     primItr != drawElements->end();
                                     ++primItr )
                                {
                        ...
                        case osg::PrimitiveSet::DrawElementsUIntPrimitiveType :
                            {
                                ...
                                for( osg::DrawElementsUInt::const_iterator primItr =
                                         drawElements->begin();
                                     primItr != drawElements->end();
                                     ++primItr )
                                {
                    ...
                    ok = processPrimitiveSet( g,
                                              ...
                                              drawElemIndices.get(),
                                              needSeparateTriangles,
                                              drawElemIndices->getNumElements(),
                                              primSize,
                                              0,
                                              drawElemIndices->getNumElements(),
                                              normalIndex,
...
void
ConvertToInventor::processShapeDrawable( const osg::ShapeDrawable* d,
                                         InventorState*            ivState )
{
    ...
    class MyShapeVisitor : public osg::ConstShapeVisitor
    {
        public:
            ...
            void
            processNode( SoNode*          ivNode,
                         const osg::vec3& center,
                         osg::quat        rotation,
                         SoGroup*         root )
            {
                // convert rotation
                rotation = osg::quat( -M_PI_2, osg::vec3( 0., 1., 0. ) ) *
                           osg::quat( M_PI_2, osg::vec3( 1., 0., 0. ) ) *
                           rotation;

                if( osg::length2( center ) ==
                    0. &&
                    rotation.zeroRotation() &&
                    ivState->ivTexture == NULL )
                {
                ...
                else
                {
                    ...
                    if( osg::length2( center ) != 0. || !rotation.zeroRotation() )
                    {
            ...
            virtual void
            apply( const osg::Sphere& s )
            {
                SoSphere* ivSphere = new SoSphere;
                ivSphere->radius.setValue( s.getRadius() );
                processNode( ivSphere,
                             s.getCenter(),
                             osg::quat( 0., osg::vec3( 1., 0., 0. ) ),
                             ivState->ivHead );
            }

            virtual void
            apply( const osg::Box& b )
            {
            ...
            warnNonSupported()
            {
                OSG_WARN << "IvWriter: Not supported ShapeDrawable found. Skipping it."
                         << std::endl;
            }
            ...
            MyShapeVisitor( InventorState* in_ivState )
            {
                ivState = in_ivState;
            }
...
void
ConvertToInventor::processDrawable( osg::Drawable* d )
{
    deprecated_osg::Geometry* g = dynamic_cast<deprecated_osg::Geometry*>(
        d
    );    // FIXME: other drawables have to be handled also
...
void
ConvertToInventor::apply( osg::Geode& node )
{
#ifdef DEBUG_IV_WRITER
...
void
ConvertToInventor::apply( osg::Group& node )
{
#ifdef DEBUG_IV_WRITER
...
void
ConvertToInventor::apply( osg::Billboard& node )
{
#ifdef DEBUG_IV_WRITER
    ...
    if( useIvExtensions )
    {
        ...
        for( int i = 0; i < numDrawables; i++ )
        {
            ...
            // SoVRMLBillboard::axisOfRotation is not 0,0,0, the billboard behaviour is
            // strange. As long as it is set to 0,0,0, POINT_ROT_EYE-style billboard
            // works perfectly. AXIAL_ROT seems not possible with the bug. And
            // POINT_ROT_WORLD was not investigated by me until now. There is also
            // billboard culling bug in Coin, so the billboards may not be rendered
            // properly from time to time. PCJohn-2007-09-08
    #if 0
      SbVec3f axis;
      switch (node.getMode()) {
        ...
        case osg::Billboard::AXIAL_ROT:       axis = node.getAxis().data(); break;
        default:
      ...
      billboard->axisOfRotation.setValue(axis);
            ...
            translation->translation.setValue( node.getPosition( i ).data() );

            // Rotate billboard correctly (OSG->IV conversion)
            // Note: use SoTransform instead of SoRotation because SoRotation is not
            // supported by VRML1.
...
void
ConvertToInventor::apply( osg::MatrixTransform& node )
{
#ifdef DEBUG_IV_WRITER
    ...
    SbMatrix                      ivMatrix;
    const osg::dmat4::value_type* src  = node.getMatrix().data();
...
void
ConvertToInventor::apply( osg::PositionAttitudeTransform& node )
{
#ifdef DEBUG_IV_WRITER
...
void
ConvertToInventor::apply( osg::LOD& node )
{
#ifdef DEBUG_IV_WRITER
    ...
    if( rangeMode == osg::LOD::DISTANCE_FROM_EYE_POINT )
    {
        ...
        lod->center.setValue( center.data() );
