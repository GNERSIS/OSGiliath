            ...
            switch (pixelFormat) {
                case GL_RED: {
                    switch (dataType) {
                        ...
                        case GL_FLOAT : internalFormat = GL_R32F; break;
                    }
                    break;
                }
                case GL_RG: {
                    switch (dataType) {
                        case GL_UNSIGNED_BYTE: internalFormat = GL_RG8; break;
                        case GL_UNSIGNED_SHORT: internalFormat = GL_RG16; break;
                        case GL_FLOAT: internalFormat = GL_RG32F; break;
                    }
                    break;
                }
                case GL_RGB: {
