 ...
 * ReaderWriterSCALE, derived from ReaderWriter.
 * Provides: supportsExtension, className, acceptsExtension, readObject, readNode,
 * readNode.
 */
...
class ReaderWriterSCALE : public osgDB::ReaderWriter
{
    public:
                  ...
                  const osgDB::ReaderWriter::Options* options ) const
        {
            ...
            xform->setMatrix( osg::scale( static_cast<double>( sx ),
