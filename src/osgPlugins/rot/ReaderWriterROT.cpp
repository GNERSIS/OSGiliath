 ...
 * ReaderWriterROT, derived from ReaderWriter.
...
class ReaderWriterROT : public osgDB::ReaderWriter
{
    public:
                  ...
                  const osgDB::ReaderWriter::Options* options ) const
        {
            ...
            xform->setMatrix(
                osg::rotate( osg::radians( static_cast<double>( rx ) ), 1.0, 0.0, 0.0 ) *
                osg::rotate( osg::radians( static_cast<double>( ry ) ), 0.0, 1.0, 0.0 ) *
                osg::rotate( osg::radians( static_cast<double>( rz ) ), 0.0, 0.0, 1.0 )
            );
            xform->addChild( node );
            return xform;
        }
