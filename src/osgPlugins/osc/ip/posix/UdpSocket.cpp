 ...
 * Utility functions for osgPlugins: defined, SockaddrFromIpEndpointName, htonl, htons,
        ...
        Run()
        {
            ...
            while( !break_ )
            {
                ...
                if( !timerQueue_.empty() )
                {
                    ...
                    timeout.tv_usec =
                        ( long )( ( timeoutMs - ( timeout.tv_sec * 1'000 ) ) * 1'000 );
                    timeoutPtr = &timeout;
                }
                     ...
                     ++i )
                {
                    ...
                    {
                        int size = i->second->ReceiveFrom( remoteEndpoint,
                                                           data,
                                                           MAX_BUFFER_SIZE );
                        if( size > 0 )
                        {
