 ...
 * MessageMappingOscPacketListener, derived from OscPacketListener.
 * Provides: void.
 */
#pragma once
...
namespace osc
{
    ...
    class MessageMappingOscPacketListener : public OscPacketListener
    {
        ...
        protected:
            ...
            void
            RegisterMessageFunction( const char*   addressPattern,
                                     function_type f )
            {
            ...
            {
                typename function_map_type::iterator i =
                    functions_.find( m.AddressPattern() );
                if( i != functions_.end() )
                {
