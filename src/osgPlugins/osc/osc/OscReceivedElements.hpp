 ...
 * MalformedMessageException, derived from Exception.
 * Provides: Exception, MalformedBundleException, Exception, WrongArgumentTypeException,
...
namespace osc
{
    ...
    class ReceivedPacket
    {
        public:
            ...
            ReceivedPacket( const char* contents,
                            int32       size ) :
                contents_( contents ),
                size_( size )
            {
    ...
    class ReceivedBundleElementIterator
    {
        public:
            ...
            friend bool
            operator==( const ReceivedBundleElementIterator& lhs,
        ...
        private:
            ...
            bool
            IsEqualTo( const ReceivedBundleElementIterator& rhs ) const
            {
    ...
    class ReceivedMessageArgument
    {
        public:
            ...
            ReceivedMessageArgument( const char* typeTag,
                                     const char* argument ) :
                typeTag_( typeTag ),
                argument_( argument )
            {
            ...
            void
            AsBlob( const void*&   data,
                    unsigned long& size ) const;
            void
            AsBlobUnchecked( const void*&   data,
                             unsigned long& size ) const;
    ...
    class ReceivedMessageArgumentIterator
    {
        public:
            ...
            ReceivedMessageArgumentIterator( const char* typeTags,
            ...
            friend bool
            operator==( const ReceivedMessageArgumentIterator& lhs,
        ...
        private:
            ...
            bool
            IsEqualTo( const ReceivedMessageArgumentIterator& rhs ) const
            {
    ...
    class ReceivedMessageArgumentStream
    {
        ...
        public:
            ...
            ReceivedMessageArgumentStream&
            operator>>( MessageTerminator& /*rhs*/ )
            {
                if( !Eos() )
                {
