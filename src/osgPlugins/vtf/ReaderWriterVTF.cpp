...
enum VTFFlags
{
    VTF_FLAGS_POINTSAMPLE                   = 0X00'00'00'01,
    VTF_FLAGS_TRILINEAR                     = 0X00'00'00'02,
    VTF_FLAGS_CLAMP_S                       = 0X00'00'00'04,
    VTF_FLAGS_CLAMP_T                       = 0X00'00'00'08,
    VTF_FLAGS_ANISOTROPIC                   = 0X00'00'00'10,
    VTF_FLAGS_HINT_DXT5                     = 0X00'00'00'20,
    VTF_FLAGS_NOCOMPRESS                    = 0X00'00'00'40,
    VTF_FLAGS_NORMAL                        = 0X00'00'00'80,
    VTF_FLAGS_NOMIP                         = 0X00'00'01'00,
    VTF_FLAGS_NOLOD                         = 0X00'00'02'00,
    VTF_FLAGS_MINMIP                        = 0X00'00'04'00,
    VTF_FLAGS_PROCEDURAL                    = 0X00'00'08'00,
    VTF_FLAGS_ONEBITALPHA                   = 0X00'00'10'00,
    VTF_FLAGS_EIGHTBITALPHA                 = 0X00'00'20'00,
    VTF_FLAGS_ENVMAP                        = 0X00'00'40'00,
    VTF_FLAGS_RENDERTARGET                  = 0X00'00'80'00,
    VTF_FLAGS_DEPTHRENDERTARGET             = 0X00'01'00'00,
    VTF_FLAGS_NODEBUGOVERRIDE               = 0X00'02'00'00,
    VTF_FLAGS_SINGLECOPY                    = 0X00'04'00'00,
    VTF_FLAGS_ONEOVERMIPLEVELINALPHA        = 0X00'08'00'00,
    VTF_FLAGS_PREMULTCOLORBYONEOVERMIPLEVEL = 0X00'10'00'00,
    VTF_FLAGS_NORMALTODUDV                  = 0X00'20'00'00,
    VTF_FLAGS_ALPHATESTMIPGENERATION        = 0X00'40'00'00,
    VTF_FLAGS_NODEPTHBUFFER                 = 0X00'80'00'00,
    VTF_FLAGS_NICEFILTERED                  = 0X01'00'00'00,
    VTF_FLAGS_CLAMP_U                       = 0X02'00'00'00,
    VTF_FLAGS_PRESWIZZLED                   = 0X04'00'00'00,
    VTF_FLAGS_CACHEABLE                     = 0X08'00'00'00,
    VTF_FLAGS_UNFILTERABLE_OK               = 0X10'00'00'00,
    VTF_FLAGS_LASTFLAG                      = 0X10'00'00'00,
};
...
bool
ConvertImageFormat( unsigned int vtfFormat,
                    int&         internalFormat,
                    int&         pixelFormat,
                    int&         dataType )
{
...
osg::Image*
ReadVTFFile( std::istream& _istream )
{
    ...
    if( ( vtf_header.file_version[0] < 7 ) ||
        ( ( vtf_header.file_version[0] == 7 ) && ( vtf_header.file_version[1] < 2 ) ) )
    {
    ...
    supported = ConvertImageFormat( vtf_header.image_format,
                                    internalFormat,
                                    pixelFormat,
                                    dataType );
    ...
    if( vtf_header.num_mip_levels > 1 )
    {
        ...
        mipmaps.resize( ( unsigned int )std::max( power2_s, power2_t ), 0 );
        ...
        else
        {
                 ...
                 ++k )
            {
                ...
                offset         += depth *
                                  height *
                                  osg::Image::computeRowWidthInBytes( width,
                                                                      pixelFormat,
                                                                      dataType,
                                                                      1 );
                mipmaps[k - 1]  = offset;
...
bool
WriteVTFFile( const osg::Image* /*img*/,
              std::ostream& /*fout*/ )
{
    // Not supported
    return false;
