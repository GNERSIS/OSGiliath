...
int
equal_strings( const char*,
               const char* );

/* find an element in a plyfile's list */
PlyElement*
find_element( PlyFile*,
              const char* );

/* find a property in an element's list */
PlyProperty*
find_property( PlyElement*,
               const char*,
               int* );

/* write to a file the word describing a PLY file data type */
void
write_scalar_type( FILE*,
                   int );
...
void
write_binary_item( PlyFile*,
                   int,
                   unsigned int,
                   double,
                   int );
void
write_ascii_item( FILE*,
                  int,
                  unsigned int,
                  double,
                  int );
...
add_comment( PlyFile*,
             char* );
void
add_obj_info( PlyFile*,
              char* );

/* copy a property */
void
copy_property( PlyProperty*,
               PlyProperty* );
...
void
ascii_get_element( PlyFile*,
                   char* );
void
binary_get_element( PlyFile*,
                    char* );
...
void
swap8BE( unsigned long long* ptr )
{
    swap8Bytes( ptr );
}
...
void
swap8LE( unsigned long long* ptr )
{
    swap8Bytes( ptr );
}
...
PlyFile*
ply_open_for_writing( char*        filename,
                      int          nelems,
                      const char** elem_names,
                      int          file_type,
                      float*       version )
...
void
ply_describe_element( PlyFile*     plyfile,
...
void
ply_describe_property( PlyFile*     plyfile,
                       const char*  elem_name,
                       PlyProperty* prop )
{
    PlyElement*  elem;
...
void
ply_describe_other_properties( PlyFile*      plyfile,
                               PlyOtherProp* other,
                               int           offset )
{
    int          i;
...
void
ply_element_count( PlyFile*    plyfile,
                   const char* elem_name,
                   int         nelems )
{
    PlyElement* elem;
...
void
ply_put_element_setup( PlyFile*    plyfile,
                       const char* elem_name )
{
    PlyElement* elem;
...
void
ply_put_element( PlyFile* plyfile,
                 void*    elem_ptr )
{
    int          j, k;
    FILE*        fp = plyfile->fp;
...
void
ply_put_comment( PlyFile*    plyfile,
                 const char* comment )
{
...
void
ply_put_obj_info( PlyFile*    plyfile,
                  const char* obj_info )
{
...
PlyFile*
ply_open_for_reading( char*   filename,
                      int*    nelems,
                      char*** elem_names,
                      int*    file_type,
                      float*  version )
...
PlyProperty**
ply_get_element_description( PlyFile* plyfile,
                             char*    elem_name,
                             int*     nelems,
                             int*     nprops )
{
...
void
ply_get_element_setup( PlyFile*     plyfile,
                       char*        elem_name,
                       int          nprops,
                       PlyProperty* prop_list )
{
...
void
ply_set_property( PlyProperty* prop,
...
void
tokenizeProperties( const char*               pnames,
...
void
ply_get_property( PlyFile*     plyfile,
                  const char*  elem_name,
                  PlyProperty* prop )
{
    PlyElement*  elem;
...
void
ply_get_element( PlyFile* plyfile,
                 void*    elem_ptr )
{
    if( plyfile->file_type == PLY_ASCII )
    {
...
char**
ply_get_comments( PlyFile* plyfile,
                  int*     num_comments )
{
...
char**
ply_get_obj_info( PlyFile* plyfile,
                  int*     num_obj_info )
{
...
PlyOtherProp*
ply_get_other_properties( PlyFile* plyfile,
                          char*    elem_name,
                          int      offset )
{
    int           i;
...
PlyOtherElems*
ply_get_other_element( PlyFile* plyfile,
                       char*    elem_name,
                       int      elem_count )
{
    int            i;
    ...
    other->other_props = ply_get_other_properties( plyfile,
                                                   elem_name,
...
void
ply_describe_other_elements( PlyFile*       plyfile,
                             PlyOtherElems* other_elems )
{
    int        i;
    OtherElem* other;
    ...
    for( i = 0; i < other_elems->num_elems; i++ )
    {
        ...
        ply_describe_other_properties( plyfile,
                                       other->other_props,
                                       offsetof( OtherData, other_props ) );
    }
}
...
void
ascii_get_element( PlyFile* plyfile,
                   char*    elem_ptr )
{
    int          j, k;
    PlyElement*  elem;
...
void
binary_get_element( PlyFile* plyfile,
                    char*    elem_ptr )
{
    int          j, k;
    PlyElement*  elem;
...
void
write_binary_item( PlyFile*     plyfile,
                   int          int_val,
                   unsigned int uint_val,
                   double       double_val,
                   int          type )
...
void
get_binary_item( PlyFile*      plyfile,
                 int           type,
                 int*          int_val,
                 unsigned int* uint_val,
                 double*       double_val )
...
void
copy_property( PlyProperty* dest,
               PlyProperty* src )
{
