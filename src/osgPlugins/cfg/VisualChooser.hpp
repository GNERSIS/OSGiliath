 ...
 * VisualChooser, derived from Referenced.
 * Provides: setVisual, setSimpleConfiguration, clear, addAttribute, addAttribute,
...
namespace osgProducer
{
    ...
    class VisualChooser : public osg::Referenced
    {
        ...
        void setVisual( VisualInfo *vinfo );
            ...
            void
            setSimpleConfiguration( bool doublebuffer = true );
            ...
            // (e.g DoubleBuffer )
            void
            addAttribute( AttributeName attribute );
            ...
            // (e.g DoubleBuffer )
            void
            addExtendedAttribute( unsigned int attribute );
            ...
            void
            setAuxBuffers( unsigned int num );

            void
            setRedSize( unsigned int size );

            void
            setGreenSize( unsigned int size );

            void
            setBlueSize( unsigned int size );

            void
            setAlphaSize( unsigned int size );

            void
            setDepthSize( unsigned int size );

            void
            setStencilSize( unsigned int size );

            void
            setAccumRedSize( unsigned int size );

            void
            setAccumGreenSize( unsigned int size );

            void
            setAccumBlueSize( unsigned int size );

            void
            setAccumAlphaSize( unsigned int size );

            void
            setSampleBuffers( unsigned int size );

            void
            setSamples( unsigned int size );

            void
            setVisualID( unsigned int id );
        ...
        public:
            ...
            void
            applyAttribute( const VisualAttribute& va,
