...
bool
TXPNode_readLocalData( osg::Object&  obj,
                       osgDB::Input& fr );
bool
TXPNode_writeLocalData( const osg::Object& obj,
                        osgDB::Output&     fw );

osgDB::RegisterDotOsgWrapperProxy TXPNode_Proxy( new txp::TXPNode,
                                                 "TXPNode",
                                                 "Object Node TXPNode",
...
class Dump2Osg : public osg::DualModeVisitor
{
    public:

        Dump2Osg( osgDB::Output& fw ) :
                        ...
                        osgDB::Output&     fw )
{
    ...
    {
        fw.indent() << "databaseName \"" << txpNode.getArchiveName() << "\""
                    << std::endl;
    }
