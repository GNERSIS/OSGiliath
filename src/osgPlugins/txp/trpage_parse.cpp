...
trpgr_Token::trpgr_Token( int             in_tok,
                          trpgr_Callback* in_cb,
                          bool            in_dest )
{
...
void
trpgr_Parser::AddCallback( trpgToken       tok,
                           trpgr_Callback* cb,
                           bool            in_dest )
{
    RemoveCallback( tok );
...
const trpgr_Callback*
trpgr_Parser::GetCallback( trpgToken tok ) const
{
...
trpgr_Callback*
trpgr_Parser::GetCallback( trpgToken tok )
{
...
// Remove Callback
void
trpgr_Parser::RemoveCallback( trpgToken tok )
{
    tokenMap.erase( tok );
}
...
void
trpgr_Parser::SetDefaultCallback( trpgr_Callback* cb,
                                  bool            in_dest )
{
    defCb.Destruct();
...
*/
bool
trpgr_Parser::TokenIsValid( trpgToken tok )
{
    if( tok < 0 )
    {
        return false;
...
*/
bool
trpgr_Parser::Parse( trpgReadBuffer& buf )
{
    bool ret = true;
