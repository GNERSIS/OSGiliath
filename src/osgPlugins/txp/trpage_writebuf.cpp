...
/* Length()
    ...
    */
int
trpgMemWriteBuffer::length() const
{
    return curLen;
}
...
/* getData()
    ...
    */
const char*
trpgMemWriteBuffer::getData() const
{
    return data;
}
...
/* Length()
    ...
    */
void
trpgMemWriteBuffer::setLength( unsigned int len )
{
    if( ( int )len > totLen )
    {
        char* old_data = data;
...
/* append()
    ...
    */
void
trpgMemWriteBuffer::append( unsigned int len,
                            const char*  val )
{
    if( len == 0 )
    {
...
/* set()
    ...
    */
void
trpgMemWriteBuffer::set( unsigned int pos,
                         unsigned int len,
                         const char*  val )
{
    if( len == 0 )
...
// Add(Int32)
void
trpgMemWriteBuffer::Add( int32 val )
{
    if( ness != cpuNess )
    {
...
// Add(int64)
void
trpgMemWriteBuffer::Add( int64 val )
{
    if( ness != cpuNess )
    {
...
// [len] [value...]
void
trpgMemWriteBuffer::Add( const char* val )
{
...
// Add(std::string)
void
trpgMemWriteBuffer::Add( const std::string& val )
{
    Add( val.c_str() );
}
...
// Add(float32)
void
trpgMemWriteBuffer::Add( float32 val )
{
    char cval[4];
    if( ness != cpuNess )
    {
...
// Add(float64)
void
trpgMemWriteBuffer::Add( float64 val )
{
    char cval[8];
    if( ness != cpuNess )
    {
...
// Add(int8)
void
trpgMemWriteBuffer::Add( uint8 val )
{
...
//  Add(bool)
void
trpgMemWriteBuffer::Add( bool val )
{
    uint8 ival;
...
// Add(trpgDiskRef)
void
trpgMemWriteBuffer::Add( trpgDiskRef val )
{
    if( ness != cpuNess )
    {
        val = trpg_byteswap_llong( val );
...
// Add(trpgToken)
void
trpgMemWriteBuffer::Add( trpgToken val )
{
    if( ness != cpuNess )
    {
...
// Add(tx2iPoint)
void
trpgWriteBuffer::Add( const trpg2iPoint& val )
{
    Add( ( int32 )val.x );
    Add( ( int32 )val.y );
}
...
// Add(tx2dPoint)
void
trpgWriteBuffer::Add( const trpg2dPoint& val )
{
    Add( ( float64 )val.x );
    Add( ( float64 )val.y );
}
...
// Add(trpg3dPoint)
void
trpgWriteBuffer::Add( const trpg3dPoint& val )
{
    Add( ( float64 )val.x );
    Add( ( float64 )val.y );
    Add( ( float64 )val.z );
...
// Add(trpgColor)
void
trpgWriteBuffer::Add( const trpgColor& val )
{
    Add( val.red );
    Add( val.green );
    Add( val.blue );
...
// Add(std::string)
void
trpgWriteBuffer::Add( const std::string& val )
{
    Add( val.c_str() );
}
...
/* Push()
    ...
    */
void
trpgMemWriteBuffer::Begin( trpgToken tok )
{
    Add( tok );
...
trpgwAppFile::trpgwAppFile( trpgEndian  inNess,
                            const char* fileName,
                            bool        reuse )
{
...
void
trpgwAppFile::Init( trpgEndian  inNess,
                    const char* fileName,
                    bool        reuse )
{
    valid   = false;
...
bool
trpgwAppFile::Append( const trpgMemWriteBuffer* buf1,
                      const trpgMemWriteBuffer* buf2 )
{
    if( !isValid() )
    {
        return false;
...
bool
trpgwAppFile::Append( const char* data,
                      int         size )
{
    if( !isValid() )
    {
