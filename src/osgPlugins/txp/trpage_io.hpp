...
// 16 bit token definition value.  These are values such as TRPGTEXTABLE or TRPG_ATTACH,
// etc...
...
// {secret}
#define TRPGTILEHEADER             1'000
// {secret}
#define TRPG_TILE_MATLIST          1'001
// {secret}
#define TRPG_TILE_MODELLIST        1'002
// {secret}
#define TRPG_TILE_DATE             1'003
// {secret}
#define TRPGLOCALMATERIAL          1'004
// {secret}
#define TRPG_TILE_LOCMATLIST       1'005

// Lights support added by Nick
// {secret}
#define TRPGLIGHTTABLE             1'100
// {secret}
#define TRPGLIGHTATTR              1'150
// {secret}
#define TRPGLIGHTATTR_BASIC        1'151
// {secret}
#define TRPGLIGHTATTR_RASCAL       1'152
// {secret}
#define TRPGLIGHTATTR_CALLIGRAPHIC 1'153
// {secret}
#define TRPGLIGHTATTR_PERFORMER    1'154
// {secret}
#define TRPGLIGHTATTR_ANIMATION    1'155
// {secret}
#define TRPGLIGHTATTR_COMMENT      1'156
// {secret}
#define TRPGLIGHTATTR_HANDLE       1'157
// {secret}
#define TRPGLIGHT                  1'160
// {secret}
#define TRPG_LIGHT                 1'160

// {secret}
#define TRPGRANGETABLE             1'200
// {secret}
#define TRPG_RANGE                 1'201

// Label and style support added 12-02
// {secret}
#define TRPG_TEXT_STYLE_TABLE      1'300
// {secret}
#define TRPG_TEXT_STYLE            1'301
// {secret}
#define TRPG_TEXT_STYLE_BASIC      1'302

// {secret}
#define TRPG_SUPPORT_STYLE_TABLE   1'310
// {secret}
#define TRPG_SUPPORT_STYLE         1'311
// {secret}
#define TRPG_SUPPORT_STYLE_BASIC   1'312

// {secret}
#define TRPG_LABEL_PROPERTY_TABLE  1'320
// {secret}
#define TRPG_LABEL_PROPERTY        1'321
// {secret}
#define TRPG_LABEL_PROPERTY_BASIC  1'322

// {secret}
#define TRPG_LABEL                 1'330

// {secret}
#define TRPG_GROUP                 2'001
// {secret}
#define TRPG_BILLBOARD             2'002
// {secret}
#define TRPG_LOD                   2'003
// {secret}
#define TRPG_TRANSFORM             2'004
// {secret}
#define TRPG_MODELREF              2'005
// {secret}
#define TRPG_LAYER                 2'006

// {secret}
#define TRPG_GEOMETRY              3'000
// {secret}
#define TRPG_GEOM_PRIM             3'001
// {secret}
#define TRPG_GEOM_MATERIAL         3'002
// {secret}
#define TRPG_GEOM_VERT32           3'003
// {secret}
#define TRPG_GEOM_VERT64           3'004
// {secret}
#define TRPG_GEOM_NORM32           3'005
// {secret}
#define TRPG_GEOM_NORM64           3'006
// {secret}
#define TRPG_GEOM_COLOR            3'007
// {secret}
#define TRPG_GEOM_TEX32            3'008
// {secret}
#define TRPG_GEOM_TEX64            3'009
// {secret}
#define TRPG_GEOM_EFLAG            3'010

// {secret}
#define TRPG_ATTACH                4'000

// {secret}
#define TRPG_CHILDREF              5'000

// {secret}
#define TRPG_MAXTOKEN              5'000
...
TX_EXDECL class TX_CLDECL trpg2dPoint
{
    public:
        ...
        bool
        operator==( const trpg2dPoint& pt ) const
        {
            if( x != pt.x )
            {
                return false;
...
TX_EXDECL class TX_CLDECL trpg3dPoint
{
    public:
        ...
        bool
        operator==( const trpg3dPoint& pt ) const
        {
            if( x != pt.x )
            {
                return false;
...
TX_EXDECL class TX_CLDECL trpgColor
{
    public:
        ...
        bool
        operator==( const trpgColor& color )
        {
            if( color.red != red )
            {
                return false;
...
TX_EXDECL class TX_CLDECL trpgWriteBuffer
{
    public:
        ...
        // Some add functions are helpers for composite values that call the basic add
        // functions
        virtual void
        Add( const trpg2iPoint& );
        virtual void
        Add( const trpg2dPoint& );
        virtual void
        Add( const trpg3dPoint& );
        virtual void
        Add( const trpgColor& );
        virtual void
    ...
    protected:
        ...
        // Target endianness of the buffer.  This should be set by the subclass on
        // creation.
        trpgEndian ness;
...
TX_EXDECL class TX_CLDECL trpgMemWriteBuffer : public trpgWriteBuffer
{
    public:
        ...
        // Reset this buffer.  This will set the current length to zero, but will not
        // deallocate memory
        virtual void
                     Reset( void );
        ...
        /* This method is called at the end of a tokenized object.  See Begin for
         * details. */
        virtual void
        End( void );
...
TX_EXDECL class TX_CLDECL trpgMemReadBuffer : public trpgReadBuffer
{
    ...
    protected:
        ...
        bool
        GetData( char*,
                 int );       // Retrieve the given amount of data
        bool
        GetDataRef( char**,
                    int );    // Retrieve a pointer to the given array
        bool
              Skip( int );    // Skip over the given amount
        int   len;            // Data Length
...
TX_EXDECL class TX_CLDECL trpgCheckable
{
    public:
        ...
        // Returns the state of the valid flag, or can be overridden by a subclass to do
...
/* The Read/Writeable is a class that knows how to read itself from a trpgReadBuffer
    ...
    is used to indicate whether the given call succeeded.  In the case of "Set" and "Add"
   calls this should always work if it possibly can.  An out of range index might make it
...
TX_EXDECL class TX_CLDECL trpgReadWriteable : public trpgCheckable
{
    public:
        ...
        getErrMess() const
        {
            return errMess.empty() ? 0 : errMess.c_str();
        }
...
TX_EXDECL class TX_CLDECL trpgwAppFile
{
    public:
        ...
        trpgwAppFile( trpgEndian,
                      const char*,
                      bool reuse = false );
        virtual ~trpgwAppFile( void );
        virtual bool
        Append( const trpgMemWriteBuffer*,
...
TX_EXDECL class TX_CLDECL trpgrAppFileCache
{
    public:
        ...
        trpgrAppFileCache( const char* prefix,
                           const char* ext,
                           int         noFiles = 32 );
        // real construction is here
        virtual void
        Init( const char* prefix,
              const char* ext,
              int         noFiles );
        virtual ~trpgrAppFileCache( void );
        virtual trpgrAppFile*
        GetFile( trpgEndian ness,
                 int        id,
                 int        col,
                 int        row );
        virtual trpgrAppFile*
        GetFile( trpgEndian ness,
                 int        id );
        virtual trpgrAppFile*
        GetNewRAppFile( trpgEndian  ness,
                        const char* fileName );

    protected:

        // Prefix name and extension
        char baseName[1'024], ext[20];
