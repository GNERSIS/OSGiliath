...
#include "trpage_read.hpp"
#include "TXPArchive.hpp"
...
namespace txp
{
    ...
    osg::Texture2D*
    getLocalTexture( trpgrImageHelper&  image_helper,
                     const trpgTexture* tex );
    osg::Texture2D*
    getTemplateTexture( trpgrImageHelper&  image_helper,
    ...
    class GeodeGroup : public osg::Inherit<osg::Group, GeodeGroup>
    {
        public:
            ...
            GeodeGroup( const GeodeGroup&  gg,
    ...
    class TXPParser : public trpgSceneParser,
                      public osg::Referenced
    {
        public:
            ...
            inline void
            setPotentionalTileGroup( osg::Group* grp )
            {
                _tileGroups[grp] = 1;
            }
            ...
            inline void
            setUnderBillboardSubgraph( bool b )
            {
            ...
            inline void
            setLastBillboardInfo( TXPBillboardInfo& info )
            {
            ...
            inline void
            getLastBillboardInfo( TXPBillboardInfo& info )
            {
            ...
            getLightAttribute( int ix );

            // Returns if we are under layer subgraph
            inline bool
            underLayerSubgraph() const
            {
            ...
            void
            setMaxAnisotropy( float anisotropy )
            {
            ...
            inline double
            checkAndGetMinRange( double range )
            {
            ...
            inline double
            checkAndGetMaxRange( double range )
            {
