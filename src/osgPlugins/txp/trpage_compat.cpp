...
bool
trpgMatTable1_0::Read( trpgReadBuffer& buf )
{
    trpgMaterial                   mat;
    trpgToken                      matTok;
    int32                          len;
...
bool
trpgMatTable1_0::Write( trpgWriteBuffer& buf )
{
    if( !isValid() )
    {
        return false;
...
trpgTexture1_0
trpgTexture1_0::operator=( const trpgTexture& inTex )
{
...
bool
trpgTexture1_0::Read( trpgReadBuffer& buf )
{
    mode = External;
...
bool
trpgTexture1_0::Write( trpgWriteBuffer& buf )
{
...
bool
trpgTexTable1_0::Read( trpgReadBuffer& buf )
{
    int32 numTex;
...
bool
trpgTexTable1_0::Write( trpgWriteBuffer& buf )
{
    int32 numTex;
...
bool
trpgTileTable1_0::Write( trpgWriteBuffer& buf )
{
    try
    {
