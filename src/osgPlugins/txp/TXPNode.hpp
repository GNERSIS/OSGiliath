...
namespace txp
{
    ...
    class TXPNode : public osg::Inherit<osg::Group, TXPNode>
    {
        public:
            ...
            void
            setArchiveName( const std::string& archiveName );
            void
            setOptions( const std::string& options );
