    ...
    class ReaderWriterTXP : public osgDB::ReaderWriter
    {
        public:
            ...
            ReaderWriterTXP()
            {
                ...
                supportsEnvironment( "OSG_TXP_DEFAULT_MAX_ANISOTROPY",
                      ...
                      const osgDB::ReaderWriter::Options* options ) const
            {
                ...
                return const_cast<ReaderWriterTXP*>( this )->local_readNode( file,
                                                                             options );
            }

            bool
            removeArchive( int id );

        protected:

            ReadResult
            local_readNode( const std::string&                  file,
                            const osgDB::ReaderWriter::Options* options );

            std::string
            getArchiveName( const std::string& dir );
            osg::ref_ptr<TXPArchive>
            createArchive( int                id,
            ...
            osg::Node*
            getTileContent( const TXPArchive::TileInfo&                info,
                            int                                        x,
                            int                                        y,
                            int                                        lod,
                            TXPArchive*                                archive,
            ...
            getTileContent( const TXPArchive::TileInfo&                info,
                            ...
                            std::vector<TXPArchive::TileLocationInfo>& childrenLoc );
            void
            createChildrenLocationString(
                const std::vector<TXPArchive::TileLocationInfo>& locs,
                std::string&                                     locString
            ) const;
            bool
            extractChildrenLocations( const std::string& name,
                                      int                parentLod,
