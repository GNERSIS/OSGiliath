...
TX_EXDECL class TX_CLDECL trpgMBR
{
    public:
        ...
        Reset( void );
        void
        AddPoint( const trpg3dPoint& );
        void
        AddPoint( double,
                  double,
                  double );
        void
        GetMBR( trpg3dPoint& ll,
        ...
        bool
        Overlap( const trpg2dPoint& ll,
                 const trpg2dPoint& ur ) const;
        // bool Within(const trpg3dPoint &) const
        bool
        Within( const trpg2dPoint& ) const;
...
TX_EXDECL class TX_CLDECL trpgSceneGraphParser : public trpgSceneParser
{
    public:
        ...
        trpgReadNode*
        ParseScene( trpgReadBuffer&,
                    GroupMap& );
        trpgReadGroupBase*
        GetCurrTop( void );    // Get the current parent object
        trpgReadTileHeader*
        GetTileHeaderRef( void );
