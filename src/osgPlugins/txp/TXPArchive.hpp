...
namespace txp
{
    ...
    class TXPArchive : public trpgr_Archive,
                       public osg::Referenced
    {
        public:
            ...
            bool
            openFile( const std::string& archiveName );
            ...
            // Add light attrib
            void
            addLightAttribute( osgSim::LightPointNode* lpn,
                               osg::StateSet*          fallback,
                               const osg::vec3&        attitude,
                               int                     handle );

            int
            getNumLightAttributes()
            {
                return _lights.size();
            }

            // Get light attrib
            inline DeferredLightAttribute&
            getLightAttribute( unsigned int i )
            {
                return _lights[i];
            };
            ...
            getTileInfo( int       x,
                         ...
                         TileInfo& info );
            bool
            getTileInfo( const TileLocationInfo& loc,
                         TileInfo&               info );
            ...
            osg::Group*
            getTileContent( const TileLocationInfo&        loc,
                            double                         realMinRange,
                            double                         realMaxRange,
                            double                         usedMaxRange,
                            osg::vec3&                     tileCenter,
            ...
            void
            SetUserDataToMaterialAttributes( osg::StateSet&      osg_state_set,
        ...
        protected:
            ...
            void
            SetStatesMap( int                         key,
                          osg::ref_ptr<osg::StateSet> ref );
            osg::ref_ptr<osg::StateSet>
                                                           GetStatesMapEntry( int key );
