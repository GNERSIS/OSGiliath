...
// Setters
void
trpgLightAttr::SetType( trpgLightAttr::LightType in_type )
{
    data.type = in_type;
}

void
trpgLightAttr::SetDirectionality( trpgLightAttr::LightDirectionality in_directionality )
{
    data.directionality = in_directionality;
}

void
trpgLightAttr::SetFrontColor( trpgColor in_frontColor )
{
    data.frontColor = in_frontColor;
}

void
trpgLightAttr::SetFrontIntensity( float64 in_frontIntensity )
{
    data.frontIntensity = in_frontIntensity;
}

void
trpgLightAttr::SetBackColor( trpgColor in_backColor )
{
    data.backColor = in_backColor;
}

void
trpgLightAttr::SetBackIntensity( float64 in_backIntensity )
{
    data.backIntensity = in_backIntensity;
}

void
trpgLightAttr::SetNormal( trpg3dPoint in_normal )
{
    data.normal = in_normal;
}

void
trpgLightAttr::SetSMC( int32 in_smc )
{
    data.smc = in_smc;
}

void
trpgLightAttr::SetFID( int32 in_fid )
{
    data.fid = in_fid;
}

void
trpgLightAttr::SetFlags( int32 in_flags )
{
    data.flags = in_flags;
}

void
trpgLightAttr::SetHLobeAngle( float64 in_hLobeAngle )
{
    data.horizontalLobeAngle = in_hLobeAngle;
}

void
trpgLightAttr::SetVLobeAngle( float64 in_vLobeAngle )
{
    data.verticalLobeAngle = in_vLobeAngle;
}

void
trpgLightAttr::SetLobeRollAngle( float64 in_lobeRollAngle )
{
    data.lobeRollAngle = in_lobeRollAngle;
}

void
trpgLightAttr::SetLobeFalloff( float64 in_lobeFalloff )
{
    data.lobeFalloff = in_lobeFalloff;
}

void
trpgLightAttr::SetAmbient( float64 in_ambientIntensity )
{
    data.ambientIntensity = in_ambientIntensity;
}

void
trpgLightAttr::SetQuality( trpgLightAttr::LightQuality in_quality )
{
    data.quality = in_quality;
}

void
trpgLightAttr::SetRascalSignificance( float64 in_rascalSignificance )
{
    data.rascalSignificance = in_rascalSignificance;
}

void
trpgLightAttr::SetRandomIntensity( trpgLightAttr::LightQuality in_randomIntensity )
{
    data.randomIntensity = in_randomIntensity;
}

void
trpgLightAttr::SetCalligraphicAttr(
...
void
trpgLightAttr::SetCalligraphicDrawOrder( int32 in_drawOrder )
{
    data.calligraphicAttr.drawOrder = in_drawOrder;
}

void
trpgLightAttr::SetCalligraphicMinDefocus( float64 in_minDefocus )
{
    data.calligraphicAttr.minDefocus = in_minDefocus;
}

void
trpgLightAttr::SetCalligraphicMaxDefocus( float64 in_maxDefocus )
{
    data.calligraphicAttr.maxDefocus = in_maxDefocus;
}

void
trpgLightAttr::SetPerformerAttr( trpgLightAttr::PerformerAttr& in_performerAttr )
{
    data.performerAttr = in_performerAttr;
}

void
trpgLightAttr::SetPerformerFlags( int32 in_flags )
{
...
void
trpgLightAttr::SetPerformerMinPixelSize( float64 in_minPxSize )
{
    data.performerAttr.minPixelSize = in_minPxSize;
}

void
trpgLightAttr::SetPerformerMaxPixelSize( float64 in_maxPxSize )
{
    data.performerAttr.maxPixelSize = in_maxPxSize;
}

void
trpgLightAttr::SetPerformerActualSize( float64 in_actualSize )
{
    data.performerAttr.actualSize = in_actualSize;
}

void
trpgLightAttr::SetPerformerTpPixelSize( float64 in_tpPixelSize )
{
    data.performerAttr.transparentPixelSize = in_tpPixelSize;
}

void
trpgLightAttr::SetPerformerTpFalloffExp( float64 in_tpFalloffExp )
{
    data.performerAttr.transparentFallofExp = in_tpFalloffExp;
}

void
trpgLightAttr::SetPerformerTpScale( float64 in_tpScale )
{
    data.performerAttr.transparentScale = in_tpScale;
}

void
trpgLightAttr::SetPerformerTpClamp( float64 in_tpClamp )
{
    data.performerAttr.transparentClamp = in_tpClamp;
}

void
trpgLightAttr::SetPerformerFogScale( float64 in_fogScale )
{
    data.performerAttr.fogScale = in_fogScale;
}

void
trpgLightAttr::SetAnimationAttr( trpgLightAttr::AnimationAttr& in_animationAttr )
{
    data.animationAttr = in_animationAttr;
}

void
trpgLightAttr::SetAnimationPeriod( float64 in_period )
{
    data.animationAttr.period = in_period;
}

void
trpgLightAttr::SetAnimationPhaseDelay( float64 in_phaseDelay )
{
    data.animationAttr.phaseDelay = in_phaseDelay;
}

void
trpgLightAttr::SetAnimationTimeOn( float64 in_timeOn )
{
    data.animationAttr.timeOn = in_timeOn;
}

void
trpgLightAttr::SetAnimationVector( trpg3dPoint in_vector )
{
    data.animationAttr.vector = in_vector;
}

void
trpgLightAttr::SetAnimationFlags( int32 flags )
{
...
void
trpgLightAttr::SetComment( const char* inStr )
{
    if( !inStr )
    {
        return;
...
// Getters
void
trpgLightAttr::GetType( trpgLightAttr::LightType& out_type )
{
    out_type = data.type;
}

void
trpgLightAttr::GetDirectionality(
    trpgLightAttr::LightDirectionality& out_directionality
)
{
...
void
trpgLightAttr::GetFrontColor( trpgColor& out_frontColor )
{
    out_frontColor = data.frontColor;
}

void
trpgLightAttr::GetFrontIntensity( float64& out_frontIntensity )
{
    out_frontIntensity = data.frontIntensity;
}

void
trpgLightAttr::GetBackColor( trpgColor& out_backColor )
{
    out_backColor = data.backColor;
}

void
trpgLightAttr::GetBackIntensity( float64& out_backIntensity )
{
    out_backIntensity = data.backIntensity;
}

void
trpgLightAttr::GetNormal( trpg3dPoint& out_normal )
{
    out_normal = data.normal;
}

void
trpgLightAttr::GetSMC( int32& out_smc )
{
    out_smc = data.smc;
}

void
trpgLightAttr::GetFID( int32& out_fid )
{
    out_fid = data.fid;
}

void
trpgLightAttr::GetFlags( int32& out_flags )
{
    out_flags = data.flags;
}

void
trpgLightAttr::GetHLobeAngle( float64& out_hLobeAngle )
{
    out_hLobeAngle = data.horizontalLobeAngle;
}

void
trpgLightAttr::GetVLobeAngle( float64& out_vLobeAngle )
{
    out_vLobeAngle = data.verticalLobeAngle;
}

void
trpgLightAttr::GetLobeRollAngle( float64& out_lobeRollAngle )
{
    out_lobeRollAngle = data.lobeRollAngle;
}

void
trpgLightAttr::GetLobeFalloff( float64& out_lobeFalloff )
{
    out_lobeFalloff = data.lobeFalloff;
}

void
trpgLightAttr::GetAmbient( float64& out_ambientIntensity )
{
    out_ambientIntensity = data.ambientIntensity;
}

void
trpgLightAttr::GetQuality( trpgLightAttr::LightQuality& out_quality )
{
    out_quality = data.quality;
}

void
trpgLightAttr::GetRascalSignificance( float64& out_rascalSignificance )
{
    out_rascalSignificance = data.rascalSignificance;
}

void
trpgLightAttr::GetRandomIntensity( trpgLightAttr::LightQuality& out_randomIntensity )
{
    out_randomIntensity = data.randomIntensity;
}

void
trpgLightAttr::GetCalligraphicAttr(
    trpgLightAttr::CalligraphicAttr& out_calligraphicAttr
)
{
...
void
trpgLightAttr::GetCalligraphicDrawOrder( int32& out_drawOrder )
{
    out_drawOrder = data.calligraphicAttr.drawOrder;
}

void
trpgLightAttr::GetCalligraphicMinDefocus( float64& out_minDefocus )
{
    out_minDefocus = data.calligraphicAttr.minDefocus;
}

void
trpgLightAttr::GetCalligraphicMaxDefocus( float64& out_maxDefocus )
{
    out_maxDefocus = data.calligraphicAttr.maxDefocus;
}

void
trpgLightAttr::GetPerformerAttr( trpgLightAttr::PerformerAttr& out_performerAttr )
{
    out_performerAttr = data.performerAttr;
}

void
trpgLightAttr::GetPerformerFlags( int32& out_flags )
{
    out_flags = data.performerAttr.flags;
}

void
trpgLightAttr::GetPerformerMinPixelSize( float64& out_minPxSize )
{
    out_minPxSize = data.performerAttr.minPixelSize;
}

void
trpgLightAttr::GetPerformerMaxPixelSize( float64& out_maxPxSize )
{
    out_maxPxSize = data.performerAttr.maxPixelSize;
}

void
trpgLightAttr::GetPerformerActualSize( float64& out_actualSize )
{
    out_actualSize = data.performerAttr.actualSize;
}

void
trpgLightAttr::GetPerformerTpPixelSize( float64& out_tpPixelSize )
{
    out_tpPixelSize = data.performerAttr.transparentPixelSize;
}

void
trpgLightAttr::GetPerformerTpFalloffExp( float64& out_tpFalloffExp )
{
    out_tpFalloffExp = data.performerAttr.transparentFallofExp;
}

void
trpgLightAttr::GetPerformerTpScale( float64& out_tpScale )
{
    out_tpScale = data.performerAttr.transparentScale;
}

void
trpgLightAttr::GetPerformerTpClamp( float64& out_tpClamp )
{
    out_tpClamp = data.performerAttr.transparentClamp;
}

void
trpgLightAttr::GetPerformerFogScale( float64& out_fogScale )
{
    out_fogScale = data.performerAttr.fogScale;
}

void
trpgLightAttr::GetAnimationAttr( trpgLightAttr::AnimationAttr& out_animationAttr )
{
    out_animationAttr = data.animationAttr;
}

void
trpgLightAttr::GetAnimationPeriod( float64& out_period )
{
    out_period = data.animationAttr.period;
}

void
trpgLightAttr::GetAnimationPhaseDelay( float64& out_phaseDelay )
{
    out_phaseDelay = data.animationAttr.phaseDelay;
}

void
trpgLightAttr::GetAnimationTimeOn( float64& out_timeOn )
{
    out_timeOn = data.animationAttr.timeOn;
}

void
trpgLightAttr::GetAnimationVector( trpg3dPoint& out_vector )
{
    out_vector = data.animationAttr.vector;
}

void
trpgLightAttr::GetAnimationFlags( int32& flags )
{
    flags = data.animationAttr.flags;
}

const char*
trpgLightAttr::GetComment()
{
...
bool
trpgLightAttr::Write( trpgWriteBuffer& buf )
{
...
void*
lightAttrCB::Parse( trpgToken       tok,
                    trpgReadBuffer& buf )
{
    int       type_data;
    ...
    try
    {
        switch( tok )
        {
            case TRPGLIGHTATTR_BASIC :
                ...
                lightAttr->SetDirectionality(
                    ( trpgLightAttr::LightDirectionality )directionality_data
                );
                buf.Get( color_data );
                ...
                buf.Get( quality_data );
                lightAttr->SetRandomIntensity(
                    ( trpgLightAttr::LightQuality )quality_data
                );
                break;
...
bool
trpgLightAttr::Read( trpgReadBuffer& buf )
{
    Reset();
...
bool
trpgLightAttr::isValid( void ) const
{
    return true;
}

trpgLightAttr&
trpgLightAttr::operator=( const trpgLightAttr& in )
{
    data = in.data;
...
trpgLightAttr::operator==( const trpgLightAttr& in )
{
    ...
    if( data.performerAttr.transparentPixelSize !=
        in.data.performerAttr.transparentPixelSize )
    {
        return false;
    }
    if( data.performerAttr.transparentFallofExp !=
        in.data.performerAttr.transparentFallofExp )
    {
        return false;
    }
    ...
    if( data.commentStr &&
        in.data.commentStr &&
        strcmp( data.commentStr, in.data.commentStr ) )
    {
        return false;
    }
    if( handle != in.handle )
...
void
trpgLight::AddVertex( trpg3dPoint pt )
{
...
void
trpgLight::GetNumVertices( uint32& nvertices ) const
{
...
bool
trpgLight::GetVertex( uint32       ix,
                      trpg3dPoint& pt ) const
{
...
bool
trpgLight::GetVertices( trpg3dPoint* pts ) const
{
    unsigned int i;
...
bool
trpgLight::GetVertices( float64* fts ) const
{
    unsigned int i;
    unsigned int j = 0;
...
bool
trpgLight::GetVertices( float32* fts ) const
{
    unsigned int i;
    unsigned int j = 0;
...
void
trpgLight::GetAttrIndex( int& ix ) const
{
    ix = index;
}
...
// Writes this class to a write buffer
bool
trpgLight::Write( trpgWriteBuffer& buf )
{
...
// Reads this class from a read buffer
bool
trpgLight::Read( trpgReadBuffer& buf )
{
    Reset();
...
// operator
trpgLight&
trpgLight::operator=( const trpgLight& in )
{
    Reset();
...
// Set functions
int
trpgLightTable::AddLightAttr( const trpgLightAttr& inLight )
{
...
int
trpgLightTable::FindAddLightAttr( const trpgLightAttr& inLight )
{
...
// Copy operator
trpgLightTable&
trpgLightTable::operator=( const trpgLightTable& in )
{
    Reset();
...
// Write Light table
bool
trpgLightTable::Write( trpgWriteBuffer& buf )
{
    int32 numLights;
...
// Get functions
bool
trpgLightTable::GetNumLightAttrs( int& no ) const
{
    if( !isValid() )
    {
        return false;
...
const trpgLightAttr*
trpgLightTable::GetLightAttrRef( int id ) const
{
    if( id < 0 )
    {
        return NULL;
...
bool
trpgLightTable::Read( trpgReadBuffer& buf )
{
    int32     numLights;
    trpgToken lightTok;
    int32     len;
