...
void
trpgTextStyle::SetMaterial( int inMatId )
{
    matId = inMatId;
}

int
trpgTextStyle::GetMaterial( void ) const
{
    return matId;
}

void
trpgTextStyle::SetFont( std::string& inFont )
{
    font = inFont;
}

const std::string*
trpgTextStyle::GetFont( void ) const
{
    return &font;
}

void
trpgTextStyle::SetBold( bool inBold )
{
    bold = inBold;
}

bool
trpgTextStyle::GetBold( void ) const
{
    return bold;
}

void
trpgTextStyle::SetItalic( bool inItalic )
{
    italic = inItalic;
}

bool
trpgTextStyle::GetItalic( void ) const
{
    return italic;
}

void
trpgTextStyle::SetUnderline( bool inUnder )
{
    underline = inUnder;
}

bool
trpgTextStyle::GetUnderline( void ) const
{
    return underline;
}

void
trpgTextStyle::SetCharacterSize( float32 inSize )
{
    characterSize = inSize;
}

float32
trpgTextStyle::GetCharacterSize( void ) const
{
...
bool
trpgTextStyle::Write( trpgWriteBuffer& buf )
{
...
void*
textStyleCB::Parse( trpgToken       tok,
                    trpgReadBuffer& buf )
{
    std::string sVal;
    int         iVal;
...
bool
trpgTextStyle::Read( trpgReadBuffer& buf )
{
    Reset();
...
bool
trpgTextStyle::isValid( void ) const
{
...
bool
trpgTextStyle::operator==( const trpgTextStyle& in ) const
{
    if( font != in.font )
    {
        return false;
    ...
    if( bold != in.bold || italic != in.italic || underline != in.underline )
    {
        return false;
    }
...
void
trpgTextStyleTable::Reset()
{
    styleMap.clear();
}

bool
trpgTextStyleTable::isValid() const
{
...
int
trpgTextStyleTable::AddStyle( const trpgTextStyle& style )
{
...
int
trpgTextStyleTable::FindAddStyle( const trpgTextStyle& style )
{
    StyleMapType::const_iterator itr = styleMap.begin();
    for( ; itr != styleMap.end(); itr++ )
    {
...
int
trpgTextStyleTable::GetNumStyle() const
{
    return styleMap.size();
}

const trpgTextStyle*
trpgTextStyleTable::GetStyleRef( int id ) const
{
    if( id < 0 )
    {
        return NULL;
...
bool
trpgTextStyleTable::Write( trpgWriteBuffer& buf )
{
    if( !isValid() )
    {
        return false;
...
bool
trpgTextStyleTable::Read( trpgReadBuffer& buf )
{
    trpgTextStyle style;
    trpgToken     styleTok;
    int32         len;
...
void
trpgSupportStyle::SetType( SupportType s )
{
    type = s;
}

trpgSupportStyle::SupportType
trpgSupportStyle::GetType() const
{
    return type;
}

void
trpgSupportStyle::SetMaterial( int inMatId )
{
    matId = inMatId;
}

int
trpgSupportStyle::GetMaterial( void ) const
{
    return matId;
}
...
// Write method
bool
trpgSupportStyle::Write( trpgWriteBuffer& buf )
{
...
void*
supportStyleCB::Parse( trpgToken       tok,
                       trpgReadBuffer& buf )
{
    int iVal;
...
bool
trpgSupportStyle::Read( trpgReadBuffer& buf )
{
    Reset();
...
bool
trpgSupportStyle::isValid( void ) const
{
    return true;
}

bool
trpgSupportStyle::operator==( const trpgSupportStyle& in ) const
{
...
bool
trpgSupportStyleTable::isValid() const
{
    // for (int i=0;i<styles.size();i++)
...
int
trpgSupportStyleTable::AddStyle( const trpgSupportStyle& style )
{
...
int
trpgSupportStyleTable::FindAddStyle( const trpgSupportStyle& style )
{
    SupportStyleMapType::const_iterator itr = supportStyleMap.begin();
    for( ; itr != supportStyleMap.end(); itr++ )
    {
...
int
trpgSupportStyleTable::GetNumStyle() const
{
    return supportStyleMap.size();
}

const trpgSupportStyle*
trpgSupportStyleTable::GetStyleRef( int id ) const
{
    if( id < 0 )
    {
        return NULL;
...
bool
trpgSupportStyleTable::Write( trpgWriteBuffer& buf )
{
    if( !isValid() )
    {
        return false;
...
bool
trpgSupportStyleTable::Read( trpgReadBuffer& buf )
{
    trpgSupportStyle style;
    trpgToken        styleTok;
    int32            len;
...
void
trpgLabelProperty::SetType( LabelType inType )
{
    type = inType;
}

trpgLabelProperty::LabelType
trpgLabelProperty::GetType() const
{
    return type;
}

void
trpgLabelProperty::SetFontStyle( int id )
{
    fontId = id;
}

int
trpgLabelProperty::GetFontStyle() const
{
    return fontId;
}

void
trpgLabelProperty::SetSupport( int id )
{
    supportId = id;
}

int
trpgLabelProperty::GetSupport( void ) const
{
    return supportId;
}
...
// Write method
bool
trpgLabelProperty::Write( trpgWriteBuffer& buf )
{
...
void*
labelPropertyCB::Parse( trpgToken       tok,
                        trpgReadBuffer& buf )
{
    int iVal;
...
bool
trpgLabelProperty::Read( trpgReadBuffer& buf )
{
    Reset();
...
bool
trpgLabelProperty::isValid( void ) const
{
    return supportId != -1 && fontId != -1 && type >= 0 && type < MaxLabelType;
}

bool
trpgLabelProperty::operator==( const trpgLabelProperty& in ) const
{
...
void
trpgLabelPropertyTable::Reset()
{
    labelPropertyMap.clear();
}

bool
trpgLabelPropertyTable::isValid() const
{
...
int
trpgLabelPropertyTable::AddProperty( const trpgLabelProperty& property )
{
...
int
trpgLabelPropertyTable::FindAddProperty( const trpgLabelProperty& property )
{
    LabelPropertyMapType::const_iterator itr = labelPropertyMap.begin();
    for( ; itr != labelPropertyMap.end(); itr++ )
    {
...
int
trpgLabelPropertyTable::GetNumProperty() const
{
    return labelPropertyMap.size();
}

const trpgLabelProperty*
trpgLabelPropertyTable::GetPropertyRef( int id ) const
{
    if( id < 0 )
    {
        return NULL;
...
bool
trpgLabelPropertyTable::Write( trpgWriteBuffer& buf )
{
    if( !isValid() )
    {
        return false;
...
bool
trpgLabelPropertyTable::Read( trpgReadBuffer& buf )
{
    trpgLabelProperty property;
...
void
trpgLabel::SetProperty( int id )
{
    propertyId = id;
}

int
trpgLabel::GetProperty() const
{
    return propertyId;
}

void
trpgLabel::SetText( const std::string& inText )
{
    text = inText;
}

const std::string*
trpgLabel::GetText() const
{
    return &text;
}

void
trpgLabel::SetAlignment( AlignmentType inType )
{
    alignment = inType;
}

trpgLabel::AlignmentType
trpgLabel::GetAlignment() const
{
    return alignment;
}

void
trpgLabel::SetTab( int size )
{
    tabSize = size;
}

int
trpgLabel::GetTab( void ) const
{
    return tabSize;
}

void
trpgLabel::SetScale( float32 inScale )
{
    scale = inScale;
}

float32
trpgLabel::GetScale( void ) const
{
    return scale;
}

void
trpgLabel::SetThickness( float32 inThickness )
{
    thickness = inThickness;
}

float32
trpgLabel::GetThickness( void ) const
{
    return thickness;
}

void
trpgLabel::SetDesc( const std::string& inText )
{
    desc = inText;
}

const std::string*
trpgLabel::GetDesc() const
{
    return &desc;
}

void
trpgLabel::SetURL( const std::string& inText )
{
    url = inText;
}

const std::string*
trpgLabel::GetURL() const
{
    return &url;
}

void
trpgLabel::SetLocation( const trpg3dPoint& pt )
{
    location = pt;
}

const trpg3dPoint&
trpgLabel::GetLocation() const
{
    return location;
}

void
trpgLabel::AddSupport( const trpg3dPoint& pt )
{
    supports.push_back( pt );
}

const std::vector<trpg3dPoint>*
trpgLabel::GetSupports() const
{
    return &supports;
}

bool
trpgLabel::Write( trpgWriteBuffer& buf )
{
    unsigned int i;
...
bool
trpgLabel::Read( trpgReadBuffer& buf )
{
    int         numSupport, i;
    trpg3dPoint support;
    int         iVal;
