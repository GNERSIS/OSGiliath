...
TX_EXDECL class TX_CLDECL trpgManagedTile
{
    ...
    public:
        ...
        */
        bool
        ParseTileHeader( trpgReadBuffer& );
        ...
        */
        ...
        bool
        SetChildLocationInfo( int                    childIdx,
                              int                    x,
                              int                    y,
        ...
        GetChildLocationInfo( int childIdx ) const;
        bool
        GetChildTileLoc( int  childIdx,
                         int& x,
                         int& y,
                         int& lod ) const;
        const trpgwAppAddress&
        GetChildTileAddress( int childIdx ) const;
...
TX_EXDECL class TX_CLDECL trpgPageManager
{
    public:
        ...
        */
        ...
        virtual void
        AckLoad( const std::vector<TileLocationInfo>& children );
        ...
        */
        TX_EXDECL class TX_CLDECL LodPageInfo
        {
            ...
            protected:
                ...
                void
                AddChildrenToLoadList( std::vector<trpgManagedTile*>& parentList );

                // Check if the given tile is within the area we care about
                bool
                isWithin( trpgManagedTile*,
                          trpg2iPoint& sw,
                          trpg2iPoint& ne );
                ...
                void
                       GetLoadedTileWithin( double                         pagingDistance,
                ...
                */
                ...
                // Used by Update.  Here because we want to avoid memory allocs, if
                // possible.
...
TX_EXDECL class TX_CLDECL trpgr_ChildRefCB : public trpgr_Callback
{
    public:
        ...
        const trpgChildRef&
        GetChildRef( unsigned int idx ) const;
