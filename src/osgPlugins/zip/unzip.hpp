...
SetUnzipBaseDir( HZIP         hz,
                 const TCHAR* dir );
// if unzipping to a filename, and it's a relative filename, then it will be relative to
...
#define ZR_OK       0X00'00'00'00    // nb. the pseudo-code zr-recent is never returned,
#define ZR_RECENT   0X00'00'00'01    // but can be passed to FormatZipMessage.
// The following come from general system stuff (e.g. files not openable)
#define ZR_GENMASK  0X00'00'FF'00
#define ZR_NODUPH   0X00'00'01'00    // couldn't duplicate the handle
#define ZR_NOFILE   0X00'00'02'00    // couldn't create/open the file
#define ZR_NOALLOC  0X00'00'03'00    // failed to allocate some resource
#define ZR_WRITE    0X00'00'04'00    // a general error writing to the file
#define ZR_NOTFOUND 0X00'00'05'00    // couldn't find that file in the zip
#define ZR_MORE     0X00'00'06'00    // there's still more data to be unzipped
#define ZR_CORRUPT  0X00'00'07'00    // the zipfile is corrupt or not a zipfile
#define ZR_READ     0X00'00'08'00    // a general error reading the file
#define ZR_PASSWORD                                                        \
    0X00'00'10'00    // we didn't get the right password to unzip the file
// The following come from mistakes on the part of the caller
#define ZR_CALLERMASK 0X00'FF'00'00
#define ZR_ARGS       0X00'01'00'00    // general mistake with the arguments
#define ZR_NOTMMAP                                                                   \
    0X00'02'00'00    // tried to ZipGetMemory, but that only works on mmap zipfiles,
                     // which yours wasn't
#define ZR_MEMSIZE 0X00'03'00'00    // the memory size is too small
#define ZR_FAILED                                                                  \
    0X00'04'00'00    // the thing was already failed when you called this function
#define ZR_ENDED   0X00'05'00'00    // the zip creation has already been closed
#define ZR_MISSIZE 0X00'06'00'00    // the indicated input file size turned out mistaken
#define ZR_PARTIALUNZ 0X00'07'00'00    // the file had already been partially unzipped
#define ZR_ZMODE      0X00'08'00'00    // tried to mix creating/opening a zip
// The following come from bugs within the zip library itself
#define ZR_BUGMASK    0XFF'00'00'00
#define ZR_NOTINITED  0X01'00'00'00    // initialisation didn't work
#define ZR_SEEK       0X02'00'00'00    // trying to seek in an unseekable file
#define ZR_NOCHANGE   0X04'00'00'00    // changed its mind on storage, but not allowed
#define ZR_FLATE      0X05'00'00'00    // an internal error in the de/inflation code
