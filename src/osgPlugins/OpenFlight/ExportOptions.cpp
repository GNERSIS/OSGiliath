 ...
 * Utility functions for osgPlugins: enabled, _version, pos, version.
 */
//
...
namespace flt
{
    ...
    const int ExportOptions::VERSION_15_7( 1'570 );
    const int ExportOptions::VERSION_15_8( 1'580 );
    const int ExportOptions::VERSION_16_1( 1'610 );
    ...
    ExportOptions::parseOptionsString()
    {
        ...
        while( pos != str.npos )
        {
            ...
            {
                OSG_INFO << "fltexp: Token: " << token << ", Value: " << value
                         << std::endl;
                ...
                {
                    OSG_WARN << "fltexp: Unsupported version: " << value
                             << ". Defaulting to 16.1." << std::endl;
                }
            ...
            else if( token == _unitsOption )
            {
                ...
                {
                    OSG_WARN << "fltexp: Unsupported units: " << value
                             << ". Defaulting to METERS." << std::endl;
                }
            ...
            else if( token == _lightingOption )
            {
                ...
                {
                    OSG_WARN << "fltexp: Unsupported lighting value: " << value
