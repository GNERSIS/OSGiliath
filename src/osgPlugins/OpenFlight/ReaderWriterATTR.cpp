 ...
 * ReaderWriterATTR, derived from ReaderWriter.
 * Provides: supportsExtension, className, acceptsExtension, equalCaseInsensitive,
...
class ReaderWriterATTR : public osgDB::ReaderWriter
{
    public:
        ...
        readObject( const std::string& fileName,
                    const ReaderWriter::Options* ) const;
...
ReaderWriterATTR::readObject( const std::string&           file,
...
ReaderWriterATTR::writeObject( const osg::Object& object,
                               const std::string& fileName,
                               const Options* /*options*/ ) const
{
    using std::ios;
