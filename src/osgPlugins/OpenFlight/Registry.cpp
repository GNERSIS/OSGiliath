 ...
 * Registry — osgPlugins library implementation.
 */
//
...
void
Registry::addPrototype( int     opcode,
                        Record* prototype )
{
    if( prototype == 0L )
    {
    ...
    {
        OSG_DEBUG << "Registry already contains prototype for opcode " << opcode << "."
                  << std::endl;
    }
...
Record*
Registry::getPrototype( int opcode )
{
