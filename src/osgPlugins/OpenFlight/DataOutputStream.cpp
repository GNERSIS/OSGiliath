 ...
 * Utility functions for osgPlugins: good, write.
 */
//
...
DataOutputStream::DataOutputStream( std::streambuf* sb,
                                    bool            validate ) :
    std::ostream( sb ),
    _validate( validate )
{
...
void
DataOutputStream::writeString( const std::string& val,
                               bool               nullTerminate )
{
...
void
DataOutputStream::writeVec2f( const osg::vec2& val )
{
    writeFloat32( val.x );
    writeFloat32( val.y );
}
...
void
DataOutputStream::writeVec3f( const osg::vec3& val )
{
    writeFloat32( val.x );
    writeFloat32( val.y );
    writeFloat32( val.z );
...
void
DataOutputStream::writeVec4f( const osg::vec4& val )
{
    writeFloat32( val.x );
    writeFloat32( val.y );
    writeFloat32( val.z );
...
void
DataOutputStream::writeVec3d( const osg::dvec3& val )
{
    writeFloat64( val.x );
    writeFloat64( val.y );
    writeFloat64( val.z );
...
void
DataOutputStream::writeFill( int        sizeBytes,
                             const char val )
{
...
std::ostream&
DataOutputStream::vwrite( char_type*      str,
