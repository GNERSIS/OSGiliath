 ...
 * AttrData, derived from osg.
 * Provides: OSG_REGISTER_TYPE.
 */
//
...
namespace flt
{
    ...
    class AttrData : public osg::Inherit<osg::Object, AttrData>
    {
        public:

            OSG_REGISTER_TYPE( flt,
                               AttrData )

            AttrData();

            AttrData( const AttrData&    attr,
            ...
            int32 texEnvMode;          // Environment type
                                       ...
                                       //    3 - TV_COLOR
                                       //    4 - TV_ADD
            int32 intensityAsAlpha;    // TRUE if intensity pattern to be loaded in alpha
                                       // with white in color
