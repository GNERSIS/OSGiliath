 ...
 * Utility functions for osgPlugins: texels_u, minFilterMode, extFormat, useMips,
 * magFilterColor.
 */
//
...
AttrData::AttrData() :
    ...
    numSubtextures( 0 )
{
    of_mips[0] = of_mips[1] = of_mips[2] = of_mips[3] = of_mips[4] = of_mips[5] =
        of_mips[6] = of_mips[7] = 0.0F;
}

AttrData::AttrData( const AttrData&    attr,
