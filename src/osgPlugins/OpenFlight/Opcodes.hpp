 ...
 * Opcodes — osgPlugins library implementation.
 */
//
...
namespace flt
{
    ...
    // Note that INVALID_OP = -1 is not an actual opcode defined in the OpenFlight
    // format. The purpose of INVALID_OP is to mark an opcode variable as invalid or
    // uninitialized.
    enum Opcodes
    {
        INVALID_OP                         = -1,
