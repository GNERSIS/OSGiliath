...
#include <stdint.h>
    ...
    #define swr_convert( ctx, out, out_size, in, in_size )                       \
        avresample_convert( ctx, out, 0, out_size, ( uint8_t** )in, 0, in_size )
    #define swr_alloc_set_opts swr_alloc_set_opts_proxy

    #include <libavutil/opt.h>

    inline AVAudioResampleContext*
    swr_alloc_set_opts_proxy( SwrContext* /*ctx*/,
