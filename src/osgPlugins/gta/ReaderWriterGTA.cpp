...
class ReaderWriterGTA : public osgDB::ReaderWriter
{
    public:
        ...
        ReaderWriterGTA()
        {
            ...
            supportsOption( "COMPRESSION",
                            "Set compression method: NONE, ZLIB (default), "
                            "ZLIB1,...,ZLIB9, BZIP2, or XZ" );
        }
        ...
        ReadResult
        local_readImage( std::istream& fin,
                         const osgDB::ReaderWriter::Options* /* options */ ) const
        {
            ...
            try
            {
                ...
                pixelFormat = hdr.components() == 1 ? GL_RED
                            : hdr.components() == 2 ? GL_RG
                ...
                {
                    internalFormat = hdr.components() == 1 ? GL_R32F
                                   : hdr.components() == 2 ? GL_RG32F
        ...
        WriteResult
        local_writeImage( std::ostream&                       fout,
                          const osg::Image&                   img,
                          const osgDB::ReaderWriter::Options* options ) const
        {
            std::string my_errmsg;
