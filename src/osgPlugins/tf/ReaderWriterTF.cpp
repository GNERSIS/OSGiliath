 ...
 * ReaderWriterTF, derived from ReaderWriter.
 * Provides: supportsExtension, supportsExtension, className, readTransferFunction, str,
 * readObject.
 */
...
class ReaderWriterTF : public osgDB::ReaderWriter
{
    public:
        ...
        ReadResult
        readTransferFunction( std::istream& fin ) const
        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        *readline = 0;
                        ...
                        colorMap[osg::asciiToFloat( value.c_str() )] =
                            osg::vec4( osg::asciiToFloat( red.c_str() ),
                                       osg::asciiToFloat( green.c_str() ),
                                       osg::asciiToFloat( blue.c_str() ),
                                       osg::asciiToFloat( alpha.c_str() ) );
                    }
                }
            }
            ...
            // colorMap[value] =
            // osg::vec4(red*colorScale,green*colorScale,blue*colorScale,alpha*colorScale);
        ...
        virtual WriteResult
        writeTransferFunction( const osg::TransferFunction1D* tf,
                 ...
                 ++itr )
            {
                ...
                fout << itr->first << " " << c.r *
                    colorScale
                     << " " << c.g *
                    colorScale
                     << " " << c.b * colorScale << " " << c.a * colorScale << std::endl;
            }
        ...
        writeObject( const osg::Object& object,
                     ...
                     const osgDB::ReaderWriter::Options* ) const
        {
            const osg::TransferFunction1D* tf =
                dynamic_cast<const osg::TransferFunction1D*>( &object );
            if( !tf )
            {
