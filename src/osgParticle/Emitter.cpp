...
void
osgParticle::Emitter::setParticleSystem( ParticleSystem* ps )
{
    if( _ps == ps )
    {
        return;
    ...
    if( _ps )
    {
        _ps->adjustEstimatedMaxNumOfParticles( _estimatedMaxNumOfParticles );
    }
}

void
osgParticle::Emitter::setEstimatedMaxNumOfParticles( int num )
{
    if( _ps )
    {
        _ps->adjustEstimatedMaxNumOfParticles( num - _estimatedMaxNumOfParticles );
    }
