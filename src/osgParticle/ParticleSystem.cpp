...
void osgParticle::ParticleSystem::setDefaultAttributesUsingShaders(const std::string& texturefile, bool emissive_particles, int texture_unit)
{
    ...
    char vertexShaderSource[] =
        ...
        "    gl_PointSize = abs(particleScreenScale * osg_ProjectionMatrix[1][1] * worldSize / gl_Position.w);\n"
        "    \n"
    ...
    stateset->addUniform(new osg::FloatUniform("particleScreenScale", 480.0f * 0.5f));
    setStateSet(stateset);
