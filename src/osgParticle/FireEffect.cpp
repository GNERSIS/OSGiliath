...
FireEffect::FireEffect( const osg::vec3& position,
                        float            scale,
                        float            intensity )
{
    setDefaults();
...
FireEffect::FireEffect( const FireEffect&  copy,
...
FireEffect::setDefaults()
{
    ...
    _defaultParticleTemplate.setColorRange(
        osgParticle::rangev4( osg::vec4( 1, 0.8F, 0.2F, 1.0F ),
