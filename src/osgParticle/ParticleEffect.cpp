...
void
ParticleEffect::setUseLocalParticleSystem( bool local )
{
...
void
ParticleEffect::setTextureFileName( const std::string& filename )
{
...
void
ParticleEffect::setDefaultParticleTemplate( const Particle& p )
{
...
void
ParticleEffect::setPosition( const osg::vec3& position )
{
...
void
ParticleEffect::setScale( float scale )
{
    if( _scale == scale )
    {
        return;
...
void
ParticleEffect::setIntensity( float intensity )
{
...
void
ParticleEffect::setStartTime( double startTime )
{
...
void
ParticleEffect::setEmitterDuration( double duration )
{
...
void
ParticleEffect::setParticleDuration( double duration )
{
...
void
ParticleEffect::setWind( const osg::vec3& wind )
{
    if( _wind == wind )
    {
        return;
...
void
ParticleEffect::setParticleSystem( ParticleSystem* ps )
{
...
ParticleEffect::buildEffect()
{
    ...
    if( _useLocalParticleSystem )
    {
        particleSystem->setParticleScaleReferenceFrame(
            ParticleSystem::LOCAL_COORDINATES
        );
