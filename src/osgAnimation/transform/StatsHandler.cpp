 ...
 */
#include <osgAnimation/transform/StatsHandler.hpp>
...
namespace osgAnimation
{
    ...
    struct StatsGraph : public osg::MatrixTransform
    {
            ...
            {
                _pos = pos - osg::vec3( 0, _height, 0.1F );
                setMatrix( osg::dmat4( osg::translate( _pos ) ) );
            ...
            void
            changeYposition( float y )
            {
                _pos    = osg::vec3( osg::getTrans( getMatrix() ) );
                _pos[1] = y - _height;
                setMatrix( osg::dmat4( osg::translate( _pos ) ) );
            }
            ...
            {
                _statsGraphGeode->addDrawable( new Graph( _width,
                                                          _height,
                                                          viewerStats,
                                                          stats,
                                                          color,
            ...
            struct Graph : public osg::Geometry
            {
                           ...
                           const std::string& nameEnd = "" )
                    {
                        ...
                        getVertexArray()->setDataVariance(
                            osg::Object::DataVariance::DYNAMIC
                        );
                        setColor( color );

                        setUpdateCallback( new GraphUpdateCallback( width,
                                                                    height,
                                                                    viewerStats,
                                                                    stats,
                                                                    max,
            ...
            struct GraphUpdateCallback : public osg::DrawableUpdateCallback
            {
                    ...
                    GraphUpdateCallback( float              width,
                                         float              height,
                                         osg::Stats*        viewerStats,
                                         osg::Stats*        stats,
                                         float              max,
                            ...
                            osg::Drawable*    drawable )
                    {
                        ...
                        if( _nameEnd.empty() )
                        {
                            if( !_stats->getAttribute( _stats->getLatestFrameNumber(),
                                                       _nameBegin,
                                                       value ) )
                            {
                                value = 0.0;
                        ...
                        if( !vertices->size() )
                        {
                            ...
                            osg::DrawArrays* drawArrays = static_cast<osg::DrawArrays*>(
                        ...
                        unsigned int excedent =
                            static_cast<unsigned int>( vertices->size() ) - _width;
                        ...
                        if( _frameNumber != frameNumber )
                        {
                            ...
                            // graph, so this is OK...
                            osg::MatrixTransform* transform = geometry->getParent( 0 )
                                                                  ->getParent( 0 )
                                                                  ->asTransform()
                                                                  ->asMatrixTransform();
                            if( transform )
                            {
                                transform->setMatrix(
                                    transform->getMatrix() *
                                    osg::translate( osg::vec3( increment, 0, 0 ) )
                                );
                            }
                        }
    ...
    {
            ValueTextDrawCallback( osg::Stats*        stats,
    ...
    struct StatAction
    {
            ...
            {
                _lastTime = 0;
                _fade     = osgAnimation::OutCubicMotion( 0, 5 );
            }

            void
            init( osg::Stats*        stats,
                  const std::string& name,
                  const osg::vec3&   pos,
                  float              width,
                  float              heigh,
                  const osg::vec4&   color );
            void
            setPosition( const osg::vec3& pos );
#if 0
        void touch()
        {
    ...
    struct StatsTimeline : public osg::NodeCallback
    {
            ...
            osg::MatrixTransform*
            createStatsForTimeline( osgAnimation::Timeline* timeline )
            {
                _timeline = timeline;
                ...
                _group->setDataVariance( osg::Object::DataVariance::DYNAMIC );

                {
...

                    {
                        ...
                        timeLabelValue->setPosition( pos +
                                                     osg::vec3( startBlocks, 0, 0 ) );
                        timeLabelValue->setText( "0.0" );

                        timeLabelValue->setDrawCallback(
                            new ValueTextDrawCallback( stats.get(), "Timeline" )
                        );
                    }
                }
                {
                    ...
                    _background       = createBackgroundRectangle(
                        ...
                        ( 3.0F + 4.5F * 1.0F ) * characterSize + 2.0F * backgroundMargin,
                        backgroundColor
                    );
            ...
            updateGraph()
            {
                ...
                for( std::map<std::string, StatAction>::iterator it = _actions.begin();
                     it != _actions.end();
                     ++it )
                {
                ...
                for( std::size_t i = 0; i < channels.size(); i++ )
                {
                    ...
                    {
                        osg::vec4 color(
                            static_cast<float>( getRandomValueinRange( 255 ) / 255.0 ),
                            static_cast<float>( getRandomValueinRange( 255 ) / 255.0 ),
                            static_cast<float>( getRandomValueinRange( 255 ) / 255.0 ),
                            1.0F
                        );
                        _actions[name].init( visitor->getStats(),
                                             name,
                                             pos,
                                             width,
                                             height,
                ...
                osg::Vec3Array* array =
                    static_cast<osg::Vec3Array*>( _background->getVertexArray() );
                // float y = (*array)[0][1];
                // y = y - (pos.y + backgroundMargin); //(2 * backgroundMargin +
                // (size.size() * (characterSize + graphSpacing)));
                ( *array )[1][1] = pos.y;
                ( *array )[2][1] = pos.y;
                array->dirty();
    ...
    struct FindTimelineStats : public osg::DualModeVisitor
    {
            ...
            apply( osg::Node& node )
            {
                ...
                while( cb )
                {
                    osgAnimation::TimelineAnimationManager* tam =
                        dynamic_cast<osgAnimation::TimelineAnimationManager*>( cb );
                    if( tam )
                    {
                          ...
                          osgGA::GUIActionAdapter&      aa )
    {
        ...
        osgViewer::Viewer* viewer =
            dynamic_cast<osgViewer::Viewer*>( myview->getViewerBase() );
            ...
            case( osgGA::GUIEventAdapter::KEYDOWN ) :
                {
                    ...
                    if( ea.getKey() == _keyEventPrintsOutStats )
                    {
                        ...
                        if( !finder._timelines.empty() )
                        {
                            ...
                            for( unsigned int i = statsList[0]->getEarliestFrameNumber();
    ...
    StatsHandler::setUpHUDCamera( osgViewer::ViewerBase* viewer )
    {
        ...
        _camera->setProjectionMatrix(
            osg::ortho2D( 0.0, ( double )_statsWidth, 0.0, ( double )_statsHeight )
        );
        _camera->setReferenceFrame( osg::Transform::ABSOLUTE_RF );
        _camera->setViewMatrix( osg::dmat4() );

        // only clear the depth buffer
        _camera->setClearMask(
            0
        );    // GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); //-1);
    ...
    void
    StatsHandler::setUpScene( osgViewer::Viewer* viewer )
    {
        ...
        for( std::size_t i = 0; i < finder._timelines.size(); i++ )
        {
            StatsTimeline*        s = new StatsTimeline;
            osg::MatrixTransform* m =
                s->createStatsForTimeline( finder._timelines[i].get() );
            m->setUpdateCallback( s );
            m->setMatrix(
                osg::translate( 0.0, -static_cast<double>( i ) * 100.0, 0.0 )
            );
            _group->addChild( m );
        }
    }
    ...
    void
    StatAction::init( osg::Stats*        stats,
                      const std::string& name,
                      const osg::vec3&   pos,
                      float              width,
                      float              height,
                      const osg::vec4&   color )
    {
        ...
        _textLabel->setDataVariance( osg::Object::DataVariance::DYNAMIC );
        ...
        StatsGraph* graph = new StatsGraph( pos + osg::vec3( startBlocks, 0, 0 ),
                                            width - startBlocks,
                                            height );
    ...
    StatAction::setAlpha( float v )
    {
        ...
        {
            StatsGraph::Graph* g = static_cast<StatsGraph::Graph*>(
                _graph->_statsGraphGeode->getDrawable( 0 )
            );
            g->setColor( color );
        }
    }
    ...
    void
    StatAction::setPosition( const osg::vec3& pos )
    {
        float characterSize = 20.0F;
