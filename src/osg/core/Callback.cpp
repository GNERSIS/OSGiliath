...
//
bool
Callback::traverse( Object* object,
                    Object* data )
{
...
//
bool
CallbackObject::run( osg::Object* object,
                     osg::Object* data )
{
...
//
bool
NodeCallback::run( osg::Object* object,
                   osg::Object* data )
{
    osg::Node*        node = object ? object->asNode() : 0;
    osg::NodeVisitor* nv   = data ? data->asNodeVisitor() : 0;
...
void
NodeCallback::operator()( Node*        node,
                          NodeVisitor* nv )
{
...
//
bool
StateAttributeCallback::run( osg::Object* object,
                             osg::Object* data )
{
...
//
bool
UniformCallback::run( osg::Object* object,
                      osg::Object* data )
{
...
//
bool
DrawableUpdateCallback::run( osg::Object* object,
                             osg::Object* data )
{
...
bool
DrawableEventCallback::run( osg::Object* object,
                            osg::Object* data )
{
    osg::Drawable*    drawable = object->asDrawable();
    osg::NodeVisitor* nv       = data->asNodeVisitor();
...
bool
DrawableCullCallback::cull( osg::NodeVisitor* nv,
...
//
void
UniformCallback::operator()( UniformBase* ub,
                             NodeVisitor* nv )
{
