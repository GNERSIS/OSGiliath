...
namespace osg
{
    ...
    ApplicationUsageProxy
        Texture_e1( ApplicationUsage::ENVIRONMENTAL_VARIABLE,
                    "OSG_GL_TEXTURE_STORAGE",
                    "ON|OFF or ENABLE|DISABLE, Enables/disables usage of glTexStorage "
                    "for textures where supported, default is ENABLED." );
    ...
    InternalPixelRelations sizedInternalFormats[] = {
        ...
        // { GL_RGB10_A2UI_EXT                      , GL_RGBA_INTEGER_EXT ,
        ...
        // { GL_RGB9_E5                             , GL_RGB              ,
        // GL_UNSIGNED_INT_9_9_9_5,                     } , { GL_RGB9_E5 , GL_RGB ,
        // GL_UNSIGNED_INT_5_9_9_9_REV,                 } , { GL_RGB9_E5 , GL_RGB ,
        // GL_HALF_FLOAT                                } , { GL_RGB9_E5 , GL_RGB ,
        // GL_FLOAT                                     } , { GL_R11F_G11F_B10F , GL_RGB
    ...
    InternalPixelRelations sizedDepthAndStencilInternalFormats[] = {
        ...
        // GL_UNSIGNED_INT_24_8                         } , { GL_DEPTH32F_STENCIL8 ,
    ...
    InternalPixelRelations compressedInternalFormats[] = {
        ...
        {       GL_COMPRESSED_SIGNED_RED_RGTC1_EXT,
         GL_RED,        GL_COMPRESSED_SIGNED_RED_RGTC1_EXT                                            },
        ...
        {   GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT,
         GL_RGBA,    GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT                                           },
        {   GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT,
         GL_RGBA,    GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT                                           },
        {   GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT,
         GL_RGBA,    GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT                                           },
        ...
        {        GL_COMPRESSED_RGBA_ASTC_10x10_KHR,
         GL_RGBA,         GL_COMPRESSED_RGBA_ASTC_10x10_KHR                                           },
        {        GL_COMPRESSED_RGBA_ASTC_12x10_KHR,
         GL_RGBA,         GL_COMPRESSED_RGBA_ASTC_12x10_KHR                                           },
        {        GL_COMPRESSED_RGBA_ASTC_12x12_KHR,
         GL_RGBA,         GL_COMPRESSED_RGBA_ASTC_12x12_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR                                           },
        {  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR,
         GL_RGBA,   GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR                                           },
        { GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR,
         GL_RGBA,  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR                                           },
        { GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR,
         GL_RGBA,  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR                                           },
        { GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR,
         GL_RGBA,  GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR                                           },
        {GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR,
         GL_RGBA, GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR                                           },
        {GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR,
         GL_RGBA, GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR                                           },
        {GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR,
         GL_RGBA, GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR                                           }
    };

    bool
    isSizedInternalFormat( GLint internalFormat )
    {
        const size_t formatsCount =
            sizeof( sizedInternalFormats ) / sizeof( sizedInternalFormats[0] );
    ...
    GLenum
    assumeSizedInternalFormat( GLint  internalFormat,
                               GLenum type )
    {
        const size_t formatsCount =
            sizeof( sizedInternalFormats ) / sizeof( sizedInternalFormats[0] );
        ...
        {
            if( internalFormat ==
                sizedInternalFormats[i].internalFormat &&
                type == sizedInternalFormats[i].type )
            {
    ...
    bool
    isCompressedInternalFormatSupportedByTexStorage( GLint internalFormat )
    {
        const size_t formatsCount =
            sizeof( compressedInternalFormats ) / sizeof( compressedInternalFormats[0] );

        for( size_t i = 0; i < formatsCount; ++i )
        {
            if( ( GLenum )internalFormat ==
                compressedInternalFormats[i].sizedInternalFormat )
            {
                return true;
            }
        }
    ...
    void
    Texture::TextureObject::bind( osg::State& /*state*/ )
    {
    ...
    void
    Texture::TextureObject::setAllocated( GLint   numMipmapLevels,
                                          ...
                                          GLint   border )
    {
                    ...
                    border ) )
        {
            ...
            _profile
                .set( numMipmapLevels, internalFormat, width, height, depth, border );
    ...
    void
    Texture::TextureProfile::computeSize()
    {
            ...
            case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR :
                {
                    ...
                    for( int i = 0; i < std::max( _numMipmapLevels, 1 ); ++i )
                    {
                        GLint blockSize;
                        GLint size;
                        getCompressedSize( _internalFormat,
                                           _width / ( 1 << i ),
                                           _height / ( 1 << i ),
                                           _depth,
                                           blockSize,
        ...
        _size = static_cast<unsigned int>(
            ceil( double( static_cast<unsigned int>( _width ) *
                          static_cast<unsigned int>( _height ) *
                          static_cast<unsigned int>( _depth ) *
                          static_cast<unsigned int>( numBitsPerTexel ) ) /
                  8.0 )
        );
        ...
        // OSG_NOTICE<<"TO ("<<_width<<", "<<_height<<", "<<_depth<<") size="<<_size<<"
        // numBitsPerTexel="<<numBitsPerTexel<<std::endl;
    }
    ...
    //
    TextureObjectSet::TextureObjectSet( TextureObjectManager*          parent,
    ...
    bool
    TextureObjectSet::checkConsistency() const
    {
        ...
        while( to != 0 )
        {
            ...
            if( to->_next )
            {
                ...
                {
                    OSG_NOTICE << "TextureObjectSet::checkConsistency() : Error "
                                  "(to->_next)->_previous != to "
                               << std::endl;
                    return false;
                }
            }
            else
            {
                ...
                {
                    OSG_NOTICE
                        << "TextureObjectSet::checkConsistency() : Error _tail != to"
                        << std::endl;
                    return false;
                }
            }
        ...
        unsigned int totalNumber =
            numInList + static_cast<unsigned int>( _orphanedTextureObjects.size() );
        if( totalNumber != _numOfTextureObjects )
        {
            OSG_NOTICE << "Error numInList + _orphanedTextureObjects.size() != "
                          "_numOfTextureObjects"
                       << std::endl;
            OSG_NOTICE << "    numInList = " << numInList << std::endl;
            OSG_NOTICE << "    _orphanedTextureObjects.size() = "
                       << _orphanedTextureObjects.size() << std::endl;
            OSG_NOTICE << "    _pendingOrphanedTextureObjects.size() = "
                       << _pendingOrphanedTextureObjects.size() << std::endl;
            OSG_NOTICE << "    _numOfTextureObjects = " << _numOfTextureObjects
                       << std::endl;
            return false;
        }
    ...
    void
    TextureObjectSet::handlePendingOrphandedTextureObjects()
    {
        ...
        unsigned int numOrphaned =
            static_cast<unsigned int>( _pendingOrphanedTextureObjects.size() );

        for( Texture::TextureObjectList::iterator itr =
                 _pendingOrphanedTextureObjects.begin();
        ...
        // update the TextureObjectManager's running total of active + orphaned
        // TextureObjects
    ...
    void
    TextureObjectSet::deleteAllTextureObjects()
    {
...

        {
            ...
            if( !_pendingOrphanedTextureObjects.empty() )
            {
                // OSG_NOTICE<<"TextureObjectSet::flushDeletedTextureObjects(..) handling
                // orphans"<<std::endl;
    ...
    void
    TextureObjectSet::discardAllTextureObjects()
    {
    ...
    TextureObjectSet::flushAllDeletedTextureObjects()
    {
             ...
             ++itr )
        {
            ...
            // OSG_NOTICE<<"    Deleting textureobject ptr="<<itr->get()<<"
            // id="<<id<<std::endl;
            glDeleteTextures( 1L, &id );
        }

        unsigned int numDeleted =
            static_cast<unsigned int>( _orphanedTextureObjects.size() );
    ...
    void
    TextureObjectSet::discardAllDeletedTextureObjects()
    {
        ...
        // just clear the list as there is nothing else we can do with them when
        // discarding them
        _orphanedTextureObjects.clear();
    }

    void
    TextureObjectSet::flushDeletedTextureObjects( double /*currentTime*/,
                                                  double& availableTime )
    {
        ...
        if( _profile._size !=
            0 &&
            _parent->getCurrTexturePoolSize() <= _parent->getMaxTexturePoolSize() )
        {
        ...
        unsigned int maxNumObjectsToDelete =
            _profile._size != 0
                ? static_cast<unsigned int>( ceil( double( sizeRequired ) /
                                                   double( _profile._size ) ) )
                : static_cast<unsigned int>( _orphanedTextureObjects.size() );

        OSG_INFO << "_parent->getCurrTexturePoolSize()="
                 << _parent->getCurrTexturePoolSize()
                 << " _parent->getMaxTexturePoolSize()="
                 << _parent->getMaxTexturePoolSize() << std::endl;
        OSG_INFO << "Looking to reclaim " << sizeRequired << ", going to look to remove "
                 << maxNumObjectsToDelete << " from " << _orphanedTextureObjects.size()
                 << " orphans" << std::endl;
        ...
        for( ; itr !=
               _orphanedTextureObjects.end() &&
               timer.elapsedTime() <
               availableTime &&
               numDeleted < maxNumObjectsToDelete;
             ++itr )
        {
        ...
        // OSG_NOTICE<<", after = "<<_orphanedTextureObjects.size()<<" numDeleted =
        // "<<numDeleted<<std::endl;
    ...
    bool
    TextureObjectSet::makeSpace( unsigned int& size )
    {
        {
            std::lock_guard<std::mutex> lock( _mutex );
            if( !_pendingOrphanedTextureObjects.empty() )
            {
                // OSG_NOTICE<<"TextureObjectSet::TextureObjectSet::makeSpace(..)
                // handling orphans"<<std::endl;
                handlePendingOrphandedTextureObjects();
            }
        }
    ...
    TextureObjectSet::takeFromOrphans( Texture* texture )
    {
        ...
        OSG_INFO << "Reusing orphaned TextureObject, _numOfTextureObjects="
                 << _numOfTextureObjects << std::endl;

        return to;
    }

    osg::ref_ptr<Texture::TextureObject>
    TextureObjectSet::takeOrGenerate( Texture* texture )
    {
        ...
        // see if we can reuse TextureObject by taking the least recently used active
        // TextureObject
            ...
            ( _head->_frameLastUsed < minFrameNumber ) )
        {
            ...
            {
                original_texture->setTextureObject( _contextID, 0 );
                OSG_INFO << "TextureObjectSet=" << this
                         << ": Reusing an active TextureObject " << to.get()
                         << " _numOfTextureObjects=" << _numOfTextureObjects
                         << " width=" << _profile._width
                         << " height=" << _profile._height << std::endl;
            }
            else
            {
                OSG_INFO << "Reusing a recently orphaned active TextureObject "
                         << to.get() << std::endl;
            }
        ...
        //
        GLuint id;
        glCreateTextures( _profile._target, 1, &id );

        osg::ref_ptr<Texture::TextureObject> to =
            new Texture::TextureObject( const_cast<Texture*>( texture ), id, _profile );
        to->_set = this;
        ++_numOfTextureObjects;
        ...
        OSG_INFO << "Created new " << this << " TextureObject, _numOfTextureObjects "
                 << _numOfTextureObjects << std::endl;
    ...
    void
    TextureObjectSet::moveToBack( Texture::TextureObject* to )
    {
#if 0
    ...
    OSG_NOTICE<<"    before to->_next = "<<to->_next<<std::endl;
        ...
        if( _tail == 0 )
        {
            OSG_NOTICE << "Error ***************** Should not get here !!!!!!!!!"
                       << std::endl;
            _head = to;
            _tail = to;
            return;
        ...
        if( to->_next == 0 )
        {
            OSG_NOTICE << "Error ***************** Should not get here either !!!!!!!!!"
                       << std::endl;
            return;
        }
    ...
    void
    TextureObjectSet::addToBack( Texture::TextureObject* to )
    {
#if 0
    ...
    void
    TextureObjectSet::orphan( Texture::TextureObject* to )
    {
        ...
        // will be removed from the active list, and then placed in the
        // orhpanTextureObject list.  This double buffered approach to handling orphaned
        // TO's is used to avoid having to mutex the process of appling active TO's.
    ...
    void
    TextureObjectSet::remove( Texture::TextureObject* to )
    {
        if( to->_previous != 0 )
        {
            ( to->_previous )->_next = to->_next;
    ...
    void
    TextureObjectSet::moveToSet( Texture::TextureObject* to,
    ...
    unsigned int
    TextureObjectSet::computeNumTextureObjectsInList() const
    {
        unsigned int            num = 0;
    ...
    TextureObjectManager::TextureObjectManager( unsigned int contextID ) :
        GraphicsObjectManager( "TextureObjectManager",
                               contextID ),
    ...
    void
    TextureObjectManager::setMaxTexturePoolSize( unsigned int size )
    {
        ...
        {
            OSG_NOTICE << "Warning: new MaxTexturePoolSize=" << size
                       << " is smaller than current TexturePoolSize="
                       << _currTexturePoolSize << std::endl;
        }
    ...
    bool
    TextureObjectManager::makeSpace( unsigned int size )
    {
    ...
    osg::ref_ptr<Texture::TextureObject>
    TextureObjectManager::generateTextureObject( const Texture* texture,
                                                 GLenum         target )
    {
                                                 ...
                                                 GLint          border )
    {
        ...
        Texture::TextureProfile profile( target,
                                         numMipmapLevels,
                                         internalFormat,
                                         width,
                                         height,
    ...
    Texture::generateAndAssignTextureObject( unsigned int contextID,
                                             GLenum       target ) const
    {
        _textureObjectBuffer[contextID] =
            generateTextureObject( this, contextID, target );
    ...
    Texture::generateAndAssignTextureObject( unsigned int contextID,
                                             ...
                                             GLint        border ) const
    {
        _textureObjectBuffer[contextID] = generateTextureObject( this,
                                                                 contextID,
                                                                 target,
                                                                 numMipmapLevels,
                                                                 internalFormat,
    ...
    TextureObjectSet*
    TextureObjectManager::getTextureObjectSet( const Texture::TextureProfile& profile )
    {
        osg::ref_ptr<TextureObjectSet>& tos = _textureSetMap[profile];
        if( !tos )
        {
            tos = new TextureObjectSet( this, profile );
        }
        return tos.get();
    }

    void
    TextureObjectManager::handlePendingOrphandedTextureObjects()
    {
        for( TextureSetMap::iterator itr = _textureSetMap.begin();
    ...
    void
    TextureObjectManager::deleteAllGLObjects()
    {
        for( TextureSetMap::iterator itr = _textureSetMap.begin();
             itr != _textureSetMap.end();
             ++itr )
    ...
    void
    TextureObjectManager::discardAllGLObjects()
    {
        for( TextureSetMap::iterator itr = _textureSetMap.begin();
             itr != _textureSetMap.end();
             ++itr )
    ...
    void
    TextureObjectManager::flushAllDeletedGLObjects()
    {
        for( TextureSetMap::iterator itr = _textureSetMap.begin();
             itr != _textureSetMap.end();
             ++itr )
    ...
    void
    TextureObjectManager::discardAllDeletedGLObjects()
    {
        for( TextureSetMap::iterator itr = _textureSetMap.begin();
             itr != _textureSetMap.end();
             ++itr )
    ...
    void
    TextureObjectManager::flushDeletedGLObjects( double  currentTime,
                                                 double& availableTime )
    {
        for( TextureSetMap::iterator itr = _textureSetMap.begin();
    ...
    void
    TextureObjectManager::newFrame( osg::FrameStamp* fs )
    {
        if( fs )
        {
    ...
    void
    TextureObjectManager::reportStats( std::ostream& out )
    {
        double numFrames( _numFrames == 0 ? 1.0 : _numFrames );
        out << "TextureObjectMananger::reportStats()" << std::endl;
        out << "   total _numOfTextureObjects=" << _numActiveTextureObjects
            << ", _numOrphanedTextureObjects=" << _numOrphanedTextureObjects
            << " _currTexturePoolSize=" << _currTexturePoolSize << std::endl;
        out << "   total _numGenerated=" << _numGenerated
            << ", _generateTime=" << _generateTime << ", averagePerFrame="
            << _generateTime / numFrames * 1000.0 << "ms" << std::endl;
        out << "   total _numDeleted=" << _numDeleted << ", _deleteTime=" << _deleteTime
            << ", averagePerFrame="
            << _deleteTime / numFrames * 1000.0 << "ms" << std::endl;
        out << "   getMaxTexturePoolSize()=" << getMaxTexturePoolSize()
            << " current/max size = " << double( _currTexturePoolSize ) /
            double( getMaxTexturePoolSize() )
            << std::endl;
        recomputeStats( out );
    }

    void
    TextureObjectManager::resetStats()
    {
        _numFrames    = 0;
        _numDeleted   = 0;
        _deleteTime   = 0;
    ...
    void
    TextureObjectManager::recomputeStats( std::ostream& out ) const
    {
             ...
             ++itr )
        {
            ...
            currentSize +=
                os->getProfile()._size *
                ( os->computeNumTextureObjectsInList() + os->getNumOrphans() );
            out << "   size=" << os->getProfile()._size
                << ", os->computeNumTextureObjectsInList()"
                << os->computeNumTextureObjectsInList()
        ...
        out << "   numObjectsInLists=" << numObjectsInLists
            << ", numActive=" << numActive << ", numOrphans=" << numOrphans
            << " currentSize=" << currentSize << std::endl;
        out << "   getMaxTexturePoolSize()=" << getMaxTexturePoolSize()
            << " current/max size = "
            << double( currentSize ) / double( getMaxTexturePoolSize() ) << std::endl;
        if( currentSize != _currTexturePoolSize )
        {
            out << "   WARNING: _currTexturePoolSize(" << _currTexturePoolSize
                << ") != currentSize, delta = "
                << int( _currTexturePoolSize ) - int( currentSize ) << std::endl;
        }
    }

    bool
    TextureObjectManager::checkConsistency() const
    {
        unsigned int currentSize = 0;
        for( TextureSetMap::const_iterator itr = _textureSetMap.begin();
             itr != _textureSetMap.end();
    ...
    osg::ref_ptr<Texture::TextureObject>
    Texture::generateTextureObject( const Texture* texture,
                                    unsigned int   contextID,
                                    GLenum         target )
    {
        return osg::get<TextureObjectManager>( contextID )
            ->generateTextureObject( texture, target );
    }
    ...
    int
    Texture::compareTexture( const Texture& rhs ) const
    {
        COMPARE_StateAttribute_Parameter( _wrap_s )
            ...
            // only compare _internalFomat is it has already been set in both lhs, and
            // rhs
    ...
    int
    Texture::compareTextureObjects( const Texture& rhs ) const
    {
    ...
    void
    Texture::setWrap( WrapParameter which,
                      WrapMode      wrap )
    {
        switch( which )
        {
            ...
            case WRAP_R :
                ...
                break;
            default :
                OSG_WARN << "Error: invalid 'which' passed Texture::setWrap("
                         << ( unsigned int )which << "," << ( unsigned int )wrap << ")"
                         << std::endl;
                break;
        }
    }
    ...
    Texture::WrapMode
    Texture::getWrap( WrapParameter which ) const
    {
        switch( which )
        {
            case WRAP_S :
            ...
            case WRAP_R :
                return _wrap_r;
            default :
                OSG_WARN << "Error: invalid 'which' passed Texture::getWrap(which)"
                         << std::endl;
                return _wrap_s;
        }
    }
    ...
    void
    Texture::setFilter( FilterParameter which,
                        FilterMode      filter )
    {
        switch( which )
        {
            ...
            case MAG_FILTER :
                ...
                break;
            default :
                OSG_WARN << "Error: invalid 'which' passed Texture::setFilter("
    ...
    Texture::FilterMode
    Texture::getFilter( FilterParameter which ) const
    {
        switch( which )
        {
            case MIN_FILTER :
            ...
            case MAG_FILTER :
                return _mag_filter;
            default :
                OSG_WARN << "Error: invalid 'which' passed Texture::getFilter(which)"
                         << std::endl;
                return _min_filter;
        }
    }
    ...
    void
    Texture::setMaxAnisotropy( float anis )
    {
    ...
    void
    Texture::computeInternalFormatWithImage( const osg::Image& image ) const
    {
        ...
        else
        {
            ...
            const unsigned int contextID =
                0;    // state.getContextID();  // set to 0 right now, assume same
                      // parameters for each graphics context...
        ...
        // Map legacy numeric internal format values to core profile formats
    ...
    void
    Texture::computeInternalFormatType() const
    {
    ...
    bool
    Texture::isCompressedInternalFormat() const
    {
        return isCompressedInternalFormat( getInternalFormat() );
    }

    bool
    Texture::isCompressedInternalFormat( GLint internalFormat )
    {
        switch( internalFormat )
        {
    ...
    void
    Texture::getCompressedSize( GLenum internalFormat,
                                GLint  width,
                                GLint  height,
                                GLint  depth,
                                GLint& blockSize,
                                GLint& size )
    {
        ...
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 4.0 ) * ceil( height / 4.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 5.0 ) * ceil( height / 4.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 5.0 ) * ceil( height / 5.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 6.0 ) * ceil( height / 5.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 6.0 ) * ceil( height / 6.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 8.0 ) * ceil( height / 5.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 8.0 ) * ceil( height / 6.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 8.0 ) * ceil( height / 8.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 10.0 ) * ceil( height / 5.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 10.0 ) * ceil( height / 6.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 10.0 ) * ceil( height / 8.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 10.0 ) * ceil( height / 10.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 12.0 ) * ceil( height / 10.0 ) * blockSize
            );
            return;
        }
        else if( internalFormat ==
                 ...
                 internalFormat == GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR )
        {
            blockSize = 16;
            size      = static_cast<GLint>(
                ceil( width / 12.0 ) * ceil( height / 12.0 ) * blockSize
            );
            return;
        }
        else
        {
            OSG_WARN << "Texture::getCompressedSize(...) : cannot compute correct size "
                        "of compressed format ("
                     << internalFormat << ") returning 0." << std::endl;
            blockSize = 0;
        }
    ...
    void
    Texture::applyTexParameters( GLenum target,
                                 State& state ) const
    {
        ...
        // DSA: use texture object ID directly instead of bind-then-modify
        const GLuint texId = to ? to->id() : 0;
        if( texId == 0 )
        {
            OSG_WARN << "Texture::applyTexParameters: no valid texture object for DSA"
                     << std::endl;
            ...
            Image::computeNumberOfMipmapLevels( image->s(), image->t(), image->r() ) )
        {
            glTextureParameteri( texId,
                                 ...
                                 image->getNumMipmapLevels() - 1 );
        }

        glTextureParameteri( texId, GL_TEXTURE_WRAP_S, ws );

        if( target != GL_TEXTURE_1D )
        {
            glTextureParameteri( texId, GL_TEXTURE_WRAP_T, wt );
        }

        if( target == GL_TEXTURE_3D )
        {
            glTextureParameteri( texId, GL_TEXTURE_WRAP_R, wr );
        }

        glTextureParameteri( texId, GL_TEXTURE_MIN_FILTER, _min_filter );
        glTextureParameteri( texId, GL_TEXTURE_MAG_FILTER, _mag_filter );
        ...
        {
            // Apply luminance-broadcasting swizzle for 1-channel and 2-channel formats
            // when the user hasn't overridden the default swizzle.
            // This replicates the old GL_LUMINANCE/GL_LUMINANCE_ALPHA behavior at zero
            // runtime cost.
            bool isDefaultSwizzle = ( _swizzle[0] ==
                                      GL_RED &&
                                      _swizzle[1] ==
                                      GL_GREEN &&
                                      _swizzle[2] ==
            ...
            if( isDefaultSwizzle )
            {
                switch( _internalFormat )
                {
                    // 1-channel formats: replicate RED to RGB, alpha = 1
                    case GL_RED :
                    case GL_R8 :
                    case GL_R8_SNORM :
                    case GL_R16 :
                    ...
                    case GL_COMPRESSED_SIGNED_RED_RGTC1_EXT :
                        {
                            ...
                            glTextureParameteriv( texId,
                                                  GL_TEXTURE_SWIZZLE_RGBA,
                                                  swizzle );
                            break;
                        }

                    // 2-channel formats: replicate RED to RGB, alpha from GREEN
                    case GL_RG :
                    case GL_RG8 :
                    case GL_RG8_SNORM :
                    case GL_RG16 :
            ...
            {
                // User has set a custom swizzle, use it directly
                glTextureParameteriv( texId, GL_TEXTURE_SWIZZLE_RGBA, _swizzle.data() );
            }
        }
        ...
        if( extensions->isTextureBorderClampSupported )
        {
            ...
            {
                GLint color[4] = {
                    ( GLint )_borderColor.r,
                    ( GLint )_borderColor.g,
                    ( GLint )_borderColor.b,
                    ( GLint )_borderColor.a
                };
                glTextureParameterIiv( texId, GL_TEXTURE_BORDER_COLOR, color );
            }
            else if( _internalFormatType == UNSIGNED_INTEGER )
            {
                GLuint color[4] = {
                    ( GLuint )_borderColor.r,
                    ( GLuint )_borderColor.g,
                    ( GLuint )_borderColor.b,
                    ( GLuint )_borderColor.a
                };
                glTextureParameterIuiv( texId, GL_TEXTURE_BORDER_COLOR, color );
            }
            else
            {
                GLfloat color[4] = {
                    ( GLfloat )_borderColor.r,
                    ( GLfloat )_borderColor.g,
                    ( GLfloat )_borderColor.b,
                    ( GLfloat )_borderColor.a
                };
                glTextureParameterfv( texId, GL_TEXTURE_BORDER_COLOR, color );
            }
        }

        // integer textures are not supported by the shadow
        // GL_TEXTURE_1D_ARRAY_EXT could be included in the check below but its not yet
        // implemented in OSG
            ...
            _internalFormatType != UNSIGNED_INTEGER )
        {
            ...
            {
                glTextureParameteri( texId, GL_TEXTURE_COMPARE_MODE_ARB, GL_NONE );
            }
        }
        // if range is valid
        if( _maxlod - _minlod >= 0 )
        {
            glTextureParameterf( texId, GL_TEXTURE_MIN_LOD, _minlod );
            glTextureParameterf( texId, GL_TEXTURE_MAX_LOD, _maxlod );
        }

        if( extensions->isTextureLODBiasSupported )
        {
            glTextureParameterf( texId, GL_TEXTURE_LOD_BIAS, _lodbias );
        }
    ...
    void
    Texture::computeRequiredTextureDimensions( State&            state,
                                               ...
                                               GLsizei&          numMipmapLevels ) const
    {
        ...
        {
            width  = Image::computeNearestPowerOfTwo( image.s() - 2 * _borderWidth ) +
                     2 *
                     _borderWidth;
            height = Image::computeNearestPowerOfTwo( image.t() - 2 * _borderWidth ) +
                     2 *
                     _borderWidth;
        }
        ...
        {
            numMipmapLevels = static_cast<GLsizei>( image.getNumMipmapLevels() );
        }
        else
        {
            numMipmapLevels = 1;
        ...
        // "<<image.s()<<" image.t()="<<image.t()<<" width="<<width<<"
        // height="<<height<<" numMipmapLevels="<<numMipmapLevels<<std::endl;
        // OSG_NOTICE<<"  _resizeNonPowerOfTwoHint="<<_resizeNonPowerOfTwoHint<<"
        // extensions->isNonPowerOfTwoTextureSupported(_min_filter)="<<extensions->isNonPowerOfTwoTextureSupported(_min_filter)
        // <<std::endl;
    }

    bool
    Texture::areAllTextureObjectsLoaded() const
    {
        for( unsigned int i = 0;
             i < DisplaySettings::instance()->getMaxNumberOfGraphicsContexts();
             ++i )
        {
    ...
    GLenum
    Texture::selectSizedInternalFormat( const osg::Image* image ) const
    {
        if( image )
        {
            bool compressed_image = isCompressedInternalFormat(
                static_cast<GLint>( image->getPixelFormat() )
            );
            ...
            if( compressed_image )
            {
                ...
                {
                    return static_cast<GLenum>( _internalFormat );
                }
                else
                {
                    return 0;
            ...
            else
            {
                ...
                {
                    return assumeSizedInternalFormat( image->getInternalTextureFormat(),
                                                      image->getDataType() );
                }
            }
        }
        else
        {
            ...
            return assumeSizedInternalFormat( _internalFormat,
                                              ( _sourceType != 0 ) ? _sourceType
                                                                   : GL_UNSIGNED_BYTE );
        }
    }

    void
    Texture::applyTexImage2D_load( State&       state,
                                   GLenum       target,
                                   const Image* image,
                                   GLsizei      inwidth,
                                   GLsizei      inheight,
                                   GLsizei      numMipmapLevels ) const
    {
        ...
        OSG_NOTICE << "glTexImage2D pixelFormat = " << std::hex
        ...
        bool                compressed_image =
            isCompressedInternalFormat( static_cast<GLint>( image->getPixelFormat() ) );
        ...
        {
            OSG_NOTICE << "Received a request to compress an image, but image size is "
                          "not a multiple of four ("
                       << inwidth << "x" << inheight
                       << "). Reverting to uncompressed.\n";
            switch( _internalFormat )
            {
                case GL_COMPRESSED_RGB_S3TC_DXT1_EXT :
                case GL_COMPRESSED_SRGB_S3TC_DXT1_EXT :
        ...
        // OSG_NOTICE<<"inwidth="<<inwidth<<" inheight="<<inheight<<"
        // image->getFileName()"<<image->getFileName()<<std::endl;
        ...
        if( needImageRescale )
        {
            ...
            if( image->isMipmap() )
            {
                OSG_WARN << "Warning:: Mipmapped osg::Image not a power of two, cannot "
                            "apply to texture."
                         << std::endl;
                return;
            }
            ...
            {
                OSG_WARN << "Warning:: Compressed osg::Image not a power of two, cannot "
                            "apply to texture."
                         << std::endl;
                return;
            }

            unsigned int newTotalSize = osg::Image::computeRowWidthInBytes(
                                            inwidth,
                                            image->getPixelFormat(),
                                            image->getDataType(),
                                            static_cast<int>( image->getPacking() )
                                        ) *
                                        static_cast<unsigned int>( inheight );
            dataPtr                   = new unsigned char[newTotalSize];

            if( !dataPtr )
            {
                OSG_WARN << "Warning:: Not enough memory to resize image, cannot apply "
                            "to texture."
                         << std::endl;
                return;
            }
            ...
            {
                OSG_NOTICE << "Scaling image '" << image->getFileName() << "' from ("
                           << image->s() << "," << image->t() << ") to (" << inwidth
                           << "," << inheight << ")" << std::endl;
            }
            else
            {
                OSG_NOTICE << "Scaling image from (" << image->s() << "," << image->t()
                           << ") to (" << inwidth << "," << inheight << ")" << std::endl;
            }

            PixelStorageModes psm;
            psm.pack_alignment   = static_cast<GLint>( image->getPacking() );
            psm.pack_row_length  = static_cast<GLint>( image->getRowLength() );
            psm.unpack_alignment = static_cast<GLint>( image->getPacking() );
        ...
        bool useGluBuildMipMaps =
            mipmappingRequired && ( !useHardwareMipMapGeneration && !image->isMipmap() );
        ...
        if( !mipmappingRequired || useHardwareMipMapGeneration )
        {
            ...
            GenerateMipmapMode mipmapResult =
                mipmapBeforeTexImage( state, useHardwareMipMapGeneration );
        ...
        else
        {
            ...
            if( image->isMipmap() )
            {
                ...
                GLenum texStorageSizedInternalFormat =
                    extensions->isTexStorage2DSupported() && ( _borderWidth == 0 )
                ...
                if( texStorageSizedInternalFormat != 0 )
                {
                    if( getTextureTarget() == GL_TEXTURE_CUBE_MAP )
                    {
                        ...
                        {
                            extensions->glTexStorage2D( GL_TEXTURE_CUBE_MAP,
                                                        numMipmapLevels,
                    ...
                    else if( extensions->isCompressedTexImage2DSupported() )
                    {
                             ...
                             k++ )
                        {
                            ...
                            getCompressedSize(
                                static_cast<GLenum>( image->getInternalTextureFormat() ),
                                width,
                                height,
                                1,
                                blockSize,
            ...
            else
            {
                ...
                {
                    OSG_WARN << "Warning:: Compressed image cannot be mip mapped"
                             << std::endl;
                }
            }
        }
        ...
        OSG_NOTICE << "glTexImage2D " << delta_time << "ms  total " << s_total_time
                   << "ms" << std::endl;
#endif
                                      ...
                                      GLint        numMipmapLevels ) const
    {
...
#ifdef DO_TIMING
        osg::Timer_t start_tick = osg::Timer::instance()->tick();
        OSG_NOTICE << "glTexSubImage2D pixelFormat = " << std::hex
                   << image->getPixelFormat() << std::dec << std::endl;
#endif
        ...
        if( !mipmappingRequired || useHardwareMipMapGeneration )
        {
            ...
            else if( extensions->isCompressedTexImage2DSupported() )
            {
                ...
                extensions->glCompressedTexSubImage2D( target,
                                                       0,
                                                       0,
                                                       0,
                                                       inwidth,
        ...
        else
        {
                ...
                else if( extensions->isCompressedTexImage2DSupported() )
                {
                    ...
                    for( GLsizei k = 0; k < numMipmapLevels && ( width || height ); k++ )
                    {
                        ...
                        extensions->glCompressedTexSubImage2D(
                            ...
                            size,
                            dataPtr +
                                image->getMipmapOffset( static_cast<unsigned int>( k ) )
                        );
            ...
            {
                // OSG_WARN<<"Warning:: cannot subload mip mapped texture from non
                // mipmapped image."<<std::endl;
                applyTexImage2D_load( state,
                                      target,
                                      image,
                                      inwidth,
    ...
    bool
    Texture::isHardwareMipmapGenerationEnabled( const State& state ) const
    {
    ...
    Texture::GenerateMipmapMode
    Texture::mipmapBeforeTexImage( const State& /*state*/,
    ...
    void
    Texture::mipmapAfterTexImage( State&             state,
    ...
    void
    Texture::generateMipmap( State& state ) const
    {
        const unsigned int contextID = state.getContextID();
        ...
        // if internal format does not provide automatic mipmap generation, then do
        // manual allocation
        if( _internalFormatType ==
            SIGNED_INTEGER ||
            _internalFormatType == UNSIGNED_INTEGER )
        {
    ...
    void
    Texture::compileGLObjects( State& state ) const
    {
        apply( state );
    }

    void
    Texture::resizeGLObjectBuffers( unsigned int maxSize )
    {
    ...
    void
    Texture::releaseGLObjects( State* state ) const
    {
        // if (state) OSG_NOTICE<<"Texture::releaseGLObjects
        // contextID="<<state->getContextID()<<std::endl; else
        // OSG_NOTICE<<"Texture::releaseGLObjects no State "<<std::endl;
