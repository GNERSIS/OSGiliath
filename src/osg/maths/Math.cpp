...
double
osg::asciiToDouble( const char* str )
{
    const char* ptr = str;
    ...
    else
    {
        ...
        // OSG_NOTICE<<"Read "<<str<<" mantissa = "<<mantissa<<" exponent="<<exponent<<"
        // result = "<<mantissa*pow(10.0,exponent)<<std::endl;
        return mantissa * pow( 10.0, exponent );
    }
}

double
osg::findAsciiToDouble( const char* str )
{
    const char* ptr   = str;
    double      value = 0.0;
