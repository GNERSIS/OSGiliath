...
// dmat4 decomposition code taken from Graphics Gems IV
...
namespace MatrixDecomposition
{
    ...
    typedef struct
    {
            osg::dvec4 t;    // Translation Component;
    ...
    HVect
    spectDecomp( _HMatrix S,
                 _HMatrix U );
    quat
    snuggle( quat   q,
             HVect* k );
    double
                    polarDecomp( _HMatrix M,
                                 _HMatrix Q,
                                 _HMatrix S );
...
#define caseMacro( i, j, k, I, J, K )                                         \
    ...
    /******* Decompose Affine dmat4 *******/

    /* Decompose 4x4 affine matrix A as TFRUK(U transpose), where t contains the
     * translation components, q contains the rotation R, u contains U, k contains
     * scale factors, and f contains the sign of the determinant.
     * Assumes A transforms column vectors in right-handed coordinates.
     * See Ken Shoemake and Tom Duff. dmat4 Animation and Polar Decomposition.
     * Proceedings of Graphics Interface 1992.
     */
    void
    decompAffine( _HMatrix      A,
                  _affineParts* parts )
    {
        _HMatrix Q, S, U;
        quat     p;
        ...
        parts->t   = osg::dvec4( A[X][W], A[Y][W], A[Z][W], 0 );
     ...
     * Fast Polar Decomposition of An Arbitrary dmat4,
...
#define TOL 1.0E-6
        ...
        do
        {
            ...
            gamma     = sqrt( sqrt( ( MadjT_one * MadjT_inf ) / ( M_one * M_inf ) ) /
                              fabs( det ) );
            g1        = gamma * 0.5;
            g2        = 0.5 / ( gamma * det );
            matrixCopy( Ek, =, Mk, 3 );
     ...
     * See Gene H. Golub and Charles F. Van Loan. dmat4 Computations. Hopkins 1983.
     */
    HVect
    spectDecomp( _HMatrix S,
                 _HMatrix U )
...
void
osg::mat4::decompose( osg::dvec3& t,
                      osg::quat&  r,
                      osg::dvec3& s,
                      osg::quat&  so ) const noexcept
{
...
void
osg::dmat4::decompose( osg::vec3& t,
                       osg::quat& r,
                       osg::vec3& s,
                       osg::quat& so ) const noexcept
{
...
void
osg::dmat4::decompose( osg::dvec3& t,
                       osg::quat&  r,
                       osg::dvec3& s,
                       osg::quat&  so ) const noexcept
{
