...
// simply define GLAPIENTRY as nothing so that we can keep function signatures the same
// as declaration.
#define GLAPIENTRY
...
namespace osg
{
    ...
    static int
    gluBuild1DMipmapLevelsCore( GLenum,
                                GLint,
                                GLsizei,
                                GLsizei,
                                GLenum,
                                ...
                                const void* );
    static int
    gluBuild2DMipmapLevelsCore( GLenum,
                                GLint,
                                GLsizei,
                                GLsizei,
                                GLsizei,
                                ...
                                const void* );
    static int
    gluBuild3DMipmapLevelsCore( GLTexImage3DProc gluTexImage3D,
                                GLenum,
                                GLint,
                                GLsizei,
                                GLsizei,
    ...
    image_size( GLint  width,
                ...
                GLenum type );
    static void
    fill_image( const PixelStorageModes*,
                GLint       width,
                GLint       height,
                GLenum      format,
                GLenum      type,
                ...
                GLushort*   newimage );
    static void
    empty_image( const PixelStorageModes*,
                 GLint           width,
                 GLint           height,
                 GLenum          format,
                 GLenum          type,
                 ...
                 void*           userdata );
    static void
    scale_internal( GLint           components,
                    GLint           widthin,
                    GLint           heightin,
    ...
    static void
    scale_internal_ubyte( GLint          components,
                          GLint          widthin,
                          GLint          heightin,
                          const GLubyte* datain,
                          GLint          widthout,
                          GLint          heightout,
                          GLubyte*       dataout,
                          GLint          element_size,
                          ...
                          GLint          group_size );
    static void
    scale_internal_byte( GLint         components,
                         GLint         widthin,
                         GLint         heightin,
                         const GLbyte* datain,
                         GLint         widthout,
                         ...
                         GLint         group_size );
    static void
    scale_internal_ushort( GLint           components,
                           GLint           widthin,
                           GLint           heightin,
                           const GLushort* datain,
                           GLint           widthout,
                           ...
                           GLint           myswap_bytes );
    static void
    scale_internal_short( GLint          components,
                          GLint          widthin,
                          GLint          heightin,
                          const GLshort* datain,
                          GLint          widthout,
                          GLint          heightout,
                          GLshort*       dataout,
                          GLint          element_size,
                          ...
                          GLint          myswap_bytes );
    static void
    scale_internal_uint( GLint         components,
                         GLint         widthin,
                         GLint         heightin,
                         const GLuint* datain,
                         GLint         widthout,
                         ...
                         GLint         myswap_bytes );
    static void
    scale_internal_int( GLint        components,
                        GLint        widthin,
                        GLint        heightin,
                        const GLint* datain,
                        GLint        widthout,
                        ...
                        GLint        myswap_bytes );
    static void
                     scale_internal_float( GLint          components,
                                           GLint          widthin,
                                           GLint          heightin,
                                           const GLfloat* datain,
                                           GLint          widthout,
                                           GLint          heightout,
                                           GLfloat*       dataout,
                                           GLint          element_size,
    ...
    static int       checkMipmapArgs( GLenum,
                                      GLenum,
                                      GLenum );
    static GLboolean legalFormat( GLenum );
    static GLboolean legalType( GLenum );
    static GLboolean isTypePackedPixel( GLenum );
    static GLboolean isLegalFormatForPackedPixelType( GLenum,
                                                      GLenum );
    static GLboolean isLegalLevels( GLint,
                                    GLint,
                                    GLint,
                                    GLint );
    static void
    ...
    extract1010102( int,
                    ...
                    GLfloat[] );
    static void
    shove1010102( const GLfloat[],
                  int,
                  void* );
    static void
    extract2101010rev( int,
                       const void*,
                       GLfloat[] );
    static void
    shove2101010rev( const GLfloat[],
                     int,
                     void* );
    static void
    scaleInternalPackedPixel( int,
                              void ( * )( int,
                                          const void*,
                                          GLfloat[] ),
                              void ( * )( const GLfloat[],
    ...
    static GLint imageSize3D( GLint,
                              GLint,
                              GLint,
                              GLenum,
                              GLenum );
    static void
    fillImage3D( const PixelStorageModes*,
                 GLint,
                 GLint,
                 GLint,
                 GLenum,
                 ...
                 GLushort* );
    static void
    emptyImage3D( const PixelStorageModes*,
                  GLint,
                  GLint,
                  GLint,
                  GLenum,
    ...
    {
        // Default Settings set from values specified in glGet docs in the OpenGL red
        // book.
        pack_alignment      = 4;
        pack_row_length     = 0;
        pack_skip_rows      = 0;
    ...
    void
    PixelStorageModes::retrieveStoreModes()
    {
    ...
    void
    PixelStorageModes::retrieveStoreModes3D()
    {
        glGetIntegerv( GL_UNPACK_ALIGNMENT, &unpack_alignment );
        glGetIntegerv( GL_UNPACK_ROW_LENGTH, &unpack_row_length );
        glGetIntegerv( GL_UNPACK_SKIP_ROWS, &unpack_skip_rows );
...
#define __GLU_SWAP_2_BYTES( s )                                  \
    ( GLushort )( ( ( GLushort )( ( const GLubyte* )( s ) )[1] ) \
                  << 8 | ( ( const GLubyte* )( s ) )[0] )
...
#define __GLU_SWAP_4_BYTES( s )                                      \
                ...
                GLushort*       dataout )
    {
        ...
        newwidth  = width / 2;
        newheight = height / 2;
        delta     = static_cast<int>( width ) * components;
        s         = dataout;
        t         = datain;
        ...
        for( i = 0; i < newheight; i++ )
        {
            for( j = 0; j < newwidth; j++ )
            {
                ...
                {
                    s[0] =
                        ( t[0] + t[components] + t[delta] + t[delta + components] + 2 ) /
                        4;
                    s++;
                    t++;
                }
    ...
    static void
    halveImage_ubyte( GLint          components,
                      GLuint         width,
                      GLuint         height,
                      const GLubyte* datain,
                      GLubyte*       dataout,
                      ...
                      GLint          group_size )
    {
        ...
        newwidth  = width / 2;
        newheight = height / 2;
        padBytes  = ysize - ( static_cast<int>( width ) * group_size );
        s         = dataout;
        t         = ( const char* )datain;
            ...
            for( j = 0; j < newwidth; j++ )
            {
                for( k = 0; k < components; k++ )
                {
                    s[0] = ( *( const GLubyte* )t +
                             ...
                             *( const GLubyte* )( t + ysize + group_size ) +
                             2 ) /
                           4;
                    s++;
                    t += element_size;
    ...
    /* */
    static void
    halve1Dimage_ubyte( GLint          components,
                        GLuint         width,
                        GLuint         height,
                        const GLubyte* dataIn,
                        GLubyte*       dataOut,
                        ...
                        GLint          group_size )
    {
        ...
        {                                    /* 1 row */
            ...
            {
                int padBytes  = ysize - ( static_cast<int>( width ) * group_size );
        ...
        {                          /* 1 column */
            ...
            for( jj = 0; jj < halfHeight; jj++ )
            {
                ...
                {
                    *dest =
                        ( *( const GLubyte* )src + *( const GLubyte* )( src + ysize ) ) /
                        2;
    ...
    static void
    halveImage_byte( GLint         components,
                     GLuint        width,
                     GLuint        height,
                     const GLbyte* datain,
                     GLbyte*       dataout,
            ...
            for( j = 0; j < newwidth; j++ )
            {
                for( k = 0; k < components; k++ )
                {
                    s[0] = ( *( const GLbyte* )t +
                             ...
                             *( const GLbyte* )( t + ysize + group_size ) +
                             2 ) /
                           4;
                    s++;
                    t += element_size;
    ...
    static void
    halve1Dimage_byte( GLint         components,
                       GLuint        width,
                       GLuint        height,
                       const GLbyte* dataIn,
                       GLbyte*       dataOut,
                       ...
                       GLint         group_size )
    {
        ...
        {                                    /* 1 row */
            ...
            for( jj = 0; jj < halfWidth; jj++ )
            {
                ...
                for( kk = 0; kk < components; kk++ )
                {
                    *dest  = ( *( const GLbyte* )src +
                               *( const GLbyte* )( src + group_size ) ) /
                             2;
        ...
        {                          /* 1 column */
            ...
            for( jj = 0; jj < halfHeight; jj++ )
            {
                ...
                {
                    *dest =
                        ( *( const GLbyte* )src + *( const GLbyte* )( src + ysize ) ) /
                        2;
    ...
    static void
    halveImage_ushort( GLint           components,
                       GLuint          width,
                       GLuint          height,
                       const GLushort* datain,
                       GLushort*       dataout,
                       ...
                       GLint           myswap_bytes )
    {
        ...
        {
            assert( !( width == 1 && height == 1 ) ); /* can't be 1x1 */
            halve1Dimage_ushort( components,
                                 width,
                                 height,
                                 datain,
                                 dataout,
                ...
                for( j = 0; j < newwidth; j++ )
                {
                    for( k = 0; k < components; k++ )
                    {
                        s[0] = ( *( const GLushort* )t +
                                 ...
                                 *( const GLushort* )( t + ysize + group_size ) +
                                 2 ) /
                               4;
                        s++;
                        t += element_size;
                ...
                for( j = 0; j < newwidth; j++ )
                {
                    for( k = 0; k < components; k++ )
                    {
                        s[0] = ( __GLU_SWAP_2_BYTES( t ) +
                                 ...
                                 __GLU_SWAP_2_BYTES( t + ysize + group_size ) +
                                 2 ) /
                               4;
                        s++;
                        t += element_size;
    ...
    static void
    halve1Dimage_ushort( GLint           components,
                         GLuint          width,
                         GLuint          height,
                         const GLushort* dataIn,
                         GLushort*       dataOut,
...
#define BOX2 2
    ...
    static void
    halveImage_short( GLint          components,
                      GLuint         width,
                      GLuint         height,
                      const GLshort* datain,
                      GLshort*       dataout,
                ...
                for( j = 0; j < newwidth; j++ )
                {
                    for( k = 0; k < components; k++ )
                    {
                        s[0] = ( *( const GLshort* )t +
                                 ...
                                 *( const GLshort* )( t + ysize + group_size ) +
                                 2 ) /
                               4;
                        s++;
                        t += element_size;
    ...
    static void
    halve1Dimage_short( GLint          components,
                        GLuint         width,
                        GLuint         height,
                        const GLshort* dataIn,
                        GLshort*       dataOut,
...
#define BOX2 2
                    ...
                    if( myswap_bytes )
                    {
                        sshort[0] = static_cast<GLshort>( __GLU_SWAP_2_BYTES( src ) );
                        sshort[1] = static_cast<GLshort>(
                            __GLU_SWAP_2_BYTES( src + group_size )
                        );
                    }
                    else
                    {
...
#define BOX2 2
                    ...
                    if( myswap_bytes )
                    {
                        sshort[0] = static_cast<GLshort>( __GLU_SWAP_2_BYTES( src ) );
                        sshort[1] =
                            static_cast<GLshort>( __GLU_SWAP_2_BYTES( src + ysize ) );
                    }
                    else
                    {
                        sshort[0] = *( const GLshort* )src;
    ...
    static void
    halveImage_uint( GLint         components,
                     GLuint        width,
                     GLuint        height,
                     const GLuint* datain,
                     GLuint*       dataout,
    ...
    /* */
    static void
    halve1Dimage_uint( GLint         components,
                       GLuint        width,
                       GLuint        height,
                       const GLuint* dataIn,
                       GLuint*       dataOut,
...
#define BOX2 2
    ...
    static void
    halveImage_int( GLint        components,
                    GLuint       width,
                    GLuint       height,
                    const GLint* datain,
                    GLint*       dataout,
                    ...
                    for( k = 0; k < components; k++ )
                    {
                        s[0] = GLint(
                            ( ( float )*( const GLint* )t +
                              ...
                              ( float )*( const GLint* )( t + ysize + group_size ) ) /
                            4 +
                            0.5
                        );
                        s++;
            ...
            for( i = 0; i < newheight; i++ )
            {
                for( j = 0; j < newwidth; j++ )
                {
                    for( k = 0; k < components; k++ )
                    {
                        ...
                        buf   = static_cast<GLfloat>( *( GLint* )&b );
    ...
    /* */
    static void
    halve1Dimage_int( GLint        components,
                      GLuint       width,
                      GLuint       height,
                      const GLint* dataIn,
                      GLint*       dataOut,
...
#define BOX2 2
    ...
    static void
    halveImage_float( GLint          components,
                      GLuint         width,
                      GLuint         height,
                      const GLfloat* datain,
                      GLfloat*       dataout,
                ...
                for( j = 0; j < newwidth; j++ )
                {
                    for( k = 0; k < components; k++ )
                    {
                        s[0] = ( *( const GLfloat* )t +
                                 ...
                                 *( const GLfloat* )( t + ysize + group_size ) ) /
                               4;
                        s++;
                        t += element_size;
                    }
    ...
    /* */
    static void
    halve1Dimage_float( GLint          components,
                        GLuint         width,
                        GLuint         height,
                        const GLfloat* dataIn,
                        GLfloat*       dataOut,
...
#define BOX2 2
                    ...
                    if( myswap_bytes )
                    {
                        sfloat[0] = static_cast<GLfloat>( __GLU_SWAP_4_BYTES( src ) );
                        sfloat[1] = static_cast<GLfloat>(
                            __GLU_SWAP_4_BYTES( src + group_size )
                        );
                    }
                    else
                    {
...
#define BOX2 2
                    ...
                    if( myswap_bytes )
                    {
                        sfloat[0] = static_cast<GLfloat>( __GLU_SWAP_4_BYTES( src ) );
                        sfloat[1] =
                            static_cast<GLfloat>( __GLU_SWAP_4_BYTES( src + ysize ) );
                    }
                    else
                    {
                        sfloat[0] = *( const GLfloat* )src;
                    ...
                    GLushort*       dataout )
    {
        ...
        if( widthin == widthout * 2 && heightin == heightout * 2 )
        {
            halveImage( components,
                        static_cast<GLuint>( widthin ),
                        static_cast<GLuint>( heightin ),
                        datain,
                        dataout );
            return;
        }
        convy     = static_cast<float>( heightin ) / static_cast<float>( heightout );
        convx     = static_cast<float>( widthin ) / static_cast<float>( widthout );
        halfconvx = convx / 2;
        halfconvy = convy / 2;
        for( i = 0; i < heightout; i++ )
        {
            y = convy * ( static_cast<float>( i ) + 0.5F );
            ...
            {
                x = convx * ( static_cast<float>( j ) + 0.5F );
                if( widthin > widthout )
                {
                    highx = x + halfconvx;
                    lowx  = x - halfconvx;
                ...
                */
                ...
                while( y < highy )
                {
                    ...
                    if( highy < static_cast<float>( yint + 1 ) )
                    {
                        ypercent = highy - y;
                    }
                    else
                    {
                        ypercent = static_cast<float>( yint ) + 1 - y;
                    }
                    ...
                    while( x < highx )
                    {
                        ...
                        if( highx < static_cast<float>( xint + 1 ) )
                        {
                            xpercent = highx - x;
                        }
                        else
                        {
                            xpercent = static_cast<float>( xint ) + 1 - x;
                        }
                          ...
                          GLint          group_size )
    {
        ...
        convy_float = convy - static_cast<float>( convy_int );
        convx_int   = int( floor( convx ) );
        convx_float = convx - static_cast<float>( convx_int );
        ...
        for( i = 0; i < heightout; i++ )
        {
            ...
            for( j = 0; j < widthout; j++ )
            {
                ...
                */
                ...
                {
                    percent =
                        ( highy_float - lowy_float ) * ( highx_float - lowx_float );
                    temp = ( const char* )datain + xindex + lowy_int * ysize;
                    for( k = 0, temp_index  = temp; k < components;
                         k++, temp_index   += element_size )
                    {
                ...
                if( ( highy_int > lowy_int ) && ( highx_int > lowx_int ) )
                {
                    ...
                    for( m = lowy_int + 1; m < highy_int; m++ )
                    {
                             ...
                             k++, left += element_size, right += element_size )
                        {
                            if( myswap_bytes )
                            {
                                totals[k] += __GLU_SWAP_2_BYTES( left ) *
                                             ( 1 - lowx_float ) +
                            ...
                            {
                                totals[k] += *( const GLushort* )left *
                                             ( 1 - lowx_float ) +
                                           *( const GLushort* )right *
                                             highx_float;
                            }
                        }
                    }
                ...
                */
                ...
                if( ( highy_int > lowy_int ) && ( highx_int > lowx_int ) )
                {
                         ...
                         k++, temp_index   += element_size )
                    {
                        ...
                        {
                            totals[k] +=
                                static_cast<float>( __GLU_SWAP_4_BYTES( temp_index ) ) *
                                percent;
                        }
                        else
                        {
                            totals[k] +=
                                static_cast<float>( *( const GLuint* )temp_index ) *
                                percent;
                        }
                    }
                    left = temp;
                    ...
                    for( m = lowy_int + 1; m < highy_int; m++ )
                    {
                             ...
                             k++, left += element_size, right += element_size )
                        {
                            ...
                            {
                                totals[k] +=
                                    static_cast<float>( __GLU_SWAP_4_BYTES( left ) ) *
                                    ( 1 - lowx_float ) +
                                    static_cast<float>( __GLU_SWAP_4_BYTES( right ) ) *
                                    highx_float;
                            }
                            else
                            {
                                totals[k] +=
                                    static_cast<float>( *( const GLuint* )left ) *
                                    ( 1 - lowx_float ) +
                                    static_cast<float>( *( const GLuint* )right ) *
                                    highx_float;
                            }
                        }
                    }
                ...
                if( ( highy_int > lowy_int ) && ( highx_int > lowx_int ) )
                {
                         ...
                         k++, temp_index   += element_size )
                    {
                        if( myswap_bytes )
                        {
                            ...
                            totals[k] +=
                                static_cast<float>( *( const GLint* )&swapbuf ) *
                                percent;
                        }
                        else
                        {
                            totals[k] +=
                                static_cast<float>( *( const GLint* )temp_index ) *
                                percent;
                        }
                    }
                    left = temp;
                    ...
                    for( m = lowy_int + 1; m < highy_int; m++ )
                    {
                             ...
                             k++, left += element_size, right += element_size )
                        {
                            ...
                            {
                                totals[k] +=
                                    static_cast<float>( *( const GLint* )left ) *
                                    ( 1 - lowx_float ) +
                                    static_cast<float>( *( const GLint* )right ) *
                                    highx_float;
                            }
                        }
                    }
    ...
    static int
    checkMipmapArgs( GLenum /*internalFormat*/,
                     GLenum format,
                     GLenum type )
    {
                ...
                GLint* newHeight )
    {
        ...
        {
            GLint widthPowerOf2  = nearestPower( static_cast<GLuint>( width ) );
            GLint heightPowerOf2 = nearestPower( static_cast<GLuint>( height ) );
            GLint proxyWidth;

            do
            {
                /* compute level 1 width & height, clamping each at 1 */
                GLint widthAtLevelOne =
                    ( widthPowerOf2 > 1 ) ? widthPowerOf2 >> 1 : widthPowerOf2;
                GLint heightAtLevelOne =
                    ( heightPowerOf2 > 1 ) ? heightPowerOf2 >> 1 : heightPowerOf2;
                GLenum proxyTarget;
                ...
                glGetTexLevelParameteriv( proxyTarget,
                                          1,
                                          GL_TEXTURE_WIDTH,
                                          &proxyWidth );
                /* does it fit??? */
        ...
        *newWidth = nearestPower( static_cast<GLuint>( width ) );
        if( *newWidth > maxsize )
        {
            *newWidth = maxsize;
        }
        *newHeight = nearestPower( static_cast<GLuint>( height ) );
                   ...
                   void*              dataout )
    {
        ...
        beforeImage = ( GLushort* )malloc(
            image_size( widthin, heightin, format, GL_UNSIGNED_SHORT )
        );
        afterImage = ( GLushort* )malloc(
            image_size( widthout, heightout, format, GL_UNSIGNED_SHORT )
        );
        ...
        fill_image( psm,
                    ...
                    format,
                    typein,
                    static_cast<GLboolean>( is_index( format ) ),
                    datain,
                    beforeImage );
    ...
    int
    gluBuild1DMipmapLevelsCore( GLenum      target,
                                GLint       internalFormat,
                                GLsizei     width,
                                ...
                                const void* data )
    {
        ...
        assert( checkMipmapArgs( static_cast<GLenum>( internalFormat ), format, type ) ==
                0 );
        assert( width >= 1 );
        ...
        newwidth    = widthPowerOf2;
        levels      = computeLog( static_cast<GLuint>( newwidth ) );

        levels     += userLevel;

        psm.retrieveStoreModes();
        newImage =
            ( GLushort* )malloc( image_size( width, 1, format, GL_UNSIGNED_SHORT ) );
                            ...
                            const void* data )
    {
        ...
        int rc = checkMipmapArgs( static_cast<GLenum>( internalFormat ), format, type );
        if( rc != 0 )
        {
            return rc;
        }
        ...
        levels  = computeLog( static_cast<GLuint>( width ) );
        ...
        return gluBuild1DMipmapLevelsCore( target,
                                           internalFormat,
                                           width,
                                           width,
                                           format,
                       ...
                       const void* data )
    {
        ...
        closestFit( target,
                    ...
                    &widthPowerOf2,
                    &dummy );
        levels = computeLog( static_cast<GLuint>( widthPowerOf2 ) );
    ...
    static int
    bitmapBuild2DMipmaps( GLenum      target,
                          GLint       internalFormat,
                          GLint       width,
                          GLint       height,
                          GLenum      format,
                          ...
                          const void* data )
    {
        ...
        closestFit( target,
                    ...
                    &newheight );
        levels = computeLog( static_cast<GLuint>( newwidth ) );
        level  = computeLog( static_cast<GLuint>( newheight ) );
        if( level > levels )
        {
            levels = level;
        }
        ...
        otherImage = NULL;
        newImage   = ( GLushort* )malloc(
            image_size( width, height, format, GL_UNSIGNED_SHORT )
        );
        newImage_width  = width;
...
#define __GLU_SWAP_IMAGE( a, b )   \
    ...
    static int
    gluBuild2DMipmapLevelsCore( GLenum      target,
                                GLint       internalFormat,
                                GLsizei     width,
                                GLsizei     height,
                                GLsizei     widthPowerOf2,
                                ...
                                const void* data )
    {
        ...
        if( type == GL_BITMAP )
        {
            return bitmapBuild2DMipmaps( target,
                                         internalFormat,
                                         width,
                                         height,
                                         format,
        ...
        usersImage = ( const GLubyte* )data +
                     psm.unpack_skip_rows *
                     rowsize +
                     psm.unpack_skip_pixels *
                     group_size;
            ...
            else
            {
                switch( type )
                {
                    case GL_UNSIGNED_BYTE :
                        ...
                        break;
                    case GL_BYTE :
                        halveImage_byte( cmpts,
                                         static_cast<GLuint>( width ),
                                         static_cast<GLuint>( height ),
                                         ( const GLbyte* )usersImage,
                                         ( GLbyte* )dstImage,
                                         element_size,
                                         rowsize,
                                         group_size );
                        break;
                    case GL_UNSIGNED_SHORT :
                        halveImage_ushort( cmpts,
                                           static_cast<GLuint>( width ),
                                           static_cast<GLuint>( height ),
                                           ( const GLushort* )usersImage,
                                           ( GLushort* )dstImage,
                                           element_size,
                                           rowsize,
                                           group_size,
                        ...
                        break;
                    case GL_SHORT :
                        halveImage_short( cmpts,
                                          static_cast<GLuint>( width ),
                                          static_cast<GLuint>( height ),
                                          ( const GLshort* )usersImage,
                                          ( GLshort* )dstImage,
                                          element_size,
                                          rowsize,
                                          group_size,
                        ...
                        break;
                    case GL_UNSIGNED_INT :
                        halveImage_uint( cmpts,
                                         static_cast<GLuint>( width ),
                                         static_cast<GLuint>( height ),
                                         ( const GLuint* )usersImage,
                                         ( GLuint* )dstImage,
                                         element_size,
                                         rowsize,
                                         group_size,
                    ...
                    case GL_INT :
                        ...
                        break;
                    case GL_FLOAT :
                        halveImage_float( cmpts,
                                          static_cast<GLuint>( width ),
                                          static_cast<GLuint>( height ),
                                          ( const GLfloat* )usersImage,
                                          ( GLfloat* )dstImage,
                                          element_size,
                                          rowsize,
                                          group_size,
        ...
        for( ; level <= levels; level++ )
        {
            switch( type )
            {
                case GL_UNSIGNED_BYTE :
                    halveImage_ubyte( cmpts,
                                      static_cast<GLuint>( newwidth ),
                                      static_cast<GLuint>( newheight ),
                                      ( GLubyte* )srcImage,
                                      ( GLubyte* )dstImage,
                                      element_size,
                                      rowsize,
            ...
            }
            {
                ...
                { /* yes, row should be padded */
                    ...
                    int ii;
                    unsigned char *dstTrav, *srcTrav; /* indices for copying */

                    /* allocate new image for mipmap of size newRowLength x newheight */
                    void*          newMipmapImage =
                        malloc( ( size_t )( newRowLength * newheight ) );
                    ...
                    for( ii      = 0,
                         ...
                         srcTrav += rowsize )
                    {                             /* ...is skipped */
                        memcpy( dstTrav, srcTrav, static_cast<size_t>( rowsize ) );
                            ...
                            const void* data )
    {
        ...
        levels = computeLog( static_cast<GLuint>( width ) );
        level  = computeLog( static_cast<GLuint>( height ) );
        if( level > levels )
        {
            levels = level;
        }
        ...
        return gluBuild2DMipmapLevelsCore( target,
                                           internalFormat,
                                           width,
                                           height,
                                           width,
                       ...
                       const void* data )
    {
        ...
        levels = computeLog( static_cast<GLuint>( widthPowerOf2 ) );
        level  = computeLog( static_cast<GLuint>( heightPowerOf2 ) );
        if( level > levels )
        {
            levels = level;
        }
...
*/
    ...
    */
                ...
                GLenum type )
    {
        ...
        assert( width > 0 );
        assert( height > 0 );
        components = static_cast<size_t>( elements_per_group( format, type ) );
        if( type == GL_BITMAP )
        {
            bytes_per_row = static_cast<size_t>( ( width + 7 ) / 8 );
        }
        else
        {
            bytes_per_row =
                size_t( bytes_per_element( type ) * static_cast<float>( width ) );
        }
        return bytes_per_row * static_cast<size_t>( height ) * components;
    }
    ...
    */
    static void
    fill_image( const PixelStorageModes* psm,
                GLint                    width,
                GLint                    height,
                GLenum                   format,
                GLenum                   type,
                ...
                GLushort*                newimage )
    {
        ...
        else
        {
                ...
                for( j = 0; j < elements_per_line; j++ )
                {
                    ...
                    switch( type )
                    {
                        case GL_UNSIGNED_BYTE_3_3_2 :
                            ...
                            for( k = 0; k < 3; k++ )
                            {
                                *iter2++ = ( GLushort )( extractComponents[k] * 65'535 );
                            }
                            break;
                        case GL_UNSIGNED_BYTE_2_3_3_REV :
                        ...
                        case GL_BYTE :
                            ...
                            {
                                *iter2++ =
                                    static_cast<GLushort>( *( ( const GLbyte* )iter ) );
                            }
                            else
                            {
                                /* rough approx */
                                *iter2++ = static_cast<GLushort>(
                        ...
                        case GL_SHORT :
                            ...
                            if( type == GL_SHORT )
                            {
                                if( index_format )
                                {
                                    *iter2++ = static_cast<GLushort>( widget.s[0] );
                                }
                                else
                                {
                                    /* rough approx */
                                    *iter2++ = static_cast<GLushort>( widget.s[0] * 2 );
                                }
                            }
                            else
                            {
                        ...
                        case GL_FLOAT :
                            ...
                            if( type == GL_FLOAT )
                            {
                                ...
                                {
                                    *iter2++ = GLushort( 65'535 * widget.f );
                                }
                            }
                            else if( type == GL_UNSIGNED_INT )
                            {
                                if( index_format )
                                {
                                    *iter2++ = static_cast<GLushort>( widget.ui );
                                }
                                else
                                {
                                    *iter2++ = widget.ui >> 16;
                            ...
                            else
                            {
                                if( index_format )
                                {
                                    *iter2++ = static_cast<GLushort>( widget.i );
                                }
                                else
                                {
                                    *iter2++ = static_cast<GLushort>( widget.i >> 15 );
                                }
                            }
                            break;
                    }
            ...
            {
                assert( iter2 ==
                        &newimage[width * height * elements_per_group( format, 0 )] );
            }
            assert( iter == &( ( const GLubyte* )userdata )[rowsize *
                                                            height +
                                                            psm->unpack_skip_rows *
                                                            rowsize +
                                                            psm->unpack_skip_pixels *
    ...
    */
    static void
    empty_image( const PixelStorageModes* psm,
                 GLint                    width,
                 GLint                    height,
                 GLenum                   format,
                 GLenum                   type,
                 ...
                 void*                    userdata )
    {
        ...
        else
        {
                ...
                for( j = 0; j < elements_per_line; j++ )
                {
                    ...
                    switch( type )
                    {
                        ...
                        case GL_UNSIGNED_BYTE :
                            if( index_format )
                            {
                                *iter = static_cast<GLubyte>( *iter2++ );
                            }
                            else
                            {
                                *iter = *iter2++ >> 8;
                        ...
                        case GL_BYTE :
                            if( index_format )
                            {
                                *( ( GLbyte* )iter ) = static_cast<GLbyte>( *iter2++ );
                            }
                            else
                            {
                                *( ( GLbyte* )iter ) = *iter2++ >> 9;
                        ...
                        case GL_SHORT :
                            if( type == GL_SHORT )
                            {
                                if( index_format )
                                {
                                    widget.s[0] = static_cast<short>( *iter2++ );
                                }
                                else
                                {
                                    widget.s[0] = *iter2++ >> 1;
                        ...
                        case GL_FLOAT :
                            ...
                            else if( type == GL_UNSIGNED_INT )
                            {
                                ...
                                {
                                    widget.ui = ( unsigned int )*iter2++ * 65'537;
                                }
                            }
                            else
                            {
                                ...
                                {
                                    widget.i = ( ( unsigned int )*iter2++ * 65'537 ) / 2;
                                }
                            }
                            if( myswap_bytes )
                            {
            ...
            {
                assert( iter2 ==
                        &oldimage[width * height * elements_per_group( format, 0 )] );
            }
                ...
                GLfloat     extractComponents[] )
    {
        ...
        extractComponents[1] = ( float )( ( ubyte & 0X1C ) >> 2 ) / 7.0F; /* 7 = 2^3-1 */
        extractComponents[2] = ( float )( ubyte & 0X03 ) / 3.0F;          /* 3 = 2^2-1 */
    } /* extract332() */

    static void
    shove332( const GLfloat shoveComponents[],
              int           index,
              void*         packedPixel )
    {
        /* 11100000 == 0xe0 */
    ...
    static void
    shove233rev( const GLfloat shoveComponents[],
                 int           index,
                 void*         packedPixel )
    {
        /* 0000,0111 == 0x07 */
                ...
                GLfloat     extractComponents[] )
    {
        ...
        extractComponents[0] =
            ( float )( ( ushort & 0XF8'00 ) >> 11 ) / 31.0F; /* 31 = 2^5-1*/
        extractComponents[1] =
            ( float )( ( ushort & 0X07'E0 ) >> 5 ) / 63.0F;  /* 63 = 2^6-1*/
        extractComponents[2] = ( float )( ushort & 0X00'1F ) / 31.0F;
    } /* extract565() */

    static void
    shove565( const GLfloat shoveComponents[],
              int           index,
              void*         packedPixel )
    {
        /* 11111000,00000000 == 0xf800 */
        ...
        ( ( GLushort* )packedPixel )[index] =
            ( ( GLushort )( ( shoveComponents[0] * 31 ) + 0.5 ) << 11 ) & 0XF8'00;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[1] * 63 ) + 0.5 ) << 5 ) & 0X07'E0;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[2] * 31 ) + 0.5 ) ) & 0X00'1F;
    } /* shove565() */

    static void
    extract565rev( int         isSwap,
                   const void* packedPixel,
                   GLfloat     extractComponents[] )
    {
        GLushort ushort;
        ...
        extractComponents[0] = ( float )( ushort & 0X00'1F ) / 31.0F;
        extractComponents[1] = ( float )( ( ushort & 0X07'E0 ) >> 5 ) / 63.0F;
        extractComponents[2] = ( float )( ( ushort & 0XF8'00 ) >> 11 ) / 31.0F;
    } /* extract565rev() */

    static void
    shove565rev( const GLfloat shoveComponents[],
                 int           index,
                 void*         packedPixel )
    {
        /* 00000000,00011111 == 0x001f */
        ...
        /* due to limited precision, need to round before shoving */
        ( ( GLushort* )packedPixel )[index] =
            ( ( GLushort )( ( shoveComponents[0] * 31.0 ) + 0.5 ) ) & 0X00'1F;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[1] * 63.0 ) + 0.5 ) << 5 ) & 0X07'E0;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[2] * 31.0 ) + 0.5 ) << 11 ) & 0XF8'00;
    } /* shove565rev() */

    static void
    extract4444( int         isSwap,
                 const void* packedPixel,
                 GLfloat     extractComponents[] )
    {
        GLushort ushort;
        ...
        extractComponents[0] =
            ( float )( ( ushort & 0XF0'00 ) >> 12 ) / 15.0F; /* 15=2^4-1 */
        extractComponents[1] = ( float )( ( ushort & 0X0F'00 ) >> 8 ) / 15.0F;
        extractComponents[2] = ( float )( ( ushort & 0X00'F0 ) >> 4 ) / 15.0F;
        extractComponents[3] = ( float )( ushort & 0X00'0F ) / 15.0F;
    } /* extract4444() */

    static void
    shove4444( const GLfloat shoveComponents[],
               int           index,
               void*         packedPixel )
    {
        assert( 0.0 <= shoveComponents[0] && shoveComponents[0] <= 1.0 );
        ...
        /* due to limited precision, need to round before shoving */
        ( ( GLushort* )packedPixel )[index] =
            ( ( GLushort )( ( shoveComponents[0] * 15 ) + 0.5 ) << 12 ) & 0XF0'00;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[1] * 15 ) + 0.5 ) << 8 ) & 0X0F'00;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[2] * 15 ) + 0.5 ) << 4 ) & 0X00'F0;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[3] * 15 ) + 0.5 ) ) & 0X00'0F;
    } /* shove4444() */

    static void
    extract4444rev( int         isSwap,
                    const void* packedPixel,
                    GLfloat     extractComponents[] )
    {
        GLushort ushort;
        ...
        /* 15 = 2^4-1 */
        extractComponents[0] = ( float )( ushort & 0X00'0F ) / 15.0F;
        extractComponents[1] = ( float )( ( ushort & 0X00'F0 ) >> 4 ) / 15.0F;
        extractComponents[2] = ( float )( ( ushort & 0X0F'00 ) >> 8 ) / 15.0F;
        extractComponents[3] = ( float )( ( ushort & 0XF0'00 ) >> 12 ) / 15.0F;
    } /* extract4444rev() */

    static void
    shove4444rev( const GLfloat shoveComponents[],
                  int           index,
                  void*         packedPixel )
    {
        /* 00000000,00001111 == 0x000f */
        ...
        /* due to limited precision, need to round before shoving */
        ( ( GLushort* )packedPixel )[index] =
            ( ( GLushort )( ( shoveComponents[0] * 15 ) + 0.5 ) ) & 0X00'0F;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[1] * 15 ) + 0.5 ) << 4 ) & 0X00'F0;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[2] * 15 ) + 0.5 ) << 8 ) & 0X0F'00;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[3] * 15 ) + 0.5 ) << 12 ) & 0XF0'00;
    } /* shove4444rev() */

    static void
    extract5551( int         isSwap,
                 const void* packedPixel,
                 GLfloat     extractComponents[] )
    {
        GLushort ushort;
        ...
        extractComponents[0] =
            ( float )( ( ushort & 0XF8'00 ) >> 11 ) / 31.0F; /* 31 = 2^5-1*/
        extractComponents[1] = ( float )( ( ushort & 0X07'C0 ) >> 6 ) / 31.0F;
        extractComponents[2] = ( float )( ( ushort & 0X00'3E ) >> 1 ) / 31.0F;
        extractComponents[3] = ( float )( ushort & 0X00'01 );
    } /* extract5551() */

    static void
    shove5551( const GLfloat shoveComponents[],
               int           index,
               void*         packedPixel )
    {
        /* 11111000,00000000 == 0xf800 */
        ...
        ( ( GLushort* )packedPixel )[index] =
            ( ( GLushort )( ( shoveComponents[0] * 31 ) + 0.5 ) << 11 ) & 0XF8'00;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[1] * 31 ) + 0.5 ) << 6 ) & 0X07'C0;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[2] * 31 ) + 0.5 ) << 1 ) & 0X00'3E;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[3] ) + 0.5 ) ) & 0X00'01;
    } /* shove5551() */

    static void
    extract1555rev( int         isSwap,
                    const void* packedPixel,
                    GLfloat     extractComponents[] )
    {
        GLushort ushort;
        ...
        /* 31 = 2^5-1 */
        extractComponents[0] = ( float )( ushort & 0X00'1F ) / 31.0F;
        extractComponents[1] = ( float )( ( ushort & 0X03'E0 ) >> 5 ) / 31.0F;
        extractComponents[2] = ( float )( ( ushort & 0X7C'00 ) >> 10 ) / 31.0F;
        extractComponents[3] = ( float )( ( ushort & 0X80'00 ) >> 15 );
    } /* extract1555rev() */

    static void
    shove1555rev( const GLfloat shoveComponents[],
                  int           index,
                  void*         packedPixel )
    {
        /* 00000000,00011111 == 0x001F */
        ...
        /* due to limited precision, need to round before shoving */
        ( ( GLushort* )packedPixel )[index] =
            ( ( GLushort )( ( shoveComponents[0] * 31 ) + 0.5 ) ) & 0X00'1F;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[1] * 31 ) + 0.5 ) << 5 ) & 0X03'E0;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[2] * 31 ) + 0.5 ) << 10 ) & 0X7C'00;
        ( ( GLushort* )packedPixel )[index] |=
            ( ( GLushort )( ( shoveComponents[3] ) + 0.5 ) << 15 ) & 0X80'00;
    } /* shove1555rev() */

    static void
    extract8888( int         isSwap,
                 const void* packedPixel,
                 GLfloat     extractComponents[] )
    {
        GLuint uint;
        ...
        /* 255 = 2^8-1 */
        extractComponents[0] = ( float )( ( uint & 0XFF'00'00'00 ) >> 24 ) / 255.0F;
        extractComponents[1] = ( float )( ( uint & 0X00'FF'00'00 ) >> 16 ) / 255.0F;
        extractComponents[2] = ( float )( ( uint & 0X00'00'FF'00 ) >> 8 ) / 255.0F;
        extractComponents[3] = ( float )( uint & 0X00'00'00'FF ) / 255.0F;
    } /* extract8888() */

    static void
    shove8888( const GLfloat shoveComponents[],
               int           index,
               void*         packedPixel )
    {
        /* 11111111,00000000,00000000,00000000 == 0xff000000 */
        ...
        ( ( GLuint* )packedPixel )[index] =
            ( ( GLuint )( ( shoveComponents[0] * 255 ) + 0.5 ) << 24 ) & 0XFF'00'00'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[1] * 255 ) + 0.5 ) << 16 ) & 0X00'FF'00'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[2] * 255 ) + 0.5 ) << 8 ) & 0X00'00'FF'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[3] * 255 ) + 0.5 ) ) & 0X00'00'00'FF;
    } /* shove8888() */

    static void
    extract8888rev( int         isSwap,
                    const void* packedPixel,
                    GLfloat     extractComponents[] )
    {
        GLuint uint;
        ...
        /* 255 = 2^8-1 */
        extractComponents[0] = ( float )( uint & 0X00'00'00'FF ) / 255.0F;
        extractComponents[1] = ( float )( ( uint & 0X00'00'FF'00 ) >> 8 ) / 255.0F;
        extractComponents[2] = ( float )( ( uint & 0X00'FF'00'00 ) >> 16 ) / 255.0F;
        extractComponents[3] = ( float )( ( uint & 0XFF'00'00'00 ) >> 24 ) / 255.0F;
    } /* extract8888rev() */

    static void
    shove8888rev( const GLfloat shoveComponents[],
                  int           index,
                  void*         packedPixel )
    {
        /* 00000000,00000000,00000000,11111111 == 0x000000ff */
        ...
        /* due to limited precision, need to round before shoving */
        ( ( GLuint* )packedPixel )[index] =
            ( ( GLuint )( ( shoveComponents[0] * 255 ) + 0.5 ) ) & 0X00'00'00'FF;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[1] * 255 ) + 0.5 ) << 8 ) & 0X00'00'FF'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[2] * 255 ) + 0.5 ) << 16 ) & 0X00'FF'00'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[3] * 255 ) + 0.5 ) << 24 ) & 0XFF'00'00'00;
    } /* shove8888rev() */

    static void
    extract1010102( int         isSwap,
                    const void* packedPixel,
                    GLfloat     extractComponents[] )
    {
        GLuint uint;
        ...
        /* 1023 = 2^10-1 */
        extractComponents[0] = ( float )( ( uint & 0XFF'C0'00'00 ) >> 22 ) / 1023.0F;
        extractComponents[1] = ( float )( ( uint & 0X00'3F'F0'00 ) >> 12 ) / 1023.0F;
        extractComponents[2] = ( float )( ( uint & 0X00'00'0F'FC ) >> 2 ) / 1023.0F;
        extractComponents[3] = ( float )( uint & 0X00'00'00'03 ) / 3.0F;
    } /* extract1010102() */

    static void
    shove1010102( const GLfloat shoveComponents[],
                  int           index,
                  void*         packedPixel )
    {
        /* 11111111,11000000,00000000,00000000 == 0xffc00000 */
        ...
        /* due to limited precision, need to round before shoving */
        ( ( GLuint* )packedPixel )[index] =
            ( ( GLuint )( ( shoveComponents[0] * 1'023 ) + 0.5 ) << 22 ) & 0XFF'C0'00'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[1] * 1'023 ) + 0.5 ) << 12 ) & 0X00'3F'F0'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[2] * 1'023 ) + 0.5 ) << 2 ) & 0X00'00'0F'FC;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[3] * 3 ) + 0.5 ) ) & 0X00'00'00'03;
    } /* shove1010102() */

    static void
    extract2101010rev( int         isSwap,
                       const void* packedPixel,
                       GLfloat     extractComponents[] )
    {
        GLuint uint;
        ...
        /* 1023 = 2^10-1 */
        extractComponents[0] = ( float )( uint & 0X00'00'03'FF ) / 1023.0F;
        extractComponents[1] = ( float )( ( uint & 0X00'0F'FC'00 ) >> 10 ) / 1023.0F;
        extractComponents[2] = ( float )( ( uint & 0X3F'F0'00'00 ) >> 20 ) / 1023.0F;
        extractComponents[3] = ( float )( ( uint & 0XC0'00'00'00 ) >> 30 ) / 3.0F;
        /* 3 = 2^2-1 */
    } /* extract2101010rev() */

    static void
    shove2101010rev( const GLfloat shoveComponents[],
                     int           index,
                     void*         packedPixel )
    {
        /* 00000000,00000000,00000011,11111111 == 0x000003FF */
        ...
        /* due to limited precision, need to round before shoving */
        ( ( GLuint* )packedPixel )[index] =
            ( ( GLuint )( ( shoveComponents[0] * 1'023 ) + 0.5 ) ) & 0X00'00'03'FF;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[1] * 1'023 ) + 0.5 ) << 10 ) & 0X00'0F'FC'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[2] * 1'023 ) + 0.5 ) << 20 ) & 0X3F'F0'00'00;
        ( ( GLuint* )packedPixel )[index] |=
            ( ( GLuint )( ( shoveComponents[3] * 3 ) + 0.5 ) << 30 ) & 0XC0'00'00'00;
    } /* shove2101010rev() */

    static void
    scaleInternalPackedPixel( int         components,
                              void        ( *extractPackedPixel )( int,
                                                                   const void*,
                                                                   GLfloat[] ),
                              void        ( *shovePackedPixel )( const GLfloat[],
                                                                 int,
                                                                 void* ),
                              GLint       widthIn,
                              GLint       heightIn,
                              ...
                              GLint       isSwap )
    {
        ...
        if( widthIn == widthOut * 2 && heightIn == heightOut * 2 )
        {
            halveImagePackedPixel( components,
                                   extractPackedPixel,
                                   shovePackedPixel,
                                   widthIn,
                                   heightIn,
...
#define BOX2 2
                 ...
                 GLenum type )
    {
        ...
        int bytes_per_row =
            int( bytes_per_element( type ) * static_cast<float>( width ) );
    ...
    static void
    fillImage3D( const PixelStorageModes* psm,
                 GLint                    width,
                 GLint                    height,
                 GLint                    depth,
                 GLenum                   format,
                 ...
                 GLushort*                newImage )
    {
        ...
        else
        {
            assert(
                iter2 ==
                &newImage[width * height * depth * elements_per_group( format, 0 )]
            );
        }
        assert( iter ==
                &( ( const GLubyte* )userImage )[rowSize *
                                                 height *
                                                 depth +
                                                 psm->unpack_skip_rows *
                                                 rowSize +
    ...
    static void
    scaleInternal3D( GLint           components,
                     GLint           widthIn,
                     GLint           heightIn,
                     GLint           depthIn,
                     const GLushort* dataIn,
                     ...
                     GLushort*       dataOut )
    {
        ...
        convz     = static_cast<float>( depthIn ) / static_cast<float>( depthOut );
        convy     = static_cast<float>( heightIn ) / static_cast<float>( heightOut );
        convx     = static_cast<float>( widthIn ) / static_cast<float>( widthOut );
        halfconvx = convx / 2;
        halfconvy = convy / 2;
        ...
        {
            z = convz * ( static_cast<float>( d ) + 0.5F );
            if( depthIn > depthOut )
            {
                highz = z + halfconvz;
                lowz  = z - halfconvz;
                ...
                for( j = 0; j < widthOut; j++ )
                {
                    ...
                    */
                    ...
                    while( z < highz )
                    {
                        ...
                        if( highz < static_cast<float>( zint + 1 ) )
                        {
                            zpercent = highz - z;
                        }
                        else
                        {
                            zpercent = static_cast<float>( zint + 1 ) - z;
                        }
                    ...
                    temp = ( j + ( i * widthOut ) + ( d * widthOut * heightOut ) ) *
                           components;
                    for( k = 0; k < components; k++ )
                    {
                        ...
                        assert( 0 <=
                                ( temp + k ) &&
                                ( temp + k ) <
                                ( widthOut * heightOut * depthOut * components ) );
    ...
    static void
    emptyImage3D( const PixelStorageModes* psm,
                  GLint                    width,
                  GLint                    height,
                  GLint                    depth,
                  GLenum                   format,
                  ...
                  void*                    userImage )
    {
        ...
        else
        {
            assert(
                iter2 ==
                &oldImage[width * height * depth * elements_per_group( format, 0 )]
            );
        }
        assert( iter ==
                &( ( GLubyte* )userImage )[rowSize *
                                           height *
                                           depth +
                                           psm->unpack_skip_rows *
                                           rowSize +
                     ...
                     void*       dataOut )
    {
        ...
        beforeImage = ( GLushort* )malloc( static_cast<size_t>(
            imageSize3D( widthIn, heightIn, depthIn, format, GL_UNSIGNED_SHORT )
        ) );
        afterImage  = ( GLushort* )malloc( static_cast<size_t>(
            imageSize3D( widthOut, heightOut, depthOut, format, GL_UNSIGNED_SHORT )
        ) );
        if( beforeImage == NULL || afterImage == NULL )
        {
            free( beforeImage );
    ...
    static void
    closestFit3D( GLTexImage3DProc gluTexImage3D,
                  GLint            width,
                  GLint            height,
                  GLint            depth,
                  GLint            internalFormat,
                  ...
                  GLint*           newDepth )
    {
        GLint widthPowerOf2  = nearestPower( static_cast<GLuint>( width ) );
        GLint heightPowerOf2 = nearestPower( static_cast<GLuint>( height ) );
        GLint depthPowerOf2  = nearestPower( static_cast<GLuint>( depth ) );
        GLint proxyWidth;
        ...
        do
        {
            ...
            GLint heightAtLevelOne =
                ( heightPowerOf2 > 1 ) ? heightPowerOf2 >> 1 : heightPowerOf2;
            GLint depthAtLevelOne =
                ( depthPowerOf2 > 1 ) ? depthPowerOf2 >> 1 : depthPowerOf2;
                                ...
                                GLint       isSwap )
    {
        ...
        { /* horizontal slice viewed from top */
            assert( width != 1 );
        ...
        { /* vertical slice viewed from top */
            assert( height != 1 );
...
#define BOX8 8
                                ...
                                const void*      data )
    {
        ...
        level = computeLog( static_cast<GLuint>( newDepth ) );
        if( level > levels )
        {
            levels = level;
        }
        ...
        if( width == newWidth && height == newHeight && depth == newDepth )
        {
            ...
            {
                case GL_UNSIGNED_BYTE :
                    dstImage = ( GLubyte* )malloc( static_cast<size_t>( memReq ) );
                    break;
                case GL_BYTE :
                    dstImage = ( GLbyte* )malloc( static_cast<size_t>( memReq ) );
                    break;
                case GL_UNSIGNED_SHORT :
                    dstImage = ( GLushort* )malloc( static_cast<size_t>( memReq ) );
                    break;
                case GL_SHORT :
                    dstImage = ( GLshort* )malloc( static_cast<size_t>( memReq ) );
                    break;
                case GL_UNSIGNED_INT :
                    dstImage = ( GLuint* )malloc( static_cast<size_t>( memReq ) );
                    break;
                case GL_INT :
                    dstImage = ( GLint* )malloc( static_cast<size_t>( memReq ) );
                    break;
                case GL_FLOAT :
                    dstImage = ( GLfloat* )malloc( static_cast<size_t>( memReq ) );
                    break;
                case GL_UNSIGNED_BYTE_3_3_2 :
                case GL_UNSIGNED_BYTE_2_3_3_REV :
                    dstImage = ( GLubyte* )malloc( static_cast<size_t>( memReq ) );
            ...
            { /* use as little memory as possible */
                {
                    ...
                    memReq =
                        imageSize3D( nextWidth, nextHeight, nextDepth, format, type );
                }
                switch( type )
                {
                    case GL_UNSIGNED_BYTE :
    ...
    GLint GLAPIENTRY
    gluBuild3DMipmapLevels( GLTexImage3DProc gluTexImage3D,
                            GLenum           target,
                            GLint            internalFormat,
                            GLsizei          width,
                            GLsizei          height,
                            ...
                            const void*      data )
    {
        ...
        level = computeLog( static_cast<GLuint>( depth ) );
        if( level > levels )
        {
            levels = level;
        }
    ...
    GLint GLAPIENTRY
    gluBuild3DMipmaps( GLTexImage3DProc gluTexImage3D,
                       GLenum           target,
                       GLint            internalFormat,
                       GLsizei          width,
                       GLsizei          height,
                       ...
                       const void*      data )
    {
        ...
        level = computeLog( static_cast<GLuint>( depthPowerOf2 ) );
        if( level > levels )
        {
            levels = level;
        }
                   ...
                   const void* sitem )
    {
        ...
        if( isSwap )
        {
            sshort = static_cast<GLshort>( __GLU_SWAP_2_BYTES( sitem ) );
        }
        else
        {
                 ...
                 const void* uitem )
    {
        ...
        assert( uint <= 0XFF'FF'FF'FF );

        return ( GLdouble )uint;
    } /* extractUint() */

    static void
    shoveUint( GLdouble value,
               int      index,
               void*    data )
    {
                 ...
                 const void* sitem )
    {
        ...
        if( isSwap )
        {
            sint = static_cast<GLint>( __GLU_SWAP_4_BYTES( sitem ) );
        }
        else
        {
        ...
        assert( sint <= 0X7F'FF'FF'FF );

        return ( GLdouble )sint;
    } /* extractSint() */

    static void
    shoveSint( GLdouble value,
               int      index,
               void*    data )
    {
                  ...
                  const void* item )
    {
        ...
        if( isSwap )
        {
            ffloat = static_cast<GLfloat>( __GLU_SWAP_4_BYTES( item ) );
        }
        else
        {
    ...
    static void
    shoveFloat( GLdouble value,
                int      index,
                void*    data )
    {
        assert( 0.0 <= value && value <= 1.0 );

        ( ( GLfloat* )data )[index] = static_cast<GLfloat>( value );
    } /* shoveFloat() */

    static void
    halveImageSlice( int         components,
                     GLdouble    ( *extract )( int,
                                               const void* ),
                     void        ( *shove )( GLdouble,
                                             int,
                                             void* ),
        ...
        { /* a 1-pixel column viewed from top */
            ...
            for( ii = 0; ii < halfDepth; ii++ )
            {
                ...
                for( cc = 0; cc < components; cc++ )
                {
                    ...
                    extractTotals[1][cc] =
                        ( *extract )( isSwap, src + imageSizeInBytes );
            ...
            for( ii = 0; ii < halfDepth; ii++ )
            {
                for( jj = 0; jj < halfWidth; jj++ )
                {
                    ...
                    for( cc = 0; cc < components; cc++ )
                    {
                        ...
                        extractTotals[0][cc] = ( *extract )( isSwap, src );
                        extractTotals[1][cc] =
                            ( *extract )( isSwap, src + groupSizeInBytes );
                        extractTotals[2][cc] =
                            ( *extract )( isSwap, src + imageSizeInBytes );
                        extractTotals[3][cc] =
                            ( *extract )( isSwap,
            ...
            for( ii = 0; ii < halfDepth; ii++ )
            {
                for( jj = 0; jj < halfHeight; jj++ )
                {
                    ...
                    for( cc = 0; cc < components; cc++ )
                    {
                        ...
                        extractTotals[0][cc] = ( *extract )( isSwap, src );
                        extractTotals[1][cc] =
                            ( *extract )( isSwap, src + rowSizeInBytes );
                        extractTotals[2][cc] =
                            ( *extract )( isSwap, src + imageSizeInBytes );
                        extractTotals[3][cc] =
                            ( *extract )( isSwap,
