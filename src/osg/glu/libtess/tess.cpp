...
#define GLU_TESS_MESH              100'112 /* void (*)(GLUmesh *mesh)	    */
...
void GLAPIENTRY
osg::gluTessProperty( GLUtesselator* tess,
                      GLenum         which,
                      GLdouble       value )
{
    GLenum windingRule;
...
void GLAPIENTRY
osg::gluGetTessProperty( GLUtesselator* tess,
                         GLenum         which,
                         GLdouble*      value )
{
    switch( which )
...
void GLAPIENTRY
osg::gluTessNormal( GLUtesselator* tess,
                    GLdouble       x,
                    GLdouble       y,
                    GLdouble       z )
{
...
void GLAPIENTRY
osg::gluTessCallback( GLUtesselator* tess,
                      GLenum         which,
                      _GLUfuncptr    fn )
{
    switch( which )
...
static void
CacheVertex( GLUtesselator* tess,
             GLdouble       coords[3],
             void*          data )
{
...
void GLAPIENTRY
osg::gluTessVertex( GLUtesselator* tess,
                    GLdouble       coords[3],
                    void*          data )
{
...
void GLAPIENTRY
osg::gluTessBeginPolygon( GLUtesselator* tess,
                          void*          data )
{
    RequireState( tess, T_DORMANT );
