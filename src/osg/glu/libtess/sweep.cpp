...
static void
SweepEvent( GLUtesselator* tess,
            GLUvertex*     vEvent );
static void
WalkDirtyRegions( GLUtesselator* tess,
                  ActiveRegion*  regUp );
static int
CheckForRightSplice( GLUtesselator* tess,
                     ActiveRegion*  regUp );

static int
EdgeLeq( GLUtesselator* tess,
         ActiveRegion*  reg1,
         ActiveRegion*  reg2 )
/*
...
static void
DeleteRegion( GLUtesselator* tess,
              ActiveRegion*  reg )
{
    if( reg->fixUpperEdge )
    {
...
static ActiveRegion*
AddRegionBelow( GLUtesselator* tess,
...
static GLboolean
IsWindingInside( GLUtesselator* tess,
                 int            n )
{
...
static void
ComputeWinding( GLUtesselator* tess,
                ActiveRegion*  reg )
{
...
static void
FinishRegion( GLUtesselator* tess,
              ActiveRegion*  reg )
/*
...
static void
SpliceMergeVertices( GLUtesselator* tess,
                     GLUhalfEdge*   e1,
                     GLUhalfEdge*   e2 )
/*
 ...
 */
{
    ...
    weights[0]        = static_cast<GLfloat>( 0.5 * t2 / ( t1 + t2 ) );
    weights[1]        = static_cast<GLfloat>( 0.5 * t1 / ( t1 + t2 ) );
...
static int
CheckForLeftSplice( GLUtesselator* tess,
                    ActiveRegion*  regUp )
/*
 * Check the upper and lower edge of "regUp", to make sure that the
...
static int
CheckForIntersect( GLUtesselator* tess,
                   ActiveRegion*  regUp )
/*
...
static void
ConnectLeftVertex( GLUtesselator* tess,
                   GLUvertex*     vEvent )
/*
...
static void
AddSentinel( GLUtesselator* tess,
             GLdouble       t )
/*
