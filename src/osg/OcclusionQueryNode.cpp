...
QueryGeometry* createDefaultQueryGeometry( const std::string& name )
{
    ...
    GLushort indices[] = {
        0, 1, 3,  1, 2, 3,   // face: was quad 0,1,2,3
        4, 5, 7,  5, 6, 7,   // face: was quad 4,5,6,7
        0, 3, 5,  3, 6, 5,   // face: was quad 0,3,6,5
        2, 1, 7,  1, 4, 7,   // face: was quad 2,1,4,7
        5, 4, 0,  4, 1, 0,   // face: was quad 5,4,1,0
        2, 7, 3,  7, 6, 3    // face: was quad 2,7,6,3
    };

    ref_ptr<QueryGeometry> geom = new QueryGeometry( name );
    geom->setDataVariance( Object::DYNAMIC );
    geom->addPrimitiveSet( new DrawElementsUShort( PrimitiveSet::TRIANGLES, 36, indices ) );
