...
void
PerlinNoise::SetNoiseFrequency( int frequency )
{
    start = 1;
    B     = frequency;
    BM    = B - 1;
...
double
PerlinNoise::noise2( double vec[2] )
{
...
double
PerlinNoise::PerlinNoise1D( double x,
                            double alpha,
                            double beta,
                            int    n )
{
...
double
PerlinNoise::PerlinNoise2D( double x,
                            double y,
                            double alpha,
                            double beta,
                            int    n )
...
double
PerlinNoise::PerlinNoise3D( double x,
                            double y,
                            double z,
                            double alpha,
                            double beta,
...
osg::Image*
PerlinNoise::create3DNoiseImage( int texSize )
{
    ...
    image->setImage(
        ...
        GL_RGBA,
        GL_UNSIGNED_BYTE,
        new unsigned char[static_cast<std::size_t>( 4 * texSize * texSize * texSize )],
...
osg::Texture3D*
PerlinNoise::create3DNoiseTexture( int texSize )
{
