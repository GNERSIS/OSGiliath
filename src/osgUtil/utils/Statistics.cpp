...
void
Statistics::drawArrays( GLenum mode,
                        GLint,
                        GLsizei count )
{
    PrimitivePair& prim = _primitiveCount[mode];
    ++prim.first;
    prim.second             += static_cast<unsigned int>( count );
    _primitives_count[mode] += _calculate_primitives_number_by_mode( mode, count );
}

void
Statistics::drawElements( GLenum  mode,
                          GLsizei count,
                          const GLubyte* )
{
    PrimitivePair& prim = _primitiveCount[mode];
...
Statistics::end()
{
    _primitives_count[_currentPrimitiveFunctorMode] +=
        _calculate_primitives_number_by_mode(
            ...
            static_cast<GLsizei>( _number_of_vertexes )
        );
...
void
Statistics::add( const Statistics& stats )
{
...
void
StatsVisitor::apply( osg::Node& node )
{
    if( node.getStateSet() )
    {
...
void
StatsVisitor::apply( osg::Group& node )
{
    if( node.getStateSet() )
    {
        apply( *node.getStateSet() );
...
void
StatsVisitor::apply( osg::Transform& node )
{
    if( node.getStateSet() )
    {
        apply( *node.getStateSet() );
...
void
StatsVisitor::apply( osg::LOD& node )
{
    if( node.getStateSet() )
    {
        apply( *node.getStateSet() );
...
void
StatsVisitor::apply( osg::Switch& node )
{
    if( node.getStateSet() )
    {
        apply( *node.getStateSet() );
...
void
StatsVisitor::apply( osg::Geode& node )
{
    if( node.getStateSet() )
    {
        apply( *node.getStateSet() );
...
void
StatsVisitor::apply( osg::Drawable& drawable )
{
...
void
StatsVisitor::apply( osg::StateSet& stateSet )
{
...
StatsVisitor::totalUpStats()
{
    ...
    for( DrawableSet::iterator itr = _drawableSet.begin(); itr != _drawableSet.end();
         ++itr )
    {
...
void
StatsVisitor::print( std::ostream& out )
{
    ...
    for( StateSetSet::iterator statsetitr = _statesetSet.begin();
         ...
         ++statsetitr )
    {
        if( ( *statsetitr )->getDataVariance() == osg::Object::DataVariance::DYNAMIC )
        {
            ++dynamic_statesets;
        }
        if( ( *statsetitr )->getRenderBinMode() !=
            osg::StateSet::INHERIT_RENDERBIN_DETAILS )
        {
            ++non_default_renderbin_statesets;
            if( ( *statsetitr )->getBinNumber() == 10 )
            {
                ++bin10_statesets;
            }
        }
    ...
    for( DrawableSet::iterator drawableitr = _drawableSet.begin();
         ...
         ++drawableitr )
    {
        if( ( *drawableitr )->getDataVariance() == osg::Object::DataVariance::DYNAMIC )
        {
            ++dynamic_drawables;
        }
    }
    ...
    {
        out << std::setw( 12 ) << "Object Type" << std::setw( 10 ) << "Unique"
            << std::setw( 10 ) << "Instanced" << std::setw( 10 ) << "Dynamic"
            << std::endl;
    ...
    {
        out << std::setw( 12 ) << "Object Type" << std::setw( 10 ) << "Unique"
            << std::setw( 10 ) << "Instanced" << std::endl;
        out << std::setw( 12 ) << "-----------" << std::setw( 10 ) << "------"
            << std::setw( 10 ) << "---------" << std::endl;
    }
    out << std::setw( 12 ) << "StateSet   " << std::setw( 10 ) << _statesetSet.size()
        << std::setw( 10 ) << _numInstancedStateSet << std::setw( 10 )
        << dynamic_statesets << std::endl;
    if( bin10_statesets != 0 )
    {
        out << std::setw( 12 ) << "  bin 10   " << std::setw( 10 ) << bin10_statesets
            << std::endl;
    }
    if( non_default_renderbin_statesets != 0 )
    {
        out << std::setw( 12 ) << "  other bin" << std::setw( 10 )
            << non_default_renderbin_statesets - bin10_statesets << std::endl;
    }
    out << std::setw( 12 ) << "Group      " << std::setw( 10 ) << _groupSet.size()
        << std::setw( 10 ) << _numInstancedGroup << std::endl;
    out << std::setw( 12 ) << "Transform  " << std::setw( 10 ) << _transformSet.size()
        << std::setw( 10 ) << _numInstancedTransform << std::endl;
    out << std::setw( 12 ) << "LOD        " << std::setw( 10 ) << _lodSet.size()
        << std::setw( 10 ) << _numInstancedLOD << std::endl;
    out << std::setw( 12 ) << "Switch     " << std::setw( 10 ) << _switchSet.size()
        << std::setw( 10 ) << _numInstancedSwitch << std::endl;
    out << std::setw( 12 ) << "Geode      " << std::setw( 10 ) << _geodeSet.size()
        << std::setw( 10 ) << _numInstancedGeode << std::endl;
    out << std::setw( 12 ) << "Drawable   " << std::setw( 10 ) << _drawableSet.size()
        << std::setw( 10 ) << _numInstancedDrawable << std::setw( 10 )
        << dynamic_drawables << std::endl;
    out << std::setw( 12 ) << "Geometry   " << std::setw( 10 ) << _geometrySet.size()
        << std::setw( 10 ) << _numInstancedGeometry << std::endl;
    out << std::setw( 12 ) << "Fast geom. " << std::setw( 10 ) << _fastGeometrySet.size()
        << std::setw( 10 ) << _numInstancedFastGeometry << std::endl;
    out << std::setw( 12 ) << "Vertices   " << std::setw( 10 )
        << _uniqueStats._vertexCount << std::setw( 10 ) << _instancedStats._vertexCount
        << std::endl;
    out << std::setw( 12 ) << "Primitives " << std::setw( 10 ) << unique_primitives
        << std::setw( 10 ) << instanced_primitives << std::endl;
}
