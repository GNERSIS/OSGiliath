...
static const char vertexShaderSource_noBaseTexture[] =
    ...
    "                      osg_FrontMaterial.diffuse.rgb * osg_LightSource.diffuse.rgb * NdotL;\n"
...
static const char fragmentShaderSource_noBaseTexture[] =
    ...
    "void main(void) \n"
    "{ \n"
    "    fragColor = vertexColor * (osgShadow_ambientBias.x + textureProj( osgShadow_shadowTexture, texCoord_0 ) * osgShadow_ambientBias.y); \n"
    "}\n";
...
static const char fragmentShaderSource_withBaseTexture[] =
    ...
    "    fragColor = color * (osgShadow_ambientBias.x + textureProj( osgShadow_shadowTexture, texCoord_1 ) * osgShadow_ambientBias.y); \n"
    "}\n";
...
void ShadowMap::createUniforms()
{
    ...
    _shadowTextureMatrixUniform = new osg::Uniform(osg::Uniform::FLOAT_MAT4, "osgShadow_shadowTextureMatrix");
...
void ShadowMap::createShaders()
{
    ...
    if( _shaderList.empty() )
    {
        ...
        {
            osg::Shader* vertex_shader = new osg::Shader(osg::Shader::VERTEX, vertexShaderSource_noBaseTexture);
        ...
        {
            osg::Shader* vertex_shader = new osg::Shader(osg::Shader::VERTEX, vertexShaderSource_withBaseTexture);
            _shaderList.push_back(vertex_shader);
...
void ShadowMap::cull(osgUtil::CullVisitor& cv)
{
    ...
    if (selectLight)
    {
        ...
        {
            osg::Matrix inverseCameraView = osg::Matrix::inverse(*cv.getModelViewMatrix());
            ...
            osg::Matrixf shadowTextureMatrix =
                inverseCameraView * _camera->getViewMatrix() * _camera->getProjectionMatrix() * bias;
...
osg::ref_ptr<osg::Camera> ShadowMap::makeDebugHUD()
{
    ...
    osg::Shader* vertex_shader = new osg::Shader(osg::Shader::VERTEX, vertexShaderSource_debugHUD);
