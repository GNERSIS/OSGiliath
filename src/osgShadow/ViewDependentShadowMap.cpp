...
static const char fragmentShaderSource_withBaseTexture[] =
        ...
        "void main(void)                                                         \n"
        "{                                                                       \n"
        "  vec4 colorAmbientEmissive = osg_FrontMaterial.emission + osg_FrontMaterial.ambient * osg_LightSource.ambient; \n"
        "  vec4 color = texture( baseTexture, baseTexCoord.xy );                \n"
        "  color *= mix( colorAmbientEmissive, vertexColor, textureProj( shadowTexture0, shadowTexCoord0 ).r ); \n"
        "  fragColor = color;                                                   \n"
        "} \n";
