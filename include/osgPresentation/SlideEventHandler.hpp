...
namespace osgPresentation
{
    ...
    struct JumpData : public osg::Inherit<osg::Object, JumpData>
    {
            JumpData() :
                relativeJump( true ),
                slideNum( 0 ),
            ...
            JumpData( const std::string& in_slideName,
            ...
            requiresJump() const
            {
                if( !slideName.empty() || !layerName.empty() )
                {
                    return true;
                }
            ...
            bool
            jump( SlideEventHandler* seh ) const;

            void
            setRelativeJump( bool flag )
            {
                relativeJump = flag;
            }

            bool
            getRelativeJump() const
            {
                return relativeJump;
            }
            ...
            void
            setSlideName( const std::string& name )
            {
                slideName = name;
            }
            ...
            void
            setLayerName( const std::string& name )
            {
                layerName = name;
            }
    ...
    struct HomePosition : public osg::Inherit<osg::Object, HomePosition>
    {
            HomePosition() :
                eye( 0.0,
                     -1.0,
            ...
            HomePosition( const osg::vec3& in_eye,
                          const osg::vec3& in_center,
                          const osg::vec3& in_up ) :
                eye( in_eye ),
                center( in_center ),
                up( in_up )
            {
            ...
            HomePosition( const HomePosition& rhs,
                          const osg::CopyOp&  copyop = osg::CopyOp::SHALLOW_COPY ) :
                Inherit( rhs,
                         copyop ),
                eye( rhs.eye ),
            ...
            HomePosition&
            operator=( const HomePosition& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
    ...
    struct KeyPosition : public osg::Inherit<osg::Object, KeyPosition>
    {
            KeyPosition( unsigned int key                = 0,
                         float        x                  = FLT_MAX,
                         float        y                  = FLT_MAX,
            ...
            KeyPosition( const KeyPosition& rhs,
                         const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY ) :
                Inherit( rhs,
                         copyop ),
                _key( rhs._key ),
            ...
            KeyPosition&
            operator=( const KeyPosition& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
            ...
            setKey( int key )
            {
                _key = static_cast<osgGA::GUIEventAdapter::KeySymbol>( key );
            }
            ...
            void
            setForwardToDevices( bool flag )
            {
                _forwardToDevices = flag;
            }

            bool
            getForwardToDevices() const
            {
                return _forwardToDevices;
            }
    ...
    {
            virtual void
            operator()( osg::Node* node ) const = 0;
    };
    ...
    struct OSGPRESENTATION_EXPORT LayerAttributes : public virtual osg::Referenced
    {
            ...
            void
            addKey( const KeyPosition& kp )
            {
                _keys.push_back( kp );
            }

            void
            setRunStrings( const RunStrings& runStrings )
            {
                _runStrings = runStrings;
            }
            ...
            void
            addRunString( const std::string& runString )
            {
                _runStrings.push_back( runString );
            }

            void
            setJump( const JumpData& jumpData )
            {
                _jumpData = jumpData;
            }
            ...
            void
            addEnterCallback( LayerCallback* lc )
            {
                _enterLayerCallbacks.push_back( lc );
            }

            void
            addLeaveCallback( LayerCallback* lc )
            {
                _leaveLayerCallbacks.push_back( lc );
            }

            void
            callEnterCallbacks( osg::Node* node );
            void
            callLeaveCallbacks( osg::Node* node );
    ...
    {
            inline bool
            operator<( const ObjectOperator& rhs ) const
            {
                return ptr() < rhs.ptr();
            }
            ...
            virtual void
            enter( SlideEventHandler* ) = 0;
            virtual void
            frame( SlideEventHandler* ) {};
            virtual void
            maintain( SlideEventHandler* ) = 0;
            virtual void
            leave( SlideEventHandler* ) = 0;
            virtual void
            setPause( SlideEventHandler*,
                      bool pause ) = 0;
            virtual void
            reset( SlideEventHandler* ) = 0;
    ...
    class OSGPRESENTATION_EXPORT ActiveOperators
    {
        public:
            ...
            typedef std::set<osg::ref_ptr<ObjectOperator>, dereference_less>
                OperatorList;

        protected:

            void
            processOutgoing( SlideEventHandler* seh );
            void
            processIncoming( SlideEventHandler* seh );
            void
                         processMaintained( SlideEventHandler* seh );
    ...
    class OSGPRESENTATION_EXPORT SlideEventHandler
        : public osg::Inherit<osgGA::GUIEventHandler, SlideEventHandler>
    {
        public:

            SlideEventHandler( osgViewer::Viewer* viewer = 0 );

            SlideEventHandler( const SlideEventHandler& seh,
                               const osg::CopyOp&       copyop );

            static SlideEventHandler*
            instance();
            ...
            void
            compileSlide( unsigned int slideNum );
            void
            releaseSlide( unsigned int slideNum );

            unsigned int
            getNumSlides();

            int
            getActiveSlide() const
            {
                return _activeSlide;
            }
            ...
            osg::Switch*
            getSlide( int slideNum );
            osg::Node*
            getLayer( int slideNum,
                      int layerNum );
            ...
            void
            setTimeDelayBetweenSlides( double dt )
            {
                _timePerSlide = dt;
            }

            double
            getTimeDelayBetweenSlides() const
            {
                return _timePerSlide;
            }

            double
            getDuration( const osg::Node* node ) const;

            double
            getCurrentTimeDelayBetweenSlides() const;

            void
            setReleaseAndCompileOnEachNewSlide( bool flag )
            {
                _releaseAndCompileOnEachNewSlide = flag;
            }

            bool
            getReleaseAndCompileOnEachNewSlide() const
            {
                return _releaseAndCompileOnEachNewSlide;
            }

            void
            setTimeDelayOnNewSlideWithMovies( float t )
            {
                _timeDelayOnNewSlideWithMovies = t;
            }

            float
            getTimeDelayOnNewSlideWithMovies() const
            {
                return _timeDelayOnNewSlideWithMovies;
            }
            ...
            void
            dispatchEvent( const KeyPosition& keyPosition );
            void
            dispatchEvent( osgGA::Event* event );

            void
            forwardEventToDevices( osgGA::Event* event );

            void
            setRequestReload( bool flag );

            bool
            getRequestReload() const
            {
