...
namespace osgPresentation
{
    ...
    class PropertyManager : public osg::Inherit<osg::Object, PropertyManager>
    {
        public:
            ...
            PropertyManager( const PropertyManager& pm,
            ...
            ref() const
            {
                return osg::Referenced::ref();
            }

            int
            unref() const
            {
                return osg::Referenced::unref();
            }
    ...
    extern OSGPRESENTATION_EXPORT const osg::Object*
                                        getUserObject( const osg::NodePath& nodepath,
                                                       const std::string&   name );

    template<typename T>
    bool
    getUserValue( const osg::NodePath& nodepath,
                  const std::string&   name,
                  T&                   value )
    {
    ...
    extern OSGPRESENTATION_EXPORT bool
    containsPropertyReference( const std::string& str );

    struct PropertyReader
    {
            PropertyReader( const osg::NodePath& nodePath,
            ...
            {
                // skip white space.
                while( !_sstream.fail() && _sstream.peek() == ' ' )
                {
                    _sstream.ignore();
                }
                ...
                if( _sstream.peek() == '$' )
                {
                    ...
                    if( !_sstream.fail() && !propertyName.empty() )
                    {
                        return getUserValue( _nodePath, propertyName, value );
                    }
                    else
                    {
                        return false;
            ...
            ok()
            {
                return !_sstream.fail() && !_errorGenerated;
            }
    ...
    class OSGPRESENTATION_EXPORT PropertyAnimation : public osg::NodeCallback
    {
        public:
            ...
            void
            setPropertyManager( PropertyManager* pm )
            {
                _pm = pm;
            }

            PropertyManager*
            getPropertyManager() const
            {
                return _pm.get();
            }
            ...
            const KeyFrameMap&
            getKeyFrameMap() const
            {
                return _keyFrameMap;
            }

            void
            addKeyFrame( double                  time,
        ...
        protected:
            ...
            void
            assign( osg::UserDataContainer* destination,
                    osg::UserDataContainer* source );
            void
                        assign( osg::UserDataContainer* udc,
                                osg::Object*            obj );
    ...
    {
            ImageSequenceUpdateCallback( osg::ImageSequence* is,
                                         PropertyManager*    pm,
