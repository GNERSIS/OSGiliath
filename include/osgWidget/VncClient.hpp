...
namespace osgWidget
{
    ...
    /** Pure virtual base class for VncImage that is sublcassed by vnc plugin to provide
    ...
    class VncImage : public osg::Image
    {
        public:
            ...
            virtual bool
            connect( const std::string& hostname ) = 0;
    ...
    /** Convenience Vnc Client class that provides a interactive quad that can be placed
    ...
    class OSGWIDGET_EXPORT VncClient : public osg::Geode
    {
        public:
            ...
            VncClient( const std::string&   hostname,
                       const GeometryHints& hints = GeometryHints() );

            bool
            assign( VncImage*            vncImage,
                    const GeometryHints& hints = GeometryHints() );
