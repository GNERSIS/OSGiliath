 ...
 * Base 2D widget with position, size, color, texture, and
 * event callbacks. Renders as a textured quad in a Window.
 */
...
#include <osgWidget/EventInterface.hpp>
#include <osgWidget/StyleInterface.hpp>
#include <osgWidget/Types.hpp>
#include <osgWidget/UIObjectParent.hpp>
...
namespace osgWidget
{
    ...
    // A Widget is a rectangular region that receives events about the state of various
    // input devices such as the pointer and keyboard. It is aware of it's width, height,
    // and origin but nothing else. It is the job of higher-level container objects to
    // organize layouts and the like, and to contextualize the meaning of the widgets
    // "origin" (whether it is absolute or relative).
    class OSGWIDGET_EXPORT Widget : public osg::Inherit<osg::Geometry, Widget>,
                                    ...
                                    public StyleInterface
    {
        public:
            ...
            // way. This is useful when the widget manages some internal Drawables that
            ...
            void setDimensions( point_type = -1.0F,
                                point_type = -1.0F,
                                point_type = -1.0F,
                                point_type = -1.0F,
                                point_type = -1.0F );
            ...
            void setColor( color_type,
                           color_type,
                           color_type,
                           color_type,
                           Corner = ALL_CORNERS );
            void addColor( color_type,
                           color_type,
                           color_type,
                           color_type,
                           Corner = ALL_CORNERS );
            void setTexCoord( texcoord_type,
                              texcoord_type,
                              Corner = ALL_CORNERS );
            void
                 setLayer( Layer        l,
            ...
            // This method will use a given origin as the LOWER_LEFT point and texture
            // the remaining area based on some width and height values.
            void setTexCoordRegion( point_type,
                                    point_type,
                                    point_type,
                                    point_type );
            ...
            setImage( const osg::ref_ptr<T>& image,
                      ...
                      bool                   f2 = false )
            {
                return setImage( image.get(), f1, f2 );
            }
            ...
            void addOrigin( point_type,
                            point_type );
            void addSize( point_type,
                          point_type );
            ...
            getZ() const;
            point_type
            getPadHorizontal() const;
            point_type
                            getPadVertical() const;
            ...
            Color
            getImageColorAtXY( point_type x,
                               point_type y ) const;
            XYCoord
            localXY( double,
                     double ) const;
            ...
            void
            setWidth( point_type w )
            {
                setDimensions( -1.0F, -1.0F, w );
            }

            void
            setHeight( point_type h )
            {
                setDimensions( -1.0F, -1.0F, -1.0F, h );
            }

            void
            setOrigin( point_type x,
                       point_type y )
            {
                setDimensions( x, y );
            }
            ...
            void
            setSize( const XYCoord& xy )
            {
                setSize( xy.x, xy.y );
            }

            void
            setColor( const Color& col,
            ...
            void
            setTexCoordRegion( const XYCoord& xy,
                               point_type     w,
                               point_type     h )
            {
            ...
            void
            setTexCoordRegion( point_type     x,
                               point_type     y,
                               const XYCoord& wh )
            {
            ...
            void
            addOrigin( const XYCoord& xy )
            {
                addOrigin( xy.x, xy.y );
            }

            void
            addSize( const XYCoord& xy )
            {
                addSize( xy.x, xy.y );
            }

            void
            setMinimumSize( point_type width,
                            point_type height )
            {
                _minWidth  = width;
                _minHeight = height;
            ...
            void
            setMinimumSize( const XYCoord& xy )
            {
                setMinimumSize( xy.x, xy.y );
            }

            void
            setPadLeft( point_type p )
            {
                _padLeft = p;
            }

            void
            setPadRight( point_type p )
            {
                _padRight = p;
            }

            void
            setPadTop( point_type p )
            {
                _padTop = p;
            }

            void
            setPadBottom( point_type p )
            {
                _padBottom = p;
            }

            void
            setAlignHorizontal( HorizontalAlignment h )
            {
                _halign = h;
            }

            void
            setAlignVertical( VerticalAlignment v )
            {
                _valign = v;
            }

            void
            setCoordinateMode( CoordinateMode cm )
            {
                _coordMode = cm;
            }
            ...
            Color
            getImageColorAtXY( const XYCoord& xy ) const
            {
                return getImageColorAtXY( xy.x, xy.y );
            }

            Color
            getImageColorAtPointerXY( double x,
                                      double y ) const
            {
            ...
            HorizontalAlignment
            getAlignHorizontal() const
            {
                return _halign;
            }

            VerticalAlignment
            getAlignVertical() const
            {
                return _valign;
            }

            CoordinateMode
            getCoordinateMode() const
            {
                return _coordMode;
            }
            ...
            // This casts the bool _fill variable to be used in iteratively in functions
            // such as Window::_accumulate and whatnot.
            point_type
            getFillAsNumeric() const
            {
            ...
            point_type
            getMinWidthTotal() const
            {
                return _minWidth + getPadHorizontal();
            }

            point_type
            getMinHeightTotal() const
            {
        ...
        protected:
            ...
            point_type
            _calculateZ( unsigned int ) const;
            ...
            // Padding is the value of pixels of space between whatever the widget is
            // "contianed" in and the point at which it starts getting placed.
            point_type                      _padLeft;
            ...
            // This flag determines how sizing values are interpretted by
            // setDimensions().
            ...
            // This fill flag determines whether or not the widget will resize itself to
            ...
            // This variable is only used by the Window object to determine if it's
            // necessary to call managed().
            bool                            _isManaged;

            // This variable is like _isManaged; it is used to store whether the Widget
            // has been styled yet.
            bool                            _isStyled;

            // Set these variables to be the minimum size of a Widget so that it cannot
    ...
    struct NotifyWidget : public Widget
    {
            ...
            NotifyWidget( const std::string& n = "",
                          point_type         w = 0.0F,
                          point_type         h = 0.0F ) :
                Widget( n,
                        w,
            ...
            NotifyWidget( const NotifyWidget& widget,
                          const osg::CopyOp&  co ) :
                Widget( widget,
                        co )
            {
                        ...
                        const WindowManager* )
            {
                osg::notify( osg::NOTICE )
                    << _name << " > mouseEnter called" << std::endl;
            ...
            {
                osg::notify( osg::NOTICE )
                    << _name << " > mouseOver called" << std::endl;
            ...
            {
                osg::notify( osg::NOTICE )
                    << _name << " > mouseLeave called" << std::endl;
            ...
            {
                osg::notify( osg::NOTICE )
                    << _name << " > mouseDrag called" << std::endl;
            ...
            {
                osg::notify( osg::NOTICE )
                    << _name << " > mousePush called" << std::endl;
            ...
            {
                osg::notify( osg::NOTICE )
                    << _name << " > mouseRelease called" << std::endl;
            ...
            {
                osg::notify( osg::NOTICE )
                    << _name << " > mouseScroll called" << std::endl;
            ...
            {
                osg::notify( osg::NOTICE )
                    << _name << " > keyRelease called" << std::endl;
    ...
    struct NullWidget : public Widget
    {
            ...
            NullWidget( const NullWidget&  widget,
                        const osg::CopyOp& co ) :
                Widget( widget,
                        co )
            {
