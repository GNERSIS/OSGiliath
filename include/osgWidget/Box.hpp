...
namespace osgWidget
{
    ...
    class OSGWIDGET_EXPORT Box : public osg::Inherit<Window, Box>
    {
        public:
            ...
            //! The main constructor; takes the string name, the BoxType orientation, and
            //! a boolean indicating whether or not all of the Box regions should be
            //! uniformly sized.
