 ...
 * Damps particle linear velocity over time.
 * Applies configurable drag factor per axis.
 */
...
namespace osgParticle
{
    ...
    */
    class DampingOperator : public osg::Inherit<Operator, DampingOperator>
    {
        public:
            ...
            DampingOperator( const DampingOperator& copy,
        ...
        protected:
            ...
            DampingOperator&
            operator=( const DampingOperator& )
            {
                return *this;
            }
    ...
    inline void
    DampingOperator::operate( Particle* P,
                              double    dt )
    {
