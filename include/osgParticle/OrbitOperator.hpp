 ...
 * Applies orbital attraction/repulsion around a center point.
 * Creates spiral and vortex particle motion.
 */
...
namespace osgParticle
{
    ...
    */
    class OrbitOperator : public osg::Inherit<Operator, OrbitOperator>
    {
        public:
            ...
            OrbitOperator( const OrbitOperator& copy,
    ...
    inline void
    OrbitOperator::operate( Particle* P,
                            double    dt )
    {
    ...
    inline void
    OrbitOperator::beginOperate( Program* prg )
    {
