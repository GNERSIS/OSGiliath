 ...
 * Shoots particles in a radial pattern with configurable
 * theta/phi angle ranges and initial speed range.
 */
...
namespace osgParticle
{
    ...
    /**    A shooter class that shoots particles radially.
        ...
        the angle between the X axis and the velocity vector projected onto the X-Y
       plane.
    */
    class RadialShooter : public osg::Inherit<Shooter, RadialShooter>
    {
        public:

            inline RadialShooter();
            inline RadialShooter( const RadialShooter& copy,
            ...
            inline void
            setThetaRange( const rangef& r );

            /// Set the range of possible values for <B>theta</B> angle.
            inline void
            setThetaRange( float r1,
                           float r2 );
            ...
            inline const rangef&
            getInitialSpeedRange() const;

            /// Set the range of possible values for initial speed of particles.
            inline void
            setInitialSpeedRange( const rangef& r );

            /// Set the range of possible values for initial speed of particles.
            inline void
            setInitialSpeedRange( float r1,
                                  float r2 );

            /// Get the range of possible values for initial rotational speed of
            /// particles.
            inline const rangev3&
            getInitialRotationalSpeedRange() const;

            /// Set the range of possible values for initial rotational speed of
            /// particles.
            inline void
            setInitialRotationalSpeedRange( const rangev3& r );

            /// Set the range of possible values for initial rotational speed of
            /// particles.
            inline void
            setInitialRotationalSpeedRange( const osg::vec3& r1,
                                            const osg::vec3& r2 );

            /// Shoot a particle. Do not call this method manually.
            inline void
            shoot( Particle* P ) const;
    ...
    inline RadialShooter::RadialShooter() :
        _theta_range( 0,
                      static_cast<float>( 0.5 * osg::PI_4 ) ),
        _phi_range( 0,
                    static_cast<float>( 2.0 * osg::PI ) ),
        _speed_range( 10,
                      10 ),
        _rot_speed_range( osg::vec3( 0,
                                     0,
                                     0 ),
                          osg::vec3( 0,
                                     0,
    ...
    inline RadialShooter::RadialShooter( const RadialShooter& copy,
                                         const osg::CopyOp&   copyop ) :
        Inherit( copy,
                 copyop ),
    ...
    inline const rangef&
    RadialShooter::getThetaRange() const
    {
        return _theta_range;
    }

    inline const rangef&
    RadialShooter::getPhiRange() const
    {
        return _phi_range;
    }

    inline const rangef&
    RadialShooter::getInitialSpeedRange() const
    {
        return _speed_range;
    }

    inline const rangev3&
    RadialShooter::getInitialRotationalSpeedRange() const
    {
        return _rot_speed_range;
    }

    inline void
    RadialShooter::setThetaRange( const rangef& r )
    {
        _theta_range = r;
    }

    inline void
    RadialShooter::setThetaRange( float r1,
                                  float r2 )
    {
    ...
    inline void
    RadialShooter::setPhiRange( const rangef& r )
    {
        _phi_range = r;
    }

    inline void
    RadialShooter::setPhiRange( float r1,
                                float r2 )
    {
    ...
    inline void
    RadialShooter::setInitialSpeedRange( const rangef& r )
    {
        _speed_range = r;
    }

    inline void
    RadialShooter::setInitialSpeedRange( float r1,
                                         float r2 )
    {
    ...
    inline void
    RadialShooter::setInitialRotationalSpeedRange( const rangev3& r )
    {
        _rot_speed_range = r;
    }

    inline void
    RadialShooter::setInitialRotationalSpeedRange( const osg::vec3& r1,
                                                   const osg::vec3& r2 )
    {
    ...
    RadialShooter::shoot( Particle* P ) const
    {
        ...
        P->setVelocity( osg::vec3( speed * sinf( theta ) * cosf( phi ),
