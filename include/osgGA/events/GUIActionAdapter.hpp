 ...
 * Abstract interface for actions an event handler can request
 * (requestRedraw, requestContinuousUpdate, requestWarpPointer).
 */
#pragma once
    ...
    */
    ...
    class GUIActionAdapter
    {
        public:
            ...
            /** Provide a mechanism for getting the osg::View associated with this
            ...
            */
            virtual void
            requestContinuousUpdate( bool needed = true ) = 0;

            /**
            requestWarpPointer(int,int) is requesting a repositioning of the mouse
            pointer to a specified x,y location on the window.  This is used by some
            camera manipulators to initialise the mouse pointer when mouse position
            relative to a controls neutral mouse position is required, i.e when mimicking
            an aircraft joystick.
            */
            virtual void
