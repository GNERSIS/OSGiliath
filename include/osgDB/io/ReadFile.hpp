 ...
 * Convenience functions for loading scene graphs, images, and shaders
 * from files using the plugin registry.
 */
#pragma once
...
namespace osgDB
{
    ...
    extern OSGDB_EXPORT osg::ref_ptr<osg::Object>
                        readRefObjectFile( const std::string& filename,
    ...
    template<class T>
    inline osg::ref_ptr<T>
    readRefFile( const std::string& filename,
                 const Options*     options )
    {
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::ref_ptr<osg::Image>
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::ref_ptr<osg::HeightField>
                        readRefHeightFieldFile( const std::string& filename,
                                                const Options*     options );
     ...
     * for the filename extension, and this plugin then handles the request
     * to read the specified file.*/
    inline osg::ref_ptr<osg::HeightField>
    readRefHeightFieldFile( const std::string& filename )
    {
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::ref_ptr<osg::Node>
                        readRefNodeFile( const std::string& filename,
                                         const Options*     options );
    ...
    /** Read an osg::Node subgraph from files, creating a osg::Group to contain the nodes
     * if more than one subgraph has been loaded. Use the Options object to control cache
     * operations and file search paths in osgDB::Registry. Does NOT ignore strings
     * beginning with a dash '-' character. */
    extern OSGDB_EXPORT osg::ref_ptr<osg::Node>
                        readRefNodeFiles( std::vector<std::string>& fileList,
                                          const Options*            options );

    /** Read an osg::Node subgraph from files, creating a osg::Group to contain the nodes
     * if more than one subgraph has been loaded.*/
    inline osg::ref_ptr<osg::Node>
    readRefNodeFiles( std::vector<std::string>& fileList )
    {
    ...
    /** Read an osg::Node subgraph from files, creating a osg::Group to contain the nodes
     * if more than one subgraph has been loaded. Use the Options object to control cache
     * operations and file search paths in osgDB::Registry.*/
    extern OSGDB_EXPORT osg::ref_ptr<osg::Node>
                        readRefNodeFiles( osg::ArgumentParser& parser,
                                          const Options*       options );
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::ref_ptr<osg::Shader>
                        readRefShaderFile( const std::string& filename,
                                           const Options*     options );
     ...
     * read the specified file.*/
    inline osg::ref_ptr<osg::Shader>
    readRefShaderFile( osg::Shader::Type  type,
    ...
    /** Read an osg::Shader from file and set to specified shader type, if a shader isn't
     * loaded fallback to specific shader source. Use the Options object to control cache
     * operations and file search paths in osgDB::Registry. The osgDB::Registry is used
     * to load the appropriate ReaderWriter plugin for the filename extension, and this
     * plugin then handles the request to read the specified file.*/
    extern OSGDB_EXPORT osg::ref_ptr<osg::Shader>
                        readRefShaderFileWithFallback( osg::Shader::Type  type,
                                                       const std::string& filename,
                                                       const Options*     options,
                                                       const char*        fallback );

    /** Read an osg::Shader from file and set to specified shader type, if a shader isn't
     * loaded fallback to specific shader source. The osgDB::Registry is used to load the
     * appropriate ReaderWriter plugin for the filename extension, and this plugin then
     * handles the request to read the specified file.*/
    inline osg::ref_ptr<osg::Shader>
    readRefShaderFileWithFallback( osg::Shader::Type  type,
                                   const std::string& filename,
                                   const char*        fallback )
    {
        return osgDB::readRefShaderFileWithFallback( type,
                                                     filename,
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::ref_ptr<osg::Script>
                        readRefScriptFile( const std::string& filename,
                                           const Options*     options );
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::Object*
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::HeightField*
                        readHeightFieldFile( const std::string& filename,
                                             const Options*     options );
     ...
     * beginning with a dash '-' character. */
    extern OSGDB_EXPORT osg::Node*
                        readNodeFiles( std::vector<std::string>& fileList,
                                       const Options*            options );
     ...
     * operations and file search paths in osgDB::Registry.*/
    extern OSGDB_EXPORT osg::Node*
                        readNodeFiles( osg::ArgumentParser& parser,
                                       const Options*       options );
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::Shader*
     ...
     * read the specified file.*/
    inline osg::Shader*
    readShaderFile( osg::Shader::Type  type,
                    const std::string& filename,
                    const Options*     options )
    {
        osg::Shader* shader = readShaderFile( filename, options );
        if( shader && type != osg::Shader::UNDEFINED )
        {
            shader->setType( type );
        }
        return shader;
     ...
     * plugin then handles the request to read the specified file.*/
    inline osg::Shader*
    readShaderFileWithFallback( osg::Shader::Type  type,
                                const std::string& filename,
                                const Options*     options,
                                const char*        fallback )
    {
    ...
    readShaderFileWithFallback( osg::Shader::Type  type,
                                ...
                                const char*        fallback )
    {
        return osgDB::readShaderFileWithFallback( type,
                                                  filename,
                                                  Registry::instance()->getOptions(),
                                                  fallback );
    }
     ...
     * plugin for the filename extension, and this plugin then handles the request to
     * read the specified file.*/
    extern OSGDB_EXPORT osg::Script*
                        readScriptFile( const std::string& filename,
                                        const Options*     options );
