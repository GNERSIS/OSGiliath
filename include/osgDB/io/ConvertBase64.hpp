...
namespace osgDB
{
    ...
    class OSGDB_EXPORT Base64encoder
    {
        public:
            ...
            void
            encode( std::istream& istream_in,
                    std::ostream& ostream_in );

            void
            encode( const char*  chars_in,
                    int          length_in,
                    std::string& code_out );
