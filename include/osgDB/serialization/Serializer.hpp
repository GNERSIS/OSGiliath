 ...
 * Serialization property templates for ObjectWrapper. Provides
 * typed read/write for ints, floats, enums, vectors, and objects.
 */
...
#include <osgDB/serialization/OutputStream.hpp>
#include <sstream>
#include <string>
...
namespace osgDB
{
    ...
    class IntLookup
    {
        public:
            ...
            size() const
            {
                return static_cast<unsigned int>( _stringToValue.size() );
            }
...
#define BEGIN_USER_TABLE( NAME, CLASS )                                                 \
    ...
    static osgDB::UserLookupTableProxy s_user_lookup_table_##NAME(                      \
        &add_user_value_func_##NAME                                                     \
    );                                                                                  \
    static void add_user_value_func_##NAME( osgDB::IntLookup* lookup )                  \
    {                                                                                   \
...
#define USER_WRITE_FUNC( NAME, FUNCNAME )                                    \
    ...
    {                                                                        \
        if( os.isBinary() )                                                  \
            ...
            os << ( s_user_lookup_table_##NAME )._lookup.getString( value ); \
    }
    ...
    class BaseSerializer : public osg::Referenced
    {
        ...
        public:
            ...
            BaseSerializer( int usage ) :
                _firstVersion( 0 ),
                _lastVersion( INT_MAX ),
                _usage( usage )
            {
            }

            virtual bool
            set( osg::Object& /*object*/,
                 void* /*value*/ )
            {
                return false;
            }
            ...
            void
            setUsage( bool hasGetter,
                      bool hasSetter )
            {
                setUsage( ( ( hasGetter && hasSetter )
            ...
            bool
            supportsReadWrite() const
            {
                return ( _usage & READ_WRITE_PROPERTY ) != 0;
            }

            bool
            supportsGetSet() const
            {
                return ( _usage & GET_SET_PROPERTY ) != 0;
            }

            bool
            supportsGet() const
            {
                return ( _usage & GET_PROPERTY ) != 0;
            }

            bool
            supportsSet() const
            {
                return ( _usage & SET_PROPERTY ) != 0;
            }

        protected:

            int _firstVersion;    // Library version when the serializer is first
                                  // introduced
    ...
    class UserSerializer : public BaseSerializer
    {
        public:
            ...
            typedef bool ( *Reader )( InputStream&,
                                      C& );
            typedef bool ( *Writer )( OutputStream&,
                                      const C& );

            UserSerializer( const char* name,
                            Checker     cf,
                            Reader      rf,
                            Writer      wf ) :
                BaseSerializer( READ_WRITE_PROPERTY ),
    ...
    class PropByValSerializer : public TemplateSerializer<P>
    {
        public:
            ...
            PropByValSerializer( const char* name,
                                 P           def,
                                 Getter      gf,
                                 Setter      sf,
                                 bool        useHex = false ) :
    ...
    class PropByRefSerializer : public TemplateSerializer<P>
    {
        public:
            ...
            PropByRefSerializer( const char* name,
                                 CP          def,
                                 Getter      gf,
                                 Setter      sf ) :
                ParentType( name,
                   ...
                   const osg::Object& obj )
            {
                ...
                {
                    os << os.PROPERTY( ( ParentType::_name ).c_str() ) << value
                       << std::endl;
                }
                return true;
            }
    ...
    template<typename C>
    class MatrixSerializer : public TemplateSerializer<osg::dmat4>
    {
        public:

            typedef TemplateSerializer<osg::dmat4> ParentType;
            typedef const osg::dmat4&              ( C::*Getter )() const;
            typedef void                           ( C::*Setter )( const osg::dmat4& );

            MatrixSerializer( const char*       name,
                              const osg::dmat4& def,
                              Getter            gf,
                              Setter            sf ) :
                ParentType( name,
                   ...
                   const osg::Object& obj )
            {
                ...
                const C&          object = OBJECT_CAST<const C&>( obj );
                const osg::dmat4& value  = ( object.*_getter )();
                if( os.isBinary() )
                {
                    os << value;
                }
        ...
        protected:
            ...
            void
            readMatrixImplementation( InputStream& is,
                                      osg::dmat4&  matrix )
            {
#if 1
                is >> matrix;
    ...
    class GLenumSerializer : public TemplateSerializer<P>
    {
        public:
            ...
            GLenumSerializer( const char* name,
                              P           def,
                              Getter      gf,
                              Setter      sf ) :
                ParentType( name,
                   ...
                   const osg::Object& obj )
            {
                ...
                {
                    os << os.PROPERTY( ( ParentType::_name ).c_str() ) << GLENUM( value )
                       << std::endl;
                }
                return true;
            }
    ...
    class StringSerializer : public TemplateSerializer<std::string>
    {
        public:
            ...
            StringSerializer( const char*        name,
    ...
    class ObjectSerializer : public BaseSerializer
    {
        public:
            ...
            ObjectSerializer( const char* name,
                              P*          def,
                              Getter      gf,
                              Setter      sf ) :
                BaseSerializer( READ_WRITE_PROPERTY ),
                 ...
                 void*        value )
            {
                C& object = OBJECT_CAST<C&>( obj );
                ( object.*_setter )(
                    dynamic_cast<P*>( *( reinterpret_cast<osg::Object**>( value ) ) )
                );
                return true;
            }

            virtual bool
            get( const osg::Object& obj,
                 void*              value )
            {
                const C& object = OBJECT_CAST<const C&>( obj );
                *( reinterpret_cast<const osg::Object**>( value ) ) =
                    dynamic_cast<const osg::Object*>( ( object.*_getter )() );
                return true;
            }
    ...
    class ImageSerializer : public TemplateSerializer<P*>
    {
        public:
            ...
            ImageSerializer( const char* name,
                             P*          def,
                             Getter      gf,
                             Setter      sf ) :
                ParentType( name,
            ...
            {
                C& object = OBJECT_CAST<C&>( obj );
                ( object.*_setter )( *( reinterpret_cast<P**>( value ) ) );
                return true;
            }
            ...
            {
                const C& object                           = OBJECT_CAST<const C&>( obj );
                *( reinterpret_cast<const P**>( value ) ) = ( object.*_getter )();
                return true;
            }
    ...
    class EnumSerializer : public TemplateSerializer<P>
    {
        public:
            ...
            EnumSerializer( const char* name,
                            P           def,
                            Getter      gf,
                            Setter      sf ) :
                ParentType( name,
    ...
    class ListSerializer : public BaseSerializer
    {
        public:
            ...
            ListSerializer( const char* name,
                            Getter      gf,
                            Setter      sf ) :
                BaseSerializer( READ_WRITE_PROPERTY ),
                _name( name ),
                   ...
                   const osg::Object& obj )
            {
                ...
                {
                    os << os.PROPERTY( ( _name ).c_str() ) << size << os.BEGIN_BRACKET
                       << std::endl;
                    for( ConstIterator itr = list.begin(); itr != list.end(); ++itr )
                    {
                        os << ( *itr );
    ...
    class VectorBaseSerializer : public BaseSerializer
    {
        public:
            ...
            VectorBaseSerializer( BaseSerializer::Type elementType,
            ...
            size( const osg::Object& /*obj*/ ) const
            {
                return 0;
            }

            virtual void
            resize( osg::Object& /*obj*/,
                    unsigned int /*numElements*/ ) const
            {
            }

            virtual void
            reserve( osg::Object& /*obj*/,
                     unsigned int /*numElements*/ ) const
            {
            }

            virtual void
            clear( osg::Object& /*obj*/ ) const
            {
            }

            virtual void
            addElement( osg::Object& /*obj*/,
                        void* /*ptr*/ ) const
            {
            }

            virtual void
            insertElement( osg::Object& /*obj*/,
                           unsigned int /*index*/,
                           void* /*ptr*/ ) const
            {
            }
            ...
            virtual const void*
            getElement( const osg::Object& /*obj*/,
                        unsigned int /*index*/ ) const
            {
                return 0;
            }
    ...
    class VectorSerializer : public VectorBaseSerializer
    {
        public:
            ...
            VectorSerializer( const char*          name,
                              ConstGetter          cgf,
                              Getter               gf,
                              Setter               sf,
    ...
    class IsAVectorSerializer : public VectorBaseSerializer
    {
        public:
            ...
            IsAVectorSerializer( const char*          name,
                                 BaseSerializer::Type elementType,
                                 unsigned int         numElementsOnRow ) :
                VectorBaseSerializer( elementType,
                                      sizeof( ValueType ) ),
    ...
    class MapIteratorObject : public osg::Inherit<osg::Object, MapIteratorObject>
    {
        public:

            MapIteratorObject() :
                _keyType( BaseSerializer::RW_UNDEFINED ),
                _keySize( 0 ),
                _elementType( BaseSerializer::RW_UNDEFINED ),
                _elementSize( 0 )
            {
            }

            MapIteratorObject( BaseSerializer::Type keyType,
            ...
            MapIteratorObject( const MapIteratorObject& rhs,
                               const osg::CopyOp copyop = osg::CopyOp::SHALLOW_COPY ) :
                Inherit( rhs,
                         copyop ),
                _keyType( rhs._keyType ),
                _keySize( rhs._keySize ),
    ...
    class MapBaseSerializer : public BaseSerializer
    {
        public:
            ...
            MapBaseSerializer( BaseSerializer::Type keyType,
                               unsigned int         keySize,
                               BaseSerializer::Type elementType,
                               unsigned int         elementSize ) :
                BaseSerializer( READ_WRITE_PROPERTY | GET_SET_PROPERTY ),
            ...
            virtual MapIteratorObject*
            createIterator( osg::Object& /*obj*/ ) const
            {
                return 0;
            }

            virtual MapIteratorObject*
            createReverseIterator( osg::Object& /*obj*/ ) const
            {
                return 0;
            }
    ...
    class MapSerializer : public MapBaseSerializer
    {
        public:
            ...
            MapSerializer( const char*          name,
                           ConstGetter          cgf,
                           Getter               gf,
                           Setter               sf,
                           BaseSerializer::Type keyType,
                           BaseSerializer::Type elementType ) :
                MapBaseSerializer( keyType,
                                   sizeof( KeyType ),
                                   elementType,
                                   sizeof( ElementType ) ),
                _name( name ),
                        ...
                        void*        ptrValue ) const
            {
                C& object = OBJECT_CAST<C&>( obj );
                P& map    = ( object.*_getter )();
                map[*reinterpret_cast<KeyType*>( ptrKey )] =
                    *reinterpret_cast<ElementType*>( ptrValue );
            }
            ...
            {
                    MapIterator( BaseSerializer::Type keyType,
                                 unsigned int         keySize,
                                 BaseSerializer::Type elementType,
                                 unsigned int         elementSize,
                                 Iterator             itr,
                                 Iterator             endItr ) :
                        MapIteratorObject( keyType,
                                           keySize,
                                           elementType,
                                           elementSize ),
                        _itr( itr ),
                    ...
                    setElement( void* ptr ) const
                    {
                        if( valid() )
                        {
                            _itr->second = *reinterpret_cast<ElementType*>( ptr );
                        }
                    }
            };
            ...
            {
                    ReverseMapIterator( BaseSerializer::Type keyType,
                                        unsigned int         keySize,
                                        BaseSerializer::Type elementType,
                                        unsigned int         elementSize,
                                        ReverseIterator      itr,
                                        ReverseIterator      endItr ) :
                        MapIteratorObject( keyType,
                                           keySize,
                                           elementType,
                                           elementSize ),
            ...
            createIterator( osg::Object& obj ) const
            {
                C& object = OBJECT_CAST<C&>( obj );
                P& map    = ( object.*_getter )();
                return new MapIterator( _keyType,
                                        _keySize,
                                        _elementType,
                                        _elementSize,
                                        map.begin(),
            ...
            createReverseIterator( osg::Object& obj ) const
            {
                C& object = OBJECT_CAST<C&>( obj );
                P& map    = ( object.*_getter )();
                return new ReverseMapIterator( _keyType,
                                               _keySize,
                                               _elementType,
                                               _elementSize,
                                               map.rbegin(),
    ...
    class BitFlagsSerializer : public osgDB::TemplateSerializer<P>
    {
        public:
            ...
            BitFlagsSerializer( const char* name,
                                P           def,
                                Getter      gf,
                                Setter      sf ) :
                ParentType( name,
            ...
            getString( P value )
            {
                return _lookup.getString(
                    static_cast<osgDB::IntLookup::Value>( value )
                );
            }

            virtual bool
            read( osgDB::InputStream& is,
                  osg::Object&        obj )
            {
                C& object = OBJECT_CAST<C&>( obj );
                if( is.isBinary() )
                {
                    ...
                    {
                        bool ok = false;
                        is >> ok;    // code from user serialized ensuring
                ...
                else
                {
                    if( !is.matchString(
                            ParentType::_name
                        ) )    // code from user serialized ensuring
                               // backwards-compatibility
                    {
                        return true;
                    }
                   ...
                   const osg::Object&   obj )
            {
                ...
                else
                {
                    ...
                    const osgDB::IntLookup::ValueToString& v2sm =
                        _lookup.getValueToString();
                    for( osgDB::IntLookup::ValueToString::const_iterator itr =
                             v2sm.begin();
                         itr != v2sm.end();
                         itr++ )
                    {
...
#define ADD_USER_SERIALIZER( PROP )                                             \
    wrapper->addSerializer( new osgDB::UserSerializer<MyClass>( #PROP,          \
                                                                &check##PROP,   \
                                                                &read##PROP,    \
                                                                &write##PROP ), \
...
#define ADD_BOOL_SERIALIZER( PROP, DEF )                                      \
    wrapper->addSerializer(                                                   \
        new osgDB::PropByValSerializer<MyClass, bool>( #PROP,                 \
                                                       DEF,                   \
                                                       &MyClass::get##PROP,   \
                                                       &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_BOOL                                        \
    )

#define ADD_CHAR_SERIALIZER( PROP, DEF )                                      \
    wrapper->addSerializer(                                                   \
        new osgDB::PropByValSerializer<MyClass, char>( #PROP,                 \
                                                       DEF,                   \
                                                       &MyClass::get##PROP,   \
                                                       &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_CHAR                                        \
    )

#define ADD_UCHAR_SERIALIZER( PROP, DEF )                                              \
    wrapper->addSerializer(                                                            \
        new osgDB::PropByValSerializer<MyClass, unsigned char>( #PROP,                 \
                                                                DEF,                   \
                                                                &MyClass::get##PROP,   \
                                                                &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_UCHAR                                                \
    )

#define ADD_SHORT_SERIALIZER( PROP, DEF )                                      \
    wrapper->addSerializer(                                                    \
        new osgDB::PropByValSerializer<MyClass, short>( #PROP,                 \
                                                        DEF,                   \
                                                        &MyClass::get##PROP,   \
                                                        &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_SHORT                                        \
    )

#define ADD_USHORT_SERIALIZER( PROP, DEF )                                              \
    wrapper->addSerializer(                                                             \
        new osgDB::PropByValSerializer<MyClass, unsigned short>( #PROP,                 \
                                                                 DEF,                   \
                                                                 &MyClass::get##PROP,   \
                                                                 &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_USHORT                                                \
    )
...
#define ADD_INT_SERIALIZER( PROP, DEF )                                      \
    wrapper->addSerializer(                                                  \
        new osgDB::PropByValSerializer<MyClass, int>( #PROP,                 \
                                                      DEF,                   \
                                                      &MyClass::get##PROP,   \
                                                      &MyClass::set##PROP ), \
...
#define ADD_UINT_SERIALIZER( PROP, DEF )                                              \
    wrapper->addSerializer(                                                           \
        new osgDB::PropByValSerializer<MyClass, unsigned int>( #PROP,                 \
                                                               DEF,                   \
                                                               &MyClass::get##PROP,   \
                                                               &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_UINT                                                \
    )
...
#define ADD_GLINT_SERIALIZER( PROP, DEF )                                      \
    wrapper->addSerializer(                                                    \
        new osgDB::PropByValSerializer<MyClass, GLint>( #PROP,                 \
                                                        ( ( int )( DEF ) ),    \
                                                        &MyClass::get##PROP,   \
                                                        &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_INT                                          \
...
#define ADD_FLOAT_SERIALIZER( PROP, DEF )                                      \
    wrapper->addSerializer(                                                    \
        new osgDB::PropByValSerializer<MyClass, float>( #PROP,                 \
                                                        DEF,                   \
                                                        &MyClass::get##PROP,   \
                                                        &MyClass::set##PROP ), \
...
#define ADD_DOUBLE_SERIALIZER( PROP, DEF )                                      \
    wrapper->addSerializer(                                                     \
        new osgDB::PropByValSerializer<MyClass, double>( #PROP,                 \
                                                         DEF,                   \
                                                         &MyClass::get##PROP,   \
                                                         &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_DOUBLE                                        \
    )

#define ADD_REF_BOOL_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                   \
        new osgDB::PropByRefSerializer<MyClass, bool>( #PROP,                 \
                                                       DEF,                   \
                                                       &MyClass::get##PROP,   \
                                                       &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_BOOL                                        \
...
#define ADD_REF_CHAR_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                   \
        new osgDB::PropByRefSerializer<MyClass, char>( #PROP,                 \
                                                       DEF,                   \
                                                       &MyClass::get##PROP,   \
                                                       &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_CHAR                                        \
...
#define ADD_REF_UCHAR_SERIALIZER( PROP, DEF )                                          \
    wrapper->addSerializer(                                                            \
        new osgDB::PropByRefSerializer<MyClass, unsigned char>( #PROP,                 \
                                                                DEF,                   \
                                                                &MyClass::get##PROP,   \
                                                                &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_UCHAR                                                \
...
#define ADD_REF_SHORT_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                    \
        new osgDB::PropByRefSerializer<MyClass, short>( #PROP,                 \
                                                        DEF,                   \
                                                        &MyClass::get##PROP,   \
                                                        &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_SHORT                                        \
...
#define ADD_REF_USHORT_SERIALIZER( PROP, DEF )                                          \
    wrapper->addSerializer(                                                             \
        new osgDB::PropByRefSerializer<MyClass, unsigned short>( #PROP,                 \
                                                                 DEF,                   \
                                                                 &MyClass::get##PROP,   \
                                                                 &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_USHORT                                                \
...
#define ADD_REF_INT_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                  \
        new osgDB::PropByRefSerializer<MyClass, int>( #PROP,                 \
                                                      DEF,                   \
                                                      &MyClass::get##PROP,   \
                                                      &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_INT                                        \
...
#define ADD_REF_UINT_SERIALIZER( PROP, DEF )                                          \
    wrapper->addSerializer(                                                           \
        new osgDB::PropByRefSerializer<MyClass, unsigned int>( #PROP,                 \
                                                               DEF,                   \
                                                               &MyClass::get##PROP,   \
                                                               &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_UINT                                                \
...
#define ADD_REF_GLINT_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                    \
        new osgDB::PropByRefSerializer<MyClass, GLint>( #PROP,                 \
                                                        ( ( int )( DEF ) ),    \
                                                        &MyClass::get##PROP,   \
                                                        &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_INT                                          \
...
#define ADD_REF_FLOAT_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                    \
        new osgDB::PropByRefSerializer<MyClass, float>( #PROP,                 \
                                                        DEF,                   \
                                                        &MyClass::get##PROP,   \
                                                        &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_FLOAT                                        \
...
#define ADD_REF_DOUBLE_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                     \
        new osgDB::PropByRefSerializer<MyClass, double>( #PROP,                 \
                                                         DEF,                   \
                                                         &MyClass::get##PROP,   \
                                                         &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_DOUBLE                                        \
...
#define ADD_VEC2B_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::bvec2>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2B                                             \
    )

#define ADD_VEC2UB_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::ubvec2>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2UB                                             \
    )

#define ADD_VEC2S_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::svec2>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2S                                             \
    )

#define ADD_VEC2US_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::usvec2>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2US                                             \
    )

#define ADD_VEC2I_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::ivec2>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2I                                             \
    )

#define ADD_VEC2UI_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::uivec2>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2UI                                             \
    )

#define ADD_VEC2F_SERIALIZER( PROP, DEF )                                          \
    wrapper->addSerializer(                                                        \
        new osgDB::PropByRefSerializer<MyClass, osg::vec2>( #PROP,                 \
                                                            DEF,                   \
                                                            &MyClass::get##PROP,   \
                                                            &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2F                                            \
    )

#define ADD_VEC2D_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::dvec2>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC2D                                             \
    )
...
#define ADD_VEC3B_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::bvec3>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC3B                                             \
    )

#define ADD_VEC3UB_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::ubvec3>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC3UB                                             \
    )

#define ADD_VEC3S_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::svec3>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC3S                                             \
    )

#define ADD_VEC3US_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::usvec3>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC3US                                             \
    )

#define ADD_VEC3I_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::ivec3>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC3I                                             \
    )

#define ADD_VEC3UI_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::uivec3>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC3UI                                             \
    )

#define ADD_VEC3F_SERIALIZER( PROP, DEF )                                          \
    wrapper->addSerializer(                                                        \
        new osgDB::PropByRefSerializer<MyClass, osg::vec3>( #PROP,                 \
                                                            DEF,                   \
                                                            &MyClass::get##PROP,   \
                                                            &MyClass::set##PROP ), \
...
#define ADD_VEC3D_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::dvec3>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC3D                                             \
    )
...
#define ADD_VEC4B_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::bvec4>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4B                                             \
    )

#define ADD_VEC4UB_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::ubvec4>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4UB                                             \
    )

#define ADD_VEC4S_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::svec4>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4S                                             \
    )

#define ADD_VEC4US_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::usvec4>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4US                                             \
    )

#define ADD_VEC4I_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::ivec4>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4I                                             \
    )

#define ADD_VEC4UI_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::uivec4>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4UI                                             \
    )

#define ADD_VEC4F_SERIALIZER( PROP, DEF )                                          \
    wrapper->addSerializer(                                                        \
        new osgDB::PropByRefSerializer<MyClass, osg::vec4>( #PROP,                 \
                                                            DEF,                   \
                                                            &MyClass::get##PROP,   \
                                                            &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4F                                            \
    )

#define ADD_VEC4D_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::dvec4>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_VEC4D                                             \
    )
...
#define ADD_QUAT_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                        \
        new osgDB::PropByRefSerializer<MyClass, osg::quat>( #PROP,                 \
                                                            DEF,                   \
                                                            &MyClass::get##PROP,   \
                                                            &MyClass::set##PROP ), \
...
#define ADD_PLANE_SERIALIZER( PROP, DEF )                                           \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::Plane>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_PLANE                                             \
    )

#define ADD_MATRIXF_SERIALIZER( PROP, DEF )                                        \
    wrapper->addSerializer(                                                        \
        new osgDB::PropByRefSerializer<MyClass, osg::mat4>( #PROP,                 \
                                                            DEF,                   \
                                                            &MyClass::get##PROP,   \
                                                            &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_MATRIXF                                          \
    )

#define ADD_MATRIXD_SERIALIZER( PROP, DEF )                                         \
    wrapper->addSerializer(                                                         \
        new osgDB::PropByRefSerializer<MyClass, osg::dmat4>( #PROP,                 \
                                                             DEF,                   \
                                                             &MyClass::get##PROP,   \
                                                             &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_MATRIXD                                           \
    )

#define ADD_MATRIX_SERIALIZER( PROP, DEF )                           \
    wrapper->addSerializer(                                          \
        new osgDB::MatrixSerializer<MyClass>( #PROP,                 \
                                              DEF,                   \
                                              &MyClass::get##PROP,   \
                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_MATRIX                             \
    )

#define ADD_BOUNDINGBOXF_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                       \
        new osgDB::PropByRefSerializer<MyClass, osg::box>( #PROP,                 \
                                                           DEF,                   \
                                                           &MyClass::get##PROP,   \
                                                           &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_BOUNDINGBOXF                                    \
    )

#define ADD_BOUNDINGBOXD_SERIALIZER( PROP, DEF )                                   \
    wrapper->addSerializer(                                                        \
        new osgDB::PropByRefSerializer<MyClass, osg::dbox>( #PROP,                 \
                                                            DEF,                   \
                                                            &MyClass::get##PROP,   \
                                                            &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_BOUNDINGBOXD                                     \
    )

#define ADD_BOUNDINGSPHEREF_SERIALIZER( PROP, DEF )                                  \
    wrapper->addSerializer(                                                          \
        new osgDB::PropByRefSerializer<MyClass, osg::sphere>( #PROP,                 \
                                                              DEF,                   \
                                                              &MyClass::get##PROP,   \
                                                              &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_BOUNDINGSPHEREF                                    \
    )

#define ADD_BOUNDINGSPHERED_SERIALIZER( PROP, DEF )                                   \
    wrapper->addSerializer(                                                           \
        new osgDB::PropByRefSerializer<MyClass, osg::dsphere>( #PROP,                 \
                                                               DEF,                   \
                                                               &MyClass::get##PROP,   \
                                                               &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_BOUNDINGSPHERED                                     \
    )

#define ADD_GLENUM_SERIALIZER( PROP, TYPE, DEF )                           \
    wrapper->addSerializer(                                                \
        new osgDB::GLenumSerializer<MyClass, TYPE>( #PROP,                 \
                                                    DEF,                   \
                                                    &MyClass::get##PROP,   \
                                                    &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_GLENUM                                   \
    )
...
#define ADD_STRING_SERIALIZER( PROP, DEF )                           \
    wrapper->addSerializer(                                          \
        new osgDB::StringSerializer<MyClass>( #PROP,                 \
                                              DEF,                   \
                                              &MyClass::get##PROP,   \
                                              &MyClass::set##PROP ), \
...
#define ADD_OBJECT_SERIALIZER( PROP, TYPE, DEF )                           \
    wrapper->addSerializer(                                                \
        new osgDB::ObjectSerializer<MyClass, TYPE>( #PROP,                 \
                                                    DEF,                   \
                                                    &MyClass::get##PROP,   \
                                                    &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_OBJECT                                   \
    )
...
#define ADD_IMAGE_SERIALIZER( PROP, TYPE, DEF )                           \
    wrapper->addSerializer(                                               \
        new osgDB::ImageSerializer<MyClass, TYPE>( #PROP,                 \
                                                   DEF,                   \
                                                   &MyClass::get##PROP,   \
                                                   &MyClass::set##PROP ), \
...
#define ADD_LIST_SERIALIZER( PROP, TYPE )                                \
    wrapper->addSerializer(                                              \
        new osgDB::ListSerializer<MyClass, TYPE>( #PROP,                 \
                                                  &MyClass::get##PROP,   \
                                                  &MyClass::set##PROP ), \
        osgDB::BaseSerializer::RW_LIST                                   \
    )

#define ADD_VECTOR_SERIALIZER( PROP, TYPE, ELEMENTTYPE, NUMELEMENTSONROW ) \
    wrapper->addSerializer(                                                \
        new osgDB::VectorSerializer<MyClass, TYPE>( #PROP,                 \
                                                    &MyClass::get##PROP,   \
                                                    &MyClass::get##PROP,   \
                                                    &MyClass::set##PROP,   \
                                                    ELEMENTTYPE,           \
                                                    NUMELEMENTSONROW ),    \
        osgDB::BaseSerializer::RW_VECTOR                                   \
    )

#define ADD_ISAVECTOR_SERIALIZER( PROP, ELEMENTTYPE, NUMELEMENTSONROW ) \
    wrapper->addSerializer(                                             \
        new osgDB::IsAVectorSerializer<MyClass>( #PROP,                 \
                                                 ELEMENTTYPE,           \
                                                 NUMELEMENTSONROW ),    \
        osgDB::BaseSerializer::RW_VECTOR                                \
    )
...
#define BEGIN_ENUM_SERIALIZER( PROP, DEF )                                              \
    {                                                                                   \
        ...
        osg::ref_ptr<MySerializer> serializer = new MySerializer( #PROP,                \
                                                                  MyClass::DEF,         \
                                                                  &MyClass::get##PROP,  \
                                                                  &MyClass::set##PROP )
...
#define BEGIN_ENUM_SERIALIZER4( PROPERTIES_CLASS, PROP, DEF )                \
    {                                                                        \
        typedef osgDB::EnumSerializer<MyClass, PROPERTIES_CLASS::PROP, void> \
                                   MySerializer;                             \
        osg::ref_ptr<MySerializer> serializer =                              \
            new MySerializer( #PROP,                                         \
                              PROPERTIES_CLASS::DEF,                         \
                              &MyClass::get##PROP,                           \
                              &MyClass::set##PROP )
...
#define BEGIN_ENUM_SERIALIZER_NO_SET( PROP, DEF )                                 \
    {                                                                             \
        typedef osgDB::EnumSerializer<MyClass, MyClass::PROP, void> MySerializer; \
        osg::ref_ptr<MySerializer>                                  serializer =  \
            new MySerializer( #PROP, MyClass::DEF, &MyClass::get##PROP, 0 )
...
#define BEGIN_BITFLAGS_SERIALIZER( PROP, DEF )                                       \
    {                                                                                \
        ...
        osg::ref_ptr<MySerializer>                 serializer =                      \
            new MySerializer( #PROP, DEF, &MyClass::get##PROP, &MyClass::set##PROP )
...
#define ADD_MAP_SERIALIZER( PROP, TYPE, KEYTYPE, ELEMENTTYPE )        \
    wrapper->addSerializer(                                           \
        new osgDB::MapSerializer<MyClass, TYPE>( #PROP,               \
                                                 &MyClass::get##PROP, \
                                                 &MyClass::get##PROP, \
                                                 &MyClass::set##PROP, \
                                                 KEYTYPE,             \
                                                 ELEMENTTYPE ),       \
        osgDB::BaseSerializer::RW_MAP                                 \
    )
