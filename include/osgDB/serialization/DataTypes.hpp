 ...
 * Serialization data type identifiers. Enumerates the primitive
 * and compound types used by InputStream/OutputStream.
 */
...
#define OSG_HEADER_LOW  0X6C'91'0E'A1
#define OSG_HEADER_HIGH 0X1A'FB'45'45
    ...
    struct ObjectGLenum
    {
            ...
            ObjectGLenum( const ObjectGLenum& copy ) :
                _value( copy._value )
            {
            }
    ...
    class ObjectProperty
    {
        public:
            ...
            ObjectProperty( const ObjectProperty& copy ) :
                _name( copy._name ),
                _value( copy._value ),
                _mapProperty( copy._mapProperty )
            {
            }
    ...
    class ObjectMark
    {
        public:
            ...
            ObjectMark( const ObjectMark& copy ) :
                _name( copy._name ),
                _indentDelta( copy._indentDelta )
            {
            }
