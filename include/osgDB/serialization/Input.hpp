 ...
 * Legacy .osg format input helper. Provides tokenized reading
 * for the deprecated ASCII scene format parser.
 */
#pragma once
...
namespace osgDB
{
    ...
    struct basic_type_wrapper
    {
            ...
            virtual bool
            matches( const osg::Object* proto ) const = 0;
    };
    ...
    **/
    ...
    class OSGDB_EXPORT Field
    {
        public:
            ...
            int
            getNoCharacters() const
            {
                return _fieldCacheSize;
            }

            void
            setWithinQuotes( bool withinQuotes = true );
            bool
            getWithinQuotes();

            void
            setNoNestedBrackets( int no );
            int
            getNoNestedBrackets();
            ...
            isOpenBracket() const;
            bool
            isCloseBracket() const;

            bool
            isWord() const;
            bool
            matchWord( const char* str ) const;
            bool
            matchWord( const char* str,
                       int         noCharacters ) const;

            bool
            isString() const;
            bool
            matchString( const char* str ) const;
            bool
            matchString( const char* str,
                         int         noCharacters ) const;
            bool
            isQuotedString() const;
            ...
            isUInt() const;
            bool
            matchUInt( unsigned int i ) const;
            bool
            getUInt( unsigned int& i ) const;

            bool
            isFloat() const;
            bool
            matchFloat( float f ) const;
            bool
            getFloat( float& f ) const;
            bool
            getFloat( double& f ) const;

            static FieldType
            calculateFieldType( const char* str,
    ...
    class OSGDB_EXPORT FieldReader
    {
        public:
            ...
            virtual FieldReader&
            operator=( const FieldReader& ic );

            void
            attach( std::istream* input );
            void
            detach();
            ...
            bool
            readField( Field& fieldPtr );
            void
            ignoreField();

            /** no of unmatched `{' encountered so far in file*/
            int
            getNoNestedBrackets() const;

        private:

            bool
            _readField( Field* fieldPtr );
    ...
    class OSGDB_EXPORT FieldReaderIterator
    {
        public:
            ...
            FieldReaderIterator&
            operator=( const FieldReaderIterator& ic );
            ...
            void
            advanceToEndOfBlock( int noNestBrackets );

            bool
            matchSequence( const char* str );

            bool
            readSequence( const char*  keyword,
                          std::string& value );
            bool
            readSequence( const char*   keyword,
                          unsigned int& value );
            ...
            bool
            readSequence( std::string& value );
            bool
            readSequence( unsigned int& value );
            bool
            readSequence( int& value );
            bool
            readSequence( float& value );
            bool
            readSequence( osg::vec2& value );
            bool
            readSequence( osg::vec3& value );
            bool
            readSequence( osg::vec4& value );
            bool
            readSequence( osg::dvec2& value );
            bool
            readSequence( osg::dvec3& value );
            bool
            readSequence( osg::dvec4& value );
        ...
        private:
            ...
            _free();
            void
                        _copy( const FieldReaderIterator& ic );
    ...
    class OSGDB_EXPORT Input : public FieldReaderIterator
    {
        public:
            ...
            virtual osg::ref_ptr<osg::Object>
            ...
            virtual osg::ref_ptr<osg::Shader>
            readShader( const std::string& fileName );

            virtual osg::Object*
            getObjectForUniqueID( const std::string& uniqueID );
            virtual void
            registerUniqueIDForObject( const std::string& uniqueID,
                                       osg::Object*       obj );

            typedef osg::ArgumentParser::Parameter Parameter;

            bool
            read( Parameter value1 );
            bool
            read( Parameter value1,
                  Parameter value2 );
            bool
        ...
        private:
            ...
            typedef std::map<std::string, osg::ref_ptr<osg::Object>>
                                        UniqueIDToObjectMapping;
