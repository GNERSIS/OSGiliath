 ...
 * DLL export/import macros for the osgDB library.
 * Defines OSGDB_EXPORT for shared library symbol visibility.
 */
#pragma once
...
The osgDB library provides support for reading and writing scene graphs, providing a
plugin framework and file utility classes. The plugin framework in centered around the
osgDB::Registry, and allows plugins which provide specific file format support to be
