 ...
 * Color-mapped scalar bar (legend) for data visualization.
 * Displays a labeled color gradient mapped to a value range.
 */
#pragma once

#include <osg/core/Inherit.hpp>
#include <osg/nodes/Geode.hpp>
#include <osgSim/ColorRange.hpp>    // The default ScalarsToColors is a ColorRange
...
namespace osgSim
{
    ...
    */
    class OSGSIM_EXPORT ScalarBar : public osg::Inherit<osg::Geode, ScalarBar>
    {
        ...
        public:
            ...
            /**
            Users may provide their own ScalarPrinter by deriving from this base class
            and overriding the printScalar() method. Users may map the scalar float
            passed in to any string they wish.
            */
            ...
            text used to display the labels & title on the ScalarBar. Specifying a
            character size of 0 will cause the ScalarBar to estimate an appropriate size.
            Note that the attributes are public, and may be set directly.
            */
            ...
            @param aspectRatio  The aspect ration (y/x) for the displayed bar. Bear in
            mind you may want to change this if you change the orientation.
            @param sp           A ScalarPrinter object for the ScalarBar. For every
            displayed ScalarBar label, the scalar value will be passed to the
                                ScalarPrinter object to turn it into a string. Users may
                                override the default ScalarPrinter object to map scalars
            to whatever strings they wish. @see ScalarPrinter
            */
            ScalarBar( int                numColors,
                       int                numLabels,
                       ScalarsToColors*   stc,
            ...
            void
            setOrientation( ScalarBar::Orientation orientation );
