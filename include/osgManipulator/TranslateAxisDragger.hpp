...
namespace osgManipulator
{
    ...
    class OSGMANIPULATOR_EXPORT TranslateAxisDragger : public CompositeDragger
    {
        public:
             ...
             */
            void
            setPickCylinderRadius( float pickCylinderRadius );

            /** Retrieves the radius of the cylinders representing the axis lines for
             * picking. */
            float
            getPickCylinderRadius() const
            {
                return _pickCylinderRadius;
            }

            /** Sets the height of the cones. */
            void
            setConeHeight( float radius );
