...
namespace osgManipulator
{
    ...
    class DraggerCallback : public osg::Inherit<osg::Object, DraggerCallback>
    {
        public:
            ...
            DraggerCallback( const DraggerCallback& org,
    ...
    class OSGMANIPULATOR_EXPORT Constraint : public osg::Referenced
    {
        public:
            ...
            virtual bool
            constrain( MotionCommand& ) const
            {
                return false;
            }

            virtual bool
            constrain( TranslateInLineCommand& command ) const
            {
                return constrain( ( MotionCommand& )command );
            }

            virtual bool
            constrain( TranslateInPlaneCommand& command ) const
            {
                return constrain( ( MotionCommand& )command );
            }

            virtual bool
            constrain( Scale1DCommand& command ) const
            {
                return constrain( ( MotionCommand& )command );
            }

            virtual bool
            constrain( Scale2DCommand& command ) const
            {
                return constrain( ( MotionCommand& )command );
            }

            virtual bool
            constrain( ScaleUniformCommand& command ) const
            {
                return constrain( ( MotionCommand& )command );
            }

            virtual bool
            constrain( Rotate3DCommand& command ) const
            {
                return constrain( ( MotionCommand& )command );
            }
        ...
        protected:
            ...
            void
            computeLocalToWorldAndWorldToLocal() const;
    ...
    class OSGMANIPULATOR_EXPORT GridConstraint : public Constraint
    {
        public:
            ...
            GridConstraint( osg::Node&        refNode,
                            const osg::dvec3& origin,
                            const osg::dvec3& spacing );

            void
            setOrigin( const osg::dvec3& origin )
            {
                _origin = origin;
            }
            ...
            void
            setSpacing( const osg::dvec3& spacing )
            {
                _spacing = spacing;
            }
