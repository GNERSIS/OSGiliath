...
namespace osgManipulator
{
    ...
    class OSGMANIPULATOR_EXPORT AntiSquish : public osg::Transform
    {
        public:
            ...
            AntiSquish( const osg::dvec3& pivot,
                        const osg::dvec3& position );
            AntiSquish( const AntiSquish&  pat,
            ...
            {
                return new AntiSquish( *this, copyop );
            }

            virtual bool
            isSameKindAs( const osg::Object* obj ) const
            {
                return dynamic_cast<const AntiSquish*>( obj ) != NULL;
            }
            ...
            void
            setPosition( const osg::dvec3& pos )
            {
                _position    = pos;
                _usePosition = true;
                _cacheDirty  = true;
        ...
        protected:
            ...
            bool
                               computeUnSquishedMatrix( osg::dmat4& ) const;
