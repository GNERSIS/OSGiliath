...
namespace osgUtil
{
    ...
    class OSGUTIL_EXPORT BaseOptimizerVisitor : public osg::DualModeVisitor
    {
        public:

            BaseOptimizerVisitor( Optimizer*   optimizer,
                                  unsigned int operation ) :
                osg::DualModeVisitor( osg::DualModeVisitor::TRAVERSE_ALL_CHILDREN ),
                _optimizer( optimizer ),
                _operationType( operation )
            {
                setNodeMaskOverride( 0XFF'FF'FF'FF );
            }

            inline bool
            isOperationPermissibleForObject( const osg::StateSet* object ) const;
            inline bool
            isOperationPermissibleForObject( const osg::StateAttribute* object ) const;
            inline bool
            isOperationPermissibleForObject( const osg::Drawable* object ) const;
            inline bool
            isOperationPermissibleForObject( const osg::Node* object ) const;
    ...
    class OSGUTIL_EXPORT Optimizer
    {
        ...
        public:
            ...
            /** Reset internal data to initial state - the getPermissibleOptionsMap is
             * cleared.*/
            void
            reset();
            ...
            void
            optimize( osg::Node* node );

            template<class T>
            void
            optimize( const osg::ref_ptr<T>& node )
            {
                optimize( node.get() );
            }
            ...
            optimize( const osg::ref_ptr<T>& node,
                      unsigned int           options )
            {
                optimize( node.get(), options );
            }

            /** Callback for customizing what operations are permitted on objects in the
             * scene graph.*/
            struct IsOperationPermissibleForObjectCallback : public osg::Referenced
            {
                    ...
                    {
                        return optimizer->isOperationPermissibleForObjectImplementation(
                            stateset,
                            option
                        );
                    }
            ...
            /** Set the callback for customizing what operations are permitted on objects
             * in the scene graph.*/
            void
            setIsOperationPermissibleForObjectCallback(
                IsOperationPermissibleForObjectCallback* callback
            )
            {
                _isOperationPermissibleForObjectCallback = callback;
            }

            /** Get the callback for customizing what operations are permitted on objects
             * in the scene graph.*/
            IsOperationPermissibleForObjectCallback*
            getIsOperationPermissibleForObjectCallback()
            {
                return _isOperationPermissibleForObjectCallback.get();
            }

            /** Get the callback for customizing what operations are permitted on objects
             * in the scene graph.*/
            const IsOperationPermissibleForObjectCallback*
            ...
            inline void
            setPermissibleOptimizationsForObject( const osg::Object* object,
                                                  unsigned int       options )
            {
            ...
            inline unsigned int
            getPermissibleOptimizationsForObject( const osg::Object* object ) const
            {
                PermissibleOptimizationsMap::const_iterator itr =
                    _permissibleOptimizationsMap.find( object );
                if( itr != _permissibleOptimizationsMap.end() )
                {
                    return itr->second;
                }
                else
            ...
            inline bool
            isOperationPermissibleForObject( const osg::StateSet* object,
                                             unsigned int         option ) const
            {
                if( _isOperationPermissibleForObjectCallback.valid() )
                {
                    return _isOperationPermissibleForObjectCallback
                        ->isOperationPermissibleForObjectImplementation( this,
                                                                         object,
                                                                         option );
                }
                else
                {
                    return isOperationPermissibleForObjectImplementation( object,
                                                                          option );
                }
            }

            inline bool
            isOperationPermissibleForObject( const osg::StateAttribute* object,
                                             unsigned int               option ) const
            {
                if( _isOperationPermissibleForObjectCallback.valid() )
                {
            ...
            inline bool
            isOperationPermissibleForObject( const osg::Drawable* object,
                                             unsigned int         option ) const
            {
                if( _isOperationPermissibleForObjectCallback.valid() )
                {
            ...
            inline bool
            isOperationPermissibleForObject( const osg::Node* object,
                                             unsigned int     option ) const
            {
                if( _isOperationPermissibleForObjectCallback.valid() )
                {
            ...
            bool
            isOperationPermissibleForObjectImplementation( const osg::StateSet* stateset,
                                                           unsigned int option ) const
            {
                return ( option & getPermissibleOptimizationsForObject( stateset ) ) !=
                       0;
            }
            ...
            {
                return ( option & getPermissibleOptimizationsForObject( attribute ) ) !=
                       0;
            }

            bool
            isOperationPermissibleForObjectImplementation( const osg::Drawable* drawable,
                                                           unsigned int option ) const
            {
                if( option & ( REMOVE_REDUNDANT_NODES | MERGE_GEOMETRY ) )
                {
                    if( drawable->getUserData() )
                    {
                        return false;
                    }
                ...
                return ( option & getPermissibleOptimizationsForObject( drawable ) ) !=
                       0;
            }

            bool
            isOperationPermissibleForObjectImplementation( const osg::Node* node,
                                                           unsigned int option ) const
            {
                if( option & ( REMOVE_REDUNDANT_NODES |
                               COMBINE_ADJACENT_LODS |
                               FLATTEN_STATIC_TRANSFORMS ) )
                {
                    ...
                    if( node->getNodeMask() != 0XFF'FF'FF'FF )
                    {
                        return false;
                    }
        ...
        protected:
            ...
            typedef std::map<const osg::Object*, unsigned int>
        ...
        public:
             ...
             * to FlattenStaticTransformsVisitor in that it is designed to remove static
             * transforms from the scene graph, pushing down the transforms to the
             * geometry leaves of the scene graph, but with the difference that any
             * subgraphs that are shared between different transforms are duplicated and
             * flattened individually.  This results in more static transforms being
             * removed, but also means that more data is generated, and as a result may
             * not always be the most appropriate flatten visitor to use.*/
            class OSGUTIL_EXPORT FlattenStaticTransformsDuplicatingSharedSubgraphsVisitor
                : public BaseOptimizerVisitor
            {
                public:
                ...
                protected:
                    ...
                    void
                    transformGeode( osg::Geode& geode );
                    void
                    transformDrawable( osg::Drawable& drawable );
                    void
                    transformBillboard( osg::Billboard& billboard );

                    std::vector<osg::dmat4> _matrixStack;
            };

            /** Combine Static Transform nodes that sit above one another.*/
            class OSGUTIL_EXPORT CombineStaticTransformsVisitor
                : public BaseOptimizerVisitor
            {
                public:
                    ...
                    virtual void
                    apply( osg::MatrixTransform& transform );
                ...
                : public BaseOptimizerVisitor
            {
                public:
                    ...
                    bool
                    isOperationPermissible( osg::Node& node );
            ...
            class OSGUTIL_EXPORT RemoveLoadedProxyNodesVisitor
                : public BaseOptimizerVisitor
            {
                public:
            ...
            class OSGUTIL_EXPORT StateVisitor : public BaseOptimizerVisitor
            {
                public:
                                              ...
                                              SHARE_DUPLICATE_STATE )
                    {
                        ...
                        _optimize[static_cast<int>(
                            osg::Object::DataVariance::UNSPECIFIED
                ...
                protected:
                    ...
                    void
                    addStateSet( osg::StateSet* stateset,
                                 osg::Node*     node );

                    inline bool
                    optimize( osg::Object::DataVariance variance )
                    {
                        return _optimize[static_cast<int>( variance )];
                    }
            ...
            class OSGUTIL_EXPORT MergeGeodesVisitor : public BaseOptimizerVisitor
            {
                public:
                    ...
                    bool
                    mergeGeodes( osg::Group& group );

                protected:

                    bool
                    mergeGeode( osg::Geode& lhs,
                                osg::Geode& rhs );
            };
            ...
            class OSGUTIL_EXPORT MergeGeometryVisitor : public BaseOptimizerVisitor
            {
                public:
                    ...
                    MergeGeometryVisitor( Optimizer* optimizer = 0 ) :
                        BaseOptimizerVisitor( optimizer,
                                              MERGE_GEOMETRY ),
                        _targetMaximumNumberOfVertices( 10'000 )
                    {
                    }

                    void
                    setTargetMaximumNumberOfVertices( unsigned int num )
                    {
                        _targetMaximumNumberOfVertices = num;
                    }

                    unsigned int
                    getTargetMaximumNumberOfVertices() const
                    {
                    ...
                    bool
                    mergeGroup( osg::Group& group );

                    static bool
                    geometryContainsSharedArrays( osg::Geometry& geom );

                    static bool
                    mergeGeometry( osg::Geometry& lhs,
                                   osg::Geometry& rhs );

                    static bool
                    mergePrimitive( osg::DrawArrays& lhs,
                                    osg::DrawArrays& rhs );
                    static bool
                    mergePrimitive( osg::DrawArrayLengths& lhs,
                                    osg::DrawArrayLengths& rhs );
                    static bool
                    mergePrimitive( osg::DrawElementsUByte& lhs,
                                    osg::DrawElementsUByte& rhs );
                    static bool
                    mergePrimitive( osg::DrawElementsUShort& lhs,
                                    osg::DrawElementsUShort& rhs );
                    static bool
                    mergePrimitive( osg::DrawElementsUInt& lhs,
            ...
            class OSGUTIL_EXPORT SpatializeGroupsVisitor : public BaseOptimizerVisitor
            {
                public:
                    ...
                    bool
                    divide( unsigned int maxNumTreesPerCell = 8 );

                    bool
                    divide( osg::Group*  group,
                            unsigned int maxNumTreesPerCell );
                    bool
                    divide( osg::Geode*  geode,
                            unsigned int maxNumTreesPerCell );
            ...
            class OSGUTIL_EXPORT TextureVisitor : public BaseOptimizerVisitor
            {
                public:
                    ...
                    TextureVisitor( bool       changeAutoUnRef,
                                    bool       valueAutoUnRef,
            ...
            /** Texture Atlas Builder creates a set of textures/images which each contain
             * multiple images. Texture Atlas' are used to make it possible to use much
             * wider batching of data. */
            class OSGUTIL_EXPORT TextureAtlasBuilder
            {
                public:
                    ...
                    void
                    setMaximumAtlasSize( int width,
                                         int height );

                    int
                    getMaximumAtlasWidth() const
                    {
                        return _maximumAtlasWidth;
                    }

                    int
                    getMaximumAtlasHeight() const
                    {
                        return _maximumAtlasHeight;
                    }
                    ...
                    void
                    addSource( const osg::Image* image );
                    void
                    addSource( const osg::Texture2D* texture );

                    unsigned int
                    getNumSources() const
                    {
                        return static_cast<unsigned int>( _sourceList.size() );
                    }

                    const osg::Image*
                    getSourceImage( unsigned int i )
                    {
                        return _sourceList[i]->_image.get();
                    }

                    const osg::Texture2D*
                    getSourceTexture( unsigned int i )
                    {
                        return _sourceList[i]->_texture.get();
                    }

                    void
                    buildAtlas();
                    osg::Image*
                    getImageAtlas( unsigned int i );
                    osg::Texture2D*
                    getTextureAtlas( unsigned int i );
                    osg::dmat4
                    getTextureMatrix( unsigned int i );

                    osg::Image*
                    getImageAtlas( const osg::Image* image );
                    osg::Texture2D*
                    getTextureAtlas( const osg::Image* image );
                    osg::dmat4
                    getTextureMatrix( const osg::Image* image );

                    osg::Image*
                    getImageAtlas( const osg::Texture2D* textue );
                    osg::Texture2D*
                    getTextureAtlas( const osg::Texture2D* texture );
                    osg::dmat4
                    getTextureMatrix( const osg::Texture2D* texture );
                ...
                protected:
                    ...
                    class Source : public osg::Referenced
                    {
                        public:
                            ...
                            bool
                            suitableForAtlas( int maximumAtlasWidth,
                                              int maximumAtlasHeight,
                                              int margin );
                            osg::dmat4
                            computeTextureMatrix() const;
                    ...
                    class Atlas : public osg::Referenced
                    {
                        public:
                            ...
                            int                          _height;
                            unsigned int
                                _indexFirstOfRow;    ///< Contain the index of the first
                            ...
                            FitsIn
                            doesSourceFit( Source* source );
                            bool
                            addSource( Source* source );
                            void
                            clampToNearestPowerOfTwoSize();
                            void
                            copySources();
                    ...
                    Source*
                    getSource( const osg::Image* image );
                    Source*
                               getSource( const osg::Texture2D* texture );
                ...
                private:
                    ...
                    {
                            bool
                            operator()( osg::ref_ptr<Source> src1,
                                        osg::ref_ptr<Source> src2 ) const
                            {
                    ...
                    void
                    completeRow( unsigned int indexAtlas );
            };

            /** Optimize texture usage in the scene graph by combining textures into
             * texture atlas Use of texture atlas cuts down on the number of separate
             * states in the scene, reducing state changes and improving the chances of
             * using larger batches of geometry.*/
            ...
            /** Optimize the setting of StateSet and Geometry objects in scene so that
             * they have a STATIC DataVariance when they don't have any callbacks
             * associated with them. */
            class OSGUTIL_EXPORT StaticObjectDetectionVisitor
                : public BaseOptimizerVisitor
            {
                public:
            ...
            class OSGUTIL_EXPORT BufferObjectVisitor : public BaseOptimizerVisitor
            {
                public:
                    ...
                    BufferObjectVisitor( bool       changeVBO,
                                         bool       valueVBO,
                                         bool       changeVertexArrayObject,
                                         bool       valueVertexArrayObject,
                                         Optimizer* optimizer = 0 ) :
                        BaseOptimizerVisitor( optimizer,
                                              BUFFER_OBJECT_SETTINGS ),
                        _changeVertexBufferObject( changeVBO ),
                        _valueVertexBufferObject( valueVBO ),
                        _changeVertexArrayObject( changeVertexArrayObject ),
                        _valueVertexArrayObject( valueVertexArrayObject )
                    {
                    }

                    virtual void
                         apply( osg::Geometry& geometry );
    ...
    inline bool
    BaseOptimizerVisitor::isOperationPermissibleForObject(
        const osg::StateSet* object
    ) const
    {
        return _optimizer
                 ? _optimizer->isOperationPermissibleForObject( object, _operationType )
                 : true;
    }

    inline bool
    BaseOptimizerVisitor::isOperationPermissibleForObject(
        const osg::StateAttribute* object
    ) const
    {
        return _optimizer
                 ? _optimizer->isOperationPermissibleForObject( object, _operationType )
