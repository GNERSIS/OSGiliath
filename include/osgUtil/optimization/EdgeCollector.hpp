...
namespace osgUtil
{
    ...
    class OSGUTIL_EXPORT EdgeCollector
    {
        public:
            ...
            typedef std::map<osg::ref_ptr<Triangle>, unsigned int, dereference_less>
                TriangleMap;
            ...
            struct OSGUTIL_EXPORT Edge : public osg::Referenced
            {
                    ...
                    bool
                    endConnected( const Edge& rhs ) const
                    {
                        return ( _op2 == rhs._op1 );
                    }

                    bool
                    beginConnected( const Edge& rhs ) const
                    {
                        return ( _op1 == rhs._op2 );
                    }
            };
            ...
            struct OSGUTIL_EXPORT Edgeloop : public osg::Referenced
            {
                    ...
                    {
                        return (
                            _edgeList.back()->endConnected( *_edgeList.front().get() )
                        );
                    }
            ...
            void
            getBoundaryEdgeList( EdgeList& el );
            bool
            extractBoundaryEdgeloop( EdgeList& el,
                                     Edgeloop& edgeloop );
            bool
            extractBoundaryEdgeloopList( EdgeList&     el,
                                         EdgeloopList& edgeloopList );

            void
                           getEdgeloopIndexList( IndexArrayList& ial );
