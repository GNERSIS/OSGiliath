...
namespace osgUtil
{
    ...
    class OSGUTIL_EXPORT IndexMeshVisitor : public GeometryCollector
    {
        public:
            ...
            IndexMeshVisitor( Optimizer* optimizer = 0 ) :
                ...
                _generateNewIndicesOnAllGeometries( false )
            {
            }

            inline void
            setGenerateNewIndicesOnAllGeometries( bool b )
            {
                _generateNewIndicesOnAllGeometries = b;
            }

            inline bool
            getGenerateNewIndicesOnAllGeometries() const
            {
                return _generateNewIndicesOnAllGeometries;
            }

            void
            makeMesh( osg::Geometry& geom );
            void
            makeMesh();
    ...
    class OSGUTIL_EXPORT VertexCacheVisitor : public GeometryCollector
    {
        public:
            ...
            void
            optimizeVertices( osg::Geometry& geom );
            void
            optimizeVertices();
        ...
        private:
            ...
            void
            doVertexOptimization( osg::Geometry&         geom,
                                  std::vector<unsigned>& vertDrawList );
    };

    // Gather statistics on post-transform cache misses for geometry
    class OSGUTIL_EXPORT VertexCacheMissVisitor : public osg::DualModeVisitor
    {
        public:
    ...
    class OSGUTIL_EXPORT VertexAccessOrderVisitor : public GeometryCollector
    {
            ...
            {
                    inline bool
                    operator()( const osg::ref_ptr<osg::PrimitiveSet>& prim1,
        ...
        public:
            ...
            optimizeOrder();
            void
            optimizeOrder( osg::Geometry& geom );
    };
    ...
    class OSGUTIL_EXPORT SharedArrayOptimizer
    {
        public:
            ...
            void
            findDuplicatedUVs( const osg::Geometry& geometry );
            void
            deduplicateUVs( osg::Geometry& geometry );
