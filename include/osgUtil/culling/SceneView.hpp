...
namespace osgUtil
{
     ...
     */
    class OSGUTIL_EXPORT SceneView : public osg::Inherit<osg::Object, SceneView>,
                                     public osg::CullSettings
    {
        public:
             ...
             */
            virtual void
            setDefaults( unsigned int options );
             ...
             */
            osg::Node*
            getSceneData( unsigned int childNo = 0 )
            {
             ...
             */
            const osg::Node*
            getSceneData( unsigned int childNo = 0 ) const
            {
                return ( _camera->getNumChildren() > childNo )
                         ? _camera->getChild( childNo )
                         : 0;
            ...
            unsigned int
            getNumSceneData() const
            {
                return _camera->getNumChildren();
            }
            ...
            inline void
            setDisplaySettings( osg::DisplaySettings* vs )
            {
                _displaySettings = vs;
            }
            ...
            /** Manually set the redraw interlaced stereo stencil mask request flag to
             * control whether to redraw the stencil buffer on the next frame.*/
            void
            setRedrawInterlacedStereoStencilMask( bool flag )
            {
                _redrawInterlacedStereoStencilMask = flag;
            }

            /** Get the redraw interlaced stereo stencil mask request flag.*/
            bool
            getRedrawInterlacedStereoStencilMask() const
            {
                return _redrawInterlacedStereoStencilMask;
            }

            void
            setGlobalStateSet( osg::StateSet* state )
            {
                _globalStateSet = state;
            }
            ...
            const osg::StateSet*
            getGlobalStateSet() const
            {
                return _globalStateSet.get();
            }

            void
            setSecondaryStateSet( osg::StateSet* state )
            {
            ...
            const osg::StateSet*
            getSecondaryStateSet() const
            {
                return _secondaryStateSet.get();
            }

            void
            setLocalStateSet( osg::StateSet* state )
            {
                _localStateSet = state;
            }
            ...
            void
            setActiveUniforms( int activeUniforms )
            {
            ...
            {
                _light = light;
                if( _light.valid() && _lightingMode != NO_SCENEVIEW_LIGHT )
                {
                    osg::StateSet* ss = _secondaryStateSet.valid()
                                          ? _secondaryStateSet.get()
                                          : _globalStateSet.get();
                    if( ss )
                    {
                        ss->setAttributeAndModes( _light.get(),
             ...
             * camera. */
            inline void
            setProjectionMatrix( const osg::mat4& matrix )
            {
             ...
             * camera. */
            inline void
            setProjectionMatrix( const osg::dmat4& matrix )
            {
                _camera->setProjectionMatrix( matrix );
            }

            /** Set to an orthographic projection. See OpenGL glOrtho documentation for
             * further details.*/
            void
            setProjectionMatrixAsOrtho( double left,
                                        double right,
                                        double bottom,
                                        double top,
                                        double zNear,
             ...
             * for further details.*/
            void
            setProjectionMatrixAsOrtho2D( double left,
                                          double right,
                                          double bottom,
                                          double top );
             ...
             * further details.*/
            void
            setProjectionMatrixAsFrustum( double left,
                                          double right,
                                          double bottom,
                                          double top,
                                          double zNear,
             ...
             * width/height.*/
            void
            setProjectionMatrixAsPerspective( double fovy,
                                              double aspectRatio,
                                              double zNear,
                                              double zFar );
            ...
            bool
            getProjectionMatrixAsOrtho( double& left,
                                        double& right,
                                        double& bottom,
                                        double& top,
                                        double& zNear,
             ...
             * values are undefined.*/
            bool
            getProjectionMatrixAsFrustum( double& left,
                                          double& right,
                                          double& bottom,
                                          double& top,
                                          double& zNear,
             ...
             * matrix then the shear will be lost. Asymmetric matrices occur when stereo,
             * power walls, caves and reality center display are used. In these
             * configurations one should use the 'getProjectionMatrixAsFrustum' method
             * instead.*/
            bool
            getProjectionMatrixAsPerspective( double& fovy,
                                              double& aspectRatio,
                                              double& zNear,
                                              double& zFar ) const;
            ...
            inline void
            setViewMatrix( const osg::mat4& matrix )
            {
             ...
             * world relative to the camera in camera coordinates. */
            inline void
            setViewMatrix( const osg::dmat4& matrix )
            {
                _camera->setViewMatrix( matrix );
            }

            /** Set the position and orientation components of the view matrix, using the
             * same convention as gluLookAt. */
            void
            setViewMatrixAsLookAt( const osg::vec3& eye,
            ...
            /** Get the position and orientation components of a modelview matrix, using
             * the same convention as gluLookAt. */
            void
            getViewMatrixAsLookAt( osg::vec3& eye,
                                   osg::vec3& center,
                                   osg::vec3& up,
                                   float      lookDistance = 1.0F ) const;

            void
            setInitVisitor( osg::NodeVisitor* av )
            {
                _initVisitor = av;
            }
            ...
            getInitVisitor() const
            {
                return _initVisitor.get();
            }

            void
            setUpdateVisitor( osg::NodeVisitor* av )
            {
                _updateVisitor = av;
            }
            ...
            const osg::NodeVisitor*
            getUpdateVisitor() const
            {
                return _updateVisitor.get();
            }

            void
            setCullVisitor( osgUtil::CullVisitor* cv )
            {
                _cullVisitor = cv;
            }
            ...
            const osgUtil::CullVisitor*
            getCullVisitor() const
            {
                return _cullVisitor.get();
            }

            void
            setCullVisitorLeft( osgUtil::CullVisitor* cv )
            {
                _cullVisitorLeft = cv;
            }
            ...
            getCullVisitorLeft()
            {
                return _cullVisitorLeft.get();
            }

            const osgUtil::CullVisitor*
            getCullVisitorLeft() const
            {
                return _cullVisitorLeft.get();
            }

            void
            setCullVisitorRight( osgUtil::CullVisitor* cv )
            {
                _cullVisitorRight = cv;
            }

            osgUtil::CullVisitor*
            getCullVisitorRight()
            {
                return _cullVisitorRight.get();
            }

            const osgUtil::CullVisitor*
            getCullVisitorRight() const
            {
                return _cullVisitorRight.get();
            }

            void
            setCollectOccludersVisitor( osg::CollectOccludersVisitor* cov )
            {
            ...
            const osg::CollectOccludersVisitor*
            getCollectOccludersVisitor() const
            {
                return _collectOccludersVisitor.get();
            }

            void
            setStateGraph( osgUtil::StateGraph* rg )
            {
                _stateGraph = rg;
            }
            ...
            void
            setStateGraphLeft( osgUtil::StateGraph* rg )
            {
                _stateGraphLeft = rg;
            }
            ...
            getStateGraphLeft()
            {
                return _stateGraphLeft.get();
            }

            const osgUtil::StateGraph*
            getStateGraphLeft() const
            {
                return _stateGraphLeft.get();
            }

            void
            setStateGraphRight( osgUtil::StateGraph* rg )
            {
                _stateGraphRight = rg;
            }
            ...
            getStateGraphRight()
            {
                return _stateGraphRight.get();
            }

            const osgUtil::StateGraph*
            getStateGraphRight() const
            {
                return _stateGraphRight.get();
            }

            void
            setRenderStage( osgUtil::RenderStage* rs )
            {
                _renderStage = rs;
            }
            ...
            const osgUtil::RenderStage*
            getRenderStage() const
            {
                return _renderStage.get();
            }

            void
            setRenderStageLeft( osgUtil::RenderStage* rs )
            {
                _renderStageLeft = rs;
            }
            ...
            getRenderStageLeft()
            {
                return _renderStageLeft.get();
            }

            const osgUtil::RenderStage*
            getRenderStageLeft() const
            {
                return _renderStageLeft.get();
            }

            void
            setRenderStageRight( osgUtil::RenderStage* rs )
            {
                _renderStageRight = rs;
            }

            osgUtil::RenderStage*
            getRenderStageRight()
            {
                return _renderStageRight.get();
            }

            const osgUtil::RenderStage*
            getRenderStageRight() const
            {
                return _renderStageRight.get();
            }

            /** search through any pre and post RenderStages that reference a Camera, and
            ...
            /** Set the draw buffer value used at the start of each frame draw.  Note,
             * overridden in quad buffer stereo mode */
            void
            setDrawBufferValue( GLenum drawBufferValue )
            {
            ...
            GLenum
            getDrawBufferValue() const
            {
                return _camera->getDrawBuffer();
            }
            ...
            enum FusionDistanceMode
            {
                ...
                /** Compute the fusion distance by multiplying the screen distance by the
                 * fusion distance value.*/
                PROPORTIONAL_TO_SCREEN_DISTANCE,
            };

            /** Set the FusionDistanceMode and Value. Note, is used only when working in
             * stereo.*/
            void
            setFusionDistance( FusionDistanceMode mode,
                               float              value = 1.0F )
            {
            ...
            void
            setPrioritizeTextures( bool pt )
            {
                _prioritizeTextures = pt;
            }

            /** Get whether the draw method should call renderer->prioritizeTexture.*/
            bool
            getPrioritizeTextures() const
            {
                return _prioritizeTextures;
            }
            ...
            {
                    virtual osg::dmat4
                    computeLeftEyeProjection( const osg::dmat4& projection ) const = 0;
                    virtual osg::dmat4
                    computeLeftEyeView( const osg::dmat4& view ) const = 0;

                    virtual osg::dmat4
                    computeRightEyeProjection( const osg::dmat4& projection ) const = 0;
                    virtual osg::dmat4
                    computeRightEyeView( const osg::dmat4& view ) const = 0;
            };

            void
            setComputeStereoMatricesCallback( ComputeStereoMatricesCallback* callback )
            {
                _computeStereoMatricesCallback = callback;
            }
            ...
            getComputeStereoMatricesCallback() const
            {
                return _computeStereoMatricesCallback.get();
            }
            ...
            /** Calculate the object coordinates of a point in window coordinates.
               ...
               previously called for projectWindowIntoObject to produce valid values.
               Consistent with OpenGL, window coordinates are calculated relative to the
               bottom left of the window. Returns true on successful projection.
            */
            bool
            projectWindowIntoObject( const osg::vec3& window,
                                     osg::vec3&       object ) const;

            /** Calculate the object coordinates of a window x,y when projected onto the
               near and far planes. Note, current implementation requires that
               SceneView::draw() has been previously called for projectWindowIntoObject
               to produce valid values. Consistent with OpenGL, window coordinates are
               calculated relative to the bottom left of the window. Returns true on
               successful projection.
            */
            bool
            projectWindowXYIntoObject( int        x,
                                       int        y,
                                       osg::vec3& near_point,
            ...
            /** Calculate the window coordinates of a point in object coordinates.
               ...
               previously called for projectWindowIntoObject to produce valid values.
               Consistent with OpenGL, window coordinates are calculated relative to the
               bottom left of the window, whereas window API's normally have the top left
               as the origin, so you may need to pass in
               (mouseX,window_height-mouseY,...). Returns true on successful projection.
            */
            bool
            ...
            inline osg::dmat4
            computeLeftEyeProjection( const osg::dmat4& projection ) const
            {
                if( _computeStereoMatricesCallback.valid() )
                {
                    return _computeStereoMatricesCallback->computeLeftEyeProjection(
                        projection
                    );
                }
                else
                {
                    return computeLeftEyeProjectionImplementation( projection );
                }
            }

            inline osg::dmat4
            computeLeftEyeView( const osg::dmat4& view ) const
            {
                if( _computeStereoMatricesCallback.valid() )
                {
                ...
                {
                    return computeLeftEyeViewImplementation( view );
                }
            }

            inline osg::dmat4
            computeRightEyeProjection( const osg::dmat4& projection ) const
            {
                if( _computeStereoMatricesCallback.valid() )
                {
                    return _computeStereoMatricesCallback->computeRightEyeProjection(
                        projection
                    );
                }
                else
                {
                    return computeRightEyeProjectionImplementation( projection );
                }
            }

            inline osg::dmat4
            computeRightEyeView( const osg::dmat4& view ) const
            {
                if( _computeStereoMatricesCallback.valid() )
                {
                ...
                {
                    return computeRightEyeViewImplementation( view );
                }
            }

            /** helper function for computing the left eye projection matrix.*/
            virtual osg::dmat4
            computeLeftEyeProjectionImplementation( const osg::dmat4& projection ) const;

            /** helper function for computing the left eye view matrix.*/
            virtual osg::dmat4
            computeLeftEyeViewImplementation( const osg::dmat4& view ) const;

            /** helper function for computing the right eye view matrix.*/
            virtual osg::dmat4
            computeRightEyeProjectionImplementation(
                const osg::dmat4& projection
            ) const;

            /** helper function for computing the right eye view matrix.*/
            virtual osg::dmat4
            computeRightEyeViewImplementation( const osg::dmat4& view ) const;

            /** Inherit the local cull settings variable from a specified CullSettings
             * object, according to the inheritance mask.*/
            virtual void
            inheritCullSettings( const osg::CullSettings& settings )
            {
            ...
            /** Release all OpenGL objects from the scene graph, such as texture objects,
             * display lists, etc. These released scene graphs are placed in the
             * respective delete GLObjects cache, and then need to be deleted in OpenGL
             * by SceneView::flushAllDeleteGLObjects(). */
            virtual void
            releaseAllGLObjects();
            ...
            /** Flush deleted OpenGL objects, such as texture objects, display lists,
             * etc., within the specified available time.*/
            virtual void
            flushDeletedGLObjects( double& availableTime );

            /** Extract stats for current draw list. */
            bool
            getStats( Statistics& primStats );

            /** Set whether the SceneView should automatically call flushDeletedObjects()
             * on each new frame.*/
            void
            setAutomaticFlush( bool automaticFlush )
            {
                _automaticFlush = automaticFlush;
            }

            bool
            getAutomaticFlush() const
            {
                return _automaticFlush;
            }

            void
            setResetColorMaskToAllOn( bool enable )
            {
                _resetColorMaskToAllEnabled = enable;
            }

            bool
            getResetColorMaskToAllOn() const
            {
                return _resetColorMaskToAllEnabled;
            }
        ...
        protected:
            ...
            virtual bool
            cullStage( const osg::dmat4&     projection,
            ...
            void
            computeLeftEyeViewport( const osg::Viewport* viewport );
            void
            computeRightEyeViewport( const osg::Viewport* viewport );
