...
namespace osg
{
     ...
     *
     *   If INCR_WRAP or DECR_WRAP values are used while they are detected to be not
     * supported, the INCR or DECR values are sent to OpenGL instead.
     *
     *   OpenGL 2.0 introduced two side stenciling that is available through
     *   osg::StencilTwoSided class.
     */
    class OSG_EXPORT Stencil : public osg::Inherit<StateAttribute, Stencil>
    {
        public:
            ...
            inline int
            getFunctionRef() const
            {
                return _funcRef;
            }

            inline void
            setFunctionMask( unsigned int mask )
            {
                _funcMask = mask;
            }

            inline unsigned int
            getFunctionMask() const
            {
                return _funcMask;
            }
            ...
            inline void
            setStencilFailOperation( Operation sfail )
            {
                _sfail = sfail;
            }
             ...
             * fails.*/
            inline void
            setStencilPassAndDepthFailOperation( Operation zfail )
            {
                _zfail = zfail;
            }
             ...
             * fails.*/
            inline Operation
            getStencilPassAndDepthFailOperation() const
            {
                return _zfail;
            }
            ...
            inline void
            setStencilPassAndDepthPassOperation( Operation zpass )
            {
                _zpass = zpass;
            }
            ...
            inline Operation
            getStencilPassAndDepthPassOperation() const
            {
                return _zpass;
            }

            inline void
            setWriteMask( unsigned int mask )
            {
                _writeMask = mask;
            }
