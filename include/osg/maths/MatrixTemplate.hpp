 ...
 * Template matrix utilities providing common operations
 * (preMult, postMult, ortho, frustum) for both mat4 and dmat4.
 */
...
namespace osg
{
    ...
    //
    // If you define an Uniform with type Uniform::FLOAT_MAT4X2 and so use a Matrix4x2 to
    // setup your Uniform, like this : 1 2 3 4 5 6 7 8
    //
    // you will get in your shader a Column Major dmat4 like this :
    // 1 3 5 7
    // 2 4 6 8
    //
    ...
    class TemplateMatrix
    {
        ...
        public:
            ...
            TemplateMatrix&
            operator=( const TemplateMatrix& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
            ...
            void
            set( const TemplateMatrix& rhs )
            {
                set( rhs.data() );
            }

            void
            set( const value_type* const ptr )
            {
            ...
            reset()
            {
                for( int i = 0; i < value_count; ++i )
                {
                    ptr()[i] = static_cast<value_type>( 0.0 );
                }
            }
    ...
    class Matrix2Template : public TemplateMatrix<T, 2, 2>
    {
        ...
        public:
            ...
            Matrix2Template( value_type a00,
                             value_type a01,
                             value_type a10,
                             value_type a11 )
            {
            ...
            Matrix2Template&
            operator=( const Matrix2Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
            ...
            set( value_type a00,
                 ...
                 value_type a11 )
            {
                base_class::_mat[0][0] = a00;
                base_class::_mat[0][1] = a01;
                base_class::_mat[1][0] = a10;
                base_class::_mat[1][1] = a11;
            }
    ...
    class Matrix2x3Template : public TemplateMatrix<T, 2, 3>
    {
        ...
        public:
            ...
            Matrix2x3Template( value_type a00,
                               value_type a01,
                               value_type a02,
                               value_type a10,
                               value_type a11,
            ...
            Matrix2x3Template&
            operator=( const Matrix2x3Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
                 ...
                 value_type a12 )
            {
                base_class::_mat[0][0] = a00;
                base_class::_mat[0][1] = a01;
                base_class::_mat[0][2] = a02;
                base_class::_mat[1][0] = a10;
                base_class::_mat[1][1] = a11;
                base_class::_mat[1][2] = a12;
            }
    };
    ...
    class Matrix2x4Template : public TemplateMatrix<T, 2, 4>
    {
        ...
        public:
            ...
            Matrix2x4Template( value_type a00,
                               value_type a01,
                               value_type a02,
                               value_type a03,
                               value_type a10,
            ...
            Matrix2x4Template&
            operator=( const Matrix2x4Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
                 ...
                 value_type a13 )
            {
                ...
                base_class::_mat[0][1] = a01;
                base_class::_mat[0][2] = a02;
                base_class::_mat[0][3] = a03;
                base_class::_mat[1][0] = a10;
                base_class::_mat[1][1] = a11;
                base_class::_mat[1][2] = a12;
                base_class::_mat[1][3] = a13;
            }
    };
    ...
    class Matrix3x2Template : public TemplateMatrix<T, 3, 2>
    {
        ...
        public:
            ...
            Matrix3x2Template( value_type a00,
                               value_type a01,
                               value_type a10,
                               value_type a11,
                               value_type a20,
            ...
            Matrix3x2Template&
            operator=( const Matrix3x2Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
                 ...
                 value_type a21 )
            {
                ...
                base_class::_mat[1][0] = a10;
                base_class::_mat[1][1] = a11;
                base_class::_mat[2][0] = a20;
                base_class::_mat[2][1] = a21;
            }
    };
    ...
    class Matrix3Template : public TemplateMatrix<T, 3, 3>
    {
        ...
        public:
            ...
            Matrix3Template( value_type a00,
                             value_type a01,
                             value_type a02,
                             value_type a10,
                             value_type a11,
            ...
            Matrix3Template&
            operator=( const Matrix3Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
    ...
    class Matrix3x4Template : public TemplateMatrix<T, 3, 4>
    {
        ...
        public:
            ...
            Matrix3x4Template( value_type a00,
                               value_type a01,
                               value_type a02,
                               value_type a03,
                               value_type a10,
                               ...
                               value_type a23 )
            {
                set( a00, a01, a02, a03, a10, a11, a12, a13, a20, a21, a22, a23 );
            }
            ...
            Matrix3x4Template&
            operator=( const Matrix3x4Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
    ...
    class Matrix4x2Template : public TemplateMatrix<T, 4, 2>
    {
        ...
        public:
            ...
            Matrix4x2Template( value_type a00,
                               value_type a01,
                               value_type a10,
                               value_type a11,
                               value_type a20,
                               ...
                               value_type a31 )
            {
                set( a00, a01, a10, a11, a20, a21, a30, a31 );
            }
            ...
            Matrix4x2Template&
            operator=( const Matrix4x2Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
                 ...
                 value_type a31 )
            {
                ...
                base_class::_mat[2][0] = a20;
                base_class::_mat[2][1] = a21;
                base_class::_mat[3][0] = a30;
                base_class::_mat[3][1] = a31;
            }
    };
    ...
    class Matrix4x3Template : public TemplateMatrix<T, 4, 3>
    {
        ...
        public:
            ...
            Matrix4x3Template( value_type a00,
                               value_type a01,
                               value_type a02,
                               value_type a10,
                               value_type a11,
            ...
            Matrix4x3Template&
            operator=( const Matrix4x3Template& rhs )
            {
                if( &rhs == this )
                {
                    return *this;
