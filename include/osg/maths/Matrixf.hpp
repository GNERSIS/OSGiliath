...
namespace osg
{
    ...
    class OSG_EXPORT mat4
    {
        public:

            using value_type       = float;
            using other_value_type = double;
            ...
            inline mat4( const mat4& mat ) noexcept
            {
                set( mat.data() );
            }

            mat4( const dmat4& mat ) noexcept;

            inline explicit mat4( const float* const ptr ) noexcept
            {
                set( ptr );
            }

            inline explicit mat4( const double* const ptr ) noexcept
            {
                set( ptr );
            }

            inline explicit mat4( const quat& quat ) noexcept
            {
                makeRotate( quat );
            }
            ...
            int
            compare( const mat4& m ) const noexcept;

            bool
            operator<( const mat4& m ) const noexcept
            {
                return compare( m ) < 0;
            }
            ...
            inline mat4&
            operator=( const mat4& rhs ) noexcept
            {
                if( &rhs == this )
                {
                    return *this;
            ...
            inline bool
            invert( const mat4& rhs ) noexcept
            {
            ...
            bool
            invert_4x3( const mat4& rhs ) noexcept;

            /** full 4x4 matrix invert. */
            bool
            invert_4x4( const mat4& rhs ) noexcept;

            /** transpose matrix **/
            bool
            transpose( const mat4& rhs ) noexcept;

            /** transpose orthogonal part of the matrix **/
            bool
            transpose3x3( const mat4& rhs ) noexcept;

            /** ortho-normalize the 3x3 rotation & scale matrix */
            void
            orthoNormalize( const mat4& rhs ) noexcept;
            ...
            inline static mat4
            inverse( const mat4& matrix ) noexcept;
            inline static mat4
            orthoNormal( const mat4& matrix ) noexcept;
            ...
            mult( const mat4&,
                  const mat4& ) noexcept;
            void
            preMult( const mat4& ) noexcept;
            void
            postMult( const mat4& ) noexcept;
            ...
            /** Binary vector add. */
            inline mat4
            operator+( const mat4& rhs ) const noexcept
            {
                return mat4( _mat[0][0] + rhs._mat[0][0],
                    ...
                    public mat4
    {
        public:
            ...
            RefMat4( const mat4& other ) :
                Object( false ),
                mat4( other )
            {
            }

            RefMat4( const dmat4& other ) :
                Object( false ),
                mat4( other )
            {
            }

            RefMat4( const RefMat4& other ) :
                Object( other ),
                mat4( other )
            {
            }

            explicit RefMat4( const mat4::value_type* const def ) :
                Object( false ),
                mat4( def )
            {
            }

            RefMat4( mat4::value_type a00,
                     mat4::value_type a01,
                     mat4::value_type a02,
                     mat4::value_type a03,
                     mat4::value_type a10,
            ...
            {
                return new RefMat4( *this );
            }

            virtual bool
            isSameKindAs( const Object* obj ) const
            {
                return dynamic_cast<const RefMat4*>( obj ) != NULL;
            }
    ...
    inline mat4
    mat4::scale( const dvec3& v ) noexcept
    {
        return scale( v.x, v.y, v.z );
    }

    inline mat4
    mat4::translate( value_type tx,
                     value_type ty,
                     value_type tz ) noexcept
    {
        mat4 m;
    ...
    inline mat4
    mat4::translate( const dvec3& v ) noexcept
    {
        return translate( v.x, v.y, v.z );
    }

    inline mat4
    mat4::rotate( const quat& q ) noexcept
    {
        return mat4( q );
    }

    inline mat4
    mat4::rotate( value_type angle,
                  value_type x,
                  value_type y,
                  value_type z ) noexcept
    {
    ...
    inline mat4
    mat4::inverse( const mat4& matrix ) noexcept
    {
        mat4 m;
        m.invert( matrix );
        return m;
    ...
    inline mat4
    mat4::orthoNormal( const mat4& matrix ) noexcept
    {
        mat4 m;
    ...
    inline vec3
    mat4::postMult( const vec3& v ) const noexcept
    {
        value_type d =
            1.0F /
    ...
    inline dvec3
    mat4::postMult( const dvec3& v ) const noexcept
    {
        value_type d =
            1.0F /
            ( _mat[3][0] * v.x + _mat[3][1] * v.y + _mat[3][2] * v.z + _mat[3][3] );
    ...
    inline vec3
    mat4::preMult( const vec3& v ) const noexcept
    {
        value_type d =
            1.0F /
    ...
    inline dvec3
    mat4::preMult( const dvec3& v ) const noexcept
    {
        value_type d =
            1.0F /
            ( _mat[0][3] * v.x + _mat[1][3] * v.y + _mat[2][3] * v.z + _mat[3][3] );
    ...
    inline vec4
    mat4::postMult( const vec4& v ) const noexcept
    {
        return vec4(
    ...
    inline dvec4
    mat4::postMult( const dvec4& v ) const noexcept
    {
        return dvec4(
            _mat[0][0] * v.x + _mat[0][1] * v.y + _mat[0][2] * v.z + _mat[0][3] * v.w,
            _mat[1][0] * v.x + _mat[1][1] * v.y + _mat[1][2] * v.z + _mat[1][3] * v.w,
    ...
    inline vec4
    mat4::preMult( const vec4& v ) const noexcept
    {
        return vec4(
    ...
    inline dvec4
    mat4::preMult( const dvec4& v ) const noexcept
    {
        return dvec4(
            _mat[0][0] * v.x + _mat[1][0] * v.y + _mat[2][0] * v.z + _mat[3][0] * v.w,
            _mat[0][1] * v.x + _mat[1][1] * v.y + _mat[2][1] * v.z + _mat[3][1] * v.w,
    ...
    inline vec3
    mat4::transform3x3( const vec3& v,
                        const mat4& m ) noexcept
    {
    ...
    inline dvec3
    mat4::transform3x3( const dvec3& v,
                        const mat4&  m ) noexcept
    {
    ...
    inline vec3
    mat4::transform3x3( const mat4& m,
                        const vec3& v ) noexcept
    {
    ...
    inline void
    mat4::preMultTranslate( const dvec3& v ) noexcept
    {
    ...
    inline void
    mat4::preMultTranslate( const vec3& v ) noexcept
    {
        for( unsigned i = 0; i < 3; ++i )
        {
            float tmp = v[i];
    ...
    inline void
    mat4::postMultTranslate( const dvec3& v ) noexcept
    {
        for( unsigned i = 0; i < 3; ++i )
        {
            double tmp = v[i];
    ...
    inline void
    mat4::postMultTranslate( const vec3& v ) noexcept
    {
        for( unsigned i = 0; i < 3; ++i )
        {
            float tmp = v[i];
    ...
    inline void
    mat4::preMultScale( const dvec3& v ) noexcept
    {
        _mat[0][0] *= v[0];
        _mat[0][1] *= v[0];
        _mat[0][2] *= v[0];
    ...
    inline void
    mat4::preMultScale( const vec3& v ) noexcept
    {
        _mat[0][0] *= v[0];
        _mat[0][1] *= v[0];
        _mat[0][2] *= v[0];
    ...
    inline void
    mat4::postMultScale( const dvec3& v ) noexcept
    {
        _mat[0][0] *= v[0];
        _mat[1][0] *= v[0];
        _mat[2][0] *= v[0];
    ...
    inline void
    mat4::postMultScale( const vec3& v ) noexcept
    {
        _mat[0][0] *= v[0];
        _mat[1][0] *= v[0];
        _mat[2][0] *= v[0];
    ...
    inline void
    mat4::preMultRotate( const quat& q ) noexcept
    {
        if( q.zeroRotation() )
        {
            return;
    ...
    inline void
    mat4::postMultRotate( const quat& q ) noexcept
    {
        if( q.zeroRotation() )
        {
            return;
    ...
    inline vec3
    mat4::operator*( const vec3& v ) const noexcept
    {
        return postMult( v );
    }

    inline dvec3
    mat4::operator*( const dvec3& v ) const noexcept
    {
        return postMult( v );
    }

    inline vec4
    mat4::operator*( const vec4& v ) const noexcept
    {
        return postMult( v );
    }

    inline dvec4
    mat4::operator*( const dvec4& v ) const noexcept
    {
        return postMult( v );
    }
