...
namespace osg
{
    ...
    /** LOD - Level Of Detail group node which allows switching between children
        ...
        n are ignored.
    */
    class OSG_EXPORT LOD : public osg::Inherit<Group, LOD>
    {
        public:
            ...
            enum CenterMode
            {
                USE_BOUNDING_SPHERE_CENTER,    ///< Uses the bounding sphere's center as
                                               ///< the center of object and the
                                               ///< geometrical bounding sphere of the
                                               ///< node's children
                USER_DEFINED_CENTER,    ///< Uses the user defined center as the center
                                        ///< of object; the bounding sphere is determined
                                        ///< by the user defined center and user defined
                                        ///< radius
                UNION_OF_BOUNDING_SPHERE_AND_USER_DEFINED,    ///< Uses the user defined
                                                              ///< center as the center
                                                              ///< of object; the
                                                              ///< bounding sphere is the
                                                              ///< user defined bounding
                                                              ///< sphere expanded by the
                                                              ///< geometrical bounding
                                                              ///< sphere of the node's
                                                              ///< children
            };
             ...
             * @param radius Radius must be larger or equal to zero. If the radius is
             * smaller than zero the geometrical bounding sphere of the node's children
             * is used as the LOD's bounding sphere regardless of the center mode
             * setting.
            ...
            /** Set how the range values should be interpreted when computing which child
             * is active.*/
            void
            setRangeMode( RangeMode mode )
            {
                _rangeMode = mode;
            }

            /** Get how the range values should be interpreted when computing which child
             * is active.*/
            RangeMode
            getRangeMode() const
            {
            ...
            /** Sets the min and max visible ranges of range of specific child.
               ...
               coordinates.*/
            void
            setRange( unsigned int childNo,
                      float        min,
                      float        max );

            /** returns the min visible range for specified child.*/
            inline float
            getMinRange( unsigned int childNo ) const
            {
            ...
            inline float
            getMaxRange( unsigned int childNo ) const
            {
