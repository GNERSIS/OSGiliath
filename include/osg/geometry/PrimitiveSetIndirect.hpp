...
namespace osg
{
    ...
    class OSG_EXPORT IndirectCommandDrawArrays : public BufferData
    {
        public:
            ...
            IndirectCommandDrawArrays() :
                BufferData()
            {
                setBufferObject( new DrawIndirectBufferObject() );
            }

            IndirectCommandDrawArrays( const IndirectCommandDrawArrays& copy,
            ...
            virtual unsigned int&
            count( const unsigned int& index ) = 0;
            virtual unsigned int&
            instanceCount( const unsigned int& index ) = 0;
            virtual unsigned int&
            first( const unsigned int& index ) = 0;
            virtual unsigned int&
            baseInstance( const unsigned int& index ) = 0;
            ...
            virtual void
            reserveElements( const unsigned int ) = 0;
            virtual void
            resizeElements( const unsigned int ) = 0;
    };
    ...
    class OSG_EXPORT IndirectCommandDrawElements : public BufferData
    {
        public:
            ...
            IndirectCommandDrawElements( const IndirectCommandDrawElements& copy,
                                         const CopyOp&
            ...
            instanceCount( const unsigned int& index ) = 0;
            virtual unsigned int&
            firstIndex( const unsigned int& index ) = 0;
            virtual unsigned int&
            baseVertex( const unsigned int& index ) = 0;
            virtual unsigned int&
            baseInstance( const unsigned int& index ) = 0;
    ...
    {
            DrawArraysIndirectCommand( unsigned int pcount         = 0,
    ...
    class DefaultIndirectCommandDrawArrays
        : public osg::Inherit<IndirectCommandDrawArrays,
                              DefaultIndirectCommandDrawArrays>,
          public MixinVector<DrawArraysIndirectCommand>
    {
        public:
            ...
            DefaultIndirectCommandDrawArrays() :
                Inherit(),
                MixinVector<DrawArraysIndirectCommand>()
            {
            }

            DefaultIndirectCommandDrawArrays( const DefaultIndirectCommandDrawArrays&
                                                  copy,
                                              const CopyOp&
                                                  copyop /*=CopyOp::SHALLOW_COPY*/ ) :
                Inherit( copy,
            ...
            virtual void
            reserveElements( const unsigned int n )
            {
                reserve( n );
            }

            virtual void
            resizeElements( const unsigned int n )
            {
                resize( n );
            }

            virtual unsigned int&
            count( const unsigned int& index )
            {
                return at( index ).count;
            }

            virtual unsigned int&
            instanceCount( const unsigned int& index )
            {
                return at( index ).instanceCount;
            }

            virtual unsigned int&
            first( const unsigned int& index )
            {
                return at( index ).first;
            }

            virtual unsigned int&
            baseInstance( const unsigned int& index )
            {
    ...
    {
            DrawElementsIndirectCommand( unsigned int pcount         = 0,
                                         unsigned int pinstanceCount = 0,
    ...
    class DefaultIndirectCommandDrawElements
        : public osg::Inherit<IndirectCommandDrawElements,
                              DefaultIndirectCommandDrawElements>,
          public MixinVector<DrawElementsIndirectCommand>
    {
        public:
            ...
            DefaultIndirectCommandDrawElements() :
                Inherit(),
                MixinVector<DrawElementsIndirectCommand>()
            {
            }

            DefaultIndirectCommandDrawElements( const DefaultIndirectCommandDrawElements&
                                                    copy,
                                                const CopyOp&
                                                    copyop /*=CopyOp::SHALLOW_COPY*/ ) :
                Inherit( copy,
            ...
            virtual unsigned int&
            firstIndex( const unsigned int& index )
            {
                return at( index ).firstIndex;
            }

            virtual unsigned int&
            baseVertex( const unsigned int& index )
            {
    ...
    class OSG_EXPORT DrawElementsIndirect : public DrawElements
    {
        public:
            ...
            DrawElementsIndirect( Type         primType     = PrimitiveType,
                                  GLenum       mode         = 0,
                                  unsigned int firstCommand = 0,
                                  GLsizei      stride       = 0 ) :
                ...
                _stride( stride )
            {
                setIndirectCommandArray( new DefaultIndirectCommandDrawElements() );
            }
            ...
            DrawElementsIndirect( const DrawElementsIndirect& rhs,
                ...
                DrawElements( rhs,
                              copyop ),
                _firstCommand( rhs._firstCommand ),
                _stride( rhs._stride )
            {
                _indirectCommandArray = ( DefaultIndirectCommandDrawElements* )copyop(
                    rhs._indirectCommandArray.get()
                );
            }

            /// set command array of this indirect primitive set
            inline void
            setIndirectCommandArray( IndirectCommandDrawElements* idc )
            {
                _indirectCommandArray = idc;
                // ensure bo of idc is of the correct type
                if( !dynamic_cast<DrawIndirectBufferObject*>(
                        _indirectCommandArray->getBufferObject()
                    ) )
                {
                    _indirectCommandArray->setBufferObject(
                        new DrawIndirectBufferObject()
                    );
                }
            }

            /// get command array of this indirect primitive set
            inline IndirectCommandDrawElements*
            getIndirectCommandArray()
            {
                return _indirectCommandArray.get();
            }

            inline const IndirectCommandDrawElements*
            getIndirectCommandArray() const
            {
                return _indirectCommandArray.get();
            }

            /// Further methods are for advanced DI when you plan to use your own
            /// IndirectCommandElement (stride) or if you want to draw a particular
            /// command index of the IndirectCommandElement(FirstCommandToDraw)

            /// set offset of the first command to draw in the IndirectCommandDrawArrays
            inline void
            setFirstCommandToDraw( unsigned int i )
            {
                _firstCommand = i;
            }
    ...
    ///
    class OSG_EXPORT DrawElementsIndirectUByte : public DrawElementsIndirect,
                                                 public VectorGLubyte
    {
        public:
            ...
            DrawElementsIndirectUByte(
                GLenum mode = 0 /*,unsigned int firstCommand = 0, GLsizei stride = 0*/
            ) :
                DrawElementsIndirect( DrawElementsUByteIndirectPrimitiveType,
                                      mode )
            {
            }

            DrawElementsIndirectUByte( const DrawElementsIndirectUByte& array,
                                       const CopyOp& copyop = CopyOp::SHALLOW_COPY ) :
                DrawElementsIndirect( array,
                                      copyop ),
                vector_type( array )
            {
            }
            ...
            /**
             * \param mode One of osg::PrimitiveSet::Mode. Determines the type of
             * primitives used.
             * \param no Number of intended elements. This will be the size of the
             * underlying vector.
             * \param ptr Pointer to a GLubyte to copy index data from.
             */
            DrawElementsIndirectUByte( GLenum         mode,
                                       unsigned int   no,
                                       const GLubyte* ptr ) :
                DrawElementsIndirect( DrawElementsUByteIndirectPrimitiveType,
                                      mode ),
            ...
            virtual void
            accept( PrimitiveFunctor& functor ) const;
            virtual void
            accept( PrimitiveIndexFunctor& functor ) const;
            ...
            virtual void
            resizeElements( unsigned int numIndices )
            {
                resize( numIndices );
            }

            virtual void
            reserveElements( unsigned int numIndices )
            {
                reserve( numIndices );
            }
    ...
    ///
    class OSG_EXPORT DrawElementsIndirectUShort : public DrawElementsIndirect,
                                                  public VectorGLushort
    {
        public:
            ...
            DrawElementsIndirectUShort(
                ...
                DrawElementsIndirect( DrawElementsUShortIndirectPrimitiveType,
                                      mode )
            {
            }

            DrawElementsIndirectUShort( const DrawElementsIndirectUShort& array,
                                        const CopyOp& copyop = CopyOp::SHALLOW_COPY ) :
                DrawElementsIndirect( array,
                                      copyop ),
                vector_type( array )
             ...
             */
            DrawElementsIndirectUShort( GLenum          mode,
                                        unsigned int    no,
                                        const GLushort* ptr ) :
                DrawElementsIndirect( DrawElementsUShortIndirectPrimitiveType,
                                      mode ),
    ...
    ///
    class OSG_EXPORT DrawElementsIndirectUInt : public DrawElementsIndirect,
                                                public VectorGLuint
    {
        public:
            ...
            DrawElementsIndirectUInt(
                ...
                DrawElementsIndirect( DrawElementsUIntIndirectPrimitiveType,
                                      mode )
            {
            }

            DrawElementsIndirectUInt( const DrawElementsIndirectUInt& array,
                                      const CopyOp& copyop = CopyOp::SHALLOW_COPY ) :
                DrawElementsIndirect( array,
                                      copyop ),
                vector_type( array )
             ...
             */
            DrawElementsIndirectUInt( GLenum        mode,
                                      unsigned int  no,
                                      const GLuint* ptr ) :
                DrawElementsIndirect( DrawElementsUIntIndirectPrimitiveType,
                                      mode ),
    ...
    class OSG_EXPORT MultiDrawElementsIndirectUShort : public DrawElementsIndirectUShort
    {
        public:
            ...
            MultiDrawElementsIndirectUShort( const MultiDrawElementsIndirectUShort& mdi,
                                             const CopyOp& copyop =
                                                 CopyOp::SHALLOW_COPY ) :
                DrawElementsIndirectUShort( mdi,
                                            copyop ),
                _count( mdi._count )
            {
            }
             ...
             * \param ptr Pointer to a GLunsigned int to copy index data from.
             */
            MultiDrawElementsIndirectUShort( GLenum          mode,
                                             unsigned int    no,
                                             const GLushort* ptr ) :
                DrawElementsIndirectUShort( mode,
                                            no,
            ...
            {
                return dynamic_cast<const MultiDrawElementsIndirectUShort*>( obj ) !=
                       NULL;
            }
            ...
            /// if you want to draw a subset of the
            /// IndirectCommandElement(FirstCommandToDraw,NumCommandsToDraw)

            /// count of Indirect Command to execute
            inline void
            setNumCommandsToDraw( unsigned int i )
            {
                _count = i;
            }
    ...
    class OSG_EXPORT MultiDrawElementsIndirectUByte : public DrawElementsIndirectUByte
    {
        public:
            ...
            MultiDrawElementsIndirectUByte( const MultiDrawElementsIndirectUByte& mdi,
                                            const CopyOp& copyop =
                                                CopyOp::SHALLOW_COPY ) :
                DrawElementsIndirectUByte( mdi,
                                           copyop ),
                _count( mdi._count )
            {
            }
             ...
             * \param ptr Pointer to a GLunsigned int to copy index data from.
             */
            MultiDrawElementsIndirectUByte( GLenum         mode,
                                            unsigned int   no,
                                            const GLubyte* ptr ) :
                DrawElementsIndirectUByte( mode,
                                           no,
            ...
            isSameKindAs( const osg::Object* obj ) const
            {
                return dynamic_cast<const MultiDrawElementsIndirectUByte*>( obj ) !=
                       NULL;
            }
    ...
    class OSG_EXPORT MultiDrawElementsIndirectUInt : public DrawElementsIndirectUInt
    {
        public:
            ...
            MultiDrawElementsIndirectUInt( const MultiDrawElementsIndirectUInt& mdi,
                                           const CopyOp&                        copyop =
                                               CopyOp::SHALLOW_COPY ) :
                DrawElementsIndirectUInt( mdi,
                                          copyop ),
                _count( mdi._count )
            {
            }
             ...
             * \param ptr Pointer to a GLunsigned int to copy index data from.
             */
            MultiDrawElementsIndirectUInt( GLenum        mode,
                                           unsigned int  no,
                                           const GLuint* ptr ) :
                DrawElementsIndirectUInt( mode,
                                          no,
    ...
    class OSG_EXPORT DrawArraysIndirect : public osg::PrimitiveSet
    {
        public:
            ...
            DrawArraysIndirect( GLenum       mode         = 0,
                                unsigned int firstcommand = 0,
                                GLsizei      stride       = 0 ) :
                osg::PrimitiveSet( Type( DrawArraysIndirectPrimitiveType ),
                                   mode ),
                _firstCommand( firstcommand ),
                _stride( stride )
            {
            ...
            DrawArraysIndirect( const DrawArraysIndirect& dal,
                                const CopyOp& copyop = CopyOp::SHALLOW_COPY ) :
                osg::PrimitiveSet( dal,
                                   copyop ),
                _firstCommand( dal._firstCommand ),
                _stride( dal._stride ),
                _indirectCommandArray( ( DefaultIndirectCommandDrawArrays* )
                                           copyop( dal._indirectCommandArray.get() ) )
            {
            }
            ...
            inline void
            setIndirectCommandArray( IndirectCommandDrawArrays* idc )
            {
                _indirectCommandArray = idc;
                // ensure bo of idc is of the correct type
                if( !dynamic_cast<DrawIndirectBufferObject*>(
            ...
            inline const IndirectCommandDrawArrays*
            getIndirectCommandArray() const
            {
                return _indirectCommandArray.get();
            }

            inline IndirectCommandDrawArrays*
            getIndirectCommandArray()
            {
                return _indirectCommandArray.get();
            }
    ...
    class OSG_EXPORT MultiDrawArraysIndirect : public DrawArraysIndirect
    {
        public:
            ...
            MultiDrawArraysIndirect( GLenum       mode         = 0,
                                     unsigned int firstcommand = 0,
                                     unsigned int count        = 0,
                                     GLsizei      stride       = 0 ) :
                osg::DrawArraysIndirect( mode,
                                         firstcommand,
                                         stride ),
                _count( count )
            {
            ...
            MultiDrawArraysIndirect( const MultiDrawArraysIndirect& dal,
                                     const CopyOp& copyop = CopyOp::SHALLOW_COPY ) :
                osg::DrawArraysIndirect( dal,
                                         copyop ),
                _count( dal._count )
            {
            }
