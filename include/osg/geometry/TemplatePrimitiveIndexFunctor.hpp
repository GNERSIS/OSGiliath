 ...
 * Template functor applied to indexed geometry primitives.
 * Generates per-triangle callbacks with original vertex indices.
 */
#pragma once
...
namespace osg
{
     ...
     *  <p>Notice that \c TemplatePrimitiveIndexFunctor is a class template, and that it
     ...
     *  created by the \c TemplatePrimitiveIndexFunctor from some other geometry
     * representation.
     *  @see \c PrimitiveFunctor for general usage hints.
     */
    template<class T>
    class TemplatePrimitiveIndexFunctor : public PrimitiveIndexFunctor,
                                          public T
    {
        public:
                    ...
                    case( GL_LINE_LOOP ) :
                        {
                            ...
                            this->operator()(
                                static_cast<unsigned int>( first + count - 1 ),
