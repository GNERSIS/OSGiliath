 ...
 * Defines draw commands (arrays, elements, indirect) for Geometry.
 * Wraps glDrawArrays, glDrawElements, and glMultiDrawElements.
 */
#pragma once
...
namespace osg
{
    ...
    class OSG_EXPORT PrimitiveSet : public BufferData
    {
        public:
            ...
            PrimitiveSet( Type   primType     = PrimitiveType,
                          GLenum mode         = 0,
                          int    numInstances = 0 ) :
            ...
            {
                return dynamic_cast<const PrimitiveSet*>( obj ) != NULL;
            }
            ...
            virtual void
            draw( State& state,
                  bool   useVertexBufferObjects ) const = 0;

            virtual void
            accept( PrimitiveFunctor& functor ) const = 0;
            virtual void
            accept( PrimitiveIndexFunctor& functor ) const = 0;

            virtual unsigned int
            index( unsigned int pos ) const = 0;
            virtual unsigned int
            getNumIndices() const = 0;
            virtual void
            offsetIndices( int offset ) = 0;
    ...
    class OSG_EXPORT DrawArrays : public PrimitiveSet
    {
        public:
            ...
            DrawArrays( GLenum mode = 0 ) :
                PrimitiveSet( DrawArraysPrimitiveType,
                              mode ),
                _first( 0 ),
                _count( 0 )
            {
            ...
            {
                return new DrawArrays( *this, copyop );
            }

            virtual bool
            isSameKindAs( const Object* obj ) const
            {
                return dynamic_cast<const DrawArrays*>( obj ) != NULL;
            }
    ...
    class OSG_EXPORT DrawArrayLengths : public PrimitiveSet,
                                        public VectorGLsizei
    {
        public:
            ...
            DrawArrayLengths( GLenum mode = 0 ) :
                PrimitiveSet( DrawArrayLengthsPrimitiveType,
                              mode ),
                _first( 0 )
            {
            }
            ...
            cloneType() const
            {
                return new DrawArrayLengths();
            }

            virtual Object*
            clone( const CopyOp& copyop ) const
            {
                return new DrawArrayLengths( *this, copyop );
            }

            virtual bool
            isSameKindAs( const Object* obj ) const
            {
                return dynamic_cast<const DrawArrayLengths*>( obj ) != NULL;
            }
    ...
    class DrawElements : public PrimitiveSet
    {
        public:
            ...
            DrawElements( Type   primType     = PrimitiveType,
                          GLenum mode         = 0,
                          int    numInstances = 0 ) :
                PrimitiveSet( primType,
                              mode,
                              numInstances )
            {
            }
            ...
            inline void
            setElementBufferObject( osg::ElementBufferObject* ebo )
            {
                setBufferObject( ebo );
            }

            /** Get the ElementBufferObject. If no EBO is assigned returns NULL*/
            inline osg::ElementBufferObject*
            getElementBufferObject()
            {
                return dynamic_cast<osg::ElementBufferObject*>( _bufferObject.get() );
            }

            /** Get the const ElementBufferObject. If no EBO is assigned returns NULL*/
            inline const osg::ElementBufferObject*
            getElementBufferObject() const
            {
                return dynamic_cast<const osg::ElementBufferObject*>(
                    _bufferObject.get()
                );
            }
            ...
            getDataType() = 0;
            virtual void
            resizeElements( unsigned int numIndices ) = 0;
            virtual void
            reserveElements( unsigned int numIndices ) = 0;
            virtual void
    ...
    class OSG_EXPORT DrawElementsUByte : public DrawElements,
                                         public VectorGLubyte
    {
        public:
            ...
            DrawElementsUByte( GLenum mode = 0 ) :
                DrawElements( DrawElementsUBytePrimitiveType,
                              mode )
            {
            }
             ...
             * \param numInstances When non zero passed as the number of draw instances
             * to use re.
             */
            DrawElementsUByte( GLenum         mode,
                               unsigned int   no,
                               const GLubyte* ptr,
                               int            numInstances = 0 ) :
                DrawElements( DrawElementsUBytePrimitiveType,
            ...
            cloneType() const
            {
                return new DrawElementsUByte();
            }

            virtual Object*
            clone( const CopyOp& copyop ) const
            {
                return new DrawElementsUByte( *this, copyop );
            }

            virtual bool
            isSameKindAs( const Object* obj ) const
            {
                return dynamic_cast<const DrawElementsUByte*>( obj ) != NULL;
            }
            ...
            {
                push_back( static_cast<GLubyte>( v ) );
            }
    ...
    class OSG_EXPORT DrawElementsUShort : public DrawElements,
                                          public VectorGLushort
    {
        public:
            ...
            DrawElementsUShort( GLenum mode = 0 ) :
                DrawElements( DrawElementsUShortPrimitiveType,
                              mode )
            {
            }
             ...
             * to use re.
             */
            DrawElementsUShort( GLenum          mode,
                                unsigned int    no,
                                const GLushort* ptr,
                                int             numInstances = 0 ) :
                DrawElements( DrawElementsUShortPrimitiveType,
            ...
            cloneType() const
            {
                return new DrawElementsUShort();
            }

            virtual Object*
            clone( const CopyOp& copyop ) const
            {
                return new DrawElementsUShort( *this, copyop );
            }

            virtual bool
            isSameKindAs( const Object* obj ) const
            {
                return dynamic_cast<const DrawElementsUShort*>( obj ) != NULL;
            }
            ...
            addElement( unsigned int v )
            {
                push_back( static_cast<GLushort>( v ) );
            }
    ...
    class OSG_EXPORT DrawElementsUInt : public DrawElements,
                                        public VectorGLuint
    {
        public:
            ...
            cloneType() const
            {
                return new DrawElementsUInt();
            }

            virtual Object*
            clone( const CopyOp& copyop ) const
            {
                return new DrawElementsUInt( *this, copyop );
            }

            virtual bool
            isSameKindAs( const Object* obj ) const
            {
                return dynamic_cast<const DrawElementsUInt*>( obj ) != NULL;
            }
    ...
    class OSG_EXPORT MultiDrawArrays : public osg::PrimitiveSet
    {
        public:
            ...
            MultiDrawArrays( GLenum mode = 0 ) :
                osg::PrimitiveSet( Type( MultiDrawArraysPrimitiveType ),
                                   mode )
            {
            }

            MultiDrawArrays( const MultiDrawArrays& dal,
                             const CopyOp&          copyop = CopyOp::SHALLOW_COPY ) :
            ...
            {
                return new MultiDrawArrays( *this, copyop );
            }

            virtual bool
            isSameKindAs( const osg::Object* obj ) const
            {
                return dynamic_cast<const MultiDrawArrays*>( obj ) != NULL;
            }
