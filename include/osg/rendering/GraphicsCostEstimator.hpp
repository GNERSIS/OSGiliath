...
namespace osg
{
    ...
    {
            ClampedLinearCostFunction1D( double       cost0     = 0.0,
                                         double       dcost_di  = 0.0,
            ...
            double
            operator()( unsigned int input ) const
            {
                return _cost0 +
                       _dcost_di *
                       double( input <= _min_input ? 0U : input - _min_input );
            }
    ...
    /** Pair of double representing CPU and GPU times in seconds as first and second
     * elements in std::pair. */
    ...
    class OSG_EXPORT GeometryCostEstimator : public osg::Referenced
    {
        public:
            ...
            setDefaults();
            void
            calibrate( osg::RenderInfo& renderInfo );
            CostPair
            estimateCompileCost( const osg::Geometry* geometry ) const;
            CostPair
            estimateDrawCost( const osg::Geometry* geometry ) const;
    ...
    class OSG_EXPORT TextureCostEstimator : public osg::Referenced
    {
        public:
            ...
            calibrate( osg::RenderInfo& renderInfo );
            CostPair
            estimateCompileCost( const osg::Texture* texture ) const;
            CostPair
            estimateDrawCost( const osg::Texture* texture ) const;
    ...
    class OSG_EXPORT ProgramCostEstimator : public osg::Referenced
    {
        public:
            ...
            calibrate( osg::RenderInfo& renderInfo );
            CostPair
            estimateCompileCost( const osg::Program* program ) const;
            CostPair
            estimateDrawCost( const osg::Program* program ) const;
    ...
    class OSG_EXPORT GraphicsCostEstimator : public osg::Referenced
    {
        public:
            ...
            estimateCompileCost( const osg::Geometry* geometry ) const
            {
                return _geometryEstimator->estimateCompileCost( geometry );
            }

            CostPair
            estimateDrawCost( const osg::Geometry* geometry ) const
            {
                return _geometryEstimator->estimateDrawCost( geometry );
            }
            ...
            estimateDrawCost( const osg::Texture* texture ) const
            {
                return _textureEstimator->estimateDrawCost( texture );
            }

            CostPair
            estimateCompileCost( const osg::Program* program ) const
            {
                return _programEstimator->estimateCompileCost( program );
            }

            CostPair
            estimateDrawCost( const osg::Program* program ) const
            {
                return _programEstimator->estimateDrawCost( program );
            }

            CostPair
            estimateCompileCost( const osg::Node* node ) const;
            CostPair
            estimateDrawCost( const osg::Node* node ) const;
