...
namespace osg
{
    ...
    class OSG_EXPORT DisplaySettings : public osg::Referenced
    {
        ...
        public:
            ...
            static ref_ptr<DisplaySettings>&
            instance();
            ...
            DisplaySettings&
            operator=( const DisplaySettings& vs );

            void
            setDisplaySettings( const DisplaySettings& vs );

            void
            merge( const DisplaySettings& vs );
            ...
            void
            setDisplayType( DisplayType type )
            {
                _displayType = type;
            }
            ...
            void
            setEyeSeparation( float eyeSeparation )
            {
                _eyeSeparation = eyeSeparation;
            }

            float
            getEyeSeparation() const
            {
            ...
            void
            setSplitStereoHorizontalEyeMapping( SplitStereoHorizontalEyeMapping m )
            {
                _splitStereoHorizontalEyeMapping = m;
            }

            SplitStereoHorizontalEyeMapping
            getSplitStereoHorizontalEyeMapping() const
            {
                return _splitStereoHorizontalEyeMapping;
            }

            void
            setSplitStereoHorizontalSeparation( int s )
            {
                _splitStereoHorizontalSeparation = s;
            }

            int
            getSplitStereoHorizontalSeparation() const
            {
                return _splitStereoHorizontalSeparation;
            }
            ...
            void
            setSplitStereoVerticalEyeMapping( SplitStereoVerticalEyeMapping m )
            {
                _splitStereoVerticalEyeMapping = m;
            }

            SplitStereoVerticalEyeMapping
            getSplitStereoVerticalEyeMapping() const
            {
                return _splitStereoVerticalEyeMapping;
            }

            void
            setSplitStereoVerticalSeparation( int s )
            {
                _splitStereoVerticalSeparation = s;
            }

            int
            getSplitStereoVerticalSeparation() const
            {
                return _splitStereoVerticalSeparation;
            }

            void
            setSplitStereoAutoAdjustAspectRatio( bool flag )
            {
                _splitStereoAutoAdjustAspectRatio = flag;
            }

            bool
            getSplitStereoAutoAdjustAspectRatio() const
            {
                return _splitStereoAutoAdjustAspectRatio;
            }

            void
            setScreenWidth( float width )
            {
                _screenWidth = width;
            }
            ...
            void
            setScreenDistance( float distance )
            {
                _screenDistance = distance;
            }

            float
            getScreenDistance() const
            {
            ...
            void
            setMinimumNumAlphaBits( unsigned int bits )
            {
                _minimumNumberAlphaBits = bits;
            }

            unsigned int
            getMinimumNumAlphaBits() const
            {
                return _minimumNumberAlphaBits;
            }

            bool
            getAlphaBuffer() const
            {
                return _minimumNumberAlphaBits != 0;
            }

            void
            setMinimumNumStencilBits( unsigned int bits )
            {
                _minimumNumberStencilBits = bits;
            }

            unsigned int
            getMinimumNumStencilBits() const
            {
                return _minimumNumberStencilBits;
            }

            bool
            getStencilBuffer() const
            {
                return _minimumNumberStencilBits != 0;
            }

            void
            setMinimumNumAccumBits( unsigned int red,
                                    unsigned int green,
                                    unsigned int blue,
                                    unsigned int alpha );

            unsigned int
            getMinimumNumAccumRedBits() const
            {
                return _minimumNumberAccumRedBits;
            }

            unsigned int
            getMinimumNumAccumGreenBits() const
            {
                return _minimumNumberAccumGreenBits;
            }

            unsigned int
            getMinimumNumAccumBlueBits() const
            {
                return _minimumNumberAccumBlueBits;
            }

            unsigned int
            getMinimumNumAccumAlphaBits() const
            {
                return _minimumNumberAccumAlphaBits;
            }
            ...
            void
            setMaxNumberOfGraphicsContexts( unsigned int num );
            unsigned int
            getMaxNumberOfGraphicsContexts() const;

            void
            setNumMultiSamples( unsigned int samples )
            {
                _numMultiSamples = samples;
            }
            ...
            bool
            getMultiSamples() const
            {
                return _numMultiSamples != 0;
            }

            void
            setCompileContextsHint( bool useCompileContexts )
            {
                _compileContextsHint = useCompileContexts;
            }

            bool
            getCompileContextsHint() const
            {
                return _compileContextsHint;
            }

            void
            setSerializeDrawDispatch( bool serializeDrawDispatch )
            {
                _serializeDrawDispatch = serializeDrawDispatch;
            }

            bool
            getSerializeDrawDispatch() const
            {
                return _serializeDrawDispatch;
            }

            void
            setUseSceneViewForStereoHint( bool hint )
            {
                _useSceneViewForStereoHint = hint;
            }

            bool
            getUseSceneViewForStereoHint() const
            {
                return _useSceneViewForStereoHint;
            }

            /** Set the hint for the total number of threads in the DatbasePager set up,
             * inclusive of the number of http dedicated threads.*/
            void
            setNumOfDatabaseThreadsHint( unsigned int numThreads )
            {
             ...
             * inclusive of the number of http dedicated threads.*/
            unsigned int
            getNumOfDatabaseThreadsHint() const
            {
                return _numDatabaseThreadsHint;
            }

            /** Set the hint for number of threads in the DatbasePager to dedicate to
             * reading http requests.*/
            void
            setNumOfHttpDatabaseThreadsHint( unsigned int numThreads )
            {
             ...
             * reading http requests.*/
            unsigned int
            getNumOfHttpDatabaseThreadsHint() const
            {
                return _numHttpDatabaseThreadsHint;
            }

            void
            setApplication( const std::string& application )
            {
            ...
            Camera::setImplicitBufferAttachment method
             ...
             DisplaySettings implicit buffer attachment selection defaults to: DEPTH and
            COLOR for both primary (Render) FBO and secondary Multisample (Resolve) FBO
            ...
            **/
            ...
            setImplicitBufferAttachmentMask(
                ImplicitBufferAttachmentMask renderMask =
            ...
            setImplicitBufferAttachmentRenderMask(
                ImplicitBufferAttachmentMask implicitBufferAttachmentRenderMask
            )
            {
            ...
            setImplicitBufferAttachmentResolveMask(
                ImplicitBufferAttachmentMask implicitBufferAttachmentResolveMask
            )
            {
            ...
            getImplicitBufferAttachmentRenderMask() const
            {
            ...
            ImplicitBufferAttachmentMask
            getImplicitBufferAttachmentResolveMask() const
            {
            ...
            enum SwapMethod
            {
                SWAP_DEFAULT,    // Leave swap method at default returned by choose Pixel
                                 // Format.
                SWAP_EXCHANGE,     // Flip front / back buffer.
                SWAP_COPY,         // Copy back to front buffer.
                SWAP_UNDEFINED,    // Move back to front buffer leaving contents of back
                                   // buffer undefined.
            };

            /** Select preferred swap method */
            void
            setSwapMethod( SwapMethod swapMethod )
            {
            ...
            void
            setSyncSwapBuffers( unsigned int numFrames = 0 )
            {
                _syncSwapBuffers = numFrames;
            }

            /** Set whether Arb Sync should be used to manage the swaps buffers.*/
            unsigned int
            getSyncSwapBuffers() const
            {
                return _syncSwapBuffers;
            }

            /** Set the hint of which OpenGL version to attempt to create a graphics
             * context for.*/
            void
            setGLContextVersion( const std::string& version )
            {
            ...
            void
            setVertexBufferHint( VertexBufferHint gi )
            {
                _vertexBufferHint = gi;
            }

            VertexBufferHint
            getVertexBufferHint() const
            {
                return _vertexBufferHint;
            }
             ...
             * By default also OSG_GLSL_VERSION and OSG_PRECISION_FLOAT values that can
             * get use directly in shaders using $OSG_GLSL_VERSION and
             * $OSG_PRECISION_FLOAT respectively.*/
            void
            setShaderHint( ShaderHint hint,
            ...
            /** Set the TextShaderTechnique that is used in the Text default constructor
             * to choose which osgText::ShaderTechnique to use.*/
            void
            setTextShaderTechnique( const std::string& str )
            {
                _textShaderTechnique = str;
            }

            const std::string&
            getTextShaderTechnique() const
            {
                return _textShaderTechnique;
            }

            void
            setKeystoneHint( bool enabled )
            {
                _keystoneHint = enabled;
            }

            bool
            getKeystoneHint() const
            {
                return _keystoneHint;
            }

            typedef std::vector<std::string> FileNames;

            void
            setKeystoneFileNames( const FileNames& filenames )
            {
            ...
            {
                return _keystoneFileNames;
            }

            const FileNames&
            getKeystoneFileNames() const
            {
                return _keystoneFileNames;
            }
            ...
            void
            setKeystones( const Objects& objects )
            {
                _keystones = objects;
            }
            ...
            OSXMenubarBehavior
            getOSXMenubarBehavior() const
            {
                return _OSXMenubarBehavior;
            }

            void
            setOSXMenubarBehavior( OSXMenubarBehavior hint )
            {
            ...
            virtual osg::dmat4
            computeLeftEyeViewImplementation( const osg::dmat4& view,
            ...
            /** helper function for computing the right eye view matrix.*/
            virtual osg::dmat4
            computeRightEyeViewImplementation( const osg::dmat4& view,
                                               double eyeSeperationScale = 1.0 ) const;

            typedef std::vector<std::string> Filenames;

            void
            setShaderPipelineFiles( const Filenames& filename )
            {
                _shaderPipelineFiles = filename;
            }

            const Filenames&
            getShaderPipelineFiles() const
            {
                return _shaderPipelineFiles;
            }

            void
            setShaderPipelineNumTextureUnits( unsigned int units )
            {
                _shaderPipelineNumTextureUnits = units;
            }

            unsigned int
            getShaderPipelineNumTextureUnits() const
            {
                return _shaderPipelineNumTextureUnits;
            }
            ...
            {
                ObjectMap::iterator itr = _objectMap.find( name );
                return itr != _objectMap.end() ? itr->second.get() : 0;
            }

            const Object*
            getObject( const std::string& name ) const
            {
                ObjectMap::const_iterator itr = _objectMap.find( name );
                return itr != _objectMap.end() ? itr->second.get() : 0;
            }
        ...
        protected:
            ...
            mutable std::mutex                             _valueMapMutex;
