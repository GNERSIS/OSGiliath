...
// Undefine GLEW macros that collide with GLExtensions member names.
// GLEW defines macros like #define glBindBuffer GLEW_GET_FUN(__glewBindBuffer)
// which break member access syntax (extensions->glBindBuffer).
// The GLExtensions class initializes its own function pointers via
// setGLExtensionFuncPtr (glXGetProcAddress), achieving the same result.
#undef glActiveTexture
#undef glAttachShader
#undef glBeginConditionalRender
#undef glBeginOcclusionQuery
#undef glBeginQuery
...
#undef glDeleteOcclusionQueries
...
#undef glFramebufferTexture2DMultisample
#undef glFramebufferTexture3D
#undef glFramebufferTextureFace
...
#undef glGetOcclusionQueryiv
#undef glGetOcclusionQueryuiv
...
#undef glUniform1i
#undef glUniform1i64
#undef glUniform1i64v
#undef glUniform1iv
#undef glUniform1ui
#undef glUniform1ui64
#undef glUniform1ui64v
#undef glUniform1uiv
#undef glUniform2d
#undef glUniform2dv
#undef glUniform2f
...
#undef glUniform2i
#undef glUniform2i64
#undef glUniform2i64v
#undef glUniform2iv
#undef glUniform2ui
#undef glUniform2ui64
#undef glUniform2ui64v
#undef glUniform2uiv
#undef glUniform3d
#undef glUniform3dv
#undef glUniform3f
...
#undef glUniform3i
#undef glUniform3i64
#undef glUniform3i64v
#undef glUniform3iv
#undef glUniform3ui
#undef glUniform3ui64
#undef glUniform3ui64v
#undef glUniform3uiv
#undef glUniform4d
#undef glUniform4dv
#undef glUniform4f
...
#undef glUniform4i
#undef glUniform4i64
#undef glUniform4i64v
#undef glUniform4iv
#undef glUniform4ui
#undef glUniform4ui64
#undef glUniform4ui64v
#undef glUniform4uiv
...
namespace osg
{
    ...
    isExtensionInExtensionString( const char* extension,
     ...
     */
    extern OSG_EXPORT bool
    isGLExtensionSupported( unsigned int contextID,
    ...
    /** Return true if OpenGL/GLES "extension" or minimum OpenGL version number is
     * supported. Note: Must only be called within a valid OpenGL context, undefined
     * behavior may occur otherwise.
     */
    extern OSG_EXPORT bool
    isGLExtensionOrVersionSupported( unsigned int contextID,
                                     const char*  extension,
    ...
    getGLExtensionFuncPtr( const char* funcName );

    /** Set a list of extensions to disable for different OpenGL renderers. This allows
     * OSG applications to work around OpenGL drivers' bugs which are due to problematic
     * extension support. The format of the string is: "GLRendererString : ExtensionName,
     * ExtensionName; GLRenderString2 : ExtensionName;" An example of is :
     * "SUN_XVR1000:GL_EXT_texture_filter_anisotropic" The default setting of
     * GLExtensionDisableString is obtained from the OSG_GL_EXTENSION_DISABLE
     * environmental variable.
     */
    extern OSG_EXPORT void
                      setGLExtensionDisableString( const std::string& disableString );

    /** Get the list of extensions that are disabled for various OpenGL renderers. */
    extern OSG_EXPORT std::string&
     ...
     */
    inline void*
    getGLExtensionFuncPtr( const char* funcName1,
    ...
    template<typename T>
    bool
    setGLExtensionFuncPtr( T&          t,
                           const char* str1,
                           bool        validContext = true )
    {
        return convertPointer( t,
                               validContext ? osg::getGLExtensionFuncPtr( str1 ) : 0 );
    }
    ...
    {
        return convertPointer( t,
                               validContext ? osg::getGLExtensionFuncPtr( str1, str2 )
                                            : 0 );
    }
                           ...
                           bool        validContext = true )
    {
        return convertPointer( t,
                               validContext
                                   ? osg::getGLExtensionFuncPtr( str1, str2, str3 )
                                   : 0 );
    }
    ...
    class VertexAttribAlias
    {
        public:
            ...
            VertexAttribAlias( GLuint             location,
            ...
            VertexAttribAlias&
            operator=( const VertexAttribAlias& rhs )
            {
                _location    = rhs._location;
                _glName      = rhs._glName;
                _osgName     = rhs._osgName;
    ...
    class OSG_EXPORT GLExtensions : public osg::Referenced
    {
        public:
            ...
            static GLExtensions*
            Get( unsigned int in_contextID,
                 bool         createIfNotInitalized );

            /** allows users to override the extensions across graphics contexts.
             * typically used when you have different extensions supported across
             * graphics pipes but need to ensure that they all use the same low common
             * denominator extensions.*/
            static void
            Set( unsigned int  in_contextID,
            ...
            bool
            getProgramInfoLog( GLuint       program,
                               std::string& result ) const;
            bool
            getShaderInfoLog( GLuint       shader,
                              std::string& result ) const;
            bool
            getAttribLocation( const char* attribName,
                               GLuint&     slot ) const;
            bool
                         getFragDataLocation( const char* fragDataName,
                                              GLuint&     slot ) const;
            ...
            void( GL_APIENTRY* glGetActiveUniformName )( GLuint   program,
                                                         ...
                                                         GLsizei* length,
                                                         GLchar*  uniformName );
            GLuint( GL_APIENTRY* glGetUniformBlockIndex )(
                GLuint        program,
            ...
            void( GL_APIENTRY* glGetBufferSubData )( GLenum     target,
                                                     ...
                                                     GLsizeiptr size,
                                                     GLvoid*    data );
            GLvoid*( GL_APIENTRY* glBufferStorage )( GLenum        target,
                                                     GLintptr      size,
                                                     const GLvoid* data,
                                                     GLbitfield    flags );
            GLvoid*( GL_APIENTRY* glNamedBufferStorage )( GLuint      buffer,
                                                          GLsizei     size,
                                                          const void* data,
                                                          GLbitfield  flags );
            GLvoid*( GL_APIENTRY* glMapBuffer )( GLenum target,
                                                 GLenum access );
            GLvoid*( GL_APIENTRY* glMapBufferRange )( GLenum     target,
                                                      GLintptr   offset,
                                                      GLsizeiptr length,
                                                      GLbitfield access );
            GLvoid*( GL_APIENTRY* glFlushMappedBufferRange )( GLenum     target,
                                                              GLintptr   offset,
                                                              GLsizeiptr length );
            ...
            bool
            isTexStorage2DSupported() const
            {
                return glTexStorage2D != 0;
            }

            bool
            isCompressedTexImage2DSupported() const
            {
                return glCompressedTexImage2D != 0;
            }

            bool
            isCompressedTexSubImage2DSupported() const
            {
                return glCompressedTexSubImage2D != 0;
            }

            bool
            isBindImageTextureSupported() const
            {
            ...
            bool
            isNonPowerOfTwoTextureSupported( GLenum filter ) const
            {
            ...
            void( GL_APIENTRY* glTextureStorage3D )( GLuint  texture,
                                                     ...
                                                     GLsizei height,
                                                     GLsizei depth );
            void( GL_APIENTRY* glTexStorage2DMultisample )(
                GLenum    target,
                GLsizei   numSamples,
                GLenum    internalformat,
                GLsizei   width,
            ...
            void( GL_APIENTRY* glTexStorage3DMultisample )(
                GLenum    target,
                GLsizei   numSamples,
                GLenum    internalformat,
                GLsizei   width,
            ...
            void( GL_APIENTRY* glGetCompressedTexImage )( GLenum  target,
                                                          GLint   level,
                                                          GLvoid* data );
            void( GL_APIENTRY* glTexImage2DMultisample )(
                GLenum    target,
                GLsizei   samples,
            ...
            bool
            isCompressedTexImage3DSupported() const
            {
                return glCompressedTexImage3D != 0;
            }

            bool
            isCompressedTexSubImage3DSupported() const
            {
            ...
            void( GL_APIENTRY* glCompressedTexSubImage3D )( GLenum        target,
                                                            ...
                                                            GLsizei       imageSize,
                                                            const GLvoid* data );
            void( GL_APIENTRY* glTexImage3DMultisample )(
                GLenum    target,
                GLsizei   samples,
                GLenum    internalformat,
                GLsizei   width,
            ...
            bool
            isRenderbufferMultisampleSupported() const
            {
                return glRenderbufferStorageMultisample != 0;
            }

            bool
            isRenderbufferMultisampleCoverageSupported() const
            {
                return glRenderbufferStorageMultisampleCoverageNV != 0;
            }
            ...
            void( GL_APIENTRY* glGenRenderbuffers )( GLsizei,
                                                     GLuint* );
            void( GL_APIENTRY* glRenderbufferStorage )( GLenum,
                                                        GLenum,
                                                        GLsizei,
                                                        GLsizei );
            ...
            void( GL_APIENTRY* glBlitFramebuffer )( GLint,
                                                    ...
                                                    GLbitfield,
                                                    GLenum );
            void( GL_APIENTRY* glInvalidateFramebuffer )(
                GLenum,
                GLsizei,
                const GLenum*
            );    // GL_ARB_invalidate_subdata or GL 4.3 or GLES 3
            void( GL_APIENTRY* glGetRenderbufferParameteriv )( GLenum,
                                                               GLenum,
                                                               GLint* );

            // ARB_framebuffer_no_attachments
            void( GL_APIENTRY* glFramebufferParameteri )( GLenum target,
                                                          GLenum pname,
                                                          GLint  param );
            ...
            void( GL_APIENTRY* glTransformFeedbackVaryings )(
                GLuint               program,
                GLsizei              count,
            ...
            void( GL_APIENTRY* glDrawTransformFeedbackStream )( GLenum mode,
                                                                GLuint id,
                                                                GLuint stream );
            void( GL_APIENTRY* glDrawTransformFeedbackInstanced )(
                GLenum  mode,
                GLuint  id,
                GLsizei instancecount
            );
            void( GL_APIENTRY* glDrawTransformFeedbackStreamInstanced )(
                GLenum  mode,
                GLuint  id,
                GLuint  stream,
                GLsizei instancecount
            ...
            void( GL_APIENTRY* glMultiDrawElements )( GLenum             mode,
                                                      ...
                                                      GLsizei            drawcount );
            void( GL_APIENTRY* glMultiDrawElementsBaseVertex )(
                GLenum             mode,
                const GLsizei*     count,
                GLenum             type,
                const void* const* indices,
            ...
            void( GL_APIENTRY* glDrawArraysInstancedBaseInstance )(
                GLenum  mode,
                GLint   first,
                GLsizei count,
                GLsizei instancecount,
            ...
            void( GL_APIENTRY* glDrawElementsInstancedBaseInstance )(
                GLenum      mode,
                GLsizei     count,
                GLenum      type,
                const void* indices,
            ...
            void( GL_APIENTRY* glDrawElementsInstancedBaseVertexBaseInstance )(
                GLenum      mode,
                GLsizei     count,
                GLenum      type,
                const void* indices,
            ...
            /** convenience wrapper around glObjectLabel that calls glObjectLabel if it's
             * supported and using std::string as a label parameter.*/
            void
            debugObjectLabel( GLenum             identifier,
                              GLuint             name,
                              const std::string& label ) const
            {
                if( glObjectLabel && !label.empty() )
                {
            ...
            inline void
            glUniform( GLint             location,
                       const osg::Plane& value ) const
            {
                glUniform( location, value.asVec4() );
            }

            inline void
            glUniform( GLint               location,
                       const osg::Matrix2& value ) const
            {
            ...
            inline void
            glUniform( GLint                 location,
                       const osg::Matrix2x3& value ) const
            {
            ...
            inline void
            glUniform( GLint                 location,
                       const osg::Matrix2x4& value ) const
            {
            ...
            inline void
            glUniform( GLint                 location,
                       const osg::Matrix3x2& value ) const
            {
            ...
            inline void
            glUniform( GLint                 location,
                       const osg::Matrix3x4& value ) const
            {
            ...
            inline void
            glUniform( GLint                 location,
                       const osg::Matrix4x2& value ) const
            {
            ...
            inline void
            glUniform( GLint                 location,
                       const osg::Matrix4x3& value ) const
            {
            ...
            inline void
            glUniform( GLint                location,
                       const osg::Matrix2d& value ) const
            {
            ...
            inline void
            glUniform( GLint                  location,
                       const osg::Matrix2x3d& value ) const
            {
            ...
            inline void
            glUniform( GLint                  location,
                       const osg::Matrix2x4d& value ) const
            {
            ...
            inline void
            glUniform( GLint                  location,
                       const osg::Matrix3x2d& value ) const
            {
            ...
            inline void
            glUniform( GLint                location,
                       const osg::Matrix3d& value ) const
            {
            ...
            inline void
            glUniform( GLint                  location,
                       const osg::Matrix3x4d& value ) const
            {
            ...
            inline void
            glUniform( GLint                  location,
                       const osg::Matrix4x2d& value ) const
            {
            ...
            inline void
            glUniform( GLint                  location,
                       const osg::Matrix4x3d& value ) const
            {
            ...
            inline void
            glUniform( GLint                          location,
                       const std::vector<osg::ivec2>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                          location,
                       const std::vector<osg::ivec3>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                          location,
                       const std::vector<osg::ivec4>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                            location,
                       const std::vector<unsigned int>& array ) const
            {
                if( !array.empty() )
                {
                    glUniform1uiv( location,
                                   static_cast<GLsizei>( array.size() ),
                                   &( array.front() ) );
                }
            }
            ...
            inline void
            glUniform( GLint                           location,
                       const std::vector<osg::uivec2>& array ) const
            {
                if( !array.empty() )
                {
                    glUniform2uiv( location,
                                   static_cast<GLsizei>( array.size() ),
                                   array.front().data() );
                }
            }
            ...
            inline void
            glUniform( GLint                           location,
                       const std::vector<osg::uivec3>& array ) const
            {
                if( !array.empty() )
                {
                    glUniform3uiv( location,
                                   static_cast<GLsizei>( array.size() ),
                                   array.front().data() );
                }
            }
            ...
            inline void
            glUniform( GLint                           location,
                       const std::vector<osg::uivec4>& array ) const
            {
                if( !array.empty() )
                {
                    glUniform4uiv( location,
                                   static_cast<GLsizei>( array.size() ),
                                   array.front().data() );
                }
            }
            ...
            inline void
            glUniform( GLint                     location,
                       const std::vector<float>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                         location,
                       const std::vector<osg::vec2>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                         location,
                       const std::vector<osg::vec3>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                         location,
                       const std::vector<osg::vec4>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                          location,
                       const std::vector<osg::dvec2>& array ) const
            {
                if( !array.empty() )
                {
                    glUniform2dv( location,
                                  static_cast<GLsizei>( array.size() ),
                                  array.front().data() );
                }
            }
            ...
            inline void
            glUniform( GLint                          location,
                       const std::vector<osg::dvec3>& array ) const
            {
                if( !array.empty() )
                {
                    glUniform3dv( location,
                                  static_cast<GLsizei>( array.size() ),
                                  array.front().data() );
                }
            }
            ...
            inline void
            glUniform( GLint                          location,
                       const std::vector<osg::dvec4>& array ) const
            {
                if( !array.empty() )
                {
                    glUniform4dv( location,
                                  static_cast<GLsizei>( array.size() ),
                                  array.front().data() );
                }
            }
            ...
            inline void
            glUniform( GLint                            location,
                       const std::vector<osg::Matrix2>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                              location,
                       const std::vector<osg::Matrix2x3>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                              location,
                       const std::vector<osg::Matrix2x4>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                            location,
                       const std::vector<osg::Matrix3>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                              location,
                       const std::vector<osg::Matrix3x2>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                              location,
                       const std::vector<osg::Matrix3x4>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                         location,
                       const std::vector<osg::mat4>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                              location,
                       const std::vector<osg::Matrix4x3>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                              location,
                       const std::vector<osg::Matrix4x2>& array ) const
            {
                if( !array.empty() )
                {
            ...
            inline void
            glUniform( GLint                          location,
                       const std::vector<osg::dmat4>& array ) const
            {
                if( !array.empty() )
                {
