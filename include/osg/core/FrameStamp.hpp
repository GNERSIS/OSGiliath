 ...
 * Per-frame timing and identification. Carries frame number,
 * reference time, and simulation time through the update/cull/draw cycle.
 */
#pragma once
...
namespace osg
{
    ...
    class OSG_EXPORT FrameStamp : public Referenced
    {
        public:
            ...
            FrameStamp&
            operator=( const FrameStamp& fs );

            void
            setFrameNumber( unsigned int fnum )
            {
                _frameNumber = fnum;
            }
            ...
            void
            setReferenceTime( double refTime )
            {
            ...
            void
            setSimulationTime( double refTime )
            {
                _simulationTime = refTime;
            }
            ...
            void
            setCalendarTime( const tm& calendarTime );
            void
            getCalendarTime( tm& calendarTime ) const;
