...
namespace osg
{
    ...
    class OSG_EXPORT UserDataContainer : public osg::Object
    {
        public:
            ...
            {
                return dynamic_cast<const UserDataContainer*>( obj ) != 0;
            }
            ...
            addUserObject( Object* obj ) = 0;

            template<class T>
            unsigned int
            addUserObject( const osg::ref_ptr<T>& obj )
            {
                return addUserObject( obj.get() );
            }

            /** Add element to list of user data objects.*/
            virtual void
            setUserObject( unsigned int i,
                           Object*      obj ) = 0;

            /** Remove element from the list of user data objects.*/
            virtual void
            removeUserObject( unsigned int i ) = 0;

            /** Get user data object as specified index position. */
            virtual Object*
            getUserObject( unsigned int i ) = 0;

            /** Get const user data object as specified index position. */
            virtual const Object*
            getUserObject( unsigned int i ) const = 0;

            /** Get number of user objects assigned to this object.*/
            virtual unsigned int
            getNumUserObjects() const = 0;

            /** Get the index position of specified user data object.*/
            virtual unsigned int
            getUserObjectIndex( const osg::Object* obj,
                                unsigned int       startPos = 0 ) const = 0;

            /** Get the index position of first user data object that matches specified
             * name.*/
            virtual unsigned int
            getUserObjectIndex( const std::string& name,
                                unsigned int       startPos = 0 ) const = 0;

            /** Get first user data object with specified name. */
            virtual Object*
            getUserObject( const std::string& name,
            ...
            virtual void
            setDescriptions( const DescriptionList& descriptions ) = 0;
            ...
            virtual const DescriptionList&
            getDescriptions() const = 0;

            /** Get number of description strings.*/
            virtual unsigned int
            getNumDescriptions() const = 0;

            /** Add a description string.*/
            virtual void
            addDescription( const std::string& desc ) = 0;
    ...
    /** Internal structure for storing all user data.*/
    class OSG_EXPORT DefaultUserDataContainer
        : public osg::Inherit<osg::UserDataContainer, DefaultUserDataContainer>
    {
        public:
            ...
            /** Remove element from the list of user data objects.*/
            virtual void
            removeUserObject( unsigned int i );
    ...
    /** Convenience function for getting the User Object associated with specified name
     * from an Object's UserDataContainer.*/
    inline Object*
    getUserObject( osg::Object*       object,
     ...
     * from an Object's UserDataContainer.*/
    inline const Object*
    getUserObject( const osg::Object* object,
                   const std::string& name )
    {
