...
namespace osg
{
    ...
    class OSG_EXPORT ArgumentParser
    {
        public:
            ...
            class OSG_EXPORT Parameter
            {
                public:
                    ...
                    {
                        _type        = BOOL_PARAMETER;
                        _value._bool = &value;
                    }

                    Parameter( float& value )
                    {
                        _type         = FLOAT_PARAMETER;
                        _value._float = &value;
                    }

                    Parameter( double& value )
                    {
                        _type          = DOUBLE_PARAMETER;
        ...
        public:
            ...
            void
            setApplicationUsage( ApplicationUsage* usage )
            {
                _usage = usage;
            }
             ...
             * remove the arguments from the list, and return true. Otherwise, return
             * false. */
            bool
            read( int                pos,
             ...
             * arguments. */
            bool
            errors( ErrorSeverity severity = BENIGN ) const;
            ...
            void
            reportRemainingOptionsAsUnrecognized( ErrorSeverity severity = BENIGN );
             ...
             * severity. */
            void
            writeErrorMessages( std::ostream& output,
