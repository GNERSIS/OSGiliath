 ...
 * std::vector wrapper that provides virtual methods for custom
 * array classes while keeping contiguous storage.
 */
#pragma once
...
namespace osg
{
    ...
    class MixinVector
    {
        ...
        public:
            ...
            explicit MixinVector() :
                _impl()
            {
            }

            explicit MixinVector( size_type         initial_size,
            ...
            MixinVector( InputIterator first,
                         InputIterator last ) :
                _impl( first,
                       last )
            {
            ...
            MixinVector&
            operator=( const vector_type& other )
            {
                _impl = other;
                return *this;
            }
            ...
            MixinVector&
            operator=( const MixinVector& other )
            {
                _impl = other._impl;
                return *this;
            }
            ...
            void
            swap( vector_type& other )
            {
                _impl.swap( other );
            }

            void
            swap( MixinVector& other )
            {
            ...
            friend inline bool
            operator==( const MixinVector<ValueT>& left,
            ...
            friend inline bool
            operator==( const std::vector<ValueT>& left,
                        const MixinVector<ValueT>& right )
            {
