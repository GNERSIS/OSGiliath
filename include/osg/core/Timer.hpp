...
namespace osg
{
    ...
    class OSG_EXPORT Timer
    {
        ...
        public:
            ...
            delta_s( Timer_t t1,
                     Timer_t t2 ) const
            {
                return ( t2 > t1 ) ? ( double )( t2 - t1 ) * _secsPerTick
                                   : -( double )( t1 - t2 ) * _secsPerTick;
            }
    ...
    class ElapsedTime
    {
        public:
            ...
            inline ElapsedTime( double*     elapsedTime,
                                osg::Timer* timer = 0 ) :
                _time( elapsedTime )
            {
                init( timer );
            ...
            finish()
            {
                ...
                if( _time )
                {
                    *_time += _timer->delta_s( _startTick, endTick );
                }
                _startTick = endTick;
            }
