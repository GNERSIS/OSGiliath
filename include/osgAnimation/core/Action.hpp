 ...
 * Timeline action base class. Represents a timed operation
 * (play animation, blend, callback) in the timeline.
 */
#pragma once
...
namespace osgAnimation
{
    ...
    class OSGANIMATION_EXPORT Action : public osg::Object
    {
        public:
            ...
            class Callback : public osg::Inherit<osg::Object, Callback>
            {
                public:
                    ...
                    void
                    addNestedCallback( Callback* callback )
                    {
                        if( callback )
                        {
            ...
            void
            setCallback( unsigned int frame,
                         Callback*    callback )
            {
            ...
            Callback*
            getCallback( unsigned int frame )
            {
            ...
            Callback*
            getFrameCallback( unsigned int frame );
            Callback*
            getFrameCallback( double time );
            ...
            void
            setNumFrames( unsigned int numFrames )
            {
            ...
            {
                _numberFrame = static_cast<unsigned int>( floor( duration * _fps ) );
            }
            ...
            bool
            evaluateFrame( unsigned int  frame,
