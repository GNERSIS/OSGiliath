 ...
 * Template interpolation functors for animation channels.
 * Linear, step, cubic Bezier, and spherical-linear modes.
 */
#pragma once
...
namespace osgAnimation
{
    ...
    class TemplateInterpolatorBase
    {
        ...
        public:
            ...
            int
            getKeyIndexFromTime( const TemplateKeyframeContainer<KEY>& keys,
                                 double                                time ) const
            {
                ...
                {
                    osg::notify( osg::WARN )
                        << "TemplateInterpolatorBase::getKeyIndexFromTime the container "
                           "is empty, impossible to get key index from time"
                        << std::endl;
                    ;
                    return -1;
                }
    ...
    class TemplateStepInterpolator : public TemplateInterpolatorBase<TYPE, KEY>
    {
        public:
            ...
            void
            getValue( const TemplateKeyframeContainer<KEY>& keyframes,
                      double                                time,
                      TYPE&                                 result ) const
            {
    ...
    class TemplateSphericalLinearInterpolator
        : public TemplateInterpolatorBase<TYPE, KEY>
    {
        public:
                      ...
                      TYPE&                                 result ) const
            {
                ...
                result =
                    osg::mix( q1, q2, static_cast<typename TYPE::value_type>( blend ) );
            }
    };
    ...
    class TemplateLinearPackedInterpolator : public TemplateInterpolatorBase<TYPE, KEY>
    {
        public:
                      ...
                      TYPE&                                 result ) const
            {
                if( time >= keyframes.back().getTime() )
                {
                    keyframes.back().getValue().uncompress( keyframes.mScale,
                                                            keyframes.mMin,
                                                            result );
                    return;
                }
                ...
                {
                    keyframes.front().getValue().uncompress( keyframes.mScale,
                                                             keyframes.mMin,
                                                             result );
                    return;
                }
                ...
                keyframes[i].getValue().uncompress( keyframes.mScale,
                                                    keyframes.mMin,
                                                    v1 );
                keyframes[i + 1].getValue().uncompress( keyframes.mScale,
                                                        keyframes.mMin,
                                                        v2 );
                result = v1 * ( 1 - blend ) + v2 * blend;
            }
    ...
    class TemplateCubicBezierInterpolator : public TemplateInterpolatorBase<TYPE, KEY>
    {
        public:
                      ...
                      TYPE&                                 result ) const
            {
                ...
                TYPE  v1 = keyframes[i].getValue().getControlPointIn() *
                           ( 3.0 * t * one_minus_t2 );
                TYPE  v2 = keyframes[i].getValue().getControlPointOut() *
                           ( 3.0 * t2 * one_minus_t );
    ...
    typedef TemplateLinearInterpolator<osg::vec3, Vec3Packed>
    ...
    typedef TemplateLinearInterpolator<osg::mat4, osg::mat4> MatrixLinearInterpolator;

    typedef TemplateCubicBezierInterpolator<float, FloatCubicBezier>
        FloatCubicBezierInterpolator;
    typedef TemplateCubicBezierInterpolator<double, DoubleCubicBezier>
        DoubleCubicBezierInterpolator;
    typedef TemplateCubicBezierInterpolator<osg::vec2, Vec2CubicBezier>
        Vec2CubicBezierInterpolator;
    typedef TemplateCubicBezierInterpolator<osg::vec3, Vec3CubicBezier>
        Vec3CubicBezierInterpolator;
    typedef TemplateCubicBezierInterpolator<osg::vec4, Vec4CubicBezier>
