...
namespace osgViewer
{
    ...
    class OSGVIEWER_EXPORT CompositeViewer
        : public osg::Inherit<ViewerBase, CompositeViewer>
    {
        public:

            CompositeViewer();

            CompositeViewer( const CompositeViewer&,
            ...
            template<class T>
            void
            addView( const osg::ref_ptr<T>& view )
            {
                addView( view.get() );
            }
            ...
            template<class T>
            void
            removeView( const osg::ref_ptr<T>& view )
            {
                removeView( view.get() );
            }
            ...
            getCameraWithFocus()
            {
                return _cameraWithFocus.get();
            }

            const osg::Camera*
            getCameraWithFocus() const
            {
                return _cameraWithFocus.get();
            }
            ...
            getViewWithFocus()
            {
                return _viewWithFocus.get();
            }

            const osgViewer::View*
            getViewWithFocus() const
            {
                return _viewWithFocus.get();
            }
