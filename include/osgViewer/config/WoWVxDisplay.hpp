 ...
 * Viewer configuration for WoWVx auto-stereoscopic displays.
 * Generates the interleaved views required by lenticular screens.
 */
#pragma once
...
namespace osgViewer
{
    ...
    class OSGVIEWER_EXPORT WoWVxDisplay : public osg::Inherit<ViewConfig, WoWVxDisplay>
    {
        public:

            // default to 20" display, type can be 20 to 42.
            WoWVxDisplay( unsigned int type      = 20,
            ...
            WoWVxDisplay( unsigned int  screenNum,
            ...
            WoWVxDisplay( const WoWVxDisplay& rhs,
            ...
            void
            setDisparityZD( float c )
            {
                _wow_disparity_Zd = c;
            }

            float
            getDisparityZD() const
            {
                return _wow_disparity_Zd;
            }

            void
            setDisparityVZ( float c )
            {
                _wow_disparity_vz = c;
            }

            float
            getDisparityVZ() const
            {
                return _wow_disparity_vz;
            }

            void
            setDisparityM( float c )
            {
                _wow_disparity_M = c;
            }
