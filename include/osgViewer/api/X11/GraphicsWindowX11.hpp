 ...
 * X11 platform graphics window. Creates and manages an X11 window
 * with GLX context, keyboard/mouse event translation, and cursor control.
 */
...
namespace osgViewer
{
                                               ...
                                               public osgViewer::GraphicsHandleX11
    {
        public:
            ...
            {
                return dynamic_cast<const GraphicsWindowX11*>( object ) != 0;
            }
        ...
        public:
            ...
            Display*
            getEventDisplay() const
            {
                return _eventDisplay;
            }

            Display*
            getDisplayToUse() const;
        ...
        protected:
            ...
            bool
            checkAndSendEventFullScreenIfNeeded( Display* display,
                                                 int      x,
                                                 int      y,
                                                 int      width,
                                                 int      height,
            ...
            void
            getModifierMap( char* keymap ) const;
            int
            getModifierMask() const;
            void
            syncLocks();
            void
                         flushKeyEvents();
