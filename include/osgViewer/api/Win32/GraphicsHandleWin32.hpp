 ...
 * Win32 platform handle holder. Stores the HWND, HDC, and HGLRC
 * for sharing with external Win32/WGL code.
 */
#pragma once
...
namespace osgViewer
{
    ...
    class OSGVIEWER_EXPORT GraphicsHandleWin32
    {
        public:
            ...
            inline void
            setEGLContext( const EGL::ContextInfo& eglContextInfo )
            {
                _eglContextInfo = eglContextInfo;
            }

            /** Get native EGL graphics context.*/
            inline const EGL::ContextInfo&
            getEGLContext() const
            {
                return _eglContextInfo;
            }
