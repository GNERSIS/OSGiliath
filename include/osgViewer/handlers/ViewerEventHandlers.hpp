...
namespace osgViewer
{
    ...
    class OSGVIEWER_EXPORT HelpHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            void
            setApplicationUsage( osg::ApplicationUsage* au )
            {
            ...
            getApplicationUsage()
            {
                return _applicationUsage.get();
            }

            const osg::ApplicationUsage*
            getApplicationUsage() const
            {
                return _applicationUsage.get();
            }
            ...
            int
            getKeyEventTogglesOnScreenHelp() const
            {
                return _keyEventTogglesOnScreenHelp;
            }
        ...
        protected:
            ...
            void
            setUpScene( osgViewer::ViewerBase* viewer );
    ...
    class OSGVIEWER_EXPORT StatsHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            virtual void
            collectWhichCamerasToRenderStatsFor(
            ...
            /** This allows the user to register additional stats lines that will
                ...
                @param label                 The label to be displayed to identify the
               line in the stats.
                @param textColor             Will be used for the text label, the numeric
               time and the bottom line graph.
                @param barColor              Will be used for the bar in the top bar
               graph.
                @param timeTakenName         The name to be queried in the viewer stats
               for the numeric value (also used for the bottom line graph).
                @param multiplier            The multiplier to apply to the numeric value
               before displaying it in the stats.
                @param average               Whether to use the average value of the
               numeric value.
                @param averageInInverseSpace Whether to average in inverse space (used
               for frame rate).
                @param beginTimeName         The name to be queried in the viewer stats
               for the begin time for the top bar graph.
                @param endTimeName           The name to be queried in the viewer stats
               for the end time for the top bar graph.
                @param maxValue              The value to use as maximum in the bottom
               line graph. Stats will be clamped between 0 and that value, and it will be
               the highest visible value in the graph.
              */
            void
            addUserStatsLine( const std::string& label,
            ...
            void
            removeUserStatsLine( const std::string& label );
        ...
        protected:
            ...
            void
            createTimeStatsLine( const std::string& lineLabel,
                                 osg::vec3          pos,
                                 const osg::vec4&   textColor,
                                 const osg::vec4&   barColor,
            ...
            void
            createCameraTimeStats( osg::vec3&   pos,
            ...
            struct UserStatsLine
            {
                    ...
                    UserStatsLine( const std::string& label_,
                        ...
                        barColor( barColor_ ),
                        timeTakenName( timeTakenName_ ),
                        multiplier( multiplier_ ),
                        average( average_ ),
                        averageInInverseSpace( averageInInverseSpace_ ),
                        beginTimeName( beginTimeName_ ),
                        endTimeName( endTimeName_ ),
                        maxValue( maxValue_ )
                    {
                    }
            };
    ...
    /** Event handler allowing to change the screen resolution (in windowed mode) and
    ...
    class OSGVIEWER_EXPORT WindowSizeHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            {
                _keyEventToggleFullscreen = key;
            }

            int
            getKeyEventToggleFullscreen() const
            {
                return _keyEventToggleFullscreen;
            }

            void
            setToggleFullscreen( bool flag )
            {
                _toggleFullscreen = flag;
            }

            bool
            getToggleFullscreen() const
            {
            ...
            int
            getKeyEventWindowedResolutionUp() const
            {
                return _keyEventWindowedResolutionUp;
            }
            ...
            int
            getKeyEventWindowedResolutionDown() const
            {
                return _keyEventWindowedResolutionDown;
            }
            ...
            bool
            getChangeWindowedResolution() const
            {
                return _changeWindowedResolution;
            }
        ...
        protected:
            ...
            void
            toggleFullscreen( osgViewer::GraphicsWindow* window );
            void
            changeWindowedResolution( osgViewer::GraphicsWindow* window,
                                      bool                       increase );

            unsigned int
                                   getNearestResolution( int screenWidth,
                                                         int screenHeight,
                                                         int width,
                                                         int height ) const;
    ...
    class OSGVIEWER_EXPORT ThreadingHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            int
            getKeyEventChangeThreadingModel() const
            {
                return _keyEventChangeThreadingModel;
            }

            void
            setChangeThreadingModel( bool flag )
            {
                _changeThreadingModel = flag;
            }

            bool
            getChangeThreadingModel() const
            {
                return _changeThreadingModel;
            }
            ...
            int
            getKeyEventChangeEndBarrierPosition() const
            {
                return _keyEventChangeEndBarrierPosition;
            }
            ...
            bool
            getChangeEndBarrierPosition() const
            {
                return _changeEndBarrierPosition;
            }
    ...
    /**
     * Event handler allowing the user to record the animation "path" of a camera. In
     * it's current implementation, this handler cannot guarantee the final view matrix
     * is correct; it is conceivable that the matrix may be one frame off. Eh--not a big
     * deal! :)
    ...
    class OSGVIEWER_EXPORT RecordCameraPathHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            {
                _keyEventToggleRecord = key;
            }

            int
            getKeyEventToggleRecord() const
            {
                return _keyEventToggleRecord;
            }

            void
            setKeyEventTogglePlayback( int key )
            {
                _keyEventTogglePlayback = key;
            }

            int
            getKeyEventTogglePlayback() const
            {
                return _keyEventTogglePlayback;
            }

            void
            setAutoIncrementFilename( bool autoinc = true )
            {
                _autoinc = autoinc ? 0 : -1;
            }
    ...
    class OSGVIEWER_EXPORT LODScaleHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            {
                _keyEventIncreaseLODScale = key;
            }

            int
            getKeyEventIncreaseLODScale() const
            {
                return _keyEventIncreaseLODScale;
            }

            void
            setKeyEventDecreaseLODScale( int key )
            {
                _keyEventDecreaseLODScale = key;
            }

            int
            getKeyEventDecreaseLODScale() const
            {
                return _keyEventDecreaseLODScale;
            }
    ...
    class OSGVIEWER_EXPORT ToggleSyncToVBlankHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            {
                _keyEventToggleSyncToVBlank = key;
            }

            int
            getKeyEventToggleSyncToVBlankHandler() const
            {
                return _keyEventToggleSyncToVBlank;
            }
    ...
    class OSGVIEWER_EXPORT ScreenCaptureHandler : public osgGA::GUIEventHandler
    {
        public:
            ...
            class CaptureOperation : public osg::Referenced
            {
                public:
                    ...
                    virtual void
                    operator()( const osg::Image&  image,
                                const unsigned int context_id ) = 0;
            };

            /** Concrete implementation of a CaptureOperation that writes the screen
             * capture to a file. */
            class OSGVIEWER_EXPORT WriteToFile : public CaptureOperation
            {
                public:
                    ...
                    void
                    setSavePolicy( SavePolicy savePolicy )
                    {
            ...
            {
                _keyEventTakeScreenShot = key;
            }

            int
            getKeyEventTakeScreenShot() const
            {
                return _keyEventTakeScreenShot;
            }
            ...
            int
            getKeyEventToggleContinuousCapture() const
            {
                return _keyEventToggleContinuousCapture;
            }

            void
            setCaptureOperation( CaptureOperation* operation );
            CaptureOperation*
            getCaptureOperation() const;
        ...
        protected:
            ...
            void
            addCallbackToViewer( osgViewer::ViewerBase& viewer );
            void
            removeCallbackFromViewer( osgViewer::ViewerBase& viewer );
            osg::Camera*
            findAppropriateCameraForCallback( osgViewer::ViewerBase& viewer );
    };

    /** InteractiveImage is an event handler that computes the mouse coordinates in an
     * images coordinate frame and then passes keyboard and mouse events to it.  This
     * event handler is useful for vnc or browser surfaces in the 3D scene.*/
    class OSGVIEWER_EXPORT InteractiveImageHandler
        : public osg::Inherit<osgGA::GUIEventHandler, InteractiveImageHandler>,
          public osg::DrawableCullCallback
    {
        public:

            /// Constructor to use when the InteractiveImage is in the 3D scene (i.e. not
            /// in a fullscreen HUD overlay).
            InteractiveImageHandler( osg::Image* image );
            /// Constructor to use when the InteractiveImage is in a fullscreen HUD
            /// overlay.
            InteractiveImageHandler( osg::Image*     image,
            ...
            {
                return new InteractiveImageHandler();
            }

            osg::Object*
            clone( const osg::CopyOp& copyop ) const override
            {
                return new InteractiveImageHandler( *this, copyop );
            }

            bool
            isSameKindAs( const osg::Object* obj ) const override
            {
                return dynamic_cast<const InteractiveImageHandler*>( obj ) != NULL;
            }
            ...
            InteractiveImageHandler( const InteractiveImageHandler& rhs,
        ...
        protected:
            ...
            bool
            mousePosition( osgViewer::View*              view,
                           osg::NodeVisitor*             nv,
