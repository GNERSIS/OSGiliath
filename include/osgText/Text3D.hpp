...
namespace osgText
{
    ...
    class OSGTEXT_EXPORT Text3D : public osg::Inherit<osgText::TextBase, Text3D>
    {
        public:
            ...
            OSG_REGISTER_TYPE( osgText,
                               Text3D ) /** Get the Charactere Depth of text. */
            float
            getCharacterDepth() const;

            /** Set the Charactere Depth of text. */
            void
            setCharacterDepth( float characterDepth );
            ...
            {
                if( _wallStateSet.valid() == false )
                {
                    _wallStateSet = new osg::StateSet;
                }
                return _wallStateSet.get();
            }
            ...
            void
            setWallStateSet( osg::StateSet* wallStateSet )
            {
                _wallStateSet = wallStateSet;
            }
            ...
            getBackStateSet()
            {
                return _backStateSet.get();
            }

            /** Get the back StateSet */
            osg::StateSet*
            getBackStateSet() const
            {
                return _backStateSet.get();
            }
            ...
            {
                if( _backStateSet.valid() == false )
                {
                    _backStateSet = new osg::StateSet;
                }
                return _backStateSet.get();
            }
            ...
            void
            setBackStateSet( osg::StateSet* backStateSet )
            {
                _backStateSet = backStateSet;
            }
             ...
             * internal primtives that this Drawable has.*/
            virtual void
        ...
        protected:
            ...
            {
                    GlyphRenderInfo( GlyphGeometry* glyphGeometry,
                                     osg::vec3&     pos ) :
