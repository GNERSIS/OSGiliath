 ...
 * DLL export/import macros for the osgText library.
 * Defines OSGTEXT_EXPORT for shared library symbol visibility.
 */
#pragma once
...
The osgText library is a NodeKit that extends the core scene graph to support high
quality text.
*/
