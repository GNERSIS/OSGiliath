...
namespace osgShadow
{
    ...
    class OSGSHADOW_EXPORT ProjectionShadowMap : public MinimalBoundsBaseClass
    {
        public:
            ...
            /** Convenient typedef used in definition of ViewData struct and methods */
            typedef ProjectionShadowMap<MinimalBoundsBaseClass,
            ...
            ProjectionShadowMap( const ProjectionShadowMap& copy,
        ...
        protected:
            ...
            virtual void init( ThisClass * st, osgUtil::CullVisitor * cv );
            {
                BaseClass::ViewData::init( st, cv );
                    ...
                    {
                        if( pass ==
                            BaseClass::ViewData::_frameShadowCastingCameraPasses -
                            1 )
                        {
                            // Force dependent name lookup
                            ShadowProjectionAlgorithmClass::operator()(
                                &this->_sceneReceivingShadowPolytope,
                                cameraMain,
                                cameraShadow
                            );
                        }
