...
namespace osgShadow
{
    ...
    class OSGSHADOW_EXPORT MinimalShadowMap
        : public osg::Inherit<StandardShadowMap, MinimalShadowMap>
    {
        public:
            ...
            MinimalShadowMap( const MinimalShadowMap& msm,
            ...
            void
            setModellingSpaceToWorldTransform( const osg::dmat4& modellingSpaceToWorld )
            {
                _modellingSpaceToWorld = modellingSpaceToWorld;
            }

            const osg::dmat4&
            getModellingSpaceToWorldTransform( void ) const
            {
                return _modellingSpaceToWorld;
            }

            float
            getMaxFarPlane() const
            {
                return _maxFarPlane;
            }

            void
            setMaxFarPlane( float maxFarPlane )
            {
                _maxFarPlane = maxFarPlane;
            }

            float
            getMinLightMargin() const
            {
                return _minLightMargin;
            }

            void
            setMinLightMargin( float minLightMargin )
            {
            ...
            void
            setShadowReceivingCoarseBoundAccuracy(
        ...
        protected:
            ...
            // built in XZY space which would require identity matrix with swapped
            // columns
            ...
            struct OSGSHADOW_EXPORT ViewData : public BaseClass::ViewData
            {
                    ...
                    virtual osg::box
                    computeShadowReceivingCoarseBounds();
                    ...
                    virtual void
                    frameShadowCastingCamera( const osg::Camera* cameraMain,
                                              osg::Camera*       cameraShadow,
                                              int                pass = 1 );

                    void
                    cutScenePolytope( const osg::dmat4& matrix,
                    ...
                    osg::box
                    computeScenePolytopeBounds();
                    osg::box
                    computeScenePolytopeBounds( const osg::dmat4& m );
                    ...
                    static void
                    trimProjection( osg::dmat4&  projection,
                                    osg::box     subrange,
                                    unsigned int trimMask = ( 1 | 2 | 4 | 8 | 16 | 32 )
                                    /*1=left|2=right|4=bottom|8=top|16=near|32=far*/ );

                    static void
                    clampProjection( osg::dmat4& projection,
                                     float       n = 0,
                                     float       f = FLT_MAX );

                    static void
                    extendProjection( osg::dmat4&      projection,
