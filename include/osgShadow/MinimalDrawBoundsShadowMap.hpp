...
namespace osgShadow
{
        ...
        : public osg::Inherit<MinimalShadowMap, MinimalDrawBoundsShadowMap>
    {
        public:
            ...
            MinimalDrawBoundsShadowMap( const MinimalDrawBoundsShadowMap& mdbsm,
        ...
        protected:
            ...
            struct OSGSHADOW_EXPORT ViewData : public BaseClass::ViewData
            {
                    ...
                    void
                    setShadowCameraProjectionMatrixPtr( osg::RefMatrix* projection )
                    {
                        _projection = projection;
                    }

                    osg::RefMatrix*
                    getShadowCameraProjectionMatrixPtr( void )
                    {
                    ...
                    virtual void
                    recordShadowMapParams();

                    virtual void
                    cullBoundAnalysisScene();

                    static osg::box
                    scanImage( const osg::Image* image,
                               osg::dmat4        m );

                    virtual void
                    performBoundAnalysis( const osg::Camera& camera );

                    ViewData( void ) :
                        _boundAnalysisSize( 64,
                                            64 )
                    {
                    }
            ...
            struct CameraCullCallback : public osg::Callback
            {
                    ...
                    CameraCullCallback( ViewData*      vd,
                                        osg::Callback* nc ) :
                        _vd( vd ),
                        _nc( nc )
                    {
                    ...
                    {
                        osgUtil::CullVisitor* cv =
                            dynamic_cast<osgUtil::CullVisitor*>( data );
