...
#include <osgTerrain/ValidDataOperator.hpp>
...
#define MAXIMUM_NUMBER_OF_LEVELS 30
     ...
     * set:setname:filename". Returns a setname of "" when non set:setname: entry is
     * present.*/
    extern OSGTERRAIN_EXPORT void
    extractSetNameAndFileName( const std::string& compoundstring,
                               std::string&       setname,
                               std::string&       filename );

    /** Create a compound string in the form set:setname:filename, or just filename if
     * setname is "".*/
    extern OSGTERRAIN_EXPORT std::string
    createCompoundSetNameAndFileName( const std::string& setname,
                                      const std::string& filename );

    class OSGTERRAIN_EXPORT Layer : public osg::Inherit<osg::Object, Layer>
    {
        public:
            ...
            void
            setSetName( const std::string& setname )
            {
                setName( setname );
            }
            ...
            /** Return the compound name of the layer in the form set::name::filename
             * string.*/
            std::string
            getCompoundName() const
            {
                return createCompoundSetNameAndFileName( getName(), getFileName() );
            }
            ...
            template<class T>
            void
            setLocator( const osg::ref_ptr<T>& locator )
            {
            ...
            void
            setMaxLevel( unsigned int maxLevel )
            {
                _maxLevel = maxLevel;
            }
            ...
            void
            setValidDataOperator( ValidDataOperator* validDataOp )
            {
            ...
            ValidDataOperator*
            getValidDataOperator()
            {
                return _validDataOperator.get();
            }

            /** Get the const data validation operator. */
            const ValidDataOperator*
            getValidDataOperator() const
            {
                return _validDataOperator.get();
            }
            ...
            void
            setDefaultValue( const osg::vec4& value )
            {
                _defaultValue = value;
            }
            ...
            /** Set the minification texture filter to use when a texture is associated
             * with this layer.*/
            void
            setMinFilter( osg::Texture::FilterMode filter )
            {
                _minFilter = filter;
            }

            /** Get the minification texture filter to use when a texture is associated
             * with this layer.*/
             ...
             * with this layer.*/
            void
            setMagFilter( osg::Texture::FilterMode filter )
            {
                _magFilter = filter;
            }

            /** Get the magnification texture filter to use when a texture is associated
             * with this layer.*/
            osg::Texture::FilterMode
            getMagFilter() const
            {
             ...
             */
            inline bool
            getInterpolatedValue( double ndc_x,
                                  double ndc_y,
                                  float& value ) const
            {
                unsigned int i, j;
                ...
                r = static_cast<float>( ( 1.0 - ir ) * ( 1.0 - jr ) );
            ...
            inline bool
            getInterpolatedValidValue( double ndc_x,
                                       double ndc_y,
                                       float& value ) const
            {
                unsigned int i, j;
            ...
            virtual osg::sphere
            computeBound( bool treatAsElevationLayer ) const;
    ...
    class OSGTERRAIN_EXPORT ImageLayer : public osg::Inherit<Layer, ImageLayer>
    {
        public:
            ...
            /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
            ImageLayer( const ImageLayer&  imageLayer,
                        const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY );
            ...
            template<class T>
            void
            setImage( const osg::ref_ptr<T>& image )
            {
                return setImage( image.get() );
            }
            ...
            getNumColumns() const
            {
                return _image.valid() ? static_cast<unsigned int>( _image->s() ) : 0;
            }

            virtual unsigned int
            getNumRows() const
            {
                return _image.valid() ? static_cast<unsigned int>( _image->t() ) : 0;
            }
    ...
    class OSGTERRAIN_EXPORT ContourLayer : public osg::Inherit<Layer, ContourLayer>
    {
        public:
            ...
            /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
            ContourLayer( const ContourLayer& tfLayer,
                          const osg::CopyOp&  copyop = osg::CopyOp::SHALLOW_COPY );
            ...
            void
            setTransferFunction( osg::TransferFunction1D* tf );

            template<class T>
            void
            setTransferFunction( const osg::ref_ptr<T>& tf )
            {
                return setTransferFunction( tf.get() );
            }
            ...
            getImage()
            {
                return _tf.valid() ? _tf->getImage() : 0;
            }
    ...
    class OSGTERRAIN_EXPORT HeightFieldLayer
        : public osg::Inherit<Layer, HeightFieldLayer>
    {
        public:
            ...
            /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
            HeightFieldLayer( const HeightFieldLayer& hfLayer,
                              const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY );
            ...
            void
            setHeightField( osg::HeightField* hf );

            template<class T>
            void
            setHeightField( const osg::ref_ptr<T>& hf )
            {
                return setHeightField( hf.get() );
            }
    ...
    class OSGTERRAIN_EXPORT ProxyLayer : public osg::Inherit<Layer, ProxyLayer>
    {
        public:
            ...
            /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
            ProxyLayer( const ProxyLayer&  proxyLayer,
                        const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY );
            ...
            void
            setImplementation( Layer* layer )
            {
                _implementation = layer;
            }
    ...
    class OSGTERRAIN_EXPORT CompositeLayer : public osg::Inherit<Layer, CompositeLayer>
    {
        public:
            ...
            /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
            CompositeLayer( const CompositeLayer& compositeLayer,
                            const osg::CopyOp&    copyop = osg::CopyOp::SHALLOW_COPY );

            OSG_REGISTER_TYPE( osgTerrain,
                               CompositeLayer )

            using Layer::getFileName;
            using Layer::setFileName;
            ...
            void
            setSetName( unsigned int       i,
                        const std::string& setname )
            {
                _layers[i].setname = setname;
                if( _layers[i].layer.valid() )
                {
            ...
            const std::string&
            getSetName( unsigned int i ) const
            {
                return _layers[i].layer.valid() ? _layers[i].layer->getName()
                                                : _layers[i].setname;
            }

            /** Set the file name of the data associated with layer 'i'. */
            void
            setFileName( unsigned int       i,
                         const std::string& filename )
            {
            ...
            {
                return _layers[i].layer.valid() ? _layers[i].layer->getFileName()
                                                : _layers[i].filename;
            }

            void
            setCompoundName( unsigned int       i,
                             const std::string& compoundname );
            std::string
            getCompoundName( unsigned int i ) const;

            void
            setLayer( unsigned int i,
                      Layer*       layer )
            {
                if( i >= _layers.size() )
                {
            ...
            {
                setLayer( i, layer.get() );
            }

            Layer*
            getLayer( unsigned int i )
            {
                return i < _layers.size() ? _layers[i].layer.get() : 0;
            }

            const Layer*
            getLayer( unsigned int i ) const
            {
                return i < _layers.size() ? _layers[i].layer.get() : 0;
            }

            void
            addLayer( const std::string& compoundname );

            void
            addLayer( const std::string& setname,
                      const std::string& filename );
            ...
            {
                _layers.push_back(
                    CompoundNameLayer( layer->getName(), layer->getFileName(), layer )
                );
            }

            template<class T>
            void
            addLayer( const osg::ref_ptr<T>& layer )
            {
                return addLayer( layer.get() );
            }

            void
            removeLayer( unsigned int i )
            {
        ...
        protected:
            ...
            struct CompoundNameLayer
            {
                    ...
                    CompoundNameLayer( const std::string& sn,
                                       const std::string& fn,
                                       Layer*             l ) :
                        setname( sn ),
                        filename( fn ),
                    ...
                    CompoundNameLayer&
                    operator=( const CompoundNameLayer& cnl )
                    {
                        if( &cnl == this )
                        {
                            return *this;
    ...
    class OSGTERRAIN_EXPORT SwitchLayer
        : public osg::Inherit<CompositeLayer, SwitchLayer>
    {
        public:
            ...
            /** Copy constructor using CopyOp to manage deep vs shallow copy.*/
            SwitchLayer( const SwitchLayer& switchLayer,
                         const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY );
            ...
            getImage()
            {
                ...
                if( _activeLayer >= static_cast<int>( getNumLayers() ) )
                {
                    return 0;
                }
                return _layers[static_cast<std::size_t>( _activeLayer )]
                    .layer->getImage();
            }
