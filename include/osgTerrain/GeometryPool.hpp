...
namespace osgTerrain
{
    ...
    extern OSGTERRAIN_EXPORT const osgTerrain::Locator*
    computeMasterLocator( const osgTerrain::TerrainTile* tile );

    class OSGTERRAIN_EXPORT SharedGeometry
        : public osg::Inherit<osg::Drawable, SharedGeometry>
    {
        public:

            SharedGeometry();

            SharedGeometry( const SharedGeometry&,
            ...
            void
            setTexCoordArray( osg::Array* array )
            {
                _texcoordArray = array;
            }

            osg::Array*
            getTexCoordArray()
            {
                return _texcoordArray.get();
            }

            const osg::Array*
            getTexCoordArray() const
            {
                return _texcoordArray.get();
            }

            void
            setDrawElements( osg::DrawElements* array )
            {
                _drawElements = array;
            }
            ...
            getDrawElements()
            {
                return _drawElements.get();
            }

            const osg::DrawElements*
            ...
            void
            setVertexToHeightFieldMapping( const VertexToHeightFieldMapping& vthfm )
            {
                _vertexToHeightFieldMapping = vthfm;
            }

            VertexToHeightFieldMapping&
            getVertexToHeightFieldMapping()
            {
                return _vertexToHeightFieldMapping;
            }

            const VertexToHeightFieldMapping&
            getVertexToHeightFieldMapping() const
            {
                return _vertexToHeightFieldMapping;
            }
            ...
            virtual void
            accept( osg::Drawable::ConstAttributeFunctor& ) const;
    ...
    class OSGTERRAIN_EXPORT GeometryPool : public osg::Referenced
    {
        public:
            ...
            struct GeometryKey
            {
                    ...
                    bool
                    operator<( const GeometryKey& rhs ) const
                    {
                        if( sx < rhs.sx )
                        {
                            return true;
            ...
            virtual bool
            createKeyForTile( TerrainTile* tile,
                              GeometryKey& key );
            ...
            osg::StateSet*
            getRootStateSetForTerrain( Terrain* terrain );

            virtual osg::ref_ptr<osg::Program>
            getOrCreateProgram( LayerTypes& layerTypes );

            virtual osg::ref_ptr<SharedGeometry>
            getOrCreateGeometry( osgTerrain::TerrainTile* tile );

            virtual osg::ref_ptr<osg::MatrixTransform>
            getTileSubgraph( osgTerrain::TerrainTile* tile );

            virtual void
            applyLayers( osgTerrain::TerrainTile* tile,
    ...
    class OSGTERRAIN_EXPORT HeightFieldDrawable
        : public osg::Inherit<osg::Drawable, HeightFieldDrawable>
    {
        public:

            HeightFieldDrawable();

            HeightFieldDrawable( const HeightFieldDrawable&,
                                 const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY );
            ...
            void
            setGeometry( SharedGeometry* geom )
            {
                _geometry = geom;
            }
