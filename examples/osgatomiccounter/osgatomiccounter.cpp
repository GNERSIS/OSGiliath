 ...
 * osgatomiccounter example application
 */
#include <iostream>
...
class AdaptNumPixelUniform : public osg::Camera::DrawCallback
{
    public:
        ...
        operator()( osg::RenderInfo& renderInfo ) const
        {
            ...
            unsigned int numPixel = std::max( 1U, _atomicCounterArray->front() );
...
class ResetAtomicCounter : public osg::StateAttributeCallback
{
    public:
        ...
        virtual void
        operator()( osg::StateAttribute* sa,
                    osg::NodeVisitor* )
        {
            osg::AtomicCounterBufferBinding* acbb =
                dynamic_cast<osg::AtomicCounterBufferBinding*>( sa );
            if( acbb )
            {
      ...
      char** argv )
{
    ...
    arguments.getApplicationUsage()->setDescription(
        arguments.getApplicationName() +
        " is a simple example which show draw order of pixel."
    );
    ...
    {
        osg::Geometry* quad =
            osg::createTexturedQuadGeometry( osg::vec3( -2.0F, 0.0F, -2.0F ),
                                             osg::vec3( 2.0F, 0.0F, 0.0F ),
                                             osg::vec3( 0.0F, 0.0F, 2.0F ) );
    ...
    ss->setAttributeAndModes( createProgram(),
    ...
    osg::ref_ptr<osg::AtomicCounterBufferObject> acboRedAndGreen =
    ...
    osg::ref_ptr<osg::AtomicCounterBufferObject> acboBlue =
        new osg::AtomicCounterBufferObject;
    acboBlue->setUsage( GL_STREAM_COPY );
    atomicCounterArrayBlue->setBufferObject( acboBlue.get() );

    osg::ref_ptr<osg::AtomicCounterBufferBinding> acbbRedAndGreen =
        new osg::AtomicCounterBufferBinding( 0,
                                             atomicCounterArrayRedAndGreen.get(),
                                             0,
                                             sizeof( GLuint ) * 3 );
    ss->setAttributeAndModes( acbbRedAndGreen.get() );

    osg::ref_ptr<osg::AtomicCounterBufferBinding> acbbBlue =
        new osg::AtomicCounterBufferBinding( 2,
                                             atomicCounterArrayBlue.get(),
                                             0,
                                             sizeof( GLuint ) );
    ...
    osg::ref_ptr<osg::Uniform> invNumPixelUniform =
        new osg::Uniform( "invNumPixel", 1.0F / ( 800.0F * 600.0F ) );
