...
// USE_TEXTURE_RECTANGLE disabled for Core Profile - regular Texture2D with NPOT works fine
...
protected:
    ...
    public:
        CullCallback(unsigned int texUnit, unsigned int offsetValue, unsigned int texWidth = 0, unsigned int texHeight = 0);
