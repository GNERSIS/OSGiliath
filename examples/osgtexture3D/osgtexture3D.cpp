 ...
 * osgtexture3D example application
 */
#include <iostream>
...
//
// A simple demo demonstrating use osg::Texture3D to create a blended animation between
// four separate images packed together into a 3d texture
//
...
class UpdateStateCallback : public osg::NodeCallback
{
    public:
        ...
        void
        animateState( osg::StateSet* /*stateset*/ )
        {
...
osg::Drawable*
createSquare( float textureCoordMax = 1.0F )
{
    // set up the Geometry.
