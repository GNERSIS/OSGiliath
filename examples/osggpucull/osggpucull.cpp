...
int main( int argc, char **argv )
{
    ...
    rootSS->addUniform(new osg::Uniform("lightPosition", osg::Vec4(1.0f, -1.0f, 1.0f, 0.0f)));
    rootSS->addUniform(new osg::Uniform("lightDiffuse", osg::Vec4(0.9f, 0.9f, 0.9f, 1.0f)));
    rootSS->addUniform(new osg::Uniform("lightAmbient", osg::Vec4(0.1f, 0.1f, 0.1f, 1.0f)));
