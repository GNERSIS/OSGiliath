...
createHUD()
{
    ...
    // add to this camera a subgraph to render
    {
        ...
        // disable depth test to ensure it's always ontop.
...
struct SnapImage : public osg::Camera::DrawCallback
{
        ...
        operator()( osg::RenderInfo& renderInfo ) const
        {
            ...
            osg::notify( osg::NOTICE )
                << "Camera callback " << camera << " " << viewport << std::endl;
      ...
      char** argv )
{
    ...
    // Headless capture: before any viewer construction
    {
        ...
        {
            return osg::headlessCapture( scene.get(), headlessOutput, 640, 480 ) ? 0 : 1;
        }
    }
