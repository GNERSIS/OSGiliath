...
namespace gsc
{
    ...
    class CaptureSettings : public osg::Inherit<osg::Object, CaptureSettings>
    {
        public:
            ...
            CaptureSettings();
            CaptureSettings( const CaptureSettings& cs,
            ...
            std::string
            getOutputFileName( unsigned int frameNumber ) const;
            std::string
            getOutputFileName( unsigned int cameraNumber,
            ...
            void
            setOutputImageFlip( bool flip )
            {
                _outputImageFlip = flip;
            }

            bool
            getOutputImageFlip() const
            {
            ...
            void
            setSampleBuffers( unsigned int s )
            {
                _sampleBuffers = s;
            }

            unsigned int
            getSampleBuffers() const
            {
            ...
            void
            setNumberOfFrames( unsigned int nf )
            {
                _numberOfFrames = nf;
            }
            ...
            void
            setEventHandlers( const EventHandlers& eh );
            ...
            void
            addUpdateProperty( UpdateProperty* up )
            {
                _properties.push_back( up );
            }

            void
            setProperties( const Properties& pl )
            {
                _properties = pl;
            }
