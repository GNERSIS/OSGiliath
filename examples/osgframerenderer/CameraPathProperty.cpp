...
void
CameraPathProperty::update( osgViewer::View* view )
{
    ...
    if( _animationPath.valid() )
    {
        ...
        OSG_NOTICE << "CameraPathProperty " << fs->getFrameNumber() << " "
                   << fs->getSimulationTime() << std::endl;
...
void
CameraPathProperty::loadAnimationPath()
{
...
bool
CameraPathProperty::getTimeRange( double& startTime,
                                  double& endTime ) const
{
    ...
    const osg::AnimationPath::TimeControlPointMap& tcpm =
        _animationPath->getTimeControlPointMap();
    if( tcpm.empty() )
    {
        return false;
    }
...
void
CameraPathProperty::resetTimeRange( double startTime,
                                    double endTime )
{
    if( !_animationPath )
    {
