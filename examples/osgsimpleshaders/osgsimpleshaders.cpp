 ...
 * osgsimpleshaders example application
 */
...
createCube()
{
    ...
    ( *normals )[7].set( 0, 0, -1 );
    // Top face
    ( *vertices )[8].set( -s, s, s );
    ( *normals )[8].set( 0, 1, 0 );
    ( *vertices )[9].set( s, s, s );
    ( *normals )[9].set( 0, 1, 0 );
    ( *vertices )[10].set( s, s, -s );
    ( *normals )[10].set( 0, 1, 0 );
    ( *vertices )[11].set( -s, s, -s );
    ( *normals )[11].set( 0, 1, 0 );
    // Bottom face
    ( *vertices )[12].set( -s, -s, -s );
    ( *normals )[12].set( 0, -1, 0 );
    ( *vertices )[13].set( s, -s, -s );
    ( *normals )[13].set( 0, -1, 0 );
    ( *vertices )[14].set( s, -s, s );
    ( *normals )[14].set( 0, -1, 0 );
    ( *vertices )[15].set( -s, -s, s );
    ( *normals )[15].set( 0, -1, 0 );
    // Right face
    ( *vertices )[16].set( s, -s, s );
    ( *normals )[16].set( 1, 0, 0 );
    ( *vertices )[17].set( s, -s, -s );
    ( *normals )[17].set( 1, 0, 0 );
    ( *vertices )[18].set( s, s, -s );
    ( *normals )[18].set( 1, 0, 0 );
    ( *vertices )[19].set( s, s, s );
    ( *normals )[19].set( 1, 0, 0 );
    // Left face
    ( *vertices )[20].set( -s, -s, -s );
    ( *normals )[20].set( -1, 0, 0 );
    ( *vertices )[21].set( -s, -s, s );
    ( *normals )[21].set( -1, 0, 0 );
    ( *vertices )[22].set( -s, s, s );
    ( *normals )[22].set( -1, 0, 0 );
    ( *vertices )[23].set( -s, s, -s );
    ( *normals )[23].set( -1, 0, 0 );
