 ...
 * osgparticle example application
 */
...
// for more details.
class VortexOperator : public osg::Inherit<osgParticle::Operator, VortexOperator>
{
    public:
        ...
        VortexOperator( const VortexOperator& copy,
        ...
        void
        operate( osgParticle::Particle* P,
                 double                 dt )
        {
            float     l  = osg::dot( xf_axis_, P->getPosition() - xf_center_ );
...
create_simple_particle_system( osg::Group* root )
{
...
osgParticle::ParticleSystem*
create_complex_particle_system( osg::Group* root )
{
    ...
    ptemplate.setColorRange( osgParticle::rangev4( osg::vec4( 1, 0.5F, 0.3F, 1.5F ),
...
osgParticle::ParticleSystem*
create_animated_particle_system( osg::Group* root )
{
    ...
    pexplosion.setColorRange( osgParticle::rangev4( osg::vec4( 1, 1, 1, 1 ),
                                                    osg::vec4( 1, 1, 1, 1 ) ) );
    ...
    shooter->setInitialRotationalSpeedRange(
        osgParticle::rangev3( osg::vec3( 0, 0, -1 ), osg::vec3( 0, 0, 1 ) )
    );
