...
#include "MFC_OSG_MDI.hpp"
#include "MFC_OSG_MDIDoc.hpp"
#include "MFC_OSG_MDIView.hpp"
#include "stdafx.hpp"
...
IMPLEMENT_DYNCREATE( CMFC_OSG_MDIView,
                     CView )

BEGIN_MESSAGE_MAP( CMFC_OSG_MDIView,
                   CView )
ON_WM_CREATE()
ON_WM_DESTROY()
ON_WM_KEYDOWN()
...
BOOL
CMFC_OSG_MDIView::PreCreateWindow( CREATESTRUCT& cs )
{
    return CView::PreCreateWindow( cs );
}

void
CMFC_OSG_MDIView::OnDraw( CDC* /*pDC*/ )
{
...
#ifdef _DEBUG
void
CMFC_OSG_MDIView::AssertValid() const
{
    CView::AssertValid();
}

void
CMFC_OSG_MDIView::Dump( CDumpContext& dc ) const
{
    CView::Dump( dc );
}

CMFC_OSG_MDIDoc*
CMFC_OSG_MDIView::GetDocument() const    // non-debug version is inline
{
...
int
CMFC_OSG_MDIView::OnCreate( LPCREATESTRUCT lpCreateStruct )
{
...
void
CMFC_OSG_MDIView::OnInitialUpdate()
{
...
void
CMFC_OSG_MDIView::OnKeyDown( UINT nChar,
                             UINT nRepCnt,
                             UINT nFlags )
{
...
BOOL
CMFC_OSG_MDIView::OnEraseBkgnd( CDC* pDC )
{
