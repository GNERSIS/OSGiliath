...
// specified below. Refer to MSDN for the latest info on corresponding values for
// different platforms.
#ifndef WINVER     // Allow use of features specific to Windows XP or later.
    #define WINVER                                                                     \
        0X05'01    // Change this to the appropriate value to target other versions of
                   // Windows.
#endif
    ...
    #define _WIN32_WINDOWS \
        0X04'10    // Change this to the appropriate value to target Windows Me or later.
#endif

#ifndef _WIN32_IE    // Allow use of features specific to IE 6.0 or later.
    #define _WIN32_IE \
        0X06'00      // Change this to the appropriate value to target other versions of
                     // IE.
#endif
