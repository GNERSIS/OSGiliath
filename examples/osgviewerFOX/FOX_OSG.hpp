...
class GraphicsWindowFOX : public FXGLCanvas,
                          public osgViewer::GraphicsWindow
{
    ...
    public:
        ...
        GraphicsWindowFOX( FXComposite* parent,
                           FXGLVisual*  vis,
                           FXObject*    tgt  = NULL,
                           FXSelector   sel  = 0,
                           FXuint       opts = 0,
        ...
        onKeyPress( FXObject*,
                    ...
                    void* );
        long
        onKeyRelease( FXObject*,
                      FXSelector,
                      void* );
        long
        onLeftBtnPress( FXObject*,
                        FXSelector,
                        void* );
        long
        onLeftBtnRelease( FXObject*,
                          FXSelector,
                          void* );
        long
        onMiddleBtnPress( FXObject*,
                          FXSelector,
                          void* );
        long
        onMiddleBtnRelease( FXObject*,
                            FXSelector,
                            void* );
        long
        onRightBtnPress( FXObject*,
                         FXSelector,
                         void* );
        long
        onRightBtnRelease( FXObject*,
                           FXSelector,
                           void* );
        long
        onMotion( FXObject*,
