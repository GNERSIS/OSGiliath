...
FXIMPLEMENT( GraphicsWindowFOX,
             FXGLCanvas,
             GraphicsWindowFOX_Map,
             ARRAYNUMBER( GraphicsWindowFOX_Map ) )

GraphicsWindowFOX::GraphicsWindowFOX( FXComposite* parent,
                                      FXGLVisual*  vis,
                                      FXObject*    tgt,
                                      FXSelector   sel,
                                      FXuint       opts,
...
void
GraphicsWindowFOX::grabFocusIfPointerInWindow()
{
    // do nothing
}

void
GraphicsWindowFOX::useCursor( bool cursorOn )
{
    if( cursorOn )
    {
        // show the old cursor
...
bool
GraphicsWindowFOX::makeCurrentImplementation()
{
...
bool
GraphicsWindowFOX::releaseContext()
{
...
void
GraphicsWindowFOX::swapBuffersImplementation()
{
    FXGLCanvas::swapBuffers();
}

long
GraphicsWindowFOX::onConfigure( FXObject*  sender,
                                FXSelector sel,
                                void*      ptr )
{
...
long
GraphicsWindowFOX::onKeyPress( FXObject*  sender,
                               FXSelector sel,
                               void*      ptr )
{
...
long
GraphicsWindowFOX::onKeyRelease( FXObject*  sender,
                                 FXSelector sel,
                                 void*      ptr )
{
    int key = ( ( FXEvent* )ptr )->code;
...
long
GraphicsWindowFOX::onLeftBtnRelease( FXObject*  sender,
                                     FXSelector sel,
                                     void*      ptr )
{
    FXEvent* event = ( FXEvent* )ptr;
...
long
GraphicsWindowFOX::onMiddleBtnPress( FXObject*  sender,
                                     FXSelector sel,
                                     void*      ptr )
{
    handle( this, FXSEL( SEL_FOCUS_SELF, 0 ), ptr );
...
long
GraphicsWindowFOX::onMiddleBtnRelease( FXObject*  sender,
                                       FXSelector sel,
                                       void*      ptr )
{
    FXEvent* event = ( FXEvent* )ptr;
...
long
GraphicsWindowFOX::onRightBtnPress( FXObject*  sender,
                                    FXSelector sel,
                                    void*      ptr )
{
    handle( this, FXSEL( SEL_FOCUS_SELF, 0 ), ptr );
...
long
GraphicsWindowFOX::onRightBtnRelease( FXObject*  sender,
                                      FXSelector sel,
                                      void*      ptr )
{
    FXEvent* event = ( FXEvent* )ptr;
...
long
GraphicsWindowFOX::onMotion( FXObject*  sender,
                             FXSelector sel,
                             void*      ptr )
{
    FXEvent* event = ( FXEvent* )ptr;
