...
class Notebook : public osgWidget::Box
{
    ...
    public:
        ...
        bool
        callbackTabPressed( osgWidget::Event& ev )
        {
            osgWidget::Canvas::Vector& objs = _windows->getObjects();

            for( unsigned int i = 0; i < objs.size(); i++ )
            {
                objs[i]->setLayer( osgWidget::Widget::LAYER_MIDDLE, i * 2 );
            }

            _windows->getByName( ev.getWidget()->getName() )
                ->setLayer( osgWidget::Widget::LAYER_MIDDLE, objs.size() * 2 );
                            ...
                            osgWidget::Box::VERTICAL )
        {
            ...
            for( unsigned int i = 0; i < 4; i++ )
            {
                ...
                descr << "This is some text" << std::endl
                ...
                label1->addCallback(
                    new osgWidget::Callback( &Notebook::callbackTabPressed,
                                             this,
