...
class OSGGTKDrawingArea : public osgViewer::Viewer
{
        ...
        _realize( GtkWidget* );
        void
        _unrealize( GtkWidget* );
        bool
        _expose_event( GtkWidget*,
                       GdkEventExpose* );
        bool
        _configure_event( GtkWidget*,
                          GdkEventConfigure* );
        bool
        _motion_notify_event( GtkWidget*,
                              GdkEventMotion* );
        bool
        _button_press_event( GtkWidget*,
                             GdkEventButton* );
        bool
        _key_press_event( GtkWidget*,
                          GdkEventKey* );
        ...
        static bool
        _sexpose_event( GtkWidget*      widget,
        ...
        static bool
        _sconfigure_event( GtkWidget*         widget,
        ...
        static bool
        _smotion_notify_event( GtkWidget*      widget,
        ...
        static bool
        _sbutton_press_event( GtkWidget*      widget,
        ...
        static bool
        _skey_press_event( GtkWidget*   widget,
                           GdkEventKey* event,
                           gpointer     self )
        {
    ...
    protected:
        ...
        stateButton()
        {
            return _state & ( GDK_BUTTON1_MASK |
                              GDK_BUTTON2_MASK |
                              GDK_BUTTON3_MASK |
                              GDK_BUTTON4_MASK |
                              GDK_BUTTON5_MASK );
