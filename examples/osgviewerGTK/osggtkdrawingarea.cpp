...
bool
OSGGTKDrawingArea::createWidget( int width,
                                 int height )
{
    ...
    gtk_widget_set_gl_capability( _widget, _glconfig, 0, true, GDK_GL_RGBA_TYPE );
    ...
    _connect( "motion_notify_event",
              G_CALLBACK( &OSGGTKDrawingArea::_smotion_notify_event ) );
    _connect( "button_press_event",
              G_CALLBACK( &OSGGTKDrawingArea::_sbutton_press_event ) );
    _connect( "button_release_event",
              G_CALLBACK( &OSGGTKDrawingArea::_sbutton_press_event ) );
...
void
OSGGTKDrawingArea::_realize( GtkWidget* widget )
{
...
void
OSGGTKDrawingArea::_unrealize( GtkWidget* widget )
{
    gtkUnrealize();
}

bool
OSGGTKDrawingArea::_expose_event( GtkWidget*      widget,
...
bool
OSGGTKDrawingArea::_configure_event( GtkWidget*         widget,
...
bool
OSGGTKDrawingArea::_motion_notify_event( GtkWidget*      widget,
...
bool
OSGGTKDrawingArea::_button_press_event( GtkWidget*      widget,
...
bool
OSGGTKDrawingArea::_key_press_event( GtkWidget*   widget,
                                     GdkEventKey* event )
{
    _state = event->state;
