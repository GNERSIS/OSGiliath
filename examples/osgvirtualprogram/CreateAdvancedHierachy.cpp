...
void
SetVirtualProgramShader( VirtualProgram*   virtualProgram,
...
CreateAdvancedHierarchy( osg::Node* model )
{
    ...
    transformCenterMiddle->setMatrix(
        osg::dmat4( osg::translate( 0.0F, 0.0F, offset * 0.5F ) )
    );
    ...
    transformCenterTop->setMatrix( osg::dmat4( osg::translate( 0.0F, 0.0F, offset ) ) );
    ...
    transformCenterBottom->setMatrix(
        osg::dmat4( osg::translate( 0.0F, 0.0F, -offset ) )
    );
    ...
    transformLeftBottom->setMatrix(
        osg::dmat4( osg::translate( -offset * 0.8F, 0.0F, -offset * 0.8F ) )
    );
    ...
    transformRightBottom->setMatrix(
        osg::dmat4( osg::translate( offset * 0.8F, 0.0F, -offset * 0.8F ) )
    );
    ...
    if( 1 )
    {
        ...
        SetVirtualProgramShader( vp,
                                 "texture",
                                 osg::Shader::VERTEX,
                                 "Vertex Texture Coord 0",
                                 TexCoordTextureVertexShaderSource );
        ...
        SetVirtualProgramShader( vp,
                                 ...
                                 osg::Shader::VERTEX,
                                 "Vertex Lighting",
                                 PerVertexDirectionalLightingVertexShaderSource );

        SetVirtualProgramShader( vp,
                                 "lighting",
                                 osg::Shader::FRAGMENT,
                                 "Fragment Lighting",
                                 PerVertexLightingFragmentShaderSource );

        transformCenterMiddle->getOrCreateStateSet()->addUniform(
            new osg::Uniform( "baseTexture", 0 )
        );
    }
    ...
    if( 1 )
    {
        ...
        SetVirtualProgramShader( vp,
                                 "texture",
                                 osg::Shader::VERTEX,
                                 "Vertex Texture Sphere Map",
                                 SphereMapTextureVertexShaderSource );

        osg::Texture2D* texture =
            new osg::Texture2D( osgDB::readRefImageFile( "Images/skymap.jpg" ) );
    ...
    if( 1 )
    {
        AddLabel( transformCenterTop,
                  "Fixed Vertex + Simple Fragment osg::Program",
                  offset );
