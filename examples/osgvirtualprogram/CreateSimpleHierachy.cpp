...
////////////////////////////////////////////////////////////////////////////////
osg::Node*
CreateSimpleHierarchy( osg::Node* node )
{
    if( !node )
    {
        return NULL;
    ...
    transform0->setMatrix( osg::dmat4( osg::translate( 0.0F, 0.0F, r ) ) );

    osg::MatrixTransform* transform1 = new osg::MatrixTransform();
    transform1->setMatrix( osg::dmat4( osg::translate( 0.0F, 0.0F, 0.0F ) ) );

    osg::MatrixTransform* transform2 = new osg::MatrixTransform();
    transform2->setMatrix( osg::dmat4( osg::translate( -r, 0.0F, -r ) ) );

    osg::MatrixTransform* transform3 = new osg::MatrixTransform();
    transform3->setMatrix( osg::dmat4( osg::translate( r, 0.0F, -r ) ) );
    ...
    if( 1 )
    {
        ...
        colorFilter->setShaderSource( "#version 460 core\n"
                                      "vec4 ColorFilter( in vec4 color ) \n"
                                      "{ \n"
    ...
    if( 1 )
    {
        ...
        redFilter->setShaderSource( "#version 460 core\n"
                                    "vec4 ColorFilter( in vec4 color ) \n"
                                    "{ \n"
