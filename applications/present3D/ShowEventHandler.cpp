...
bool
ShowEventHandler::handle( const osgGA::GUIEventAdapter& ea,
                          ...
                          osg::NodeVisitor* /*nv*/ )
{
    switch( ea.getEventType() )
    {
        case( osgGA::GUIEventAdapter::KEYUP ) :
            {
                osg::notify( osg::INFO )
                    << "ShowEventHandler KEYUP " << ( int )ea.getKey() << std::endl;
                if( ea.getKey() >=
...
void
ShowEventHandler::getUsage( osg::ApplicationUsage& /*usage*/ ) const
{
}
