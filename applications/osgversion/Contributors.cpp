...
NamePair                            NameRobertOsfield( "Robert",
                                                       "Osfield" );
NamePair                            NameDonBurns( "Don",
                                                  "Burns" );

const char*                         validNames[]   = { "de", "den", "van", "von" };
...
TypoCorrection typoCorrections[] = {
    ...
    {      "Inverson",        "Iverson"},
    {      "Iversion",        "Iverson"},
    {"Jean-Sebastein", "Jean-S�bastien"},
    {"Jean-Sebastian", "Jean-S�bastien"},
    {"Jean-Sebastirn", "Jean-S�bastien"},
...
NameCorrection nameCorrections[] = {
    {     "LaurensVoerman", "GetScalarValue",        "Laurens",               "Voerman"},
    {     "LaurensVoerman",     "Meta_Shape",        "Laurens",               "Voerman"},
    {     "LaurensVoerman",    "OpenCascade",        "Laurens",               "Voerman"},
    {     "LaurensVoerman",            "Fri",        "Laurens",               "Voerman"},
    {     "LaurensVoerman",               "",        "Laurens",               "Voerman"},
    {            "Laurens",        "Loerman",        "Laurens",               "Voerman"},
    {     "FrancoisTigeot",               "",       "Francois",                "Tigeot"},
    {               "Juan",         "Manuel",           "Juan",        "Manuel Alvarez"},
    {               "Jaap",            "Gas",           "Jaap",                  "Glas"},
    {             "Philip",           "Lamp",         "Philip",                  "Lamb"},
    {               "Dimi",       "Christop",           "Dimi",         "Christopoulos"},
    {              "Jorge",          "Ciges",          "Jorge",       "Izquierdo Ciges"},
    {              "Jorge",      "Izquierdo",          "Jorge",       "Izquierdo Ciges"},
    {               "Rafa",           "Gata",           "Rafa",                "Gaitan"},
    {           "Sukender",              "I",       "Sukender",                      ""},
    {           "Sukender",           "Here",       "Sukender",                      ""},
    {           "Sukender",            "Fix",       "Sukender",                      ""},
    {                "Ewe",       "Woessner",            "Uwe",              "Woessner"},
    {             "Martin",            "von",         "Martin",           "von Gargern"},
    {          "Alexandre",          "Irion",      "Alexander",                 "Irion"},
    {"WojciechLewandowski",               "",       "Wojciech",           "Lewandowski"},
    {              "Marin",       "Platings",        "Michael",              "Platings"},
    {              "Tomas",       "Holgarth",         "Thomas",               "Hogarth"},
    {              "Marin",         "Lavery",         "Martin",                "Lavery"},
    {            "Michael",           "Bach",        "Michael",           "Bach Jensen"},
    {             "Nguyen",            "Van",         "Nguyen",            "Van Truong"},
    {               "Thom",          "Carlo",           "Thom",               "DeCarlo"},
    {            "Stephan",     "Lamoliatte",       "Stephane",            "Lamoliatte"},
    {             "Ronald",            "van",         "Ronald",        "van Maarseveen"},
    {                "Lee",         "Bulter",            "Lee",                "Butler"},
    {               "Tery",          "Welsh",          "Terry",                 "Welsh"},
    {              "Cesar",              "L",          "C�sar",        "L. B. Silveira"},
    {               "Marc",       "Sciabica",           "Mark",              "Sciabica"},
    {                "Tom",          "Moore",            "Tim",                 "Moore"},
    {               "Time",          "Moore",            "Tim",                 "Moore"},
    {               "Jean",      "Sebastien", "Jean-S�bastien",                  "Guay"},
    {            "Michale",       "Platings",        "Michael",              "Platings"},
    {               "Mick",               "",           "Maik",                "Keller"},
    {               "Gary",           "Quin",           "Gary",                 "Quinn"},
    {          "BjornHein",               "",          "Bj�rn",                  "Hein"},
    {              "Bjorn",           "Hein",          "Bj�rn",                  "Hein"},
    {               "Erik",            "van",           "Erik",            "den Dekker"},
    {               "Erik",            "den",           "Erik",            "den Dekker"},
    {              "Jeoen",            "den",         "Jeroen",            "den Dekker"},
    {               "John",          "Vidar",           "John",         "Vidar Larring"},
    {               "John",           "Vida",           "John",         "Vidar Larring"},
    {          "Sebastien",  "Messerschmidt",      "Sebastian",         "Messerschmidt"},
    {            "Mattias",       "Fr�hlich",        "Mathias",              "Fr�hlich"},
    {            "Mathias",        "Helsing",        "Mattias",               "Helsing"},
    {               "Jose",        "Delport",           "J.P.",               "Delport"},
    {               "Jos�",        "Delport",           "J.P.",               "Delport"},
    {              "Franz",       "Melchior",       "Melchior",                 "Franz"},
    {               "Glen",         "Waldon",          "Glenn",               "Waldron"},
    {               "Glen",        "Waldron",          "Glenn",               "Waldron"},
    {               "Ralf",           "Karn",           "Ralf",                  "Kern"},
    {              "Donny",       "Cipperly",         "Donald",              "Cipperly"},
    {               "Gino",            "van",           "Gino",        "van den Bergen"},
    {               "Radu",          "Mihai",          "Mihai",                  "Radu"},
    {                "Art",          "Trevs",            "Art",                  "Tevs"},
    {                "Tim",           "More",            "Tim",                 "Moore"},
    {              "Andre",        "Garneau",          "Andr�",               "Garneau"},
    {               "Eric",         "Hammil",          "Chris",                "Hanson"},
    {               "Paul",             "de",           "Paul",         "de Repentigny"},
    {            "Raymond",             "de",        "Raymond",              "de Vries"},
    {               "Nick",               "",         "Trajce",               "Nikolov"},
    {             "Daniel",               "",         "Daniel",                "Sj�lie"},
    {              "Julia",          "Ortiz",         "Julian",                 "Ortiz"},
    {               "Rune",        "Schmidt",           "Rune",        "Schmidt Jensen"},
    {             "Romano",           "Jos�",         "Romano", "Jos� Magacho da Silva"},
    {            "Rommano",          "Silva",         "Romano", "Jos� Magacho da Silva"},
    {             "Romano",        "Magacho",         "Romano", "Jos� Magacho da Silva"},
    {            "Leandro",          "Motta",        "Leandro",          "Motta Barros"},
    {            "Leandro",          "Motto",        "Leandro",          "Motta Barros"},
    {                  "A",       "Botorabi",            "Ali",              "Botorabi"},
    {            "Waltice",               "",         "Walter",             "J. Altice"},
    {               "Drew",               "",           "Drew",            "Whitehouse"},
    {            "Douglas",              "A",        "Douglas",               "A. Pouk"},
    {              "Colin",      "MacDonald",          "Colin",              "McDonald"},
    {            "Nikolov",         "Trajce",         "Trajce",               "Nikolov"},
    {           "Frauciel",            "Luc",            "Luc",              "Frauciel"},
    {            "Alberto",          "Lucas",        "Alberto",                "Luaces"},
    {            "Alberto",         "Luacus",        "Alberto",                "Luaces"},
    {               "Tyge",               "",           "Tyge",                "L�vset"},
    {             "Ricard",        "Schmidt",        "Richard",               "Schmidt"},
    {           "Matthias",        "Helsing",        "Mattias",               "Helsing"},
    {            "Clement",         "Boesch",        "Cl�ment",                 "B�sch"},
    {             "Lauren",        "Voerman",        "Laurens",               "Voerman"},
    {              "Pjotr",     "Sventachov",          "Pjotr",             "Svetachov"},
    {            "Bradley",          "Baker",        "Bradley",         "Baker Searles"},
    {  "PawelKsiezopolski",               "",          "Pawel",          "Ksiezopolski"},
    {             "Albert",         "Luaces",        "Alberto",                "Luaces"},
    {                "KOS",               "",     "Konstantin",              "Matveyev"},
    {              "WeSee",               "",          "Alois",                "Wismer"},
    {                 "We",            "See",          "Alois",                "Wismer"},
...
string
typoCorrection( const string& name )
{
    // Loop over all known typo corrections
    for( unsigned int i = 0; i < sizeof( typoCorrections ) / sizeof( TypoCorrection );
         ++i )
    {
        // If a typo is found
...
void
nameCorrection( NamePair& name )
{
    // Loop over all known name corrections
    for( unsigned int i = 0; i < sizeof( nameCorrections ) / sizeof( NameCorrection );
         ++i )
    {
        // If a matching name is found
        if( name.first ==
            nameCorrections[i].originalFirst &&
...
void
lastValidCharacter( const string& name,
                    unsigned int& pos,
                    char          c )
{
            ...
            const string& second )
{
    ...
    if( second.empty() || !validName( second ) )
    {
...
bool
submissionsSequence( const Words&  words,
                     unsigned int& i )
{
    if( i + 1 >= words.size() )
    {
...
void
readContributors( NameMap&      names,
                  const string& file )
{
    ...
    if( names.size() > 1 )
    {
        for( NameMap::iterator itr = names.begin(); itr != names.end(); )
        {
            if( itr->first.second.empty() )
            {
                ...
                if( next_itr !=
                    names.end() &&
                    itr->first.first == next_itr->first.first )
                {
...
void
buildContributors( NameMap& names )
{
